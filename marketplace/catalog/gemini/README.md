...
- An API key for the Gemini API. You can obtain one from [Google AI
  Studio](https://makersuite.google.com/).

## Configuration

The configuration for this example is in `config.yaml`. It defines a single
upstream service for Gemini.

To use this example, you need to set the `GEMINI_API_KEY` environment variable
