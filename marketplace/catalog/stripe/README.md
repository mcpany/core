...
You can use this service to create a new charge. You will need to provide the
amount, currency, and a payment source.
...
This service requires a Stripe API key. You will need to set the
`STRIPE_API_KEY` environment variable to your API key. The `config.yaml` file is
already configured to use this environment variable.
