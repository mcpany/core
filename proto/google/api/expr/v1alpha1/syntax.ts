    ...
    return {
      ...
      positions: isObject(object.positions)
        ? (globalThis.Object.entries(object.positions) as [string, any][]).reduce(
          (acc: Map<Long, number>, [key, value]: [string, any]) => {
            acc.set(Long.fromValue(key), globalThis.Number(value));
            return acc;
          },
          new Map(),
        )
      ...
      macroCalls: isObject(object.macroCalls)
        ? (globalThis.Object.entries(object.macroCalls) as [string, any][]).reduce(
          (acc: Map<Long, Expr>, [key, value]: [string, any]) => {
...
export const SourceInfo_Extension: MessageFns<SourceInfo_Extension> = {
  ...
  create<I extends Exact<DeepPartial<SourceInfo_Extension>, I>>(base?: I): SourceInfo_Extension {
    return SourceInfo_Extension.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SourceInfo_Extension>, I>>(object: I): SourceInfo_Extension {
    const message = createBaseSourceInfo_Extension();
...
export const SourceInfo_Extension_Version: MessageFns<SourceInfo_Extension_Version> = {
  ...
  create<I extends Exact<DeepPartial<SourceInfo_Extension_Version>, I>>(base?: I): SourceInfo_Extension_Version {
    return SourceInfo_Extension_Version.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SourceInfo_Extension_Version>, I>>(object: I): SourceInfo_Extension_Version {
    const message = createBaseSourceInfo_Extension_Version();
