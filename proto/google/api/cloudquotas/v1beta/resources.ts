...
import { Int64Value } from "../../../protobuf/wrappers";
...
export const QuotaInfo: MessageFns<QuotaInfo> = {
  ...
  fromJSON(object: any): QuotaInfo {
    return {
      ...
      isPrecise: isSet(object.isPrecise)
        ? globalThis.Boolean(object.isPrecise)
        : isSet(object.is_precise)
        ? globalThis.Boolean(object.is_precise)
        : false,
      ...
      containerType: isSet(object.containerType)
        ? quotaInfo_ContainerTypeFromJSON(object.containerType)
        : isSet(object.container_type)
        ? quotaInfo_ContainerTypeFromJSON(object.container_type)
        : 0,
      dimensions: globalThis.Array.isArray(object?.dimensions)
        ? object.dimensions.map((e: any) => globalThis.String(e))
        : [],
      metricDisplayName: isSet(object.metricDisplayName)
        ? globalThis.String(object.metricDisplayName)
        : isSet(object.metric_display_name)
        ? globalThis.String(object.metric_display_name)
        : "",
      quotaDisplayName: isSet(object.quotaDisplayName)
        ? globalThis.String(object.quotaDisplayName)
        : isSet(object.quota_display_name)
        ? globalThis.String(object.quota_display_name)
        : "",
      metricUnit: isSet(object.metricUnit)
        ? globalThis.String(object.metricUnit)
        : isSet(object.metric_unit)
        ? globalThis.String(object.metric_unit)
        : "",
      quotaIncreaseEligibility: isSet(object.quotaIncreaseEligibility)
        ...
        : isSet(object.quota_increase_eligibility)
        ? QuotaIncreaseEligibility.fromJSON(object.quota_increase_eligibility)
        : undefined,
      isFixed: isSet(object.isFixed)
        ? globalThis.Boolean(object.isFixed)
        : isSet(object.is_fixed)
        ? globalThis.Boolean(object.is_fixed)
        : false,
      dimensionsInfos: globalThis.Array.isArray(object?.dimensionsInfos)
        ...
        : globalThis.Array.isArray(object?.dimensions_infos)
        ? object.dimensions_infos.map((e: any) => DimensionsInfo.fromJSON(e))
        : [],
      isConcurrent: isSet(object.isConcurrent)
        ? globalThis.Boolean(object.isConcurrent)
        : isSet(object.is_concurrent)
        ? globalThis.Boolean(object.is_concurrent)
        : false,
      serviceRequestQuotaUri: isSet(object.serviceRequestQuotaUri)
        ? globalThis.String(object.serviceRequestQuotaUri)
        : isSet(object.service_request_quota_uri)
        ? globalThis.String(object.service_request_quota_uri)
        : "",
    };
  },
  ...
  create<I extends Exact<DeepPartial<QuotaInfo>, I>>(base?: I): QuotaInfo {
    return QuotaInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QuotaInfo>, I>>(object: I): QuotaInfo {
    const message = createBaseQuotaInfo();
...
export const QuotaIncreaseEligibility: MessageFns<QuotaIncreaseEligibility> = {
  ...
  fromJSON(object: any): QuotaIncreaseEligibility {
    return {
      ...
      ineligibilityReason: isSet(object.ineligibilityReason)
        ...
        ? quotaIncreaseEligibility_IneligibilityReasonFromJSON(object.ineligibility_reason)
        : 0,
    };
  },
  ...
  create<I extends Exact<DeepPartial<QuotaIncreaseEligibility>, I>>(base?: I): QuotaIncreaseEligibility {
    return QuotaIncreaseEligibility.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QuotaIncreaseEligibility>, I>>(object: I): QuotaIncreaseEligibility {
    const message = createBaseQuotaIncreaseEligibility();
...
export const QuotaPreference: MessageFns<QuotaPreference> = {
  encode(message: QuotaPreference, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.dimensions).forEach(([key, value]: [string, string]) => {
  ...
  fromJSON(object: any): QuotaPreference {
    return {
      ...
      dimensions: isObject(object.dimensions)
        ? (globalThis.Object.entries(object.dimensions) as [string, any][]).reduce(
        ...
        : {},
      quotaConfig: isSet(object.quotaConfig)
        ? QuotaConfig.fromJSON(object.quotaConfig)
        : isSet(object.quota_config)
        ? QuotaConfig.fromJSON(object.quota_config)
        : undefined,
  ...
  toJSON(message: QuotaPreference): unknown {
    ...
    if (message.dimensions) {
      const entries = globalThis.Object.entries(message.dimensions) as [string, string][];
      if (entries.length > 0) {
        obj.dimensions = {};
        entries.forEach(([k, v]) => {
          obj.dimensions[k] = v;
  ...
  create<I extends Exact<DeepPartial<QuotaPreference>, I>>(base?: I): QuotaPreference {
    return QuotaPreference.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QuotaPreference>, I>>(object: I): QuotaPreference {
    const message = createBaseQuotaPreference();
    message.name = object.name ?? "";
    message.dimensions = (globalThis.Object.entries(object.dimensions ?? {}) as [string, string][]).reduce(
...
export const QuotaPreference_DimensionsEntry: MessageFns<QuotaPreference_DimensionsEntry> = {
  ...
  create<I extends Exact<DeepPartial<QuotaPreference_DimensionsEntry>, I>>(base?: I): QuotaPreference_DimensionsEntry {
    return QuotaPreference_DimensionsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QuotaPreference_DimensionsEntry>, I>>(
    object: I,
  ): QuotaPreference_DimensionsEntry {
    const message = createBaseQuotaPreference_DimensionsEntry();
...
export const QuotaConfig: MessageFns<QuotaConfig> = {
  ...
  fromJSON(object: any): QuotaConfig {
    return {
      preferredValue: isSet(object.preferredValue)
        ? Long.fromValue(object.preferredValue)
        : isSet(object.preferred_value)
        ? Long.fromValue(object.preferred_value)
        : Long.ZERO,
      stateDetail: isSet(object.stateDetail)
        ? globalThis.String(object.stateDetail)
        : isSet(object.state_detail)
        ? globalThis.String(object.state_detail)
        : "",
      grantedValue: isSet(object.grantedValue)
        ? Long.fromValue(object.grantedValue)
        : isSet(object.granted_value)
        ? Long.fromValue(object.granted_value)
        : undefined,
      ...
      annotations: isObject(object.annotations)
        ...
        : {},
      requestOrigin: isSet(object.requestOrigin)
        ? quotaConfig_OriginFromJSON(object.requestOrigin)
        : isSet(object.request_origin)
        ? quotaConfig_OriginFromJSON(object.request_origin)
        : 0,
    };
  },
  ...
  create<I extends Exact<DeepPartial<QuotaConfig>, I>>(base?: I): QuotaConfig {
    return QuotaConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QuotaConfig>, I>>(object: I): QuotaConfig {
    const message = createBaseQuotaConfig();
...
export const QuotaConfig_AnnotationsEntry: MessageFns<QuotaConfig_AnnotationsEntry> = {
  ...
  create<I extends Exact<DeepPartial<QuotaConfig_AnnotationsEntry>, I>>(base?: I): QuotaConfig_AnnotationsEntry {
    return QuotaConfig_AnnotationsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QuotaConfig_AnnotationsEntry>, I>>(object: I): QuotaConfig_AnnotationsEntry {
    const message = createBaseQuotaConfig_AnnotationsEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
export const DimensionsInfo: MessageFns<DimensionsInfo> = {
  ...
  fromJSON(object: any): DimensionsInfo {
    return {
      ...
      applicableLocations: globalThis.Array.isArray(object?.applicableLocations)
        ...
        : globalThis.Array.isArray(object?.applicable_locations)
        ? object.applicable_locations.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<DimensionsInfo>, I>>(base?: I): DimensionsInfo {
    return DimensionsInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DimensionsInfo>, I>>(object: I): DimensionsInfo {
    const message = createBaseDimensionsInfo();
    message.dimensions = (globalThis.Object.entries(object.dimensions ?? {}) as [string, string][]).reduce(
      (acc: { [key: string]: string }, [key, value]: [string, string]) => {
        if (value !== undefined) {
...
export const DimensionsInfo_DimensionsEntry: MessageFns<DimensionsInfo_DimensionsEntry> = {
  ...
  create<I extends Exact<DeepPartial<DimensionsInfo_DimensionsEntry>, I>>(base?: I): DimensionsInfo_DimensionsEntry {
    return DimensionsInfo_DimensionsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DimensionsInfo_DimensionsEntry>, I>>(
    object: I,
  ): DimensionsInfo_DimensionsEntry {
    const message = createBaseDimensionsInfo_DimensionsEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
export const QuotaDetails: MessageFns<QuotaDetails> = {
  ...
  fromJSON(object: any): QuotaDetails {
    return {
      ...
      rolloutInfo: isSet(object.rolloutInfo)
        ? RolloutInfo.fromJSON(object.rolloutInfo)
        : isSet(object.rollout_info)
        ? RolloutInfo.fromJSON(object.rollout_info)
        : undefined,
    };
  },
...
export const RolloutInfo: MessageFns<RolloutInfo> = {
  ...
  fromJSON(object: any): RolloutInfo {
    return {
      ongoingRollout: isSet(object.ongoingRollout)
        ? globalThis.Boolean(object.ongoingRollout)
        : isSet(object.ongoing_rollout)
        ? globalThis.Boolean(object.ongoing_rollout)
        : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<RolloutInfo>, I>>(base?: I): RolloutInfo {
    return RolloutInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RolloutInfo>, I>>(object: I): RolloutInfo {
    const message = createBaseRolloutInfo();
