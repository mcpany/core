...
export const Monitoring_MonitoringDestination: MessageFns<Monitoring_MonitoringDestination> = {
  ...
  create<I extends Exact<DeepPartial<Monitoring_MonitoringDestination>, I>>(
    base?: I,
  ): Monitoring_MonitoringDestination {
    return Monitoring_MonitoringDestination.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Monitoring_MonitoringDestination>, I>>(
    object: I,
  ): Monitoring_MonitoringDestination {
    const message = createBaseMonitoring_MonitoringDestination();
