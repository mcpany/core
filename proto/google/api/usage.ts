  ...
  fromJSON(object: any): Usage {
    return {
      ...
      producerNotificationChannel: isSet(object.producerNotificationChannel)
        ...
        : isSet(object.producer_notification_channel)
        ? globalThis.String(object.producer_notification_channel)
        : "",
    };
  },
...
export const UsageRule: MessageFns<UsageRule> = {
  ...
  fromJSON(object: any): UsageRule {
    return {
      ...
      allowUnregisteredCalls: isSet(object.allowUnregisteredCalls)
        ...
        : isSet(object.allow_unregistered_calls)
        ? globalThis.Boolean(object.allow_unregistered_calls)
        : false,
      skipServiceControl: isSet(object.skipServiceControl)
        ? globalThis.Boolean(object.skipServiceControl)
        : isSet(object.skip_service_control)
        ? globalThis.Boolean(object.skip_service_control)
        : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<UsageRule>, I>>(base?: I): UsageRule {
    return UsageRule.fromPartial(base ?? ({} as any));
  },
