...
export const FieldInfo: MessageFns<FieldInfo> = {
  ...
  fromJSON(object: any): FieldInfo {
    return {
      ...
      referencedTypes: globalThis.Array.isArray(object?.referencedTypes)
        ...
        : globalThis.Array.isArray(object?.referenced_types)
        ? object.referenced_types.map((e: any) => TypeReference.fromJSON(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<FieldInfo>, I>>(base?: I): FieldInfo {
    return FieldInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FieldInfo>, I>>(object: I): FieldInfo {
    const message = createBaseFieldInfo();
...
export const TypeReference: MessageFns<TypeReference> = {
  ...
  create<I extends Exact<DeepPartial<TypeReference>, I>>(base?: I): TypeReference {
    return TypeReference.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TypeReference>, I>>(object: I): TypeReference {
    const message = createBaseTypeReference();
