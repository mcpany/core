...
export const ConfigChange: MessageFns<ConfigChange> = {
  ...
  fromJSON(object: any): ConfigChange {
    return {
      ...
      changeType: isSet(object.changeType)
        ...
        ? changeTypeFromJSON(object.change_type)
        : 0,
      advices: globalThis.Array.isArray(object?.advices)
  ...
  create<I extends Exact<DeepPartial<ConfigChange>, I>>(base?: I): ConfigChange {
    return ConfigChange.fromPartial(base ?? ({} as any));
  },
...
export const Advice: MessageFns<Advice> = {
  ...
  create<I extends Exact<DeepPartial<Advice>, I>>(base?: I): Advice {
    return Advice.fromPartial(base ?? ({} as any));
  },
