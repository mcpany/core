...
export const MonitoredResourceMetadata: MessageFns<MonitoredResourceMetadata> = {
  encode(message: MonitoredResourceMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.userLabels).forEach(([key, value]: [string, string]) => {
  ...
  fromJSON(object: any): MonitoredResourceMetadata {
    return {
      systemLabels: isObject(object.systemLabels)
        ? object.systemLabels
        : isObject(object.system_labels)
        ? object.system_labels
        : undefined,
      userLabels: isObject(object.userLabels)
        ? (globalThis.Object.entries(object.userLabels) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
        ...
        : isObject(object.user_labels)
        ? (globalThis.Object.entries(object.user_labels) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
  ...
  toJSON(message: MonitoredResourceMetadata): unknown {
    ...
    if (message.userLabels) {
      const entries = globalThis.Object.entries(message.userLabels) as [string, string][];
      if (entries.length > 0) {
        obj.userLabels = {};
        entries.forEach(([k, v]) => {
          obj.userLabels[k] = v;
  ...
  fromPartial<I extends Exact<DeepPartial<MonitoredResourceMetadata>, I>>(object: I): MonitoredResourceMetadata {
    ...
    message.userLabels = (globalThis.Object.entries(object.userLabels ?? {}) as [string, string][]).reduce(
      (acc: { [key: string]: string }, [key, value]: [string, string]) => {
        if (value !== undefined) {
          acc[key] = globalThis.String(value);
        }
