...
export const AuthenticationRule: MessageFns<AuthenticationRule> = {
  ...
  fromJSON(object: any): AuthenticationRule {
    return {
      ...
      allowWithoutCredential: isSet(object.allowWithoutCredential)
        ...
        : isSet(object.allow_without_credential)
        ? globalThis.Boolean(object.allow_without_credential)
        : false,
  ...
  create<I extends Exact<DeepPartial<AuthenticationRule>, I>>(base?: I): AuthenticationRule {
    return AuthenticationRule.fromPartial(base ?? ({} as any));
  },
...
export const JwtLocation: MessageFns<JwtLocation> = {
  ...
  fromJSON(object: any): JwtLocation {
    return {
      ...
      valuePrefix: isSet(object.valuePrefix)
        ? globalThis.String(object.valuePrefix)
        : isSet(object.value_prefix)
        ? globalThis.String(object.value_prefix)
        : "",
    };
  },
  ...
  create<I extends Exact<DeepPartial<JwtLocation>, I>>(base?: I): JwtLocation {
    return JwtLocation.fromPartial(base ?? ({} as any));
  },
...
export const AuthProvider: MessageFns<AuthProvider> = {
  ...
  fromJSON(object: any): AuthProvider {
    return {
      ...
      jwksUri: isSet(object.jwksUri)
        ? globalThis.String(object.jwksUri)
        : isSet(object.jwks_uri)
        ? globalThis.String(object.jwks_uri)
        : "",
      ...
      jwtLocations: globalThis.Array.isArray(object?.jwtLocations)
        ...
        : globalThis.Array.isArray(object?.jwt_locations)
  ...
  create<I extends Exact<DeepPartial<AuthProvider>, I>>(base?: I): AuthProvider {
    return AuthProvider.fromPartial(base ?? ({} as any));
  },
...
export const OAuthRequirements: MessageFns<OAuthRequirements> = {
  ...
  fromJSON(object: any): OAuthRequirements {
    return {
      canonicalScopes: isSet(object.canonicalScopes)
        ? globalThis.String(object.canonicalScopes)
        : isSet(object.canonical_scopes)
        ? globalThis.String(object.canonical_scopes)
        : "",
    };
  },
  ...
  create<I extends Exact<DeepPartial<OAuthRequirements>, I>>(base?: I): OAuthRequirements {
    return OAuthRequirements.fromPartial(base ?? ({} as any));
  },
...
export const AuthRequirement: MessageFns<AuthRequirement> = {
  ...
  create<I extends Exact<DeepPartial<AuthRequirement>, I>>(base?: I): AuthRequirement {
    return AuthRequirement.fromPartial(base ?? ({} as any));
  },
