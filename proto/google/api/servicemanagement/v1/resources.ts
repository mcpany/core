...
export const ManagedService: MessageFns<ManagedService> = {
  ...
  create<I extends Exact<DeepPartial<ManagedService>, I>>(base?: I): ManagedService {
    return ManagedService.fromPartial(base ?? ({} as any));
  },
...
export const OperationMetadata_Step: MessageFns<OperationMetadata_Step> = {
  ...
  create<I extends Exact<DeepPartial<OperationMetadata_Step>, I>>(base?: I): OperationMetadata_Step {
    return OperationMetadata_Step.fromPartial(base ?? ({} as any));
  },
...
function createBaseConfigFile(): ConfigFile {
  return { filePath: "", fileContents: new Uint8Array(0), fileType: 0 };
}
...
export const ConfigFile: MessageFns<ConfigFile> = {
  ...
  fromJSON(object: any): ConfigFile {
    return {
      ...
      fileContents: isSet(object.fileContents)
        ...
        : isSet(object.file_contents)
        ? bytesFromBase64(object.file_contents)
        : new Uint8Array(0),
      fileType: isSet(object.fileType)
        ? configFile_FileTypeFromJSON(object.fileType)
        : isSet(object.file_type)
        ? configFile_FileTypeFromJSON(object.file_type)
        : 0,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ConfigFile>, I>>(object: I): ConfigFile {
    ...
    message.fileContents = object.fileContents ?? new Uint8Array(0);
...
export const ConfigRef: MessageFns<ConfigRef> = {
  ...
  create<I extends Exact<DeepPartial<ConfigRef>, I>>(base?: I): ConfigRef {
    return ConfigRef.fromPartial(base ?? ({} as any));
  },
...
export const ChangeReport: MessageFns<ChangeReport> = {
  ...
  fromJSON(object: any): ChangeReport {
    return {
      configChanges: globalThis.Array.isArray(object?.configChanges)
        ...
        : globalThis.Array.isArray(object?.config_changes)
        ? object.config_changes.map((e: any) => ConfigChange.fromJSON(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<ChangeReport>, I>>(base?: I): ChangeReport {
    return ChangeReport.fromPartial(base ?? ({} as any));
  },
  ...
  fromJSON(object: any): Rollout {
    return {
      ...
      trafficPercentStrategy: isSet(object.trafficPercentStrategy)
        ...
        : isSet(object.traffic_percent_strategy)
        ? Rollout_TrafficPercentStrategy.fromJSON(object.traffic_percent_strategy)
        : undefined,
      deleteServiceStrategy: isSet(object.deleteServiceStrategy)
        ...
        : isSet(object.delete_service_strategy)
        ? Rollout_DeleteServiceStrategy.fromJSON(object.delete_service_strategy)
        : undefined,
      serviceName: isSet(object.serviceName)
        ? globalThis.String(object.serviceName)
        : isSet(object.service_name)
...
export const Rollout_TrafficPercentStrategy: MessageFns<Rollout_TrafficPercentStrategy> = {
  encode(message: Rollout_TrafficPercentStrategy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.percentages).forEach(([key, value]: [string, number]) => {
  ...
  fromJSON(object: any): Rollout_TrafficPercentStrategy {
    return {
      percentages: isObject(object.percentages)
        ? (globalThis.Object.entries(object.percentages) as [string, any][]).reduce(
  ...
  toJSON(message: Rollout_TrafficPercentStrategy): unknown {
    ...
    if (message.percentages) {
      const entries = globalThis.Object.entries(message.percentages) as [string, number][];
      if (entries.length > 0) {
        obj.percentages = {};
        entries.forEach(([k, v]) => {
          obj.percentages[k] = v;
  ...
  create<I extends Exact<DeepPartial<Rollout_TrafficPercentStrategy>, I>>(base?: I): Rollout_TrafficPercentStrategy {
    return Rollout_TrafficPercentStrategy.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Rollout_TrafficPercentStrategy>, I>>(
    object: I,
  ): Rollout_TrafficPercentStrategy {
    const message = createBaseRollout_TrafficPercentStrategy();
    message.percentages = (globalThis.Object.entries(object.percentages ?? {}) as [string, number][]).reduce(
...
> = {
  ...
  create<I extends Exact<DeepPartial<Rollout_TrafficPercentStrategy_PercentagesEntry>, I>>(
    base?: I,
  ): Rollout_TrafficPercentStrategy_PercentagesEntry {
    return Rollout_TrafficPercentStrategy_PercentagesEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Rollout_TrafficPercentStrategy_PercentagesEntry>, I>>(
    object: I,
  ): Rollout_TrafficPercentStrategy_PercentagesEntry {
    const message = createBaseRollout_TrafficPercentStrategy_PercentagesEntry();
...
export const Rollout_DeleteServiceStrategy: MessageFns<Rollout_DeleteServiceStrategy> = {
  ...
  create<I extends Exact<DeepPartial<Rollout_DeleteServiceStrategy>, I>>(base?: I): Rollout_DeleteServiceStrategy {
    return Rollout_DeleteServiceStrategy.fromPartial(base ?? ({} as any));
  },
