  ...
  fromJSON(object: any): HttpRequest {
    return {
      requestMethod: isSet(object.requestMethod)
        ? globalThis.String(object.requestMethod)
        : isSet(object.request_method)
        ? globalThis.String(object.request_method)
        : "",
      requestUrl: isSet(object.requestUrl)
        ? globalThis.String(object.requestUrl)
        : isSet(object.request_url)
        ? globalThis.String(object.request_url)
        : "",
      requestSize: isSet(object.requestSize)
        ? Long.fromValue(object.requestSize)
        : isSet(object.request_size)
        ? Long.fromValue(object.request_size)
        : Long.ZERO,
      status: isSet(object.status) ? globalThis.Number(object.status) : 0,
      responseSize: isSet(object.responseSize)
        ? Long.fromValue(object.responseSize)
        : isSet(object.response_size)
        ? Long.fromValue(object.response_size)
        : Long.ZERO,
      userAgent: isSet(object.userAgent)
        ...
        : "",
      remoteIp: isSet(object.remoteIp)
        ? globalThis.String(object.remoteIp)
        : isSet(object.remote_ip)
        ? globalThis.String(object.remote_ip)
        : "",
      serverIp: isSet(object.serverIp)
        ? globalThis.String(object.serverIp)
        : isSet(object.server_ip)
        ? globalThis.String(object.server_ip)
        : "",
      ...
      cacheLookup: isSet(object.cacheLookup)
        ? globalThis.Boolean(object.cacheLookup)
        : isSet(object.cache_lookup)
        ? globalThis.Boolean(object.cache_lookup)
        : false,
      ...
      cacheValidatedWithOriginServer: isSet(object.cacheValidatedWithOriginServer)
        ...
        : isSet(object.cache_validated_with_origin_server)
        ? globalThis.Boolean(object.cache_validated_with_origin_server)
        : false,
      cacheFillBytes: isSet(object.cacheFillBytes)
        ? Long.fromValue(object.cacheFillBytes)
        : isSet(object.cache_fill_bytes)
        ? Long.fromValue(object.cache_fill_bytes)
        : Long.ZERO,
