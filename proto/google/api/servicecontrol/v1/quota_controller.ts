...
export const AllocateQuotaRequest: MessageFns<AllocateQuotaRequest> = {
  ...
  fromJSON(object: any): AllocateQuotaRequest {
    return {
      ...
      allocateOperation: isSet(object.allocateOperation)
        ...
        : isSet(object.allocate_operation)
        ? QuotaOperation.fromJSON(object.allocate_operation)
        : undefined,
  ...
  create<I extends Exact<DeepPartial<AllocateQuotaRequest>, I>>(base?: I): AllocateQuotaRequest {
    return AllocateQuotaRequest.fromPartial(base ?? ({} as any));
  },
...
export const QuotaOperation: MessageFns<QuotaOperation> = {
  ...
  fromJSON(object: any): QuotaOperation {
    return {
      ...
      quotaMetrics: globalThis.Array.isArray(object?.quotaMetrics)
        ...
        : globalThis.Array.isArray(object?.quota_metrics)
        ? object.quota_metrics.map((e: any) => MetricValueSet.fromJSON(e))
        : [],
      quotaMode: isSet(object.quotaMode)
        ? quotaOperation_QuotaModeFromJSON(object.quotaMode)
        : isSet(object.quota_mode)
        ? quotaOperation_QuotaModeFromJSON(object.quota_mode)
        : 0,
    };
  },
  ...
  create<I extends Exact<DeepPartial<QuotaOperation>, I>>(base?: I): QuotaOperation {
    return QuotaOperation.fromPartial(base ?? ({} as any));
  },
...
export const QuotaOperation_LabelsEntry: MessageFns<QuotaOperation_LabelsEntry> = {
  ...
  create<I extends Exact<DeepPartial<QuotaOperation_LabelsEntry>, I>>(base?: I): QuotaOperation_LabelsEntry {
    return QuotaOperation_LabelsEntry.fromPartial(base ?? ({} as any));
  },
...
export const AllocateQuotaResponse: MessageFns<AllocateQuotaResponse> = {
  ...
  fromJSON(object: any): AllocateQuotaResponse {
    return {
      ...
      allocateErrors: globalThis.Array.isArray(object?.allocateErrors)
        ...
        : globalThis.Array.isArray(object?.allocate_errors)
        ? object.allocate_errors.map((e: any) => QuotaError.fromJSON(e))
        : [],
      quotaMetrics: globalThis.Array.isArray(object?.quotaMetrics)
        ? object.quotaMetrics.map((e: any) => MetricValueSet.fromJSON(e))
        : globalThis.Array.isArray(object?.quota_metrics)
  ...
  create<I extends Exact<DeepPartial<AllocateQuotaResponse>, I>>(base?: I): AllocateQuotaResponse {
    return AllocateQuotaResponse.fromPartial(base ?? ({} as any));
  },
...
export const QuotaError: MessageFns<QuotaError> = {
  ...
  create<I extends Exact<DeepPartial<QuotaError>, I>>(base?: I): QuotaError {
    return QuotaError.fromPartial(base ?? ({} as any));
  },
...
export interface QuotaController {
   ...
   */
  AllocateQuota(request: DeepPartial<AllocateQuotaRequest>, metadata?: grpc.Metadata): Promise<AllocateQuotaResponse>;
}
...
export class QuotaControllerClientImpl implements QuotaController {
  ...
  AllocateQuota(request: DeepPartial<AllocateQuotaRequest>, metadata?: grpc.Metadata): Promise<AllocateQuotaResponse> {
    return this.rpc.unary(QuotaControllerAllocateQuotaDesc, AllocateQuotaRequest.fromPartial(request), metadata);
  }
}

export const QuotaControllerDesc = { serviceName: "google.api.servicecontrol.v1.QuotaController" };

export const QuotaControllerAllocateQuotaDesc: UnaryMethodDefinitionish = {
  methodName: "AllocateQuota",
  service: QuotaControllerDesc,
  requestStream: false,
  responseStream: false,
  requestType: {
    serializeBinary() {
      return AllocateQuotaRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = AllocateQuotaResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
