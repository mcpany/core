  ...
  fromJSON(object: any): Operation {
    return {
      ...
      metricValueSets: globalThis.Array.isArray(object?.metricValueSets)
        ...
        : globalThis.Array.isArray(object?.metric_value_sets)
        ? object.metric_value_sets.map((e: any) => MetricValueSet.fromJSON(e))
        : [],
      logEntries: globalThis.Array.isArray(object?.logEntries)
        ...
        ? object.log_entries.map((e: any) => LogEntry.fromJSON(e))
        : [],
...
export const Operation_LabelsEntry: MessageFns<Operation_LabelsEntry> = {
  ...
  create<I extends Exact<DeepPartial<Operation_LabelsEntry>, I>>(base?: I): Operation_LabelsEntry {
    return Operation_LabelsEntry.fromPartial(base ?? ({} as any));
  },
