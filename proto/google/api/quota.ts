...
export const MetricRule: MessageFns<MetricRule> = {
  encode(message: MetricRule, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.metricCosts).forEach(([key, value]: [string, Long]) => {
  ...
  fromJSON(object: any): MetricRule {
    return {
      ...
      metricCosts: isObject(object.metricCosts)
        ? (globalThis.Object.entries(object.metricCosts) as [string, any][]).reduce(
        ...
        : isObject(object.metric_costs)
        ? (globalThis.Object.entries(object.metric_costs) as [string, any][]).reduce(
          (acc: { [key: string]: Long }, [key, value]: [string, any]) => {
            acc[key] = Long.fromValue(value as Long | string);
            return acc;
          },
  ...
  toJSON(message: MetricRule): unknown {
    ...
    if (message.metricCosts) {
      const entries = globalThis.Object.entries(message.metricCosts) as [string, Long][];
      if (entries.length > 0) {
        obj.metricCosts = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<MetricRule>, I>>(object: I): MetricRule {
    ...
    message.metricCosts = (globalThis.Object.entries(object.metricCosts ?? {}) as [string, Long][]).reduce(
...
export const MetricRule_MetricCostsEntry: MessageFns<MetricRule_MetricCostsEntry> = {
  ...
  create<I extends Exact<DeepPartial<MetricRule_MetricCostsEntry>, I>>(base?: I): MetricRule_MetricCostsEntry {
    return MetricRule_MetricCostsEntry.fromPartial(base ?? ({} as any));
  },
...
export const QuotaLimit: MessageFns<QuotaLimit> = {
  encode(message: QuotaLimit, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.values).forEach(([key, value]: [string, Long]) => {
  ...
  fromJSON(object: any): QuotaLimit {
    return {
      ...
      maxLimit: isSet(object.maxLimit)
        ...
        : isSet(object.max_limit)
        ? Long.fromValue(object.max_limit)
        : Long.ZERO,
      freeTier: isSet(object.freeTier)
        ? Long.fromValue(object.freeTier)
        : isSet(object.free_tier)
        ? Long.fromValue(object.free_tier)
        : Long.ZERO,
  ...
  toJSON(message: QuotaLimit): unknown {
    ...
    if (message.values) {
      const entries = globalThis.Object.entries(message.values) as [string, Long][];
      if (entries.length > 0) {
        obj.values = {};
        entries.forEach(([k, v]) => {
  ...
  create<I extends Exact<DeepPartial<QuotaLimit>, I>>(base?: I): QuotaLimit {
    return QuotaLimit.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QuotaLimit>, I>>(object: I): QuotaLimit {
    ...
    message.values = (globalThis.Object.entries(object.values ?? {}) as [string, Long][]).reduce(
      (acc: { [key: string]: Long }, [key, value]: [string, Long]) => {
        if (value !== undefined) {
          acc[key] = Long.fromValue(value);
        }
...
export const QuotaLimit_ValuesEntry: MessageFns<QuotaLimit_ValuesEntry> = {
  ...
  create<I extends Exact<DeepPartial<QuotaLimit_ValuesEntry>, I>>(base?: I): QuotaLimit_ValuesEntry {
    return QuotaLimit_ValuesEntry.fromPartial(base ?? ({} as any));
  },
