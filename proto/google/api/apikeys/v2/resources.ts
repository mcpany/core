  ...
  fromJSON(object: any): Key {
    return {
      ...
      deleteTime: isSet(object.deleteTime)
        ...
        : isSet(object.delete_time)
        ? fromJsonTimestamp(object.delete_time)
        : undefined,
...
export const Key_AnnotationsEntry: MessageFns<Key_AnnotationsEntry> = {
  ...
  create<I extends Exact<DeepPartial<Key_AnnotationsEntry>, I>>(base?: I): Key_AnnotationsEntry {
    return Key_AnnotationsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Key_AnnotationsEntry>, I>>(object: I): Key_AnnotationsEntry {
    const message = createBaseKey_AnnotationsEntry();
  ...
  fromJSON(object: any): Restrictions {
    return {
      browserKeyRestrictions: isSet(object.browserKeyRestrictions)
        ...
        : isSet(object.browser_key_restrictions)
        ? BrowserKeyRestrictions.fromJSON(object.browser_key_restrictions)
        : undefined,
      serverKeyRestrictions: isSet(object.serverKeyRestrictions)
        ? ServerKeyRestrictions.fromJSON(object.serverKeyRestrictions)
        : isSet(object.server_key_restrictions)
        ? ServerKeyRestrictions.fromJSON(object.server_key_restrictions)
        : undefined,
      androidKeyRestrictions: isSet(object.androidKeyRestrictions)
        ? AndroidKeyRestrictions.fromJSON(object.androidKeyRestrictions)
        : isSet(object.android_key_restrictions)
        ? AndroidKeyRestrictions.fromJSON(object.android_key_restrictions)
        : undefined,
      iosKeyRestrictions: isSet(object.iosKeyRestrictions)
        ? IosKeyRestrictions.fromJSON(object.iosKeyRestrictions)
        : isSet(object.ios_key_restrictions)
        ? IosKeyRestrictions.fromJSON(object.ios_key_restrictions)
        : undefined,
      apiTargets: globalThis.Array.isArray(object?.apiTargets)
        ? object.apiTargets.map((e: any) => ApiTarget.fromJSON(e))
        : globalThis.Array.isArray(object?.api_targets)
        ? object.api_targets.map((e: any) => ApiTarget.fromJSON(e))
        : [],
    };
  },
...
export const BrowserKeyRestrictions: MessageFns<BrowserKeyRestrictions> = {
  ...
  fromJSON(object: any): BrowserKeyRestrictions {
    return {
      allowedReferrers: globalThis.Array.isArray(object?.allowedReferrers)
        ...
        : globalThis.Array.isArray(object?.allowed_referrers)
        ? object.allowed_referrers.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<BrowserKeyRestrictions>, I>>(base?: I): BrowserKeyRestrictions {
    return BrowserKeyRestrictions.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BrowserKeyRestrictions>, I>>(object: I): BrowserKeyRestrictions {
    const message = createBaseBrowserKeyRestrictions();
...
export const ServerKeyRestrictions: MessageFns<ServerKeyRestrictions> = {
  ...
  create<I extends Exact<DeepPartial<ServerKeyRestrictions>, I>>(base?: I): ServerKeyRestrictions {
    return ServerKeyRestrictions.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ServerKeyRestrictions>, I>>(object: I): ServerKeyRestrictions {
    const message = createBaseServerKeyRestrictions();
...
export const AndroidKeyRestrictions: MessageFns<AndroidKeyRestrictions> = {
  ...
  fromJSON(object: any): AndroidKeyRestrictions {
    return {
      allowedApplications: globalThis.Array.isArray(object?.allowedApplications)
        ...
        : globalThis.Array.isArray(object?.allowed_applications)
        ? object.allowed_applications.map((e: any) => AndroidApplication.fromJSON(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<AndroidKeyRestrictions>, I>>(base?: I): AndroidKeyRestrictions {
    return AndroidKeyRestrictions.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AndroidKeyRestrictions>, I>>(object: I): AndroidKeyRestrictions {
    const message = createBaseAndroidKeyRestrictions();
...
export const AndroidApplication: MessageFns<AndroidApplication> = {
  ...
  fromJSON(object: any): AndroidApplication {
    return {
      sha1Fingerprint: isSet(object.sha1Fingerprint)
        ? globalThis.String(object.sha1Fingerprint)
        : isSet(object.sha1_fingerprint)
        ? globalThis.String(object.sha1_fingerprint)
        : "",
  ...
  create<I extends Exact<DeepPartial<AndroidApplication>, I>>(base?: I): AndroidApplication {
    return AndroidApplication.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AndroidApplication>, I>>(object: I): AndroidApplication {
    const message = createBaseAndroidApplication();
...
export const IosKeyRestrictions: MessageFns<IosKeyRestrictions> = {
  ...
  fromJSON(object: any): IosKeyRestrictions {
    return {
      allowedBundleIds: globalThis.Array.isArray(object?.allowedBundleIds)
        ...
        : globalThis.Array.isArray(object?.allowed_bundle_ids)
        ? object.allowed_bundle_ids.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<IosKeyRestrictions>, I>>(base?: I): IosKeyRestrictions {
    return IosKeyRestrictions.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<IosKeyRestrictions>, I>>(object: I): IosKeyRestrictions {
    const message = createBaseIosKeyRestrictions();
...
export const ApiTarget: MessageFns<ApiTarget> = {
  ...
  create<I extends Exact<DeepPartial<ApiTarget>, I>>(base?: I): ApiTarget {
    return ApiTarget.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ApiTarget>, I>>(object: I): ApiTarget {
    const message = createBaseApiTarget();
