...
export const ContextRule: MessageFns<ContextRule> = {
  ...
  fromJSON(object: any): ContextRule {
    return {
      ...
      allowedRequestExtensions: globalThis.Array.isArray(object?.allowedRequestExtensions)
        ...
        : globalThis.Array.isArray(object?.allowed_request_extensions)
        ? object.allowed_request_extensions.map((e: any) => globalThis.String(e))
        : [],
      allowedResponseExtensions: globalThis.Array.isArray(object?.allowedResponseExtensions)
        ...
        : globalThis.Array.isArray(object?.allowed_response_extensions)
        ? object.allowed_response_extensions.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<ContextRule>, I>>(base?: I): ContextRule {
    return ContextRule.fromPartial(base ?? ({} as any));
  },
