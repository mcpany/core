...
import { McpAnyServerConfig } from "../../config/v1/config";
...
export interface CreateBackupResponse {
  ...
  config?: McpAnyServerConfig | undefined;
}
...
export const CreateBackupResponse: MessageFns<CreateBackupResponse> = {
  encode(message: CreateBackupResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.config !== undefined) {
      McpAnyServerConfig.encode(message.config, writer.uint32(10).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.config = McpAnyServerConfig.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CreateBackupResponse {
    return { config: isSet(object.config) ? McpAnyServerConfig.fromJSON(object.config) : undefined };
  },

  toJSON(message: CreateBackupResponse): unknown {
    const obj: any = {};
    if (message.config !== undefined) {
      obj.config = McpAnyServerConfig.toJSON(message.config);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CreateBackupResponse>, I>>(object: I): CreateBackupResponse {
    ...
    message.config = (object.config !== undefined && object.config !== null)
      ? McpAnyServerConfig.fromPartial(object.config)
      : undefined;
    return message;
  },
};
...
function createBaseRestoreBackupResponse(): RestoreBackupResponse {
  return { servicesRestored: 0, usersRestored: 0, secretsRestored: 0 };
}
...
export const RestoreBackupResponse: MessageFns<RestoreBackupResponse> = {
  encode(message: RestoreBackupResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.servicesRestored !== 0) {
      writer.uint32(8).int32(message.servicesRestored);
    }
    if (message.usersRestored !== 0) {
      writer.uint32(16).int32(message.usersRestored);
    }
    if (message.secretsRestored !== 0) {
      writer.uint32(24).int32(message.secretsRestored);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.servicesRestored = reader.int32();
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.usersRestored = reader.int32();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.secretsRestored = reader.int32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): RestoreBackupResponse {
    return {
      servicesRestored: isSet(object.servicesRestored)
        ? globalThis.Number(object.servicesRestored)
        : isSet(object.services_restored)
        ? globalThis.Number(object.services_restored)
        : 0,
      usersRestored: isSet(object.usersRestored)
        ? globalThis.Number(object.usersRestored)
        : isSet(object.users_restored)
        ? globalThis.Number(object.users_restored)
        : 0,
      secretsRestored: isSet(object.secretsRestored)
        ? globalThis.Number(object.secretsRestored)
        : isSet(object.secrets_restored)
        ? globalThis.Number(object.secrets_restored)
        : 0,
    };
  },
  ...
  toJSON(message: RestoreBackupResponse): unknown {
    const obj: any = {};
    if (message.servicesRestored !== 0) {
      obj.servicesRestored = Math.round(message.servicesRestored);
    }
    if (message.usersRestored !== 0) {
      obj.usersRestored = Math.round(message.usersRestored);
    }
    if (message.secretsRestored !== 0) {
      obj.secretsRestored = Math.round(message.secretsRestored);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RestoreBackupResponse>, I>>(object: I): RestoreBackupResponse {
    const message = createBaseRestoreBackupResponse();
    message.servicesRestored = object.servicesRestored ?? 0;
    message.usersRestored = object.usersRestored ?? 0;
    message.secretsRestored = object.secretsRestored ?? 0;
    return message;
  },
};
...
export interface AdminService {
  ...
  CreateBackup(request: DeepPartial<CreateBackupRequest>, metadata?: grpc.Metadata): Promise<CreateBackupResponse>;
  /** RestoreBackup restores the system configuration from a backup. */
  RestoreBackup(request: DeepPartial<RestoreBackupRequest>, metadata?: grpc.Metadata): Promise<RestoreBackupResponse>;
}
...
export class AdminServiceClientImpl implements AdminService {
  ...
  CreateBackup(request: DeepPartial<CreateBackupRequest>, metadata?: grpc.Metadata): Promise<CreateBackupResponse> {
    return this.rpc.unary(AdminServiceCreateBackupDesc, CreateBackupRequest.fromPartial(request), metadata);
  }

  RestoreBackup(request: DeepPartial<RestoreBackupRequest>, metadata?: grpc.Metadata): Promise<RestoreBackupResponse> {
    return this.rpc.unary(AdminServiceRestoreBackupDesc, RestoreBackupRequest.fromPartial(request), metadata);
  }
}
...
export const AdminServiceCreateBackupDesc: UnaryMethodDefinitionish = {
  ...
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = CreateBackupResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
...
export const AdminServiceRestoreBackupDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return RestoreBackupRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
