...
type ServiceState struct {
	...
	xxx_hidden_Status        ServiceStatus             `protobuf:"varint,2,opt,name=status,enum=mcpany.admin.v1.ServiceStatus"`
	xxx_hidden_LastError     *string                   `protobuf:"bytes,3,opt,name=last_error,json=lastError"`
	xxx_hidden_LastCheckTime int64                     `protobuf:"varint,4,opt,name=last_check_time,json=lastCheckTime"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
...
func (x *ServiceState) ClearStatus() {
	...
	x.xxx_hidden_Status = ServiceStatus_SERVICE_STATUS_UNKNOWN
}
