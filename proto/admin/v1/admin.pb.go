...
type ListServicesResponse struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	Services      []*ServiceSummary      `protobuf:"bytes,1,rep,name=services" json:"services,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListServicesResponse) SetServices(v []*ServiceSummary) {
	x.Services = v
}
...
func (x *ServiceSummary) SetId(v string) {
	x.Id = &v
}

func (x *ServiceSummary) SetName(v string) {
	x.Name = &v
}

func (x *ServiceSummary) HasId() bool {
	if x == nil {
		return false
	}
	return x.Id != nil
...
func (x *ServiceSummary) HasName() bool {
	if x == nil {
		return false
	}
	return x.Name != nil
...
func (x *ServiceSummary) ClearId() {
	x.Id = nil
}

func (x *ServiceSummary) ClearName() {
	x.Name = nil
}

type ServiceSummary_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 ServiceSummary_builder) Build() *ServiceSummary {
	m0 := &ServiceSummary{}
	b, x := &b0, m0
	_, _ = b, x
	x.Id = b.Id
...
func (x *GetServiceRequest) SetId(v string) {
	x.Id = &v
}

func (x *GetServiceRequest) HasId() bool {
	if x == nil {
		return false
	}
	return x.Id != nil
...
func (x *GetServiceRequest) ClearId() {
	x.Id = nil
}
...
func (x *GetServiceResponse) GetConfig() *v1.UpstreamServiceConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *GetServiceResponse) SetConfig(v *v1.UpstreamServiceConfig) {
	x.Config = v
}

func (x *GetServiceResponse) HasConfig() bool {
	if x == nil {
		return false
	}
	return x.Config != nil
...
func (x *GetServiceResponse) ClearConfig() {
	x.Config = nil
}
...
type ListToolsRequest struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	ServiceId     *string                `protobuf:"bytes,1,opt,name=service_id,json=serviceId" json:"service_id,omitempty"` // Optional filter by service ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListToolsRequest) GetServiceId() string {
...
func (x *ListToolsRequest) SetServiceId(v string) {
	x.ServiceId = &v
}

func (x *ListToolsRequest) HasServiceId() bool {
	if x == nil {
		return false
	}
...
func (x *ListToolsRequest) ClearServiceId() {
	x.ServiceId = nil
}
...
func (x *GetToolRequest) SetName(v string) {
	x.Name = &v
}

func (x *GetToolRequest) HasName() bool {
	if x == nil {
		return false
	}
	return x.Name != nil
...
func (x *GetToolRequest) ClearName() {
	x.Name = nil
}
...
const file_proto_admin_v1_admin_proto_rawDesc = "" +
	...
	"\bservices\x18\x01 \x03(\v2\x1f.mcpany.admin.v1.ServiceSummaryR\bservices\"4\n" +
	...
	"\x06config\x18\x01 \x01(\v2'.mcpany.config.v1.UpstreamServiceConfigR\x06config\"1\n" +
...
var file_proto_admin_v1_admin_proto_goTypes = []any{
	...
	(*ServiceSummary)(nil),           // 4: mcpany.admin.v1.ServiceSummary
	...
	(*v1.UpstreamServiceConfig)(nil), // 11: mcpany.config.v1.UpstreamServiceConfig
	(*v11.Tool)(nil),                 // 12: mcpany.mcp_router.v1.Tool
}
var file_proto_admin_v1_admin_proto_depIdxs = []int32{
	4,  // 0: mcpany.admin.v1.ListServicesResponse.services:type_name -> mcpany.admin.v1.ServiceSummary
	11, // 1: mcpany.admin.v1.GetServiceResponse.config:type_name -> mcpany.config.v1.UpstreamServiceConfig
	12, // 2: mcpany.admin.v1.ListToolsResponse.tools:type_name -> mcpany.mcp_router.v1.Tool
	12, // 3: mcpany.admin.v1.GetToolResponse.tool:type_name -> mcpany.mcp_router.v1.Tool
	...
	5,  // 6: mcpany.admin.v1.AdminService.GetService:input_type -> mcpany.admin.v1.GetServiceRequest
	7,  // 7: mcpany.admin.v1.AdminService.ListTools:input_type -> mcpany.admin.v1.ListToolsRequest
	9,  // 8: mcpany.admin.v1.AdminService.GetTool:input_type -> mcpany.admin.v1.GetToolRequest
	...
	6,  // 11: mcpany.admin.v1.AdminService.GetService:output_type -> mcpany.admin.v1.GetServiceResponse
	8,  // 12: mcpany.admin.v1.AdminService.ListTools:output_type -> mcpany.admin.v1.ListToolsResponse
	10, // 13: mcpany.admin.v1.AdminService.GetTool:output_type -> mcpany.admin.v1.GetToolResponse
