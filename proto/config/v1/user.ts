...
function createBaseUser(): User {
  return { id: "", authentication: undefined, profileIds: [], roles: [], preferencesJson: "" };
}
...
export const User: MessageFns<User> = {
  ...
  fromJSON(object: any): User {
    return {
      ...
      preferencesJson: isSet(object.preferences_json) ? globalThis.String(object.preferences_json) : "",
    };
  },
  ...
  toJSON(message: User): unknown {
    ...
    if (message.preferencesJson !== "") {
      obj.preferences_json = message.preferencesJson;
    }
    return obj;
  },
