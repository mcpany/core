...
var file_proto_config_v1_prompt_proto_goTypes = []any{
	...
	(*ResourceDefinition)(nil), // 8: mcpany.config.v1.ResourceDefinition
}
var file_proto_config_v1_prompt_proto_depIdxs = []int32{
	...
	8, // 7: mcpany.config.v1.ResourceContent.resource:type_name -> mcpany.config.v1.ResourceDefinition
