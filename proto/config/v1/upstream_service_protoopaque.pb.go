...
// BrowserUpstreamService defines an upstream service that uses a headless browser.
...
const file_proto_config_v1_upstream_service_proto_rawDesc = "" +
	...
	"\bEnvEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x123\n" +
	"\x05value\x18\x02 \x01(\v2\x1d.mcpany.config.v1.SecretValueR\x05value:\x028\x01\"\x90\x01\n" +
	"\x16BrowserUpstreamService\x12\x1a\n" +
	"\bheadless\x18\x01 \x01(\bR\bheadless\x12\"\n" +
	"\fbrowser_type\x18\x02 \x01(\tR\fbrowser_type\x126\n" +
	"\x05tools\x18\x03 \x03(\v2 .mcpany.config.v1.ToolDefinitionR\x05tools\"\xb3\x01\n" +
...
var file_proto_config_v1_upstream_service_proto_goTypes = []any{
	...
	(*BrowserUpstreamService)(nil),                        // 39: mcpany.config.v1.BrowserUpstreamService
...
var file_proto_config_v1_upstream_service_proto_depIdxs = []int32{
	...
	39,  // 21: mcpany.config.v1.UpstreamServiceConfig.browser_service:type_name -> mcpany.config.v1.BrowserUpstreamService
	...
	45,  // 106: mcpany.config.v1.McpStreamableHttpConnection.tls_config:type_name -> mcpany.config.v1.TLSConfig
	58,  // 107: mcpany.config.v1.McpBundleConnection.env:type_name -> mcpany.config.v1.McpBundleConnection.EnvEntry
	66,  // 108: mcpany.config.v1.BrowserUpstreamService.tools:type_name -> mcpany.config.v1.ToolDefinition
	73,  // 109: mcpany.config.v1.ConnectionPoolConfig.idle_timeout:type_name -> google.protobuf.Duration
	...
	73,  // 114: mcpany.config.v1.ResilienceConfig.timeout:type_name -> google.protobuf.Duration
	73,  // 115: mcpany.config.v1.CircuitBreakerConfig.open_duration:type_name -> google.protobuf.Duration
	73,  // 116: mcpany.config.v1.RetryConfig.base_backoff:type_name -> google.protobuf.Duration
	73,  // 117: mcpany.config.v1.RetryConfig.max_backoff:type_name -> google.protobuf.Duration
	73,  // 118: mcpany.config.v1.RetryConfig.max_elapsed_time:type_name -> google.protobuf.Duration
	74,  // 119: mcpany.config.v1.GrpcUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.GrpcCallDefinition
	75,  // 120: mcpany.config.v1.HttpUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.HttpCallDefinition
	76,  // 121: mcpany.config.v1.WebsocketUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.WebsocketCallDefinition
	77,  // 122: mcpany.config.v1.WebrtcUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.WebrtcCallDefinition
	78,  // 123: mcpany.config.v1.OpenapiUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.OpenAPICallDefinition
	79,  // 124: mcpany.config.v1.CommandLineUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.CommandLineCallDefinition
	80,  // 125: mcpany.config.v1.CommandLineUpstreamService.EnvEntry.value:type_name -> mcpany.config.v1.SecretValue
	81,  // 126: mcpany.config.v1.GraphQLUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.GraphQLCallDefinition
	82,  // 127: mcpany.config.v1.SqlUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.SqlCallDefinition
	83,  // 128: mcpany.config.v1.McpUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.MCPCallDefinition
	80,  // 129: mcpany.config.v1.McpStdioConnection.EnvEntry.value:type_name -> mcpany.config.v1.SecretValue
	80,  // 130: mcpany.config.v1.McpBundleConnection.EnvEntry.value:type_name -> mcpany.config.v1.SecretValue
	80,  // 131: mcpany.config.v1.ContainerEnvironment.EnvEntry.value:type_name -> mcpany.config.v1.SecretValue
