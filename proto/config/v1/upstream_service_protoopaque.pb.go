...
type BrowserUpstreamService struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Browser     *string                `protobuf:"bytes,1,opt,name=browser"`
...
func (x *BrowserUpstreamService) GetBrowser() string {
	if x != nil {
...
func (x *BrowserUpstreamService) SetBrowser(v string) {
...
func (x *BrowserUpstreamService) HasBrowser() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *BrowserUpstreamService) ClearBrowser() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
...
type BrowserUpstreamService_builder struct {
	...
	// The browser engine to use (e.g., "chromium", "firefox", "webkit").
	Browser *string
	// If true, the browser runs in headless mode.
	Headless *bool
...
const file_proto_config_v1_upstream_service_proto_rawDesc = "" +
	...
	"\x14insecure_skip_verify\x18\x05 \x01(\bR\x14insecure_skip_verify\"\x88\x02\n" +
	"\x16BrowserUpstreamService\x12\x18\n" +
	"\abrowser\x18\x01 \x01(\tR\abrowser\x12\x1a\n" +
	"\bheadless\x18\x02 \x01(\bR\bheadless\x126\n" +
	"\x05tools\x18\x03 \x03(\v2 .mcpany.config.v1.ToolDefinitionR\x05tools\x12B\n" +
	"\tresources\x18\x04 \x03(\v2$.mcpany.config.v1.ResourceDefinitionR\tresources\x12<\n" +
	"\aprompts\x18\x05 \x03(\v2\".mcpany.config.v1.PromptDefinitionR\aprompts*K\n" +
...
var file_proto_config_v1_upstream_service_proto_depIdxs = []int32{
	...
	66,  // 118: mcpany.config.v1.BrowserUpstreamService.tools:type_name -> mcpany.config.v1.ToolDefinition
	68,  // 119: mcpany.config.v1.BrowserUpstreamService.resources:type_name -> mcpany.config.v1.ResourceDefinition
	64,  // 120: mcpany.config.v1.BrowserUpstreamService.prompts:type_name -> mcpany.config.v1.PromptDefinition
