...
type ParameterSchema struct {
	...
	xxx_hidden_MinLength    int32                  `protobuf:"varint,7,opt,name=min_length,json=minLength"`
	xxx_hidden_MaxLength    int32                  `protobuf:"varint,8,opt,name=max_length,json=maxLength"`
...
type ParameterSchema_builder struct {
	...
	Pattern *string
	// The minimum length of the string parameter.
	// Only applicable for STRING type.
	MinLength *int32
	// The maximum length of the string parameter.
	// Only applicable for STRING type.
	MaxLength *int32
	// The minimum value of the numeric parameter.
	// Only applicable for NUMBER and INTEGER types.
	Minimum *float64
	// The maximum value of the numeric parameter.
	// Only applicable for NUMBER and INTEGER types.
	Maximum *float64
...
const file_proto_config_v1_call_proto_rawDesc = "" +
	...
	"\routput_schema\x18\x06 \x01(\v2\x17.google.protobuf.StructR\routput_schema\"\xfc\x02\n" +
	...
	"\apattern\x18\x06 \x01(\tR\apattern\x12\x1d\n" +
	"\n" +
	"min_length\x18\a \x01(\x05R\tminLength\x12\x1d\n" +
	"\n" +
	"max_length\x18\b \x01(\x05R\tmaxLength\x12\x18\n" +
