...
// ParameterLocation defines where a parameter is placed in an HTTP request.
type ParameterLocation int32

const (
	ParameterLocation_PARAMETER_LOCATION_UNSPECIFIED ParameterLocation = 0
	ParameterLocation_QUERY                          ParameterLocation = 1
	ParameterLocation_HEADER                         ParameterLocation = 2
	ParameterLocation_PATH                           ParameterLocation = 3
	ParameterLocation_COOKIE                         ParameterLocation = 4
	ParameterLocation_BODY                           ParameterLocation = 5
)
...
type HttpParameterMapping_builder struct {
	...
	// The name of the parameter in the HTTP request (e.g. header name, query param name).
	// If not specified, defaults to the input parameter name.
	TargetName *string
}
...
const file_proto_config_v1_call_proto_rawDesc = "" +
	...
	"\x1ePARAMETER_LOCATION_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05QUERY\x10\x01\x12\n" +
	"\n" +
	"\x06HEADER\x10\x02\x12\b\n" +
	"\x04PATH\x10\x03\x12\n" +
	"\n" +
	"\x06COOKIE\x10\x04\x12\b\n" +
	"\x04BODY\x10\x05B0Z&github.com/mcpany/core/proto/config/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
