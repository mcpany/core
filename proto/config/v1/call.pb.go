...
// ParameterLocation defines where an input parameter should be placed in the HTTP request.
type ParameterLocation int32

const (
	ParameterLocation_AUTO   ParameterLocation = 0
...
func (x *HttpParameterMapping) ClearLocation() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 3)
	x.xxx_hidden_Location = ParameterLocation_AUTO
}
...
type HttpParameterMapping_builder struct {
	...
	DisableEscape *bool
	// The location where the parameter should be placed.
