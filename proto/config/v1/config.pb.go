...
type GlobalSettings struct {
	...
	Guardrails    *GuardrailsConfig `protobuf:"bytes,25,opt,name=guardrails" json:"guardrails,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (b0 GlobalSettings_builder) Build() *GlobalSettings {
	...
	x.Guardrails = b.Guardrails
	return m0
}

type GuardrailsConfig struct {
	state          protoimpl.MessageState `protogen:"hybrid.v1"`
	BlockedPhrases []string               `protobuf:"bytes,1,rep,name=blocked_phrases" json:"blocked_phrases,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (b0 GuardrailsConfig_builder) Build() *GuardrailsConfig {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.BlockedPhrases = b.BlockedPhrases
	return m0
}
