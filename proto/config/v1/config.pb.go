...
type UpstreamServiceConfig struct {
	...
	xxx_hidden_CallPolicy             *CallPolicy                           `protobuf:"bytes,22,opt,name=call_policy,json=callPolicy"`
	XXX_raceDetectHookData            protoimpl.RaceDetectHookData
	XXX_presence                      [1]uint32
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
...
func (x case_ProtoFile_FileRef) String() string {
	md := file_proto_config_v1_config_proto_msgTypes[8].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
func (x case_ProtoDescriptor_FileRef) String() string {
	md := file_proto_config_v1_config_proto_msgTypes[9].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
func (x case_WebRTCHealthCheck_HealthCheckType) String() string {
	md := file_proto_config_v1_config_proto_msgTypes[31].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
const file_proto_config_v1_config_proto_rawDesc = "" +
	...
	"\x0fLOG_LEVEL_DEBUG\x10\x04\"\xbd\v\n" +
	...
	"\vcall_policy\x18\x16 \x01(\v2\x1c.mcpany.config.v1.CallPolicyR\n" +
	"callPolicyB\x10\n" +
	...
	"\x0eargument_regex\x18\x03 \x01(\tR\rargumentRegex\"\xd8\x05\n" +
	...
	"\x14insecure_skip_verify\x18\x05 \x01(\bR\x12insecureSkipVerify\"\xa9\x01\n" +
...
var file_proto_config_v1_config_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_proto_config_v1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_proto_config_v1_config_proto_goTypes = []any{
	...
	(*PolicyRule)(nil),                                    // 9: mcpany.config.v1.PolicyRule
	...
	(*HttpHealthCheck)(nil),                               // 25: mcpany.config.v1.HttpHealthCheck
	(*WebsocketHealthCheck)(nil),                          // 26: mcpany.config.v1.WebsocketHealthCheck
	(*GrpcHealthCheck)(nil),                               // 27: mcpany.config.v1.GrpcHealthCheck
	(*CommandLineHealthCheck)(nil),                        // 28: mcpany.config.v1.CommandLineHealthCheck
	(*ContainerEnvironment)(nil),                          // 29: mcpany.config.v1.ContainerEnvironment
	(*RateLimitConfig)(nil),                               // 30: mcpany.config.v1.RateLimitConfig
	(*ResilienceConfig)(nil),                              // 31: mcpany.config.v1.ResilienceConfig
	(*CircuitBreakerConfig)(nil),                          // 32: mcpany.config.v1.CircuitBreakerConfig
	(*RetryConfig)(nil),                                   // 33: mcpany.config.v1.RetryConfig
	(*TLSConfig)(nil),                                     // 34: mcpany.config.v1.TLSConfig
	(*WebRTCHealthCheck)(nil),                             // 35: mcpany.config.v1.WebRTCHealthCheck
	...
	nil,                                                   // 44: mcpany.config.v1.ContainerEnvironment.VolumesEntry
	(*UpstreamAuthentication)(nil),                        // 45: mcpany.config.v1.UpstreamAuthentication
	(*bus.MessageBus)(nil),                                // 46: bus.MessageBus
	(*CacheConfig)(nil),                                   // 47: mcpany.config.v1.CacheConfig
	(*AuthenticationConfig)(nil),                          // 48: mcpany.config.v1.AuthenticationConfig
	(*ToolDefinition)(nil),                                // 49: mcpany.config.v1.ToolDefinition
	(*ResourceDefinition)(nil),                            // 50: mcpany.config.v1.ResourceDefinition
	(*PromptDefinition)(nil),                              // 51: mcpany.config.v1.PromptDefinition
...
var file_proto_config_v1_config_proto_depIdxs = []int32{
	...
	7,   // 1: mcpany.config.v1.McpAnyServerConfig.upstream_services:type_name -> mcpany.config.v1.UpstreamServiceConfig
	...
	45,  // 3: mcpany.config.v1.UpstreamServiceCollection.authentication:type_name -> mcpany.config.v1.UpstreamAuthentication
	1,   // 4: mcpany.config.v1.GlobalSettings.log_level:type_name -> mcpany.config.v1.GlobalSettings.LogLevel
	46,  // 5: mcpany.config.v1.GlobalSettings.message_bus:type_name -> bus.MessageBus
	24,  // 6: mcpany.config.v1.UpstreamServiceConfig.connection_pool:type_name -> mcpany.config.v1.ConnectionPoolConfig
	45,  // 7: mcpany.config.v1.UpstreamServiceConfig.upstream_authentication:type_name -> mcpany.config.v1.UpstreamAuthentication
	47,  // 8: mcpany.config.v1.UpstreamServiceConfig.cache:type_name -> mcpany.config.v1.CacheConfig
	30,  // 9: mcpany.config.v1.UpstreamServiceConfig.rate_limit:type_name -> mcpany.config.v1.RateLimitConfig
	0,   // 10: mcpany.config.v1.UpstreamServiceConfig.load_balancing_strategy:type_name -> mcpany.config.v1.LoadBalancingStrategy
	31,  // 11: mcpany.config.v1.UpstreamServiceConfig.resilience:type_name -> mcpany.config.v1.ResilienceConfig
	21,  // 12: mcpany.config.v1.UpstreamServiceConfig.mcp_service:type_name -> mcpany.config.v1.McpUpstreamService
	15,  // 13: mcpany.config.v1.UpstreamServiceConfig.http_service:type_name -> mcpany.config.v1.HttpUpstreamService
	10,  // 14: mcpany.config.v1.UpstreamServiceConfig.grpc_service:type_name -> mcpany.config.v1.GrpcUpstreamService
	18,  // 15: mcpany.config.v1.UpstreamServiceConfig.openapi_service:type_name -> mcpany.config.v1.OpenapiUpstreamService
	19,  // 16: mcpany.config.v1.UpstreamServiceConfig.command_line_service:type_name -> mcpany.config.v1.CommandLineUpstreamService
	16,  // 17: mcpany.config.v1.UpstreamServiceConfig.websocket_service:type_name -> mcpany.config.v1.WebsocketUpstreamService
	17,  // 18: mcpany.config.v1.UpstreamServiceConfig.webrtc_service:type_name -> mcpany.config.v1.WebrtcUpstreamService
	20,  // 19: mcpany.config.v1.UpstreamServiceConfig.graphql_service:type_name -> mcpany.config.v1.GraphQLUpstreamService
	48,  // 20: mcpany.config.v1.UpstreamServiceConfig.authentication:type_name -> mcpany.config.v1.AuthenticationConfig
	8,   // 21: mcpany.config.v1.UpstreamServiceConfig.call_policy:type_name -> mcpany.config.v1.CallPolicy
	2,   // 22: mcpany.config.v1.CallPolicy.default_action:type_name -> mcpany.config.v1.CallPolicy.Action
	9,   // 23: mcpany.config.v1.CallPolicy.rules:type_name -> mcpany.config.v1.PolicyRule
	2,   // 24: mcpany.config.v1.PolicyRule.action:type_name -> mcpany.config.v1.CallPolicy.Action
	34,  // 25: mcpany.config.v1.GrpcUpstreamService.tls_config:type_name -> mcpany.config.v1.TLSConfig
	49,  // 26: mcpany.config.v1.GrpcUpstreamService.tools:type_name -> mcpany.config.v1.ToolDefinition
	27,  // 27: mcpany.config.v1.GrpcUpstreamService.health_check:type_name -> mcpany.config.v1.GrpcHealthCheck
	11,  // 28: mcpany.config.v1.GrpcUpstreamService.proto_definitions:type_name -> mcpany.config.v1.ProtoDefinition
	14,  // 29: mcpany.config.v1.GrpcUpstreamService.proto_collection:type_name -> mcpany.config.v1.ProtoCollection
	50,  // 30: mcpany.config.v1.GrpcUpstreamService.resources:type_name -> mcpany.config.v1.ResourceDefinition
	36,  // 31: mcpany.config.v1.GrpcUpstreamService.calls:type_name -> mcpany.config.v1.GrpcUpstreamService.CallsEntry
	51,  // 32: mcpany.config.v1.GrpcUpstreamService.prompts:type_name -> mcpany.config.v1.PromptDefinition
	12,  // 33: mcpany.config.v1.ProtoDefinition.proto_file:type_name -> mcpany.config.v1.ProtoFile
	13,  // 34: mcpany.config.v1.ProtoDefinition.proto_descriptor:type_name -> mcpany.config.v1.ProtoDescriptor
	49,  // 35: mcpany.config.v1.HttpUpstreamService.tools:type_name -> mcpany.config.v1.ToolDefinition
	37,  // 36: mcpany.config.v1.HttpUpstreamService.calls:type_name -> mcpany.config.v1.HttpUpstreamService.CallsEntry
	25,  // 37: mcpany.config.v1.HttpUpstreamService.health_check:type_name -> mcpany.config.v1.HttpHealthCheck
	34,  // 38: mcpany.config.v1.HttpUpstreamService.tls_config:type_name -> mcpany.config.v1.TLSConfig
	50,  // 39: mcpany.config.v1.HttpUpstreamService.resources:type_name -> mcpany.config.v1.ResourceDefinition
	51,  // 40: mcpany.config.v1.HttpUpstreamService.prompts:type_name -> mcpany.config.v1.PromptDefinition
	49,  // 41: mcpany.config.v1.WebsocketUpstreamService.tools:type_name -> mcpany.config.v1.ToolDefinition
	34,  // 42: mcpany.config.v1.WebsocketUpstreamService.tls_config:type_name -> mcpany.config.v1.TLSConfig
	50,  // 43: mcpany.config.v1.WebsocketUpstreamService.resources:type_name -> mcpany.config.v1.ResourceDefinition
	38,  // 44: mcpany.config.v1.WebsocketUpstreamService.calls:type_name -> mcpany.config.v1.WebsocketUpstreamService.CallsEntry
	51,  // 45: mcpany.config.v1.WebsocketUpstreamService.prompts:type_name -> mcpany.config.v1.PromptDefinition
	26,  // 46: mcpany.config.v1.WebsocketUpstreamService.health_check:type_name -> mcpany.config.v1.WebsocketHealthCheck
	49,  // 47: mcpany.config.v1.WebrtcUpstreamService.tools:type_name -> mcpany.config.v1.ToolDefinition
	34,  // 48: mcpany.config.v1.WebrtcUpstreamService.tls_config:type_name -> mcpany.config.v1.TLSConfig
	50,  // 49: mcpany.config.v1.WebrtcUpstreamService.resources:type_name -> mcpany.config.v1.ResourceDefinition
	39,  // 50: mcpany.config.v1.WebrtcUpstreamService.calls:type_name -> mcpany.config.v1.WebrtcUpstreamService.CallsEntry
	51,  // 51: mcpany.config.v1.WebrtcUpstreamService.prompts:type_name -> mcpany.config.v1.PromptDefinition
	35,  // 52: mcpany.config.v1.WebrtcUpstreamService.health_check:type_name -> mcpany.config.v1.WebRTCHealthCheck
	25,  // 53: mcpany.config.v1.OpenapiUpstreamService.health_check:type_name -> mcpany.config.v1.HttpHealthCheck
	34,  // 54: mcpany.config.v1.OpenapiUpstreamService.tls_config:type_name -> mcpany.config.v1.TLSConfig
	49,  // 55: mcpany.config.v1.OpenapiUpstreamService.tools:type_name -> mcpany.config.v1.ToolDefinition
	50,  // 56: mcpany.config.v1.OpenapiUpstreamService.resources:type_name -> mcpany.config.v1.ResourceDefinition
	40,  // 57: mcpany.config.v1.OpenapiUpstreamService.calls:type_name -> mcpany.config.v1.OpenapiUpstreamService.CallsEntry
	51,  // 58: mcpany.config.v1.OpenapiUpstreamService.prompts:type_name -> mcpany.config.v1.PromptDefinition
	49,  // 59: mcpany.config.v1.CommandLineUpstreamService.tools:type_name -> mcpany.config.v1.ToolDefinition
	28,  // 60: mcpany.config.v1.CommandLineUpstreamService.health_check:type_name -> mcpany.config.v1.CommandLineHealthCheck
	47,  // 61: mcpany.config.v1.CommandLineUpstreamService.cache:type_name -> mcpany.config.v1.CacheConfig
	29,  // 62: mcpany.config.v1.CommandLineUpstreamService.container_environment:type_name -> mcpany.config.v1.ContainerEnvironment
	52,  // 63: mcpany.config.v1.CommandLineUpstreamService.timeout:type_name -> google.protobuf.Duration
	50,  // 64: mcpany.config.v1.CommandLineUpstreamService.resources:type_name -> mcpany.config.v1.ResourceDefinition
	41,  // 65: mcpany.config.v1.CommandLineUpstreamService.calls:type_name -> mcpany.config.v1.CommandLineUpstreamService.CallsEntry
	51,  // 66: mcpany.config.v1.CommandLineUpstreamService.prompts:type_name -> mcpany.config.v1.PromptDefinition
	3,   // 67: mcpany.config.v1.CommandLineUpstreamService.communication_protocol:type_name -> mcpany.config.v1.CommandLineUpstreamService.CommunicationProtocol
	42,  // 68: mcpany.config.v1.GraphQLUpstreamService.calls:type_name -> mcpany.config.v1.GraphQLUpstreamService.CallsEntry
	23,  // 69: mcpany.config.v1.McpUpstreamService.http_connection:type_name -> mcpany.config.v1.McpStreamableHttpConnection
	22,  // 70: mcpany.config.v1.McpUpstreamService.stdio_connection:type_name -> mcpany.config.v1.McpStdioConnection
	49,  // 71: mcpany.config.v1.McpUpstreamService.tools:type_name -> mcpany.config.v1.ToolDefinition
	50,  // 72: mcpany.config.v1.McpUpstreamService.resources:type_name -> mcpany.config.v1.ResourceDefinition
	43,  // 73: mcpany.config.v1.McpUpstreamService.calls:type_name -> mcpany.config.v1.McpUpstreamService.CallsEntry
	51,  // 74: mcpany.config.v1.McpUpstreamService.prompts:type_name -> mcpany.config.v1.PromptDefinition
	34,  // 75: mcpany.config.v1.McpStreamableHttpConnection.tls_config:type_name -> mcpany.config.v1.TLSConfig
	52,  // 76: mcpany.config.v1.ConnectionPoolConfig.idle_timeout:type_name -> google.protobuf.Duration
	52,  // 77: mcpany.config.v1.HttpHealthCheck.interval:type_name -> google.protobuf.Duration
	52,  // 78: mcpany.config.v1.HttpHealthCheck.timeout:type_name -> google.protobuf.Duration
	52,  // 79: mcpany.config.v1.WebsocketHealthCheck.interval:type_name -> google.protobuf.Duration
	52,  // 80: mcpany.config.v1.WebsocketHealthCheck.timeout:type_name -> google.protobuf.Duration
	52,  // 81: mcpany.config.v1.GrpcHealthCheck.interval:type_name -> google.protobuf.Duration
	52,  // 82: mcpany.config.v1.GrpcHealthCheck.timeout:type_name -> google.protobuf.Duration
	52,  // 83: mcpany.config.v1.CommandLineHealthCheck.interval:type_name -> google.protobuf.Duration
	52,  // 84: mcpany.config.v1.CommandLineHealthCheck.timeout:type_name -> google.protobuf.Duration
	44,  // 85: mcpany.config.v1.ContainerEnvironment.volumes:type_name -> mcpany.config.v1.ContainerEnvironment.VolumesEntry
	32,  // 86: mcpany.config.v1.ResilienceConfig.circuit_breaker:type_name -> mcpany.config.v1.CircuitBreakerConfig
	33,  // 87: mcpany.config.v1.ResilienceConfig.retry_policy:type_name -> mcpany.config.v1.RetryConfig
	52,  // 88: mcpany.config.v1.CircuitBreakerConfig.open_duration:type_name -> google.protobuf.Duration
	52,  // 89: mcpany.config.v1.RetryConfig.base_backoff:type_name -> google.protobuf.Duration
	52,  // 90: mcpany.config.v1.RetryConfig.max_backoff:type_name -> google.protobuf.Duration
	52,  // 91: mcpany.config.v1.RetryConfig.max_elapsed_time:type_name -> google.protobuf.Duration
	25,  // 92: mcpany.config.v1.WebRTCHealthCheck.http:type_name -> mcpany.config.v1.HttpHealthCheck
	26,  // 93: mcpany.config.v1.WebRTCHealthCheck.websocket:type_name -> mcpany.config.v1.WebsocketHealthCheck
	53,  // 94: mcpany.config.v1.GrpcUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.GrpcCallDefinition
	54,  // 95: mcpany.config.v1.HttpUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.HttpCallDefinition
	55,  // 96: mcpany.config.v1.WebsocketUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.WebsocketCallDefinition
	56,  // 97: mcpany.config.v1.WebrtcUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.WebrtcCallDefinition
	57,  // 98: mcpany.config.v1.OpenapiUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.OpenAPICallDefinition
	58,  // 99: mcpany.config.v1.CommandLineUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.CommandLineCallDefinition
	59,  // 100: mcpany.config.v1.GraphQLUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.GraphQLCallDefinition
	60,  // 101: mcpany.config.v1.McpUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.MCPCallDefinition
...
func file_proto_config_v1_config_proto_init() {
	...
	file_proto_config_v1_config_proto_msgTypes[8].OneofWrappers = []any{
		(*protoFile_FileContent)(nil),
		(*protoFile_FilePath)(nil),
	}
	file_proto_config_v1_config_proto_msgTypes[9].OneofWrappers = []any{
	...
	file_proto_config_v1_config_proto_msgTypes[31].OneofWrappers = []any{
