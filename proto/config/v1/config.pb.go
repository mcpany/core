...
type WebsocketHealthCheck struct {
	state                          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PingMessage         *string                `protobuf:"bytes,1,opt,name=ping_message,json=pingMessage"`
	xxx_hidden_ExpectedPongMessage *string                `protobuf:"bytes,2,opt,name=expected_pong_message,json=expectedPongMessage"`
...
func (x *WebsocketHealthCheck) GetPingMessage() string {
	if x != nil {
		if x.xxx_hidden_PingMessage != nil {
			return *x.xxx_hidden_PingMessage
		}
		return ""
	}
	return ""
...
func (x *WebsocketHealthCheck) GetExpectedPongMessage() string {
	if x != nil {
		if x.xxx_hidden_ExpectedPongMessage != nil {
			return *x.xxx_hidden_ExpectedPongMessage
		}
		return ""
	}
	return ""
...
func (x *WebsocketHealthCheck) SetPingMessage(v string) {
	x.xxx_hidden_PingMessage = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 4)
}

func (x *WebsocketHealthCheck) SetExpectedPongMessage(v string) {
	x.xxx_hidden_ExpectedPongMessage = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 1, 4)
}
...
func (x *WebsocketHealthCheck) HasPingMessage() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *WebsocketHealthCheck) HasExpectedPongMessage() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 1)
...
func (x *WebsocketHealthCheck) ClearPingMessage() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_PingMessage = nil
}

func (x *WebsocketHealthCheck) ClearExpectedPongMessage() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_ExpectedPongMessage = nil
}
...
type WebsocketHealthCheck_builder struct {
	...
	// The message to send as a ping.
	PingMessage *string
	// The expected message in response to the ping.
...
func (b0 WebsocketHealthCheck_builder) Build() *WebsocketHealthCheck {
	...
	if b.PingMessage != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 0, 4)
		x.xxx_hidden_PingMessage = b.PingMessage
	}
	if b.ExpectedPongMessage != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 1, 4)
		x.xxx_hidden_ExpectedPongMessage = b.ExpectedPongMessage
	}
	x.xxx_hidden_Interval = b.Interval
	x.xxx_hidden_Timeout = b.Timeout
	return m0
...
const file_proto_config_v1_config_proto_rawDesc = "" +
	...
	"\binterval\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\binterval\x123\n" +
	"\atimeout\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xd9\x01\n" +
	"\x14WebsocketHealthCheck\x12!\n" +
	"\fping_message\x18\x01 \x01(\tR\vpingMessage\x122\n" +
	"\x15expected_pong_message\x18\x02 \x01(\tR\x13expectedPongMessage\x125\n" +
	"\binterval\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\binterval\x123\n" +
	"\atimeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xcb\x01\n" +
...
var file_proto_config_v1_config_proto_goTypes = []any{
	...
	(*WebsocketHealthCheck)(nil),                          // 25: mcpany.config.v1.WebsocketHealthCheck
...
var file_proto_config_v1_config_proto_depIdxs = []int32{
	...
	31, // 21: mcpany.config.v1.GrpcUpstreamService.tls_config:type_name -> mcpany.config.v1.TLSConfig
	45, // 22: mcpany.config.v1.GrpcUpstreamService.tools:type_name -> mcpany.config.v1.ToolDefinition
	...
	46, // 26: mcpany.config.v1.GrpcUpstreamService.resources:type_name -> mcpany.config.v1.ResourceDefinition
	32, // 27: mcpany.config.v1.GrpcUpstreamService.calls:type_name -> mcpany.config.v1.GrpcUpstreamService.CallsEntry
	47, // 28: mcpany.config.v1.GrpcUpstreamService.prompts:type_name -> mcpany.config.v1.PromptDefinition
	...
	45, // 31: mcpany.config.v1.HttpUpstreamService.tools:type_name -> mcpany.config.v1.ToolDefinition
	33, // 32: mcpany.config.v1.HttpUpstreamService.calls:type_name -> mcpany.config.v1.HttpUpstreamService.CallsEntry
	22, // 33: mcpany.config.v1.HttpUpstreamService.health_check:type_name -> mcpany.config.v1.HttpHealthCheck
	31, // 34: mcpany.config.v1.HttpUpstreamService.tls_config:type_name -> mcpany.config.v1.TLSConfig
	46, // 35: mcpany.config.v1.HttpUpstreamService.resources:type_name -> mcpany.config.v1.ResourceDefinition
	47, // 36: mcpany.config.v1.HttpUpstreamService.prompts:type_name -> mcpany.config.v1.PromptDefinition
	45, // 37: mcpany.config.v1.WebsocketUpstreamService.tools:type_name -> mcpany.config.v1.ToolDefinition
	31, // 38: mcpany.config.v1.WebsocketUpstreamService.tls_config:type_name -> mcpany.config.v1.TLSConfig
	46, // 39: mcpany.config.v1.WebsocketUpstreamService.resources:type_name -> mcpany.config.v1.ResourceDefinition
	34, // 40: mcpany.config.v1.WebsocketUpstreamService.calls:type_name -> mcpany.config.v1.WebsocketUpstreamService.CallsEntry
	47, // 41: mcpany.config.v1.WebsocketUpstreamService.prompts:type_name -> mcpany.config.v1.PromptDefinition
	25, // 42: mcpany.config.v1.WebsocketUpstreamService.health_check:type_name -> mcpany.config.v1.WebsocketHealthCheck
	...
	22, // 48: mcpany.config.v1.OpenapiUpstreamService.health_check:type_name -> mcpany.config.v1.HttpHealthCheck
	...
	24, // 55: mcpany.config.v1.CommandLineUpstreamService.health_check:type_name -> mcpany.config.v1.CommandLineHealthCheck
	...
	48, // 72: mcpany.config.v1.HttpHealthCheck.interval:type_name -> google.protobuf.Duration
	48, // 73: mcpany.config.v1.HttpHealthCheck.timeout:type_name -> google.protobuf.Duration
	48, // 74: mcpany.config.v1.GrpcHealthCheck.interval:type_name -> google.protobuf.Duration
	48, // 75: mcpany.config.v1.GrpcHealthCheck.timeout:type_name -> google.protobuf.Duration
	48, // 76: mcpany.config.v1.CommandLineHealthCheck.interval:type_name -> google.protobuf.Duration
	48, // 77: mcpany.config.v1.CommandLineHealthCheck.timeout:type_name -> google.protobuf.Duration
	48, // 78: mcpany.config.v1.WebsocketHealthCheck.interval:type_name -> google.protobuf.Duration
	48, // 79: mcpany.config.v1.WebsocketHealthCheck.timeout:type_name -> google.protobuf.Duration
	40, // 80: mcpany.config.v1.ContainerEnvironment.volumes:type_name -> mcpany.config.v1.ContainerEnvironment.VolumesEntry
	29, // 81: mcpany.config.v1.ResilienceConfig.circuit_breaker:type_name -> mcpany.config.v1.CircuitBreakerConfig
	30, // 82: mcpany.config.v1.ResilienceConfig.retry_policy:type_name -> mcpany.config.v1.RetryConfig
	48, // 83: mcpany.config.v1.CircuitBreakerConfig.open_duration:type_name -> google.protobuf.Duration
	48, // 84: mcpany.config.v1.RetryConfig.base_backoff:type_name -> google.protobuf.Duration
	48, // 85: mcpany.config.v1.RetryConfig.max_backoff:type_name -> google.protobuf.Duration
	48, // 86: mcpany.config.v1.RetryConfig.max_elapsed_time:type_name -> google.protobuf.Duration
	49, // 87: mcpany.config.v1.GrpcUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.GrpcCallDefinition
	50, // 88: mcpany.config.v1.HttpUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.HttpCallDefinition
	51, // 89: mcpany.config.v1.WebsocketUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.WebsocketCallDefinition
	52, // 90: mcpany.config.v1.WebrtcUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.WebrtcCallDefinition
	53, // 91: mcpany.config.v1.OpenapiUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.OpenAPICallDefinition
	54, // 92: mcpany.config.v1.CommandLineUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.CommandLineCallDefinition
	55, // 93: mcpany.config.v1.GraphQLUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.GraphQLCallDefinition
	56, // 94: mcpany.config.v1.McpUpstreamService.CallsEntry.value:type_name -> mcpany.config.v1.MCPCallDefinition
