...
export const CallPolicy: MessageFns<CallPolicy> = {
  ...
  fromJSON(object: any): CallPolicy {
    return {
      defaultAction: isSet(object.defaultAction) ? callPolicy_ActionFromJSON(object.defaultAction) : 0,
...
export const ExportPolicy: MessageFns<ExportPolicy> = {
  ...
  fromJSON(object: any): ExportPolicy {
    return {
      defaultAction: isSet(object.defaultAction) ? exportPolicy_ActionFromJSON(object.defaultAction) : 0,
...
export const CallHook: MessageFns<CallHook> = {
  ...
  fromJSON(object: any): CallHook {
    return {
      ...
      callPolicy: isSet(object.callPolicy) ? CallPolicy.fromJSON(object.callPolicy) : undefined,
    };
  },
...
export const RateLimitConfig: MessageFns<RateLimitConfig> = {
  encode(message: RateLimitConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.burst !== 0) {
      writer.uint32(24).int64(message.burst);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.burst = longToNumber(reader.int64());
          continue;
        }
        case 4: {
          if (tag !== 32) {
