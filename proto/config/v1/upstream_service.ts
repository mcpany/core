...
export interface UpstreamServiceConfig {
   ...
   * @inject_tag: yaml:"-"
   */
  provenance?: ServiceProvenance | undefined;
}
...
export const UpstreamServiceConfig: MessageFns<UpstreamServiceConfig> = {
  encode(message: UpstreamServiceConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.provenance !== undefined) {
      ServiceProvenance.encode(message.provenance, writer.uint32(314).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 39: {
          ...
          message.provenance = ServiceProvenance.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): UpstreamServiceConfig {
    return {
      ...
      provenance: isSet(object.provenance) ? ServiceProvenance.fromJSON(object.provenance) : undefined,
    };
  },
  ...
  toJSON(message: UpstreamServiceConfig): unknown {
    ...
    if (message.provenance !== undefined) {
      obj.provenance = ServiceProvenance.toJSON(message.provenance);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<UpstreamServiceConfig>, I>>(object: I): UpstreamServiceConfig {
    ...
    message.provenance = (object.provenance !== undefined && object.provenance !== null)
      ? ServiceProvenance.fromPartial(object.provenance)
      : undefined;
    return message;
  },
};

function createBaseServiceProvenance(): ServiceProvenance {
  return { verified: false, signerIdentity: "", attestationTime: undefined, signatureAlgorithm: "" };
}

export const ServiceProvenance: MessageFns<ServiceProvenance> = {
  encode(message: ServiceProvenance, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.verified !== false) {
      writer.uint32(8).bool(message.verified);
    }
    if (message.signerIdentity !== "") {
      writer.uint32(18).string(message.signerIdentity);
    }
    if (message.attestationTime !== undefined) {
      Timestamp.encode(toTimestamp(message.attestationTime), writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ServiceProvenance {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseServiceProvenance();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.signerIdentity = reader.string();
          continue;
        }
        case 3: {
          if (tag !== 26) {
          ...
          message.attestationTime = fromTimestamp(Timestamp.decode(reader, reader.uint32()));
          continue;
        }
        case 4: {
          if (tag !== 34) {
  ...
  fromJSON(object: any): ServiceProvenance {
    return {
      verified: isSet(object.verified) ? globalThis.Boolean(object.verified) : false,
      signerIdentity: isSet(object.signer_identity) ? globalThis.String(object.signer_identity) : "",
      attestationTime: isSet(object.attestation_time) ? fromJsonTimestamp(object.attestation_time) : undefined,
      signatureAlgorithm: isSet(object.signature_algorithm) ? globalThis.String(object.signature_algorithm) : "",
    };
  },

  toJSON(message: ServiceProvenance): unknown {
    const obj: any = {};
    if (message.verified !== false) {
      obj.verified = message.verified;
    }
    if (message.signerIdentity !== "") {
      obj.signer_identity = message.signerIdentity;
    }
    if (message.attestationTime !== undefined) {
      obj.attestation_time = message.attestationTime.toISOString();
    }
    if (message.signatureAlgorithm !== "") {
      obj.signature_algorithm = message.signatureAlgorithm;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<ServiceProvenance>, I>>(base?: I): ServiceProvenance {
    return ServiceProvenance.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ServiceProvenance>, I>>(object: I): ServiceProvenance {
    const message = createBaseServiceProvenance();
    message.verified = object.verified ?? false;
    message.signerIdentity = object.signerIdentity ?? "";
    message.attestationTime = object.attestationTime ?? undefined;
