...
import { RequestCollection } from "./playground";
...
export const McpAnyServerConfig: MessageFns<McpAnyServerConfig> = {
  encode(message: McpAnyServerConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.requestCollections) {
      RequestCollection.encode(v!, writer.uint32(50).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.requestCollections.push(RequestCollection.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): McpAnyServerConfig {
    return {
      ...
      requestCollections: globalThis.Array.isArray(object?.request_collections)
        ? object.request_collections.map((e: any) => RequestCollection.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: McpAnyServerConfig): unknown {
    ...
    if (message.requestCollections?.length) {
      obj.request_collections = message.requestCollections.map((e) => RequestCollection.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<McpAnyServerConfig>, I>>(object: I): McpAnyServerConfig {
    ...
    message.mergeStrategy = (object.mergeStrategy !== undefined && object.mergeStrategy !== null)
      ...
      : undefined;
    message.requestCollections = object.requestCollections?.map((e) => RequestCollection.fromPartial(e)) || [];
    return message;
  },
};
