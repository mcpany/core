...
export enum ParameterLocation {
  /** PARAMETER_LOCATION_UNSPECIFIED - Default: infer from URL template (path/query) or body. */
...
export function parameterLocationToJSON(object: ParameterLocation): string {
  switch (object) {
    ...
    case ParameterLocation.PARAMETER_LOCATION_BODY:
