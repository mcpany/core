...
export enum ParameterLocation {
  /** PARAMETER_LOCATION_UNSPECIFIED - Auto-detect (Path/Template) */
...
export function parameterLocationFromJSON(object: any): ParameterLocation {
  switch (object) {
    ...
    case "PARAMETER_LOCATION_QUERY":
      return ParameterLocation.PARAMETER_LOCATION_QUERY;
    case 2:
    case "PARAMETER_LOCATION_HEADER":
      return ParameterLocation.PARAMETER_LOCATION_HEADER;
    case 3:
    case "PARAMETER_LOCATION_COOKIE":
      return ParameterLocation.PARAMETER_LOCATION_COOKIE;
    case 4:
    case "PARAMETER_LOCATION_PATH":
      return ParameterLocation.PARAMETER_LOCATION_PATH;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function parameterLocationToJSON(object: ParameterLocation): string {
  switch (object) {
    ...
    case ParameterLocation.PARAMETER_LOCATION_QUERY:
      return "PARAMETER_LOCATION_QUERY";
    case ParameterLocation.PARAMETER_LOCATION_HEADER:
      return "PARAMETER_LOCATION_HEADER";
    case ParameterLocation.PARAMETER_LOCATION_COOKIE:
      return "PARAMETER_LOCATION_COOKIE";
    case ParameterLocation.PARAMETER_LOCATION_PATH:
...
function createBaseHttpParameterMapping(): HttpParameterMapping {
  return { schema: undefined, secret: undefined, disableEscape: false, location: 0, targetName: "" };
}
...
export const HttpParameterMapping: MessageFns<HttpParameterMapping> = {
  ...
  fromJSON(object: any): HttpParameterMapping {
    return {
      ...
      targetName: isSet(object.target_name) ? globalThis.String(object.target_name) : "",
    };
  },
  ...
  toJSON(message: HttpParameterMapping): unknown {
    ...
    if (message.targetName !== "") {
      obj.target_name = message.targetName;
    }
    return obj;
  },
