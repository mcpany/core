...
type User struct {
	...
	xxx_hidden_PreferencesJson *string                `protobuf:"bytes,5,opt,name=preferences_json"`
...
func (x *User) GetPreferencesJson() string {
	if x != nil {
		if x.xxx_hidden_PreferencesJson != nil {
			return *x.xxx_hidden_PreferencesJson
		}
		return ""
	}
	return ""
...
func (x *User) SetPreferencesJson(v string) {
	x.xxx_hidden_PreferencesJson = &v
...
func (x *User) HasPreferencesJson() bool {
	if x == nil {
		return false
	}
...
func (x *User) ClearPreferencesJson() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 4)
	x.xxx_hidden_PreferencesJson = nil
}
...
type User_builder struct {
	...
	Roles []string
	// JSON string containing user preferences (e.g., dashboard layout).
...
func (b0 User_builder) Build() *User {
	...
	if b.PreferencesJson != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 4, 5)
		x.xxx_hidden_PreferencesJson = b.PreferencesJson
	}
	return m0
}
...
const file_proto_config_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x1aproto/config/v1/user.proto\x12\x10mcpany.config.v1\x1a!google/protobuf/go_features.proto\x1a\x1aproto/config/v1/auth.proto\"\xc4\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x10preferences_json\x18\x05 \x01(\tR\x10preferences_jsonB;B\tUserProtoZ&github.com/mcpany/core/proto/config/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
