...
type UserPreferences struct {
	...
	xxx_hidden_DashboardLayout *string                `protobuf:"bytes,1,opt,name=dashboard_layout"`
...
func (x *UserPreferences) GetDashboardLayout() string {
	if x != nil {
		if x.xxx_hidden_DashboardLayout != nil {
			return *x.xxx_hidden_DashboardLayout
		}
		return ""
	}
	return ""
...
func (x *UserPreferences) SetDashboardLayout(v string) {
	x.xxx_hidden_DashboardLayout = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 1)
}

func (x *UserPreferences) HasDashboardLayout() bool {
	if x == nil {
		return false
	}
...
func (x *UserPreferences) ClearDashboardLayout() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_DashboardLayout = nil
}
...
func (b0 UserPreferences_builder) Build() *UserPreferences {
	...
	b, x := &b0, m0
	_, _ = b, x
	if b.DashboardLayout != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 0, 1)
		x.xxx_hidden_DashboardLayout = b.DashboardLayout
	}
	return m0
}
...
const file_proto_config_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x1aproto/config/v1/user.proto\x12\x10mcpany.config.v1\x1a!google/protobuf/go_features.proto\x1a\x1aproto/config/v1/auth.proto\"=\n" +
	"\x0fUserPreferences\x12*\n" +
	"\x10dashboard_layout\x18\x01 \x01(\tR\x10dashboard_layout\"\xdd\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\vpreferences\x18\x05 \x01(\v2!.mcpany.config.v1.UserPreferencesR\vpreferencesB;B\tUserProtoZ&github.com/mcpany/core/proto/config/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_proto_config_v1_user_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_config_v1_user_proto_goTypes = []any{
	(*UserPreferences)(nil), // 0: mcpany.config.v1.UserPreferences
	(*User)(nil),            // 1: mcpany.config.v1.User
...
var file_proto_config_v1_user_proto_depIdxs = []int32{
	...
	0, // 1: mcpany.config.v1.User.preferences:type_name -> mcpany.config.v1.UserPreferences
