...
type CommandLineUpstreamService struct {
	...
	Arguments     []string `protobuf:"bytes,15,rep,name=arguments" json:"arguments,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CommandLineUpstreamService) GetArguments() []string {
	if x != nil {
		return x.Arguments
	}
	return nil
...
func (x *CommandLineUpstreamService) SetArguments(v []string) {
	x.Arguments = v
}
...
const file_proto_config_v1_upstream_service_proto_rawDesc = "" +
	...
	"\x03env\x18\x0e \x03(\v25.mcpany.config.v1.CommandLineUpstreamService.EnvEntryR\x03env\x12\x1c\n" +
	"\targuments\x18\x0f \x03(\tR\targuments\x1ae\n" +
	"\n" +
	"CallsEntry\x12\x10\n" +
