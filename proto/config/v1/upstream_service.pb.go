...
type UpstreamServiceConfig struct {
	...
	xxx_hidden_SanitizedName         *string                               `protobuf:"bytes,3,opt,name=sanitized_name,json=sanitizedName"`
	...
	xxx_hidden_AutoDiscoverTool      bool                                  `protobuf:"varint,7,opt,name=auto_discover_tool,json=autoDiscoverTool"`
	xxx_hidden_ConfigError           *string                               `protobuf:"bytes,8,opt,name=config_error,json=configError"`
	xxx_hidden_ReadOnly              bool                                  `protobuf:"varint,35,opt,name=read_only,json=readOnly"`
	xxx_hidden_LastError             *string                               `protobuf:"bytes,36,opt,name=last_error,json=lastError"`
	xxx_hidden_ToolCount             int32                                 `protobuf:"varint,37,opt,name=tool_count,json=toolCount"`
	xxx_hidden_ConnectionPool        *ConnectionPoolConfig                 `protobuf:"bytes,9,opt,name=connection_pool,json=connectionPool"`
	xxx_hidden_UpstreamAuth          *Authentication                       `protobuf:"bytes,10,opt,name=upstream_auth,json=upstreamAuth"`
	xxx_hidden_Cache                 *CacheConfig                          `protobuf:"bytes,11,opt,name=cache"`
	xxx_hidden_RateLimit             *RateLimitConfig                      `protobuf:"bytes,12,opt,name=rate_limit,json=rateLimit"`
	xxx_hidden_LoadBalancingStrategy LoadBalancingStrategy                 `protobuf:"varint,13,opt,name=load_balancing_strategy,json=loadBalancingStrategy,enum=mcpany.config.v1.LoadBalancingStrategy"`
	...
	xxx_hidden_ToolExportPolicy      *ExportPolicy                         `protobuf:"bytes,16,opt,name=tool_export_policy,json=toolExportPolicy"`
	xxx_hidden_PromptExportPolicy    *ExportPolicy                         `protobuf:"bytes,17,opt,name=prompt_export_policy,json=promptExportPolicy"`
	xxx_hidden_ResourceExportPolicy  *ExportPolicy                         `protobuf:"bytes,18,opt,name=resource_export_policy,json=resourceExportPolicy"`
	xxx_hidden_ServiceConfig         isUpstreamServiceConfig_ServiceConfig `protobuf_oneof:"service_config"`
	xxx_hidden_CallPolicies          *[]*CallPolicy                        `protobuf:"bytes,30,rep,name=call_policies,json=callPolicies"`
	xxx_hidden_PreCallHooks          *[]*CallHook                          `protobuf:"bytes,31,rep,name=pre_call_hooks,json=preCallHooks"`
	xxx_hidden_PostCallHooks         *[]*CallHook                          `protobuf:"bytes,32,rep,name=post_call_hooks,json=postCallHooks"`
	...
	xxx_hidden_ConfigurationSchema   *string                               `protobuf:"bytes,38,opt,name=configuration_schema,json=configurationSchema"`
...
type upstreamServiceConfig_McpService struct {
	McpService *McpUpstreamService `protobuf:"bytes,19,opt,name=mcp_service,json=mcpService,oneof"`
}

type upstreamServiceConfig_HttpService struct {
	HttpService *HttpUpstreamService `protobuf:"bytes,20,opt,name=http_service,json=httpService,oneof"`
}

type upstreamServiceConfig_GrpcService struct {
	GrpcService *GrpcUpstreamService `protobuf:"bytes,21,opt,name=grpc_service,json=grpcService,oneof"`
}

type upstreamServiceConfig_OpenapiService struct {
	OpenapiService *OpenapiUpstreamService `protobuf:"bytes,22,opt,name=openapi_service,json=openapiService,oneof"`
}

type upstreamServiceConfig_CommandLineService struct {
	CommandLineService *CommandLineUpstreamService `protobuf:"bytes,23,opt,name=command_line_service,json=commandLineService,oneof"`
}

type upstreamServiceConfig_WebsocketService struct {
	WebsocketService *WebsocketUpstreamService `protobuf:"bytes,24,opt,name=websocket_service,json=websocketService,oneof"`
}

type upstreamServiceConfig_WebrtcService struct {
	WebrtcService *WebrtcUpstreamService `protobuf:"bytes,25,opt,name=webrtc_service,json=webrtcService,oneof"`
}

type upstreamServiceConfig_GraphqlService struct {
	GraphqlService *GraphQLUpstreamService `protobuf:"bytes,26,opt,name=graphql_service,json=graphqlService,oneof"`
}

type upstreamServiceConfig_SqlService struct {
	SqlService *SqlUpstreamService `protobuf:"bytes,27,opt,name=sql_service,json=sqlService,oneof"`
}

type upstreamServiceConfig_FilesystemService struct {
	FilesystemService *FilesystemUpstreamService `protobuf:"bytes,28,opt,name=filesystem_service,json=filesystemService,oneof"`
}

type upstreamServiceConfig_VectorService struct {
	VectorService *VectorUpstreamService `protobuf:"bytes,29,opt,name=vector_service,json=vectorService,oneof"`
}
...
type FilesystemUpstreamService struct {
	...
	xxx_hidden_AllowedPaths   []string                                   `protobuf:"bytes,6,rep,name=allowed_paths,json=allowedPaths"`
	xxx_hidden_DeniedPaths    []string                                   `protobuf:"bytes,7,rep,name=denied_paths,json=deniedPaths"`
	xxx_hidden_SymlinkMode    FilesystemUpstreamService_SymlinkMode      `protobuf:"varint,8,opt,name=symlink_mode,json=symlinkMode,enum=mcpany.config.v1.FilesystemUpstreamService_SymlinkMode"`
...
type MilvusVectorDB struct {
	...
	xxx_hidden_Username       *string                `protobuf:"bytes,2,opt,name=username"`
	xxx_hidden_Password       *string                `protobuf:"bytes,3,opt,name=password"`
	xxx_hidden_CollectionName *string                `protobuf:"bytes,4,opt,name=collection_name,json=collectionName"`
	xxx_hidden_DatabaseName   *string                `protobuf:"bytes,5,opt,name=database_name,json=databaseName"`
	xxx_hidden_UseTls         bool                   `protobuf:"varint,6,opt,name=use_tls,json=useTls"`
	xxx_hidden_ApiKey         *string                `protobuf:"bytes,7,opt,name=api_key,json=apiKey"`
	XXX_raceDetectHookData    protoimpl.RaceDetectHookData
	XXX_presence              [1]uint32
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
...
type McpStdioConnection struct {
	...
	xxx_hidden_ContainerImage   *string                 `protobuf:"bytes,3,opt,name=container_image,json=containerImage"`
...
type EnvValidation struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_RequiredEnv []string               `protobuf:"bytes,1,rep,name=required_env,json=requiredEnv"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
const file_proto_config_v1_upstream_service_proto_rawDesc = "" +
	"\n" +
	"&proto/config/v1/upstream_service.proto\x12\x10mcpany.config.v1\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x13proto/bus/bus.proto\x1a\x1aproto/config/v1/auth.proto\x1a\x1aproto/config/v1/call.proto\x1a\"proto/config/v1/health_check.proto\x1a\x1dproto/config/v1/profile.proto\x1a\x1cproto/config/v1/prompt.proto\x1a\x1eproto/config/v1/resource.proto\x1a\x1aproto/config/v1/tool.proto\x1a\x1dproto/config/v1/webhook.proto\"\xc5\x12\n" +
	"\x15UpstreamServiceConfig\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12%\n" +
	"\x0esanitized_name\x18\x03 \x01(\tR\rsanitizedName\x12\x18\n" +
	"\aversion\x18\x04 \x01(\tR\aversion\x12\x1a\n" +
	"\bpriority\x18\x05 \x01(\x05R\bpriority\x12\x18\n" +
	"\adisable\x18\x06 \x01(\bR\adisable\x12,\n" +
	"\x12auto_discover_tool\x18\a \x01(\bR\x10autoDiscoverTool\x12!\n" +
	"\fconfig_error\x18\b \x01(\tR\vconfigError\x12\x1b\n" +
	"\tread_only\x18# \x01(\bR\breadOnly\x12\x1d\n" +
	"\n" +
	"last_error\x18$ \x01(\tR\tlastError\x12\x1d\n" +
	"\n" +
	"tool_count\x18% \x01(\x05R\ttoolCount\x12O\n" +
	"\x0fconnection_pool\x18\t \x01(\v2&.mcpany.config.v1.ConnectionPoolConfigR\x0econnectionPool\x12E\n" +
	"\rupstream_auth\x18\n" +
	" \x01(\v2 .mcpany.config.v1.AuthenticationR\fupstreamAuth\x123\n" +
	"\x05cache\x18\v \x01(\v2\x1d.mcpany.config.v1.CacheConfigR\x05cache\x12@\n" +
	"\n" +
	"rate_limit\x18\f \x01(\v2!.mcpany.config.v1.RateLimitConfigR\trateLimit\x12_\n" +
	"\x17load_balancing_strategy\x18\r \x01(\x0e2'.mcpany.config.v1.LoadBalancingStrategyR\x15loadBalancingStrategy\x12B\n" +
	"\n" +
	"resilience\x18\x0e \x01(\v2\".mcpany.config.v1.ResilienceConfigR\n" +
	"resilience\x12H\n" +
	"\x0eauthentication\x18\x0f \x01(\v2 .mcpany.config.v1.AuthenticationR\x0eauthentication\x12L\n" +
	"\x12tool_export_policy\x18\x10 \x01(\v2\x1e.mcpany.config.v1.ExportPolicyR\x10toolExportPolicy\x12P\n" +
	"\x14prompt_export_policy\x18\x11 \x01(\v2\x1e.mcpany.config.v1.ExportPolicyR\x12promptExportPolicy\x12T\n" +
	"\x16resource_export_policy\x18\x12 \x01(\v2\x1e.mcpany.config.v1.ExportPolicyR\x14resourceExportPolicy\x12G\n" +
	"\vmcp_service\x18\x13 \x01(\v2$.mcpany.config.v1.McpUpstreamServiceH\x00R\n" +
	"mcpService\x12J\n" +
	"\fhttp_service\x18\x14 \x01(\v2%.mcpany.config.v1.HttpUpstreamServiceH\x00R\vhttpService\x12J\n" +
	"\fgrpc_service\x18\x15 \x01(\v2%.mcpany.config.v1.GrpcUpstreamServiceH\x00R\vgrpcService\x12S\n" +
	"\x0fopenapi_service\x18\x16 \x01(\v2(.mcpany.config.v1.OpenapiUpstreamServiceH\x00R\x0eopenapiService\x12`\n" +
	"\x14command_line_service\x18\x17 \x01(\v2,.mcpany.config.v1.CommandLineUpstreamServiceH\x00R\x12commandLineService\x12Y\n" +
	"\x11websocket_service\x18\x18 \x01(\v2*.mcpany.config.v1.WebsocketUpstreamServiceH\x00R\x10websocketService\x12P\n" +
	"\x0ewebrtc_service\x18\x19 \x01(\v2'.mcpany.config.v1.WebrtcUpstreamServiceH\x00R\rwebrtcService\x12S\n" +
	"\x0fgraphql_service\x18\x1a \x01(\v2(.mcpany.config.v1.GraphQLUpstreamServiceH\x00R\x0egraphqlService\x12G\n" +
	"\vsql_service\x18\x1b \x01(\v2$.mcpany.config.v1.SqlUpstreamServiceH\x00R\n" +
	"sqlService\x12\\\n" +
	"\x12filesystem_service\x18\x1c \x01(\v2+.mcpany.config.v1.FilesystemUpstreamServiceH\x00R\x11filesystemService\x12P\n" +
	"\x0evector_service\x18\x1d \x01(\v2'.mcpany.config.v1.VectorUpstreamServiceH\x00R\rvectorService\x12A\n" +
	"\rcall_policies\x18\x1e \x03(\v2\x1c.mcpany.config.v1.CallPolicyR\fcallPolicies\x12@\n" +
	"\x0epre_call_hooks\x18\x1f \x03(\v2\x1a.mcpany.config.v1.CallHookR\fpreCallHooks\x12B\n" +
	"\x0fpost_call_hooks\x18  \x03(\v2\x1a.mcpany.config.v1.CallHookR\rpostCallHooks\x12<\n" +
	"\aprompts\x18! \x03(\v2\".mcpany.config.v1.PromptDefinitionR\aprompts\x12\x12\n" +
	"\x04tags\x18\" \x03(\tR\x04tags\x121\n" +
	"\x14configuration_schema\x18& \x01(\tR\x13configurationSchemaB\x10\n" +
	...
	"\x05value\x18\x02 \x01(\v2#.mcpany.config.v1.SqlCallDefinitionR\x05value:\x028\x01\"\xd9\a\n" +
	...
	"\fdenied_paths\x18\a \x03(\tR\vdeniedPaths\x12Z\n" +
	"\fsymlink_mode\x18\b \x01(\x0e27.mcpany.config.v1.FilesystemUpstreamService.SymlinkModeR\vsymlinkMode\x12(\n" +
	"\x02os\x18\n" +
	...
	"\x04host\x18\x05 \x01(\tR\x04host\"\xe2\x01\n" +
	"\x0eMilvusVectorDB\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\x12'\n" +
	"\x0fcollection_name\x18\x04 \x01(\tR\x0ecollectionName\x12#\n" +
	"\rdatabase_name\x18\x05 \x01(\tR\fdatabaseName\x12\x17\n" +
	"\ause_tls\x18\x06 \x01(\bR\x06useTls\x12\x17\n" +
	"\aapi_key\x18\a \x01(\tR\x06apiKey\"\xba\x05\n" +
	...
	"\bEnvEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x123\n" +
	"\x05value\x18\x02 \x01(\v2\x1d.mcpany.config.v1.SecretValueR\x05value:\x028\x01\"2\n" +
	"\rEnvValidation\x12!\n" +
	"\frequired_env\x18\x01 \x03(\tR\vrequiredEnv\"\xac\x01\n" +
	...
	"\x13allow_http_redirect\x18\x06 \x01(\bR\x11allowHttpRedirect\"\xf8\x01\n" +
	...
	"\bEnvEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x123\n" +
	"\x05value\x18\x02 \x01(\v2\x1d.mcpany.config.v1.SecretValueR\x05value:\x028\x01\"\xaf\x01\n" +
	...
	"\bEnvEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x123\n" +
	"\x05value\x18\x02 \x01(\v2\x1d.mcpany.config.v1.SecretValueR\x05value:\x028\x01\"\xda\x01\n" +
