...
const UpstreamServiceConfig_BrowserService_case case_UpstreamServiceConfig_ServiceConfig = 39
...
type upstreamServiceConfig_BrowserService struct {
	BrowserService *BrowserUpstreamService `protobuf:"bytes,39,opt,name=browser_service,oneof"`
}
...
func (x *BrowserUpstreamService) GetAddress() string {
	if x != nil {
		if x.xxx_hidden_Address != nil {
			return *x.xxx_hidden_Address
		}
...
func (x *BrowserUpstreamService) SetAddress(v string) {
	x.xxx_hidden_Address = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 4)
}
...
func (x *BrowserUpstreamService) HasAddress() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *BrowserUpstreamService) ClearAddress() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_Address = nil
}
...
type BrowserUpstreamService_builder struct {
	...
	// Optional: The address of a remote browser instance (e.g. standard CDP).
	Address *string
	// Manually defined mappings from MCP tools to browser calls (usually not needed as we auto-register).
	Tools []*ToolDefinition
	// A list of resources served by this service.
	Resources []*ResourceDefinition
	// A list of prompts served by this service.
...
const file_proto_config_v1_upstream_service_proto_rawDesc = "" +
	"\n" +
	"&proto/config/v1/upstream_service.proto\x12\x10mcpany.config.v1\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x13proto/bus/bus.proto\x1a\x1aproto/config/v1/auth.proto\x1a\x1aproto/config/v1/call.proto\x1a\"proto/config/v1/health_check.proto\x1a\x1dproto/config/v1/profile.proto\x1a\x1cproto/config/v1/prompt.proto\x1a\x1eproto/config/v1/resource.proto\x1a\x1aproto/config/v1/tool.proto\x1a\x1dproto/config/v1/webhook.proto\"\xbf\x13\n" +
	...
	"\fidle_timeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\fidle_timeout\"\xec\x01\n" +
	"\x16BrowserUpstreamService\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x126\n" +
	"\x05tools\x18\x02 \x03(\v2 .mcpany.config.v1.ToolDefinitionR\x05tools\x12B\n" +
	"\tresources\x18\x03 \x03(\v2$.mcpany.config.v1.ResourceDefinitionR\tresources\x12<\n" +
	"\aprompts\x18\x04 \x03(\v2\".mcpany.config.v1.PromptDefinitionR\aprompts\"\xe5\x02\n" +
...
var file_proto_config_v1_upstream_service_proto_goTypes = []any{
	...
	(*BrowserUpstreamService)(nil),                        // 40: mcpany.config.v1.BrowserUpstreamService
...
var file_proto_config_v1_upstream_service_proto_depIdxs = []int32{
	...
	40,  // 21: mcpany.config.v1.UpstreamServiceConfig.browser_service:type_name -> mcpany.config.v1.BrowserUpstreamService
	...
	66,  // 109: mcpany.config.v1.BrowserUpstreamService.tools:type_name -> mcpany.config.v1.ToolDefinition
	68,  // 110: mcpany.config.v1.BrowserUpstreamService.resources:type_name -> mcpany.config.v1.ResourceDefinition
	64,  // 111: mcpany.config.v1.BrowserUpstreamService.prompts:type_name -> mcpany.config.v1.PromptDefinition
