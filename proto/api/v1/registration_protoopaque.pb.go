...
const file_proto_api_v1_registration_proto_rawDesc = "" +
	"\n" +
	"\x1fproto/api/v1/registration.proto\x12\rmcpany.api.v1\x1a!google/protobuf/go_features.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1cproto/config/v1/config.proto\x1a\x1eproto/config/v1/resource.proto\x1a\x1aproto/config/v1/call.proto\"Y\n" +
