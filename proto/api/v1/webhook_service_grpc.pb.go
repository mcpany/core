...
const (
	WebhookService_ListWebhooks_FullMethodName  = "/mcpany.api.v1.WebhookService/ListWebhooks"
	WebhookService_CreateWebhook_FullMethodName = "/mcpany.api.v1.WebhookService/CreateWebhook"
	WebhookService_DeleteWebhook_FullMethodName = "/mcpany.api.v1.WebhookService/DeleteWebhook"
)
...
var WebhookService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mcpany.api.v1.WebhookService",
	...
	Metadata: "proto/api/v1/webhook_service.proto",
}
