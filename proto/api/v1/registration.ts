...
export const RegisterToolsResponse: MessageFns<RegisterToolsResponse> = {
  ...
  fromJSON(object: any): RegisterToolsResponse {
    return {
      message: isSet(object.message) ? globalThis.String(object.message) : "",
      toolsRegistered: isSet(object.toolsRegistered) ? globalThis.Number(object.toolsRegistered) : 0,
    };
  },
...
export interface RegistrationService {
  ...
  InitiateOAuth2Flow(request: InitiateOAuth2FlowRequest): Promise<InitiateOAuth2FlowResponse>;
  RegisterTools(request: RegisterToolsRequest): Promise<RegisterToolsResponse>;
  GetServiceStatus(request: GetServiceStatusRequest): Promise<GetServiceStatusResponse>;
...
export const RegistrationServiceServiceName = "mcpany.api.v1.RegistrationService";
export class RegistrationServiceClientImpl implements RegistrationService {
  ...
  UnregisterService(request: UnregisterServiceRequest): Promise<UnregisterServiceResponse> {
    ...
    const promise = this.rpc.request(this.service, "UnregisterService", data);
    return promise.then((data) => UnregisterServiceResponse.decode(new BinaryReader(data)));
  }

  InitiateOAuth2Flow(request: InitiateOAuth2FlowRequest): Promise<InitiateOAuth2FlowResponse> {
    const data = InitiateOAuth2FlowRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "InitiateOAuth2Flow", data);
    return promise.then((data) => InitiateOAuth2FlowResponse.decode(new BinaryReader(data)));
  }

  RegisterTools(request: RegisterToolsRequest): Promise<RegisterToolsResponse> {
    const data = RegisterToolsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "RegisterTools", data);
    return promise.then((data) => RegisterToolsResponse.decode(new BinaryReader(data)));
  }

  GetServiceStatus(request: GetServiceStatusRequest): Promise<GetServiceStatusResponse> {
    const data = GetServiceStatusRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetServiceStatus", data);
    return promise.then((data) => GetServiceStatusResponse.decode(new BinaryReader(data)));
  }
