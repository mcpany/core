...
export const QuotaAdjusterSettings: MessageFns<QuotaAdjusterSettings> = {
  ...
  fromJSON(object: any): QuotaAdjusterSettings {
    return {
      ...
      inheritedFrom: isSet(object.inheritedFrom) ? globalThis.String(object.inheritedFrom) : "",
    };
  },
...
export interface QuotaAdjusterSettingsManager {
  ...
  UpdateQuotaAdjusterSettings(request: UpdateQuotaAdjusterSettingsRequest): Promise<QuotaAdjusterSettings>;
  /** RPC Method for getting QuotaAdjusterSettings based on the request */
  GetQuotaAdjusterSettings(request: GetQuotaAdjusterSettingsRequest): Promise<QuotaAdjusterSettings>;
}

export const QuotaAdjusterSettingsManagerServiceName = "google.api.cloudquotas.v1beta.QuotaAdjusterSettingsManager";
export class QuotaAdjusterSettingsManagerClientImpl implements QuotaAdjusterSettingsManager {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || QuotaAdjusterSettingsManagerServiceName;
    this.rpc = rpc;
  ...
  UpdateQuotaAdjusterSettings(request: UpdateQuotaAdjusterSettingsRequest): Promise<QuotaAdjusterSettings> {
    const data = UpdateQuotaAdjusterSettingsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "UpdateQuotaAdjusterSettings", data);
    return promise.then((data) => QuotaAdjusterSettings.decode(new BinaryReader(data)));
  }

  GetQuotaAdjusterSettings(request: GetQuotaAdjusterSettingsRequest): Promise<QuotaAdjusterSettings> {
    const data = GetQuotaAdjusterSettingsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetQuotaAdjusterSettings", data);
    return promise.then((data) => QuotaAdjusterSettings.decode(new BinaryReader(data)));
  }
}
