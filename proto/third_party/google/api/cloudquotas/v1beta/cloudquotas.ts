...
export interface CloudQuotas {
  ...
  ListQuotaInfos(request: ListQuotaInfosRequest): Promise<ListQuotaInfosResponse>;
  /** Retrieve the QuotaInfo of a quota for a project, folder or organization. */
  GetQuotaInfo(request: GetQuotaInfoRequest): Promise<QuotaInfo>;
  /** Lists QuotaPreferences in a given project, folder or organization. */
  ListQuotaPreferences(request: ListQuotaPreferencesRequest): Promise<ListQuotaPreferencesResponse>;
  /** Gets details of a single QuotaPreference. */
  GetQuotaPreference(request: GetQuotaPreferenceRequest): Promise<QuotaPreference>;
  /** Creates a new QuotaPreference that declares the desired value for a quota. */
  CreateQuotaPreference(request: CreateQuotaPreferenceRequest): Promise<QuotaPreference>;
  /**
   ...
   */
  UpdateQuotaPreference(request: UpdateQuotaPreferenceRequest): Promise<QuotaPreference>;
}

export const CloudQuotasServiceName = "google.api.cloudquotas.v1beta.CloudQuotas";
export class CloudQuotasClientImpl implements CloudQuotas {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || CloudQuotasServiceName;
    this.rpc = rpc;
  ...
  ListQuotaInfos(request: ListQuotaInfosRequest): Promise<ListQuotaInfosResponse> {
    const data = ListQuotaInfosRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListQuotaInfos", data);
    return promise.then((data) => ListQuotaInfosResponse.decode(new BinaryReader(data)));
  }

  GetQuotaInfo(request: GetQuotaInfoRequest): Promise<QuotaInfo> {
    const data = GetQuotaInfoRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetQuotaInfo", data);
    return promise.then((data) => QuotaInfo.decode(new BinaryReader(data)));
  }

  ListQuotaPreferences(request: ListQuotaPreferencesRequest): Promise<ListQuotaPreferencesResponse> {
    const data = ListQuotaPreferencesRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListQuotaPreferences", data);
    return promise.then((data) => ListQuotaPreferencesResponse.decode(new BinaryReader(data)));
  }

  GetQuotaPreference(request: GetQuotaPreferenceRequest): Promise<QuotaPreference> {
    const data = GetQuotaPreferenceRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetQuotaPreference", data);
    return promise.then((data) => QuotaPreference.decode(new BinaryReader(data)));
  }

  CreateQuotaPreference(request: CreateQuotaPreferenceRequest): Promise<QuotaPreference> {
    const data = CreateQuotaPreferenceRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CreateQuotaPreference", data);
    return promise.then((data) => QuotaPreference.decode(new BinaryReader(data)));
  }

  UpdateQuotaPreference(request: UpdateQuotaPreferenceRequest): Promise<QuotaPreference> {
    const data = UpdateQuotaPreferenceRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "UpdateQuotaPreference", data);
    return promise.then((data) => QuotaPreference.decode(new BinaryReader(data)));
  }
}
