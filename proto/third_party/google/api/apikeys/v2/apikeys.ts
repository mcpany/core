...
export interface ApiKeys {
   ...
   * location is `global`.
   */
  CreateKey(request: CreateKeyRequest): Promise<Operation>;
  /**
   ...
   * location is `global`.
   */
  GetKey(request: GetKeyRequest): Promise<Key>;
  /**
   ...
   * location is `global`.
   */
  GetKeyString(request: GetKeyStringRequest): Promise<GetKeyStringResponse>;
  /**
   ...
   * location is `global`.
   */
  UpdateKey(request: UpdateKeyRequest): Promise<Operation>;
  /**
   ...
   * location is `global`.
   */
  DeleteKey(request: DeleteKeyRequest): Promise<Operation>;
  /**
   ...
   * location is `global`.
   */
  UndeleteKey(request: UndeleteKeyRequest): Promise<Operation>;
  /**
   ...
   */
  LookupKey(request: LookupKeyRequest): Promise<LookupKeyResponse>;
}

export const ApiKeysServiceName = "google.api.apikeys.v2.ApiKeys";
export class ApiKeysClientImpl implements ApiKeys {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || ApiKeysServiceName;
    this.rpc = rpc;
  ...
  GetKeyString(request: GetKeyStringRequest): Promise<GetKeyStringResponse> {
    const data = GetKeyStringRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetKeyString", data);
    return promise.then((data) => GetKeyStringResponse.decode(new BinaryReader(data)));
  }
  ...
  UndeleteKey(request: UndeleteKeyRequest): Promise<Operation> {
    const data = UndeleteKeyRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "UndeleteKey", data);
    return promise.then((data) => Operation.decode(new BinaryReader(data)));
  }

  LookupKey(request: LookupKeyRequest): Promise<LookupKeyResponse> {
    const data = LookupKeyRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "LookupKey", data);
    return promise.then((data) => LookupKeyResponse.decode(new BinaryReader(data)));
  }
}
