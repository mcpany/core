...
export const ConformanceServiceServiceName = "google.api.expr.conformance.v1alpha1.ConformanceService";
export class ConformanceServiceClientImpl implements ConformanceService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || ConformanceServiceServiceName;
    this.rpc = rpc;
  ...
  Parse(request: ParseRequest): Promise<ParseResponse> {
    ...
    const promise = this.rpc.request(this.service, "Parse", data);
    return promise.then((data) => ParseResponse.decode(new BinaryReader(data)));
  }
