...
export const ServiceControllerServiceName = "google.api.servicecontrol.v1.ServiceController";
export class ServiceControllerClientImpl implements ServiceController {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || ServiceControllerServiceName;
    this.rpc = rpc;
  ...
  Report(request: ReportRequest): Promise<ReportResponse> {
    ...
    return promise.then((data) => ReportResponse.decode(new BinaryReader(data)));
  }
}
