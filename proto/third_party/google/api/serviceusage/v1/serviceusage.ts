...
export const ServiceUsageServiceName = "google.api.serviceusage.v1.ServiceUsage";
export class ServiceUsageClientImpl implements ServiceUsage {
  ...
  BatchGetServices(request: BatchGetServicesRequest): Promise<BatchGetServicesResponse> {
    ...
    const promise = this.rpc.request(this.service, "BatchGetServices", data);
    return promise.then((data) => BatchGetServicesResponse.decode(new BinaryReader(data)));
  }
}
