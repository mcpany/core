...
export const ServiceManagerServiceName = "google.api.servicemanagement.v1.ServiceManager";
export class ServiceManagerClientImpl implements ServiceManager {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || ServiceManagerServiceName;
    this.rpc = rpc;
  ...
  GetService(request: GetServiceRequest): Promise<ManagedService> {
    ...
    return promise.then((data) => ManagedService.decode(new BinaryReader(data)));
  }
  ...
  UndeleteService(request: UndeleteServiceRequest): Promise<Operation> {
    ...
    const promise = this.rpc.request(this.service, "UndeleteService", data);
    return promise.then((data) => Operation.decode(new BinaryReader(data)));
  }

  ListServiceConfigs(request: ListServiceConfigsRequest): Promise<ListServiceConfigsResponse> {
    const data = ListServiceConfigsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListServiceConfigs", data);
    return promise.then((data) => ListServiceConfigsResponse.decode(new BinaryReader(data)));
  }
  ...
  CreateServiceConfig(request: CreateServiceConfigRequest): Promise<Service> {
    ...
    const promise = this.rpc.request(this.service, "CreateServiceConfig", data);
    return promise.then((data) => Service.decode(new BinaryReader(data)));
  }

  SubmitConfigSource(request: SubmitConfigSourceRequest): Promise<Operation> {
    const data = SubmitConfigSourceRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SubmitConfigSource", data);
    return promise.then((data) => Operation.decode(new BinaryReader(data)));
  }

  ListServiceRollouts(request: ListServiceRolloutsRequest): Promise<ListServiceRolloutsResponse> {
    const data = ListServiceRolloutsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListServiceRollouts", data);
    return promise.then((data) => ListServiceRolloutsResponse.decode(new BinaryReader(data)));
  }

  GetServiceRollout(request: GetServiceRolloutRequest): Promise<Rollout> {
    const data = GetServiceRolloutRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetServiceRollout", data);
    return promise.then((data) => Rollout.decode(new BinaryReader(data)));
  }

  CreateServiceRollout(request: CreateServiceRolloutRequest): Promise<Operation> {
    const data = CreateServiceRolloutRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CreateServiceRollout", data);
    return promise.then((data) => Operation.decode(new BinaryReader(data)));
  }

  GenerateConfigReport(request: GenerateConfigReportRequest): Promise<GenerateConfigReportResponse> {
    const data = GenerateConfigReportRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GenerateConfigReport", data);
    return promise.then((data) => GenerateConfigReportResponse.decode(new BinaryReader(data)));
  }
}
