...
export function metricDescriptor_MetricDescriptorMetadata_TimeSeriesResourceHierarchyLevelFromJSON(
  object: any,
  ...
  switch (object) {
    ...
    case "TIME_SERIES_RESOURCE_HIERARCHY_LEVEL_UNSPECIFIED":
      return MetricDescriptor_MetricDescriptorMetadata_TimeSeriesResourceHierarchyLevel
...
export function metricDescriptor_MetricDescriptorMetadata_TimeSeriesResourceHierarchyLevelToJSON(
  object: MetricDescriptor_MetricDescriptorMetadata_TimeSeriesResourceHierarchyLevel,
): string {
  switch (object) {
    case MetricDescriptor_MetricDescriptorMetadata_TimeSeriesResourceHierarchyLevel
      .TIME_SERIES_RESOURCE_HIERARCHY_LEVEL_UNSPECIFIED:
...
export const MetricDescriptor: MessageFns<MetricDescriptor> = {
  ...
  fromJSON(object: any): MetricDescriptor {
    return {
      ...
      metricKind: isSet(object.metricKind)
        ...
        : isSet(object.metric_kind)
        ? metricDescriptor_MetricKindFromJSON(object.metric_kind)
        : 0,
      valueType: isSet(object.valueType)
        ? metricDescriptor_ValueTypeFromJSON(object.valueType)
        : isSet(object.value_type)
        ? metricDescriptor_ValueTypeFromJSON(object.value_type)
        : 0,
      ...
      monitoredResourceTypes: globalThis.Array.isArray(object?.monitoredResourceTypes)
        ...
        : globalThis.Array.isArray(object?.monitored_resource_types)
        ? object.monitored_resource_types.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<MetricDescriptor>, I>>(base?: I): MetricDescriptor {
    return MetricDescriptor.fromPartial(base ?? ({} as any));
  },
...
function createBaseMetricDescriptor_MetricDescriptorMetadata(): MetricDescriptor_MetricDescriptorMetadata {
  return { launchStage: 0, samplePeriod: undefined, ingestDelay: undefined, timeSeriesResourceHierarchyLevel: [] };
}
...
export const MetricDescriptor_MetricDescriptorMetadata: MessageFns<MetricDescriptor_MetricDescriptorMetadata> = {
  ...
  fromJSON(object: any): MetricDescriptor_MetricDescriptorMetadata {
    return {
      ...
      samplePeriod: isSet(object.samplePeriod)
        ...
        : isSet(object.sample_period)
        ? Duration.fromJSON(object.sample_period)
        : undefined,
      ingestDelay: isSet(object.ingestDelay)
        ? Duration.fromJSON(object.ingestDelay)
        : isSet(object.ingest_delay)
        ? Duration.fromJSON(object.ingest_delay)
        : undefined,
      timeSeriesResourceHierarchyLevel: globalThis.Array.isArray(object?.timeSeriesResourceHierarchyLevel)
        ? object.timeSeriesResourceHierarchyLevel.map((e: any) =>
          metricDescriptor_MetricDescriptorMetadata_TimeSeriesResourceHierarchyLevelFromJSON(e)
        )
        : globalThis.Array.isArray(object?.time_series_resource_hierarchy_level)
        ? object.time_series_resource_hierarchy_level.map((e: any) =>
          metricDescriptor_MetricDescriptorMetadata_TimeSeriesResourceHierarchyLevelFromJSON(e)
        )
        : [],
    };
  ...
  toJSON(message: MetricDescriptor_MetricDescriptorMetadata): unknown {
    ...
    if (message.timeSeriesResourceHierarchyLevel?.length) {
      obj.timeSeriesResourceHierarchyLevel = message.timeSeriesResourceHierarchyLevel.map((e) =>
        metricDescriptor_MetricDescriptorMetadata_TimeSeriesResourceHierarchyLevelToJSON(e)
      );
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<MetricDescriptor_MetricDescriptorMetadata>, I>>(
    base?: I,
  ): MetricDescriptor_MetricDescriptorMetadata {
    return MetricDescriptor_MetricDescriptorMetadata.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MetricDescriptor_MetricDescriptorMetadata>, I>>(
    object: I,
  ): MetricDescriptor_MetricDescriptorMetadata {
    const message = createBaseMetricDescriptor_MetricDescriptorMetadata();
    message.launchStage = object.launchStage ?? 0;
...
export const Metric_LabelsEntry: MessageFns<Metric_LabelsEntry> = {
  ...
  create<I extends Exact<DeepPartial<Metric_LabelsEntry>, I>>(base?: I): Metric_LabelsEntry {
    return Metric_LabelsEntry.fromPartial(base ?? ({} as any));
  },
