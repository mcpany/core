...
export const DeclType: MessageFns<DeclType> = {
  ...
  fromJSON(object: any): DeclType {
    return {
      ...
      typeParams: globalThis.Array.isArray(object?.typeParams)
        ...
        ? object.type_params.map((e: any) => DeclType.fromJSON(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<DeclType>, I>>(base?: I): DeclType {
    return DeclType.fromPartial(base ?? ({} as any));
  },
...
export const IdentDecl: MessageFns<IdentDecl> = {
  ...
  create<I extends Exact<DeepPartial<IdentDecl>, I>>(base?: I): IdentDecl {
    return IdentDecl.fromPartial(base ?? ({} as any));
  },
...
export const FunctionDecl: MessageFns<FunctionDecl> = {
  ...
  fromJSON(object: any): FunctionDecl {
    return {
      ...
      returnType: isSet(object.returnType)
        ...
        ? DeclType.fromJSON(object.return_type)
        : undefined,
      receiverFunction: isSet(object.receiverFunction)
        ? globalThis.Boolean(object.receiverFunction)
        : isSet(object.receiver_function)
        ? globalThis.Boolean(object.receiver_function)
        : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<FunctionDecl>, I>>(base?: I): FunctionDecl {
    return FunctionDecl.fromPartial(base ?? ({} as any));
  },
