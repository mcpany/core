  ...
  fromJSON(object: any): ServiceConfig {
    return {
      ...
      monitoredResources: globalThis.Array.isArray(object?.monitoredResources)
        ...
        : globalThis.Array.isArray(object?.monitored_resources)
...
export const ConsumerQuotaMetric: MessageFns<ConsumerQuotaMetric> = {
  ...
  fromJSON(object: any): ConsumerQuotaMetric {
    return {
      ...
      consumerQuotaLimits: globalThis.Array.isArray(object?.consumerQuotaLimits)
        ...
        : globalThis.Array.isArray(object?.consumer_quota_limits)
        ? object.consumer_quota_limits.map((e: any) => ConsumerQuotaLimit.fromJSON(e))
        : [],
      descendantConsumerQuotaLimits: globalThis.Array.isArray(object?.descendantConsumerQuotaLimits)
        ...
        : globalThis.Array.isArray(object?.descendant_consumer_quota_limits)
        ? object.descendant_consumer_quota_limits.map((e: any) => ConsumerQuotaLimit.fromJSON(e))
        : [],
  ...
  create<I extends Exact<DeepPartial<ConsumerQuotaMetric>, I>>(base?: I): ConsumerQuotaMetric {
    return ConsumerQuotaMetric.fromPartial(base ?? ({} as any));
  },
...
export const ConsumerQuotaLimit: MessageFns<ConsumerQuotaLimit> = {
  ...
  fromJSON(object: any): ConsumerQuotaLimit {
    return {
      ...
      allowsAdminOverrides: isSet(object.allowsAdminOverrides)
        ...
        : isSet(object.allows_admin_overrides)
        ? globalThis.Boolean(object.allows_admin_overrides)
        : false,
      quotaBuckets: globalThis.Array.isArray(object?.quotaBuckets)
        ? object.quotaBuckets.map((e: any) => QuotaBucket.fromJSON(e))
        : globalThis.Array.isArray(object?.quota_buckets)
        ? object.quota_buckets.map((e: any) => QuotaBucket.fromJSON(e))
        : [],
      supportedLocations: globalThis.Array.isArray(object?.supportedLocations)
        ...
        : globalThis.Array.isArray(object?.supported_locations)
        ? object.supported_locations.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<ConsumerQuotaLimit>, I>>(base?: I): ConsumerQuotaLimit {
    return ConsumerQuotaLimit.fromPartial(base ?? ({} as any));
  },
...
export const QuotaBucket: MessageFns<QuotaBucket> = {
  ...
  fromJSON(object: any): QuotaBucket {
    return {
      effectiveLimit: isSet(object.effectiveLimit)
        ...
        : isSet(object.effective_limit)
        ? Long.fromValue(object.effective_limit)
        : Long.ZERO,
      defaultLimit: isSet(object.defaultLimit)
        ? Long.fromValue(object.defaultLimit)
        : isSet(object.default_limit)
        ? Long.fromValue(object.default_limit)
        : Long.ZERO,
      producerOverride: isSet(object.producerOverride)
        ...
        ? QuotaOverride.fromJSON(object.producer_override)
        : undefined,
      consumerOverride: isSet(object.consumerOverride)
        ? QuotaOverride.fromJSON(object.consumerOverride)
        : isSet(object.consumer_override)
        ? QuotaOverride.fromJSON(object.consumer_override)
        : undefined,
      adminOverride: isSet(object.adminOverride)
        ? QuotaOverride.fromJSON(object.adminOverride)
        : isSet(object.admin_override)
        ? QuotaOverride.fromJSON(object.admin_override)
        : undefined,
      producerQuotaPolicy: isSet(object.producerQuotaPolicy)
        ? ProducerQuotaPolicy.fromJSON(object.producerQuotaPolicy)
        : isSet(object.producer_quota_policy)
        ? ProducerQuotaPolicy.fromJSON(object.producer_quota_policy)
        : undefined,
  ...
  create<I extends Exact<DeepPartial<QuotaBucket>, I>>(base?: I): QuotaBucket {
    return QuotaBucket.fromPartial(base ?? ({} as any));
  },
...
export const QuotaBucket_DimensionsEntry: MessageFns<QuotaBucket_DimensionsEntry> = {
  ...
  create<I extends Exact<DeepPartial<QuotaBucket_DimensionsEntry>, I>>(base?: I): QuotaBucket_DimensionsEntry {
    return QuotaBucket_DimensionsEntry.fromPartial(base ?? ({} as any));
  },
...
export const QuotaOverride: MessageFns<QuotaOverride> = {
  ...
  fromJSON(object: any): QuotaOverride {
    return {
      ...
      overrideValue: isSet(object.overrideValue)
        ...
        : isSet(object.override_value)
        ? Long.fromValue(object.override_value)
        : Long.ZERO,
      dimensions: isObject(object.dimensions)
        ? (globalThis.Object.entries(object.dimensions) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
      ...
      adminOverrideAncestor: isSet(object.adminOverrideAncestor)
        ? globalThis.String(object.adminOverrideAncestor)
        : isSet(object.admin_override_ancestor)
        ? globalThis.String(object.admin_override_ancestor)
        : "",
    };
  },
  ...
  create<I extends Exact<DeepPartial<QuotaOverride>, I>>(base?: I): QuotaOverride {
    return QuotaOverride.fromPartial(base ?? ({} as any));
  },
...
export const QuotaOverride_DimensionsEntry: MessageFns<QuotaOverride_DimensionsEntry> = {
  ...
  create<I extends Exact<DeepPartial<QuotaOverride_DimensionsEntry>, I>>(base?: I): QuotaOverride_DimensionsEntry {
    return QuotaOverride_DimensionsEntry.fromPartial(base ?? ({} as any));
  },
...
export const OverrideInlineSource: MessageFns<OverrideInlineSource> = {
  ...
  create<I extends Exact<DeepPartial<OverrideInlineSource>, I>>(base?: I): OverrideInlineSource {
    return OverrideInlineSource.fromPartial(base ?? ({} as any));
  },
...
export const ProducerQuotaPolicy: MessageFns<ProducerQuotaPolicy> = {
  ...
  fromJSON(object: any): ProducerQuotaPolicy {
    return {
      ...
      policyValue: isSet(object.policyValue)
        ...
        : isSet(object.policy_value)
        ? Long.fromValue(object.policy_value)
        : Long.ZERO,
      dimensions: isObject(object.dimensions)
        ? (globalThis.Object.entries(object.dimensions) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
  ...
  create<I extends Exact<DeepPartial<ProducerQuotaPolicy>, I>>(base?: I): ProducerQuotaPolicy {
    return ProducerQuotaPolicy.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ProducerQuotaPolicy>, I>>(object: I): ProducerQuotaPolicy {
    const message = createBaseProducerQuotaPolicy();
    message.name = object.name ?? "";
...
export const ProducerQuotaPolicy_DimensionsEntry: MessageFns<ProducerQuotaPolicy_DimensionsEntry> = {
  ...
  create<I extends Exact<DeepPartial<ProducerQuotaPolicy_DimensionsEntry>, I>>(
    base?: I,
  ): ProducerQuotaPolicy_DimensionsEntry {
    return ProducerQuotaPolicy_DimensionsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ProducerQuotaPolicy_DimensionsEntry>, I>>(
    object: I,
  ): ProducerQuotaPolicy_DimensionsEntry {
    const message = createBaseProducerQuotaPolicy_DimensionsEntry();
    message.key = object.key ?? "";
...
export const AdminQuotaPolicy: MessageFns<AdminQuotaPolicy> = {
  ...
  create<I extends Exact<DeepPartial<AdminQuotaPolicy>, I>>(base?: I): AdminQuotaPolicy {
    return AdminQuotaPolicy.fromPartial(base ?? ({} as any));
  },
...
export const AdminQuotaPolicy_DimensionsEntry: MessageFns<AdminQuotaPolicy_DimensionsEntry> = {
  ...
  create<I extends Exact<DeepPartial<AdminQuotaPolicy_DimensionsEntry>, I>>(
    base?: I,
  ): AdminQuotaPolicy_DimensionsEntry {
    return AdminQuotaPolicy_DimensionsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AdminQuotaPolicy_DimensionsEntry>, I>>(
    object: I,
  ): AdminQuotaPolicy_DimensionsEntry {
    const message = createBaseAdminQuotaPolicy_DimensionsEntry();
    message.key = object.key ?? "";
...
export const ServiceIdentity: MessageFns<ServiceIdentity> = {
  ...
  create<I extends Exact<DeepPartial<ServiceIdentity>, I>>(base?: I): ServiceIdentity {
    return ServiceIdentity.fromPartial(base ?? ({} as any));
  },
