...
func TestUpstreamService_Airtable(t *testing.T) {
	if os.Getenv("AIRTABLE_API_TOKEN") == "" || os.Getenv("AIRTABLE_BASE_ID") == "" || os.Getenv("AIRTABLE_TABLE_ID") == "" {
		t.Skip("Skipping Airtable test because AIRTABLE_API_TOKEN, AIRTABLE_BASE_ID, or AIRTABLE_TABLE_ID is not set")
	}
	...
	require.Contains(t, airtableResponse, "records", "The response should contain a list of records")
