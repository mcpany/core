...
export const GoFeatures: MessageFns<GoFeatures> = {
  ...
  fromJSON(object: any): GoFeatures {
    return {
      ...
      optimizeMode: isSet(object.optimizeMode)
        ? goFeatures_OptimizeModeFeature_OptimizeModeFromJSON(object.optimizeMode)
        : isSet(object.optimize_mode)
        ? goFeatures_OptimizeModeFeature_OptimizeModeFromJSON(object.optimize_mode)
        : 0,
    };
  },
  ...
  toJSON(message: GoFeatures): unknown {
    ...
    if (message.optimizeMode !== undefined && message.optimizeMode !== 0) {
      obj.optimizeMode = goFeatures_OptimizeModeFeature_OptimizeModeToJSON(message.optimizeMode);
    }
    return obj;
  },
...
export const GoFeatures_OptimizeModeFeature: MessageFns<GoFeatures_OptimizeModeFeature> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GoFeatures_OptimizeModeFeature {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<GoFeatures_OptimizeModeFeature>, I>>(base?: I): GoFeatures_OptimizeModeFeature {
    return GoFeatures_OptimizeModeFeature.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GoFeatures_OptimizeModeFeature>, I>>(_: I): GoFeatures_OptimizeModeFeature {
    const message = createBaseGoFeatures_OptimizeModeFeature();
    return message;
  },
};
