  ...
  fromJSON(object: any): Explain {
    return {
      ...
      exprSteps: globalThis.Array.isArray(object?.exprSteps)
        ...
        : globalThis.Array.isArray(object?.expr_steps)
        ? object.expr_steps.map((e: any) => Explain_ExprStep.fromJSON(e))
        : [],
    };
  },
...
export const Explain_ExprStep: MessageFns<Explain_ExprStep> = {
  ...
  fromJSON(object: any): Explain_ExprStep {
    return {
      ...
      valueIndex: isSet(object.valueIndex)
        ? globalThis.Number(object.valueIndex)
        : isSet(object.value_index)
        ? globalThis.Number(object.value_index)
        : 0,
    };
  },
  ...
  create<I extends Exact<DeepPartial<Explain_ExprStep>, I>>(base?: I): Explain_ExprStep {
    return Explain_ExprStep.fromPartial(base ?? ({} as any));
  },
