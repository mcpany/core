  ...
  fromJSON(object: any): MetricValue {
    return {
      ...
      distributionValue: isSet(object.distributionValue)
        ...
        : isSet(object.distribution_value)
        ? Distribution.fromJSON(object.distribution_value)
        : undefined,
    };
  },
...
export const MetricValue_LabelsEntry: MessageFns<MetricValue_LabelsEntry> = {
  ...
  create<I extends Exact<DeepPartial<MetricValue_LabelsEntry>, I>>(base?: I): MetricValue_LabelsEntry {
    return MetricValue_LabelsEntry.fromPartial(base ?? ({} as any));
  },
...
export const MetricValueSet: MessageFns<MetricValueSet> = {
  ...
  fromJSON(object: any): MetricValueSet {
    return {
      ...
      metricValues: globalThis.Array.isArray(object?.metricValues)
        ...
        : globalThis.Array.isArray(object?.metric_values)
        ? object.metric_values.map((e: any) => MetricValue.fromJSON(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<MetricValueSet>, I>>(base?: I): MetricValueSet {
    return MetricValueSet.fromPartial(base ?? ({} as any));
  },
