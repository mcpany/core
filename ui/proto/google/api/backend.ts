...
export const Backend: MessageFns<Backend> = {
  ...
  create<I extends Exact<DeepPartial<Backend>, I>>(base?: I): Backend {
    return Backend.fromPartial(base ?? ({} as any));
  },
...
export const BackendRule: MessageFns<BackendRule> = {
  encode(message: BackendRule, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.overridesByRequestProtocol).forEach(([key, value]: [string, BackendRule]) => {
  ...
  fromJSON(object: any): BackendRule {
    return {
      ...
      minDeadline: isSet(object.minDeadline)
        ? globalThis.Number(object.minDeadline)
        : isSet(object.min_deadline)
        ? globalThis.Number(object.min_deadline)
        : 0,
      operationDeadline: isSet(object.operationDeadline)
        ? globalThis.Number(object.operationDeadline)
        : isSet(object.operation_deadline)
        ? globalThis.Number(object.operation_deadline)
        : 0,
      ...
      jwtAudience: isSet(object.jwtAudience)
        ? globalThis.String(object.jwtAudience)
        : isSet(object.jwt_audience)
        ? globalThis.String(object.jwt_audience)
        : undefined,
      disableAuth: isSet(object.disableAuth)
        ? globalThis.Boolean(object.disableAuth)
        : isSet(object.disable_auth)
        ? globalThis.Boolean(object.disable_auth)
        : undefined,
      protocol: isSet(object.protocol) ? globalThis.String(object.protocol) : "",
      overridesByRequestProtocol: isObject(object.overridesByRequestProtocol)
        ? (globalThis.Object.entries(object.overridesByRequestProtocol) as [string, any][]).reduce(
          (acc: { [key: string]: BackendRule }, [key, value]: [string, any]) => {
            acc[key] = BackendRule.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.overrides_by_request_protocol)
        ? (globalThis.Object.entries(object.overrides_by_request_protocol) as [string, any][]).reduce(
          (acc: { [key: string]: BackendRule }, [key, value]: [string, any]) => {
            acc[key] = BackendRule.fromJSON(value);
            return acc;
          },
  ...
  toJSON(message: BackendRule): unknown {
    ...
    if (message.overridesByRequestProtocol) {
      const entries = globalThis.Object.entries(message.overridesByRequestProtocol) as [string, BackendRule][];
      if (entries.length > 0) {
  ...
  create<I extends Exact<DeepPartial<BackendRule>, I>>(base?: I): BackendRule {
    return BackendRule.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BackendRule>, I>>(object: I): BackendRule {
    ...
    message.overridesByRequestProtocol =
      (globalThis.Object.entries(object.overridesByRequestProtocol ?? {}) as [string, BackendRule][]).reduce(
        (acc: { [key: string]: BackendRule }, [key, value]: [string, BackendRule]) => {
          if (value !== undefined) {
...
export const BackendRule_OverridesByRequestProtocolEntry: MessageFns<BackendRule_OverridesByRequestProtocolEntry> = {
  ...
  create<I extends Exact<DeepPartial<BackendRule_OverridesByRequestProtocolEntry>, I>>(
    base?: I,
  ): BackendRule_OverridesByRequestProtocolEntry {
    return BackendRule_OverridesByRequestProtocolEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BackendRule_OverridesByRequestProtocolEntry>, I>>(
    object: I,
  ): BackendRule_OverridesByRequestProtocolEntry {
    const message = createBaseBackendRule_OverridesByRequestProtocolEntry();
