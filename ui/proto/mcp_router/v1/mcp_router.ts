...
//   protoc               v5.29.3
// source: mcp_router/v1/mcp_router.proto
...
export type McpRouterDefinition = typeof McpRouterDefinition;
export const McpRouterDefinition = {
  name: "McpRouter",
  fullName: "mcpany.mcp_router.v1.McpRouter",
  methods: {
    listTools: {
      name: "ListTools",
