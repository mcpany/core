...
- [ ] **[P0] Cognitive Debt Ledger**: (2026-07-25) Real-time visualization of reasoning borrowing, interest accrual, and debt ceilings per mission branch.
- [ ] **[P0] RSI Shard Inspector**: (2026-07-25) Visual debugger for monitoring isolated teammate scratchpads and commit-to-shared status.
- [ ] **[P0] Trust Inheritance Map**: (2026-07-25) Visualization of trust propagation and inheritance lineages within elastic meshes.
