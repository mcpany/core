...
- [ ] **[P0] Tunnel Security Monitor**: (2026-07-25) Visualization of monitored SNT tunnels with real-time alerts for "Splitting" attempts.
- [ ] **[P0] Shard Contentiousness Heatmap**: (2026-07-25) Dashboard for visualizing lock contention and race conditions in shared memory shards.
