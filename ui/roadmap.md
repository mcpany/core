...
- [ ] **[P0] Agent Identity Dashboard**: UI for managing and monitoring the "Active Agent Fleet," showing UIDs, capability tokens, and revocation status. (Added: 2026-03-06)
- [ ] **[P0] Runtime Tool Inspection Logs**: Real-time visualization of DPI violations, showing blocked/redacted tool calls and their associated agent identities. (Added: 2026-03-06)
