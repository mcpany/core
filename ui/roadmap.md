...
- [ ] **[P0] Hierarchical Budget Visualizer**: (2026-07-25) Real-time tracking of fractional token delegation and sub-mission consumption.
- [ ] **[P0] Shard Sealing Status Indicator**: (2026-07-25) Visual indicator for cryptographically sealed context fragments.
- [ ] **[P0] ESH Migration Monitor**: (2026-07-25) Real-time tracker for agent state handovers between multi-device nodes.
