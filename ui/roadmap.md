...
- [ ] **[P0] Immune-System Monitor**: Dashboard for visualizing Semantic Sanitizer hits and contagion blocks. (Added: 2026-03-06)
- [ ] **[P1] Agent Hook Manager**: UI for configuring and monitoring third-party security hooks. (Added: 2026-03-06)
