...
- [ ] **[P0] Temporal Resumption Dashboard**: (2026-07-25) Real-time visualization of MRT-compliant mission resumption latency and node migration.
- [ ] **[P0] ZK-Lease Auditor**: (2026-07-25) Visual workspace for verifying zero-knowledge capability proofs and hardware-attestation status.
- [ ] **[P0] Monotonic Sequence Inspector**: (2026-07-25) Forensic UI for visualizing hardware-bound monotonic counters in the reasoning path.
