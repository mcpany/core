...
- [ ] **[P0] Multi-Hop Lineage Tracer**: (2026-07-25) Visual debugger for hardware-attested RMA tunnels and intermediate relay provenance.
- [ ] **[P0] Lease-Bound State Inspector**: (2026-07-25) Forensic UI for visualizing SSL-isolated memory shards and automated cleanup events.
- [ ] **[P0] FRV Consensus Dashboard**: (2026-07-25) Real-time monitor for multi-agent reasoning verification quorums and mission alignment scores.
- [ ] **[P1] Lease Resumption Status Widget**: (2026-07-25) Visual indicator for optimistic lease preparation and hardware-bound renewal progress.
