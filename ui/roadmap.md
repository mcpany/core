...
- [x] **Browser-Side HTTP Connectivity Check**: Add a diagnostic step to
  ...
  to help distinguish between server-side and client-side network issues
  (subject to CORS).
...
- [ ] **[P0] Mission Anchor Visualization**: Real-time display of pinned context
  fragments and their cryptographic integrity status. (Added: 2026-05-30)

- [ ] **[P0] IEC/KNS Health Dashboard**: Visualization of micro-VM resource
  usage and isolation boundary integrity for tool execution. (Added: 2026-05-30)

- [ ] **[P1] ZK-Discovery Interface**: UI for configuring metadata-masking
  policies for public capability beacons. (Added: 2026-05-30)
