...
- [ ] **[P0] Threat Intel & Supply Chain Dashboard**: Visualize blocked malicious skills and attestation status. (Added: 2026-03-05)
- [ ] **[P1] Sandbox Management UI**: Configure and monitor isolated tool execution environments. (Added: 2026-03-05)
