...
- [ ] **[P0] Atomic Rotation Monitor**: (2026-07-25) Visual indicator for identity rotation events and authority handoff integrity.
- [ ] **[P0] Attention-Locking Heatmap**: (2026-07-25) Real-time visualization of GC-Immune reasoning anchors and ALCW-protected attention tiers.
- [ ] **[P0] Predictive Scoping Debugger**: (2026-07-25) Workspace for reviewing speculatively declared intent sequences and masked capability claims.
