...
- [ ] **[P0] Speculative State Inspector**: (2026-07-25) UI for visualizing speculative tool results, probabilistic buffers, and commit/rollback status.
- [ ] **[P0] Universal Provenance Dashboard**: (2026-07-25) Security workspace for reviewing translated reasoning watermarks across multi-model swarms.
- [ ] **[P0] Anchor Health Scoreboard**: (2026-07-25) Real-time monitor for attention-window anchor status and AAP re-injection events.
