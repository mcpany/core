...
- [ ] **[P0] Swarm Accountability Dashboard**: Visual tracer for hierarchical agent delegations and cryptographically signed actions. (Added: 2026-03-08)
- [ ] **[P1] Hardened Transport Monitor**: Real-time status of Named-Pipe/Unix Socket connections between agents. (Added: 2026-03-08)
