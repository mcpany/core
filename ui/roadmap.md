...
- [ ] **[P0] Cognitive Firewall Dashboard**: (2026-07-25) Real-time visualization of SIE-interdicted reasoning paths and invariant violation heatmaps.
- [ ] **[P0] Ephemeral Skill Forge Monitor**: (2026-07-25) Visual indicator for JIT-compiled tool attestation status and ESF-profiling results.
- [ ] **[P1] Semantic Sovereignty Inspector**: (2026-07-25) Forensic UI for reviewing hardware-attested truth-claims (SSH) embedded in agent token streams.
