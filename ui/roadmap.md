...
- [ ] **[P0] Swarm Pulse Dashboard**: Visual monitoring of swarm health, intent-drift, and active kill-switches. (Added: 2026-03-09)
- [ ] **[P1] Background Task Manager**: UI for scheduling and monitoring recurring tool calls (Cron-MCP). (Added: 2026-03-09)
