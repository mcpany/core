...
- [ ] **[P0] AID Identity Manager**: UI for viewing and managing verified agent DIDs and their associated permissions. (Added: 2026-03-09)
- [ ] **[P0] Discovery Attestation Viewer**: Security component to visualize the cryptographic validity of connected MCP servers' discovery payloads. (Added: 2026-03-09)
- [ ] **[P1] Ephemeral Tool Explorer**: Dynamic UI for exploring temporary tools discovered during a session. (Added: 2026-03-09)
