...
- [ ] **[P0] Autonomous Delegation View**: Visualize "Generalist Agent" routing and specialist agent handoffs. (Added: 2026-03-06)
- [ ] **[P1] Plugin Security Manager**: Dashboard for managing authenticated plugin routes and route shadowing alerts. (Added: 2026-03-06)
