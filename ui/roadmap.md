...
- [ ] **[P0] Swarm-to-Swarm (S2S) Handoff Monitor**: Visualization of cross-network swarm task handoffs and state sync. (Added: 2026-03-03)
- [ ] **[P0] Metadata Sanitization Dashboard**: Configuration for prompt injection filtering and visualization of "Sanitization Events." (Added: 2026-03-03)
- [ ] **[P1] Intent Router Explorer**: UI for visualizing and testing intent-to-tool semantic routing rules. (Added: 2026-03-03)
