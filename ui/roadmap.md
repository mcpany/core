...
- [ ] **[P0] NHI Identity Manager**: UI for viewing and managing issued Agent Identity (NHI) tokens and active task scopes. (Added: 2026-03-05)
- [ ] **[P0] Swarm Activity Map**: Real-time visualization of agent swarm patterns and collective tool usage across sessions. (Added: 2026-03-05)
