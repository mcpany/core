...
- [ ] **[P0] Origin-Aware Security Center**: Security dashboard for configuring Host Header allowlists and Origin validation policies. (Added: 2026-03-07)
- [ ] **[P0] ACP Swarm visualizer**: Real-time visualization of ACP context handoffs and subagent delegation. (Added: 2026-03-07)
