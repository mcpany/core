...
- [ ] **[P0] Metadata Sanitization Monitor**: UI for inspecting sanitized tool descriptions and audit logs. (Added: 2026-02-27)
- [ ] **[P1] Async Task Tracker**: Dashboard for monitoring long-running asynchronous A2A tasks. (Added: 2026-02-27)
- [ ] **[P1] OpenClaw Governance View**: Specialized monitoring dashboard for autonomous local agents. (Added: 2026-02-27)
