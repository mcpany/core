...
- [ ] **[P0] SSH Sandbox Status Hub**: (2026-04-05) Real-time monitor for OpenShell sandboxed execution and resource isolation logs.
- [ ] **[P1] Lifecycle Hook Visualizer**: (2026-04-05) Interactive debugger for Gemini-compliant hooks and Folder Trust states.
