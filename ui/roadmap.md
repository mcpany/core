...
- [ ] **[P0] Tunnel Packet Inspector**: Real-time visualization of P2P handshake semantics and FTS integrity status. (Added: 2026-07-25)
- [ ] **[P0] GC-Immune Fragment Monitor**: Visual indicator for ACP-immune context fragments and protection status. (Added: 2026-07-25)
- [ ] **[P0] Scratchpad Purge Console**: UI for monitoring ALBP-triggered workspace wipes and mission-residue audits. (Added: 2026-07-25)
- [ ] **[P0] Quorum Damping Visualizer**: Real-time dashboard showing DQD-adjusted weighting and swarm stability scores. (Added: 2026-07-25)
