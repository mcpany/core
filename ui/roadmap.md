...
- [ ] **[P0] Shard Mobility Dashboard**: (2026-07-25) Real-time visualization of hardware-attested shard migration across the SNT mesh.
- [ ] **[P0] Recipient-Locked Fragment Viewer**: (2026-07-25) Security UI for verifying recipient-specific binding of inter-teammate coordination fragments.
- [ ] **[P0] Mission Lease Reaper Log**: (2026-07-25) Real-time tracker for hardware-locked reclamation of orphaned MBHLs and blocked lease-squatting attempts.
- [ ] **[P1] Intent-Aware Jitter Config**: (2026-07-25) Interactive workspace for managing PPRP timing variations based on mission sensitivity scores.
