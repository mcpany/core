...
- [ ] **[P0] Namespace Sovereignty Dashboard**: (2026-04-06) Visual debugger for multi-registry namespace priorities and shadowing alerts.
- [ ] **[P0] HAIL Lineage Tree**: (2026-04-06) Interactive visualization of hardware-attested subagent parentage and mission-root links.
- [ ] **[P1] State Sync Normalization Monitor**: (2026-04-06) Real-time tracker for monotonic timer normalization and echo-leak alerts.
- [ ] **[P1] JIT Discovery Console**: (2026-04-06) Authorization workspace for reviewing and unmasking schemas after HAIL verification.
