...
- [ ] **[P0] Glic-Jack Security Alerts**: (2026-07-25) Real-time visualization of blocked browser-initiated high-privilege calls and GJD attestation status.
- [ ] **[P1] Corporate Bylaw Visualizer**: (2026-07-25) Dashboard for reviewing and managing ACG-compliant corporate policy sets for autonomous swarms.
