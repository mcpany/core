...
- [ ] **[P0] OMPG Violation Dashboard**: Real-time visualization of blocked tool calls and denied patterns across the swarm. (Added: 2026-04-11)
- [ ] **[P1] ClawHub Provenance Viewer**: UI for verifying hardware-attested provenance of marketplace-sourced tools. (Added: 2026-04-11)
