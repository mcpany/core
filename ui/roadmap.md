...
- [ ] **[P0] Project Config Security Center**: UI for reviewing, sandboxing, and approving project-level tool configurations. (Added: 2026-03-03)
- [ ] **[P1] Remote Planner Attestation View**: Dashboard to monitor and verify the identity of remote agents connecting to local tools. (Added: 2026-03-03)
