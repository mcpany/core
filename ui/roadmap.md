...
- [ ] **[P0] Federated Discovery Monitor**: (2026-07-25) Visual tracker for decentralized DHT discovery consensus and tool safety quorums.
- [ ] **[P0] Adaptive Attestation Dashboard**: (2026-07-25) Real-time visualization of tool risk scores and adaptive attestation strength transitions.
- [ ] **[P0] MMRP Evidence Viewer**: (2026-07-25) UI for reviewing Zero-Knowledge proofs for SVG and Audio reasoning traces.
- [ ] **[P0] MBIP Sovereignty Widget**: (2026-07-25) Kernel-level status monitor for hardware-bound workspace file descriptors.
