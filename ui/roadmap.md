...
- [ ] **[P0] Adaptive Lease Dashboard**: Visual tracker for real-time lease extensions and ALO-driven capability heartbeats. (Added: 2026-07-25)
- [ ] **[P0] Speculative Reason Proof Monitor**: Real-time visualization of SRP verification status and speculative intent confidence. (Added: 2026-07-25)
- [ ] **[P0] Handoff Sequence Inspector**: Forensic UI for visualizing AHM monotonic tokens and identifying tunnel-racing alerts. (Added: 2026-07-25)
