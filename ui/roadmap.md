...
- [ ] **[P0] Worktree Lifecycle Manager**: UI for viewing and merging changes from isolated agent worktrees. (Added: 2026-02-27)
- [ ] **[P0] Gateway Security Center**: Dashboard for managing CORS/CSRF settings and Configuration Attestations. (Added: 2026-02-27)
- [ ] **[P1] State Scavenger Dashboard**: Visualization of ephemeral session data and GC status. (Added: 2026-02-27)
