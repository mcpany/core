...
- [ ] **[P0] Shared Attention Heatmap**: Visualize teammate deduplication efficiency and logic reuse across the swarm. (Added: 2026-07-25)
- [ ] **[P0] Shard Migration Dashboard**: Real-time visualization of DSRB events and inter-node shard balancing. (Added: 2026-07-25)
- [ ] **[P0] Phantom Intent Alert Center**: UI for inspecting and approving summaries flagged by the PIG middleware. (Added: 2026-07-25)
