...
- [ ] **[P0] Origin Protection Dashboard**: Monitor and manage allowed origins, with real-time alerts for blocked cross-origin attempts. (Added: 2026-03-07)
- [ ] **[P1] A2A Routing Visualizer**: Live map of how tasks are routed between specialized agents via the gateway. (Added: 2026-03-07)
