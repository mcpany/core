...
- [ ] **[P0] PIF Intent Inspector**: UI for reviewing Prompt-Injection Firewall decisions and reasoning. (Added: 2026-03-02)
- [ ] **[P0] Origin Authorization Manager**: UI for managing and verifying trusted local origins for CORV. (Added: 2026-03-02)
