...
- [ ] **[P0] Zero-Latency Resumption Monitor**: Visual tracker for inter-node migration and session ticket health. (Added: 2026-07-25)
- [ ] **[P0] Context Re-composition Debugger**: Real-time visualization of SCR re-assembly and fragment-to-block mapping. (Added: 2026-07-25)
- [ ] **[P0] Attention-Weight Heatmap**: High-fidelity visualization of AWA-attested cognitive drivers per tool call. (Added: 2026-07-25)
- [ ] **[P1] Attestation Lease Widget**: Status monitor for LAS-leased attestation slots and batch renewal events. (Added: 2026-07-25)
