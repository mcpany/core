...
- [ ] **[P0] Zero-Copy Tunnel Monitor**: (2026-07-25) Visual indicator for kernel-mediated mesh state handoffs and `io_uring` throughput.
- [ ] **[P0] Speculative Handoff Dashboard**: (2026-07-25) Real-time visualizer for probationary task claims and speculative reasoning status.
- [ ] **[P0] Lease Phase Auditor**: (2026-07-25) Forensic UI for visualizing mission-phase anchored leases and detecting splicing attempts.
- [ ] **[P1] Multi-Modal Proof Inspector**: (2026-07-25) UI for reviewing MM-RPP attestation results for visual and audio reasoning fragments.
