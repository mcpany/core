...
- [ ] **[P0] Origin Trust Manager**: UI for managing local session tokens and viewing trusted/blocked origins. (Added: 2026-03-06)
- [ ] **[P0] Intent Verification Dashboard**: Interface for users to review and approve high-level "Intents" before agents can execute corresponding tool chains. (Added: 2026-03-06)
