...
- [ ] **[P0] Swarm Quarantine Dashboard**: (2026-07-25) Real-time visualization of HQE anomaly scores, isolated agent branches, and hardware-attested attack signatures.
- [ ] **[P0] A2A Auth Status Hub**: (2026-07-25) Security dashboard for monitoring hardware-attested inter-agent handshakes and blocked discovery probes.
- [ ] **[P0] Context Isolation Matrix**: (2026-07-25) Visualizer for role-bound context window boundaries and lateral infection alerts.
