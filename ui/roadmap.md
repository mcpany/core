...
- [ ] **[P0] Universal Skill Manager**: UI for viewing, validating, and managing `SKILL.md` files across projects. (Added: 2026-03-11)
- [ ] **[P0] Autonomous Action Quarantine**: Dashboard for reviewing and approving quarantined agent self-installation requests. (Added: 2026-03-11)
- [ ] **[P1] Reasoning Efficiency Monitor**: Visualize tool output condensation and token savings for large context windows. (Added: 2026-03-11)
