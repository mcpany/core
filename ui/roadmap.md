...
- [ ] **[P0] Lease Arbitration Dashboard**: (2026-07-25) Real-time visualization of agent progress vs. lease-squatting alerts.
- [ ] **[P0] Predictive Tunneling Monitor**: (2026-07-25) Visual tracker for speculatively established P2P tunnels and latency savings.
- [ ] **[P1] Epistemic Confidence Heatmap**: (2026-07-25) Visualization of reasoning confidence scores and their impact on ERL quotas.
- [ ] **[P0] Mission Pivot Console**: (2026-07-25) UI for manual mission-root interrupts and reviewing IACR-mediated conflict resolutions.
