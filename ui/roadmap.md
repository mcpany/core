...
- [ ] **[P0] Semantic Intent Monitoring**: Dashboard for visualizing intent classification and policy enforcement actions. (Added: 2026-03-03)
- [ ] **[P0] Localhost Security Status**: Indicators for LMA status and Origin/Host verification status. (Added: 2026-03-03)
- [ ] **[P1] Agent Card Explorer**: UI for inspecting and validating peer Agent Cards in the A2A mesh. (Added: 2026-03-03)
