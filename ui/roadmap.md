...
- [ ] **[P0] Tool Taint Flow Visualizer**: Visualize the propagation of tainted data through the agent's tool-call chain. (Added: 2026-03-07)
- [ ] **[P1] Config Sandbox Monitor**: Dashboard for auditing the sanitization and isolation status of repository-level settings. (Added: 2026-03-07)
