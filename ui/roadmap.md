...
- [ ] **[P0] RAQ Budget Visualizer**: Real-time tracker for reflection-aware token quotas and cognitive stall alerts. (Added: 2026-07-25)
- [ ] **[P0] SAP Anchor Monitor**: Visual status widget for hardware-pinned "GC-Immune" reasoning anchors. (Added: 2026-07-25)
- [ ] **[P0] MRT Termination Workspace**: Multi-signature approval interface for hardware-attested session decommissioning. (Added: 2026-07-25)
- [ ] **[P1] Ultrasonic Audio Auditor**: Forensic UI for reviewing MMS-sanitized audio fragments and smuggling alerts. (Added: 2026-07-25)
