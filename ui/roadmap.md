...
- [ ] **[P0] Intent-Lock Authorization Dashboard**: Visualize the link between user prompts and tool calls; manage "Blocked Hijack" attempts. (Added: 2026-03-01)
- [ ] **[P0] Semantic Search & Discovery Console**: Enhanced interface for searching tools and managing the semantic discovery index. (Added: 2026-03-01)
- [ ] **[P1] Biometric/Hardware MFA Prompt**: Dedicated UI component for localized MFA challenges during sensitive tool execution. (Added: 2026-03-01)
