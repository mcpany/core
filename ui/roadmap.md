...
- [ ] **[P0] Local Config Trust Manager**: UI for reviewing, auditing, and approving repository-level configuration files. (Added: 2026-03-01)
- [ ] **[P0] Grep-Discovery Workbench**: Interactive UI to test regex-based tool discovery and visualize token savings. (Added: 2026-03-01)
