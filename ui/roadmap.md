...
- [ ] **[P0] Origin Whitelist Manager**: UI for managing authorized domains and handshake tokens for local adapter access. (Added: 2026-03-05)
- [ ] **[P1] Agentic Persona Audit Log**: Detailed view of which subagent identity performed specific tool actions. (Added: 2026-03-05)
