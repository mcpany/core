...
- [ ] **[P0] Attention Guardrail Probe Monitor**: (2026-07-25) Real-time visualization of AAH heartbeat probes and guardrail attention scores.
- [ ] **[P0] Hidden-Channel Anomaly Dashboard**: (2026-07-25) Forensic UI for monitoring OS-level side-channels and AIC-triggered rollback events.
- [ ] **[P0] Immutable Snapshot Manager**: (2026-07-25) High-speed interface for reviewing and manually triggering IWS-level environment rollbacks.
