...
- [ ] **[P0] Convention Pattern Visualizer**: UI for inspecting and scoring codebase patterns detected by the routing middleware. (Added: 2026-02-27)
- [ ] **[P0] Interactive Challenge Dialog**: Real-time modal for subagent `askQuestions` prompts and high-stakes approvals. (Added: 2026-02-27)
- [ ] **[P1] Policy Hardening Advisor**: Dashboard for reviewing and applying autonomous security policy suggestions. (Added: 2026-02-27)
