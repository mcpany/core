...
- [ ] **[P0] Autonomous Loop Governance Monitor**: Real-time "Fuel Gauge" for loop budgets (tokens, calls, time) and heartbeat attestation prompts. (Added: 2026-03-10)
- [ ] **[P1] MCP Identity Bridge Manager**: UI for mapping cloud agent identities to local "Shadow Users" and managing session-bound capabilities. (Added: 2026-03-10)
