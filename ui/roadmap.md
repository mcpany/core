...
- [ ] **[P0] WASM-BSH State Sanitizer Dashboard**: (2026-03-25) UI for managing WASM sanitization rules and viewing rejected binary context fragments.
...
- [ ] **[P1] DCA Auction Broker**: (2026-04-03) Visual tracker for agent capability bidding and allocation latency.
...
- [ ] **[P0] A2A Safety Proof Inspector**: UI for reviewing "Safety Proof" and reputation-based reasoning generated by the Delegation Attestation Layer. (Added: 2026-04-14)
