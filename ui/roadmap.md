...
- [ ] **[P0] Cognitive Anchor Persistence Monitor**: Visual indicator for NECS-pinned fragments and protection status against GC algorithms. (Added: 2026-07-25)
- [ ] **[P1] Mesh Lease Dependency Graph**: Interactive visualization of MBHL wait-graphs and automated conflict resolution events. (Added: 2026-07-25)
