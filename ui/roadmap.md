...
- [ ] **[P0] Service Mesh Topology Monitor**: (2026-07-25) Real-time visualization of hardware-attested P2P tunnels and distributed node health.
- [ ] **[P0] Mission Lease Lifecycle Manager**: (2026-07-25) Visual tracker for active HLML-bound capability leases and their automated revocation status.
- [ ] **[P1] Zero-Knowledge Audit Workspace**: (2026-07-25) Security dashboard for reviewing privacy-preserving reasoning proofs and audit trails.
- [ ] **[P0] CFIA v2 Attestation Widget**: (2026-07-25) Authorization UI for human-in-the-loop signing of project-local context files.
