...
- [ ] **[P0] AgentMoat (Runtime Security) Dashboard**: Monitor and alert on host-level behavioral anomalies. (Added: 2026-03-01)
- [ ] **[P1] Efficiency Discovery Metrics Overlay**: Display token footprint and execution cost in tool search results. (Added: 2026-03-01)
