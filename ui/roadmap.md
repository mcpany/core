...
- [ ] **[P0] Instruction Provenance Visualizer**: Audit UI showing the origin chain for every tool call and instruction. (Added: 2026-03-09)
- [ ] **[P1] Swarm Intent Dashboard**: High-level visualization of multi-agent tool sequences and detected behavioral anomalies. (Added: 2026-03-09)
- [ ] **[P1] Global Kill-Switch Command Center**: Interface for managing federated governance tokens and emergency swarm pausing. (Added: 2026-03-09)
