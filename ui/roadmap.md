...
- [ ] **[P0] A2A Task Monitor**: Real-time dashboard for tracking task lifecycles, state transitions, and input-required blockers. (Added: 2026-03-05)
- [ ] **[P0] Security Origin Manager**: UI for authorizing and managing trusted origins for the local MCP Any bus. (Added: 2026-03-05)
