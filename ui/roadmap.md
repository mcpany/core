...
- [ ] **[P0] Discovery Sandbox Monitor**: Real-time visualization of sandboxed discovery command execution and safety attestation status. (Added: 2026-04-14)
- [ ] **[P0] Consensus Attestation Workspace**: Workspace for monitoring multi-agent approvals and consensus status for high-risk marketplace skills. (Added: 2026-04-14)
- [ ] **[P0] Teammate Task List Viewer**: High-speed, CRDT-native visualization of the shared task list for horizontal Agent Teams. (Added: 2026-04-14)
- [ ] **[P0] Deterministic Boot Dashboard**: UI for reviewing and signing Full-State Manifests before agent execution. (Added: 2026-04-14)
