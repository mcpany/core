...
- [ ] **[P0] Semantic State Pruning Visualizer**: Visualize how conversation history is filtered during agent handoffs. (Added: 2026-03-03)
- [ ] **[P0] Metadata Security Report**: Dashboard for viewing prompt injection scan results on tool metadata. (Added: 2026-03-03)
- [ ] **[P1] Session Entitlement Manager**: UI for tracking ephemeral tool tokens and their expiration status. (Added: 2026-03-03)
