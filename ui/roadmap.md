...
- [ ] **[P0] Shadow Config Auditor**: UI for reviewing and attesting project-level configuration changes. (Added: 2026-03-02)
- [ ] **[P1] Browser-Use Playground**: Dedicated UI for interacting with and debugging browser-agent tools. (Added: 2026-03-02)
