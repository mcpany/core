...
- [ ] **[P0] Remote Dispatch Console**: (2026-07-25) UI for monitoring and steering headless agents via RDH WebSocket streams.
- [ ] **[P0] Regulatory Compliance Inventory**: (2026-07-25) Visual dashboard for managing hardware-attested plugin and model inventories (EU AI Act).
