...
- [ ] **[P0] Remote Auth Pairing Workspace**: (2026-04-02) UI for pairing external messaging accounts (Telegram/Discord) with local hardware sessions.
- [ ] **[P0] Multi-Channel Intent Monitor**: (2026-04-02) Real-time visualization of remote instructions and their mission-root alignment scores.
- [ ] **[P1] Webhook Security Auditor**: (2026-04-02) Visual tracker for inbound webhook integrity and blocked "Mirroring" attempts.
