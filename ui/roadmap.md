...
- [ ] **[P0] Proactive Injection Alerts**: UI for monitoring and reviewing blocked injection attempts. (Added: 2026-03-05)
- [ ] **[P0] A2A Auth Manager**: UI for configuring OAuth 2.1 / PKCE for A2A agents. (Added: 2026-03-05)
- [ ] **[P1] Intent Policy Editor**: Visual editor for Rego/CEL policies tied to agent intent. (Added: 2026-03-05)
