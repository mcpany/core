...
- [ ] **[P0] Socket Registry & Health Monitor**: UI for managing Isolated Transport (UDS/Named Pipes) connections. (Added: 2026-02-27)
- [ ] **[P0] A2A Traffic Inspector**: Real-time visualization and filtering of A2A delegated tasks and security status. (Added: 2026-02-27)
- [ ] **[P1] Skill Manifest Importer**: One-click import tool for OpenClaw-standard skill manifests. (Added: 2026-02-27)
