...
- [ ] **[P0] Deterministic Replay Player (DARE)**: Visual "Black Box" player to replay agent tool interactions and debug state. (Added: 2026-03-03)
- [ ] **[P0] USH State Inspector**: UI for inspecting standardized "Intent-State" passed between agents via the USH protocol. (Added: 2026-03-03)
- [ ] **[P1] Semantic Search Explorer**: Interactive UI for testing semantic tool discovery and ranking. (Added: 2026-03-03)
