...
- [ ] **[P0] Service Mesh Topology Monitor**: Real-time visualization of hardware-attested P2P tunnels and inter-node coordination health. (Added: 2026-07-25)
- [ ] **[P0] Mission State Migration Visualizer**: Visual tracking of ASM-triggered state transfers and node residency updates. (Added: 2026-07-25)
- [ ] **[P0] Hardware Lease Manager**: Dashboard for monitoring active HLML-bound capability leases and their automated expiration. (Added: 2026-07-25)
- [ ] **[P1] ZKA Audit Viewer**: Security workspace for reviewing privacy-preserving reasoning proofs generated by the ZKA Hub. (Added: 2026-07-25)
