...
- [ ] **[P0] Memory-Poisoning Alert Center**: UI for reviewing semantically blocked writes to the Blackboard and "Belief Drift" alerts. (Added: 2026-07-25)
- [ ] **[P0] Native Sandbox Manager**: Visual interface for managing OS-level sandboxing profiles for process-spawning tools. (Added: 2026-07-25)
- [ ] **[P0] Memory Lineage Inspector**: Forensic UI for visualizing the cryptographically signed origin of Blackboard state fragments. (Added: 2026-07-25)
