...
- [ ] **[P0] RID Pipeline Visualizer**: Interactive graph UI for inspecting and approving deconstructed command pipelines. (Added: 2026-07-25)
- [ ] **[P0] HADA Approval Dialog**: Secure hardware-attestation prompt for discovery-time execution requests. (Added: 2026-07-25)
- [ ] **[P0] Pre-Flight Sandbox Monitor**: Real-time visualization of enclave-hosted discovery logic and resource limits. (Added: 2026-07-25)
