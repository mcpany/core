...
- [ ] **[P0] Chain of Custody (CoC) Visualizer**: Visual representation of agentic lineage and intent chains for every tool call. (Added: 2026-03-01)
- [ ] **[P0] Dynamic Bridge Manager**: Dashboard for monitoring and approving capability "mounts" from sandboxed agents. (Added: 2026-03-01)
- [ ] **[P1] Discovery Guardrail Monitor**: UI to track and debug tool discovery hits/misses and hallucination preventions. (Added: 2026-03-01)
