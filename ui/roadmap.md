...
- [ ] **[P0] Ephemeral Capability Manager**: UI for monitoring and manually revoking short-lived tool tokens. (Added: 2026-03-08)
- [ ] **[P0] Swarm Lock Dashboard**: Visualize active locks and wait-queues for shared agent state. (Added: 2026-03-08)
- [ ] **[P1] Real-time Tool Streamer**: UI component for viewing live, sanitized tool logs with progress indicators. (Added: 2026-03-08)
