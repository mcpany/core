...
- [ ] **[P0] HLCA Configuration Anchor Manager**: UI for reviewing and hardware-signing project-local settings files. (Added: 2026-07-25)
- [ ] **[P0] Behavioral Skill Profiling Dashboard**: Real-time monitor for skill behavior vs. baseline manifests. (Added: 2026-07-25)
- [ ] **[P0] Fast-Path Resumption Widget**: Status indicator for session-bound "Mesh Tickets" and latency reduction metrics. (Added: 2026-07-25)
