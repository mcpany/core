...
- [ ] **[P0] SLM Shard Contention Heatmap**: (2026-07-25) Real-time visualization of speculative lock hit rates and shard contention across the mesh.
- [ ] **[P0] Swarm Entropy Scoreboard**: (2026-07-25) Security dashboard for monitoring real-time "Coherence Scores" and automated interdiction events.
- [ ] **[P0] Monotonic Attention Map**: (2026-07-25) Visual indicator for MAP-pinned behavioral anchors and GC-protection status.
- [ ] **[P0] Mailbox Splicing Alert Hub**: (2026-07-25) Forensic UI for reviewing "Fragment Proof" violations and blocked mailbox injections.
