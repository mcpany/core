...
- [ ] **[P0] GC-Immune Anchor Monitor**: Visual indicator for pinned reasoning anchors and their protection status against context-window garbage collection. (Added: 2026-07-25)
- [ ] **[P1] Optimistic Tunnel Status Hub**: Real-time visualization of speculative tunnel resumption attempts and latency gains in P2P meshes. (Added: 2026-07-25)
