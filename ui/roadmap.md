...
- [ ] **[P0] Federated Node Manager**: UI for peering with remote MCP Any instances and managing shared tool access (Promoted to P0: 2026-02-27). (Added: 2026-02-26)
- [ ] **[P1] Resource Cost/Latency Overlay**: Real-time performance metrics displayed directly on tool cards. (Added: 2026-02-26)
- [ ] **[P0] Intent-Bound Token Monitor**: Security view for tracking and auditing context-bound session tokens. (Added: 2026-02-27)
- [ ] **[P1] JIT-MCP Sandbox Manager**: UI for monitoring and managing ephemeral tool sandboxes. (Added: 2026-02-27)
