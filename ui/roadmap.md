...
- [ ] **[P1] Tool Annotation Visualizer**: display and filter tools based on metadata/annotations. (Added: 2026-03-02)
- [ ] **[P1] Headless Attestation Manager**: interface for generating and managing CI/CD attestation profiles. (Added: 2026-03-02)
