...
- [ ] **[P0] Role-Based Distillation Workspace**: (2026-07-25) UI for defining semantic role profiles and reviewing distilled context manifests.
- [ ] **[P0] Intent-Forking Performance Monitor**: (2026-07-25) Real-time visualization of HAIF "Fork Leases" and attestation latency gains.
- [ ] **[P0] CFRM Replication Visualizer**: (2026-07-25) High-speed monitor for CRDT-based state replication and semantic collision alerts.
- [ ] **[P0] Anti-Eviction Shield Widget**: (2026-07-25) Visual indicator for pinned mission-root anchors and protection status in distilled sessions.
