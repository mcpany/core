...
*   **[P0] Pre-Flight Sandbox Dashboard**: Real-time visualization of sandboxed discovery execution and attestation receipts. (Added: 2026-07-25)
*   **[P0] LFTC Coordination Map**: Visual tracker for CRDT-based task list synchronization and gossip-based intent propagation. (Added: 2026-07-25)
*   **[P0] Attention-Density Heatmap**: Enhanced visual indicator for context-window utilization and noise-injection alerts. (Added: 2026-07-25)
*   **[P1] Fast-Path Trust Status Widget**: Real-time indicator for session-bound trust tickets and attestation-latency gains. (Added: 2026-07-25)
