...
- [ ] **[P0] SKILL.md Bridge Dashboard**: UI for managing and previewing `SKILL.md` library and its translation status. (Added: 2026-03-10)
- [ ] **[P0] Survivability Heartbeat Monitor**: Real-time status board for safety invariant enforcement and session health. (Added: 2026-03-10)
- [ ] **[P1] Skill Attestation Viewer**: UI for reviewing and cryptographically verifying the provenance of third-party agent skills. (Added: 2026-03-10)
