...
- [ ] **[P0] Trusted App Manager**: UI for managing authorized local applications (OpenClaw, Claude Code) and viewing attestation logs. (Added: 2026-03-06)
- [ ] **[P0] Sub-agent Delegation Monitor**: Visual tracker for dynamic tool capability handshakes during A2A flows. (Added: 2026-03-06)
- [ ] **[P1] Lazy-Discovery Heatmap**: Visualization of on-demand tool search hits and metadata loading progress. (Added: 2026-03-06)
