...
- [ ] **[P0] Autonomous Endurance Dashboard**: Real-time visualization of agent session health, duration, and compounding error alerts. (Added: 2026-03-01)
- [ ] **[P1] Thinking Token Inspector**: Visualizer for separate planning/thinking tokens in the tool execution timeline. (Added: 2026-03-01)
- [ ] **[P1] Transactional Attestation Viewer**: Interface for reviewing and approving Agentic Commerce Protocol (ACP) transactions. (Added: 2026-03-01)
