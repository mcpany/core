...
- [ ] **[P0] Origin-Bound Security Manager**: UI for managing trusted origins and Local App Tokens. (Added: 2026-03-05)
- [ ] **[P1] Marketplace Reputation Viewer**: Visual indicators for tool reputation and audit status. (Added: 2026-03-05)
