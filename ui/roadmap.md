...
- [ ] **[P0] Reasoning Integrity Dashboard**: Real-time visualization of shared reasoning consistency and RGD-blocked injections. (Added: 2026-05-30)
- [ ] **[P0] Just-in-Time Context Monitor**: Visual tracker for RBCS shard mounting and intent-binding alignment. (Added: 2026-05-30)
- [ ] **[P1] Monotonic Nonce Auditor**: Security view for tracking MTN-issued nonces and detecting task-redirection probes. (Added: 2026-05-30)
