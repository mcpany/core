...
- [ ] **[P0] Attention-Fairness Dashboard**: (2026-07-25) Real-time visualization of "Attention Quotas" and compute priority across subagents.
- [ ] **[P0] Uncertainty Masking Debugger**: (2026-07-25) Visual tool for inspecting "Cognitive Noise" injection and detecting CME probing attempts.
- [ ] **[P0] Wait-Graph Visualizer**: (2026-07-25) Interactive diagram for identifying and resolving cross-framework filesystem lock deadlocks.
- [ ] **[P0] SBR Fragment Inspector**: (2026-07-25) UI for reviewing session-bound state fragments influencing model reasoning.
- [ ] **[P1] Shard Prefetching Heatmap**: (2026-07-25) Metrics dashboard tracking speculative shard migration success rates and mesh latency.
