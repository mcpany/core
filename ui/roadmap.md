...
- [ ] **[P0] Universal Policy Translation View**: Dashboard for managing master policies and inspecting their translated native counterparts. (Added: 2026-03-03)
- [ ] **[P0] Subagent Delegation Monitor**: Visual lineage of agent-to-subagent delegations and active session scopes. (Added: 2026-03-03)
