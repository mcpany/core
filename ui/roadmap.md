...
- [ ] **[P0] JIT Permission Request Flow**: UI for agents to request permissions and for humans to approve/deny leases. (Added: 2026-02-27)
- [ ] **[P1] Tool Staging Dashboard**: UI for reviewing, testing, and promoting agent-generated tool modifications. (Added: 2026-02-27)
- [ ] **[P1] A2A Version Compatibility Matrix**: Visual guide to agent compatibility across the swarm. (Added: 2026-02-27)
