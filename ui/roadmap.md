...
- [ ] **[P0] OpenClaw Sandbox Monitor**: Real-time dashboard for blocked filesystem/shell attempts and sandbox configuration. (Added: 2026-03-06)
- [ ] **[P0] Verified Marketplace Browser**: Integrated UI for browsing and installing cryptographically signed plugins. (Added: 2026-03-06)
