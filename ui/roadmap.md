...
- [ ] **[P0] Threadbound Isolation Monitor**: Real-time visualization of isolated session threads and their resource boundaries. (Added: 2026-03-09)
- [ ] **[P0] Universal Tool Search Explorer**: Management UI for searching, indexing, and testing deferred tools. (Added: 2026-03-09)
- [ ] **[P1] Agent Identity (ACA) Manager**: UI for issuing and revoking agent certificates and managing trust chains. (Added: 2026-03-09)
