...
- [ ] **[P0] VTD Confidence Scoreboard**: Visual dashboard for monitoring CBE-triggered handoffs and autonomous delegation thresholds. (Added: 2026-04-14)
- [ ] **[P0] Ghost-Handshake Alert Center**: Security UI for visualizing blocked agency-initiation attempts and handshake lineages. (Added: 2026-04-14)
- [ ] **[P1] Intent Continuity Debugger**: Forensic tool for visualizing state recovery across framework-neutral handoffs. (Added: 2026-04-14)
