...
- [ ] **[P0] MBHL Status Widget**: Real-time visual tracker for active vs. expired mission-bound hardware leases. (Added: 2026-07-25)
- [ ] **[P0] Mesh Tunneling Security Map**: Interactive dashboard visualizing hardware-attested tunnels and inter-node handshakes. (Added: 2026-07-25)
- [ ] **[P1] Zero-Knowledge Audit Dashboard**: Security interface for reviewing privacy-preserving reasoning proofs (PPRP). (Added: 2026-07-25)
