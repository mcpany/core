...
- [ ] **[P0] Per-Agent Identity Manager**: (2026-04-14) UI for reviewing hardware-attested, unique subagent identities and tool-call attribution.
- [ ] **[P0] Reasoning Buffer Safety Monitor**: (2026-04-14) Visual tracker for MSRB-protected reasoning regions and blocked control-flow hijacking attempts.
