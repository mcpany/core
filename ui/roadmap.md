...
- [ ] **[P0] SCM Manifest Manager**: UI for viewing and managing trusted cryptographic signatures for tool configurations. (Added: 2026-03-01)
- [ ] **[P0] Intent-Verification Monitor**: Live feed showing tool calls being validated against agent high-level goals. (Added: 2026-03-01)
