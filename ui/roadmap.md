...
- [ ] **[P0] Kernel Violation Stream**: Real-time visualization of KLIE-interdicted syscalls and process-tree binding. (Added: 2026-07-25)
- [ ] **[P0] Cognitive Heatmap Dashboard**: Visual indicator for pinned vs. summarized context fragments and epistemic weight distributions. (Added: 2026-07-25)
- [ ] **[P0] CFRA Reward Monitor**: Real-time tracker for hardware-attested reward tokens crossing framework boundaries. (Added: 2026-07-25)
