...
- [ ] **[P0] Sandbox Security Monitor**: Real-time visualization of blocked SSRF and path traversal attempts by the Hardened Proxy. (Added: 2026-03-01)
- [ ] **[P1] Policy Annotation Editor**: UI for tagging tools with security annotations and managing metadata-driven policies. (Added: 2026-03-01)
- [ ] **[P1] Config Change Impact Reviewer**: A "Diff + Risk" view when updating server configuration via the UI. (Added: 2026-03-01)
