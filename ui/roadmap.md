...
- [ ] **[P0] Skill Sandbox Monitor**: Real-time visualization of containerized skill script execution and resource limits. (Added: 2026-03-08)
- [ ] **[P1] Provenance Attestation UI**: Security badge system for "Attested" vs "Community" Agent Skills. (Added: 2026-03-08)
