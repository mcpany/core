...
- [ ] **[P0] Adaptive Threat Monitor**: Real-time visualization of heuristic throttling, intent-drift alerts, and sub-network isolation status. (Added: 2026-03-06)
- [ ] **[P1] CLI Session Streamer**: Interactive UI for monitoring and interacting with streaming terminal-based agent sessions. (Added: 2026-03-06)
