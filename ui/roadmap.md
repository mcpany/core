...
- [ ] **[P0] Policy-as-Code Manager**: Interface for importing/exporting and visualizing "Seatbelt" style security profiles. (Added: 2026-02-27)
- [ ] **[P0] Attestation Status Dashboard**: High-visibility indicator of tool provenance and signature validity. (Added: 2026-02-27)
- [ ] **[P1] Swarm-Watch Monitor**: Sequence diagrams and alerts for inter-agent state transitions and cascading failures. (Added: 2026-02-27)
