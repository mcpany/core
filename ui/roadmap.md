...
- [ ] **[P0] Enclave Isolation Monitor**: Real-time visualization of hardware memory boundaries and physical shard integrity. (Added: 2026-07-25)
- [ ] **[P0] Inode Security Status Widget**: Visual indicator for filesystem-bound session tokens and blocked "Clone-and-Exfiltrate" attempts. (Added: 2026-07-25)
- [ ] **[P0] Attention Entropy Heatmap**: Forensic UI for visualizing noise levels and DAR-triggered anchor reinforcement events. (Added: 2026-07-25)
- [ ] **[P0] Fast-Path Resumption Tracker**: Performance dashboard for monitoring enclave rotation latency and hardware attestation gains. (Added: 2026-07-25)
