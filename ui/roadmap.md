...
- [ ] **[P0] Zero-Privilege Sandbox Monitor**: Real-time visualization of network-locked discovery probes and blocked host-access attempts. (Added: 2026-07-25)
- [ ] **[P0] Sovereignty Receipt Viewer**: UI for inspecting hardware-signed proofs of local PII scrubbing and HAD attestation status. (Added: 2026-07-25)
- [ ] **[P0] NLIS Injection Alert Center**: Security dashboard for reviewing semantically flagged instructions in markdown context files. (Added: 2026-07-25)
- [ ] **[P0] CRDT Conflict Visualizer**: Interactive tracker for lock-free state mutations and Strong Eventual Consistency merges. (Added: 2026-07-25)
