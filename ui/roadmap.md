...
- [ ] **[P0] Shield Logs & Policy Violation Feed**: UI for monitoring and approving/denying flagged Command Injection attempts. (Added: 2026-03-12)
- [ ] **[P1] A2A Authenticated Card Discovery**: UI for browsing and authenticating with peer agents in the mesh. (Added: 2026-03-12)
