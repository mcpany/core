...
- [ ] **[P0] Attestation Scale Dashboard**: (2026-07-25) Real-time visualization of risk-adaptive quorum thresholds and DAS scaling events.
- [ ] **[P0] Discovery Sandbox Auditor**: (2026-07-25) Security UI for inspecting HDS logs and blocked CLI path injection attempts.
- [ ] **[P0] Semantic Lineage Inspector**: (2026-07-25) Visual debugger for hardware-attested VSL fingerprints across multi-hop delegations.
- [ ] **[P1] Trust Domain Manager**: (2026-07-25) Interface for defining and visualizing mission-root trust domains and coordination tiers.
