...
- [ ] **[P1] Mesh Explorer (Topological View)**: Live visualization of agents, tools, and federated nodes. (Added: 2026-03-01)
- [ ] **[P0] Lineage Trace Viewer**: Interactive tree view for inspecting sub-agent spawning lineage and intent headers. (Added: 2026-03-01)
