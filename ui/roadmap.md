...
- [ ] **[P0] Reward Integrity Dashboard**: (2026-07-25) Real-time visualization of hardware-attested binary rewards and blocked spoofing attempts.
- [ ] **[P0] Context Stability Heatmap**: (2026-07-25) Visual tracker for semantic drift in summarized context vs. mission-root intent.
- [ ] **[P0] PID Sovereignty Monitor**: (2026-07-25) Security status for hardware-locked PID scrubbing and procfs isolation.
- [ ] **[P1] ZK-Summarization Audit Viewer**: (2026-07-25) UI for reviewing security attestation proofs for compact context fragments.
