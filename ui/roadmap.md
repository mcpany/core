...
- [ ] **[P0] Attention Persistence Dashboard**: visual tracker for mission-root anchors and ACR refresh events. (Added: 2026-07-25)
- [ ] **[P0] Task Completion Auditor**: authorization workspace for reviewing hardware-attested task completion proofs. (Added: 2026-07-25)
- [ ] **[P1] Mesh Ticket Monitor**: real-time visualization of pre-authenticated handshakes and tunnel resumption latency. (Added: 2026-07-25)
