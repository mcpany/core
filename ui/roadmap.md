...
- [ ] **[P1] Git-Context Visualization**: UI component to show current Git branch/commit state injected into agent sessions. (Added: 2026-02-26 Supplemental)
- [ ] **[P1] Hybrid Agent Status Dashboard**: Unified view of local (Ollama) vs cloud agent performance and costs. (Added: 2026-02-26 Supplemental)
