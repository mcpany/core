...
- [ ] **[P0] A2A Agent Card Registry**: UI for managing and verifying "Agent Cards" for cross-framework trust. (Added: 2026-02-28)
- [ ] **[P0] Sandbox Execution Monitor**: Visual tracking and logs for JIT Tool Sandboxes. (Added: 2026-02-28)
