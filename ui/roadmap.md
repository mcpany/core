...
- [ ] **[P0] Isolated Transport Monitor**: UI for managing and monitoring non-IP based agent connections (e.g., Named Pipes). (Added: 2026-03-02)
- [ ] **[P0] Gateway Attestation Log**: Security log for viewing and auditing gateway URL attestation results. (Added: 2026-03-02)
