...
- [ ] **[P0] Config-Jail Sandbox Monitor**: Real-time visualization of sandboxed hook executions and resource usage. (Added: 2026-03-08)
- [ ] **[P0] Credential Proxy Audit Trail**: UI for monitoring proxied API requests and blocked malicious destination attempts. (Added: 2026-03-08)
- [ ] **[P1] Sub-Agent Spawning Visualizer**: Interactive tree view of the agent hierarchy and their lifecycle status. (Added: 2026-03-08)
