...
- [ ] **[P0] Session Shadowing Monitor**: UI to visualize session isolation and verify cryptographic handoff tokens. (Added: 2026-03-11)
- [ ] **[P1] Binary Artifact Inspector**: Secure UI for previewing sandboxed binary artifacts from the Vault. (Added: 2026-03-11)
- [ ] **[P1] Routing Engine Dashboard**: Visualize how the Generalist Router delegates tasks to specialized subagents. (Added: 2026-03-11)
