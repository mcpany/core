...
- [ ] **[P0] Active Pruning Dashboard**: Visualize which tools are active vs. pruned in the current session. (Added: 2026-02-27)
- [ ] **[P1] Agent DID Identity Viewer**: View and verify cryptographic IDs for swarm participants. (Added: 2026-02-27)
- [ ] **[P1] WASM Plugin Manager**: UI for installing and configuring sandboxed WASM tools. (Added: 2026-02-27)
- [ ] **[P1] Capability Negotiation Timeline**: Visual log of pre-flight checks and granted permissions between agents. (Added: 2026-02-27)
