...
- [ ] **[P0] SSRF Security Monitor**: Real-time visualization of network fetch attempts, blocked targets, and security policy violations. (Added: 2026-03-09)
- [ ] **[P0] Intent Visualization Graph**: visual tree showing the current agent intent vs. the authorized tool boundary. (Added: 2026-03-09)
