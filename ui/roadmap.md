...
- [ ] **[P0] Handshake Auth Manager**: UI for viewing active local session tokens and authorized local clients. (Added: 2026-03-05)
- [ ] **[P0] Config Integrity Sandbox Viewer**: UI for reviewing and approving "Tainted" project-local configuration overrides. (Added: 2026-03-05)
