...
- [ ] **[P0] Connectivity & Security Dashboard**: Visualize local-only vs remote exposure, Hardware-Locked Attestation status, and active MFA sessions. (Added: 2026-02-28)
- [ ] **[P0] Stateful A2A Mailbox**: UI for viewing queued and delivered A2A messages across the agent mesh, including retry status. (Added: 2026-02-28)
- [ ] **[P1] Port Exposure Mitigation Wizard**: Interactive UI to help users transition from `0.0.0.0` to secure local/attested listeners. (Added: 2026-02-28)
