...
- [ ] **[P0] Process-Tree Integrity Dashboard**: Real-time visualization of recursive process trees and APTR termination events. (Added: 2026-07-25)
- [ ] **[P0] Multi-Modal Attention Heatmap**: Enhanced visual indicator for pinned SVG/Binary anchors and attention priority scores. (Added: 2026-07-25)
- [ ] **[P0] Mesh Transport Performance Overlay**: Real-time visualization of AMC-driven compression ratios and tunnel latency. (Added: 2026-07-25)
