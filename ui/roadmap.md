...
- [ ] **[P0] Attestation Lease Monitor**: (2026-07-25) Real-time visualization of LAL minting, rotation, and coordination latency.
- [ ] **[P0] Dynamic Anchor Dashboard**: (2026-07-25) Visual indicator for ARA-nominated anchors and their current coherence scores.
- [ ] **[P1] Hierarchical Cost Explorer**: (2026-07-25) Visual tracker for REA-bound reasoning costs broken down by sub-task lineage.
