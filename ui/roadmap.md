...
- [ ] **[P0] Collaborative Anomaly Detection Monitor**: (2026-07-25) Real-time visualization of cross-agent behavioral patterns and coordination risk scores.
- [ ] **[P0] Origin-Pinning Security Hub**: (2026-07-25) Dashboard for managing session-origin bindings and reviewing blocked hijacking attempts.
