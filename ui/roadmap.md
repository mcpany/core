...
- [ ] **[P0] JIT Elevation Manager**: UI for monitoring and overriding temporary capability leases. (Added: 2026-02-27)
- [ ] **[P1] Self-Healing Tool Workbench**: Interface for reviewing and merging agent-proposed tool fixes. (Added: 2026-02-27)
- [ ] **[P1] Workspace Conflict Viewer**: Visual detection and resolution of agent-on-agent state collisions. (Added: 2026-02-27)
