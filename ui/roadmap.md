...
- [ ] **[P1] WebView Security Panel**: Manage and audit origin-to-tool policies for browser-based agents. (Added: 2026-03-10)
- [ ] **[P1] Agent Task Scheduler (Cron/Loop)**: UI for viewing and managing recurring tool execution loops. (Added: 2026-03-10)
- [ ] **[P1] Cloud Deployment Wizard**: Guided UI for deploying hardened MCP Any instances to AWS/GCP. (Added: 2026-03-10)
