...
- [ ] **[P0] Recursive Agent Hierarchy Viewer**: Visualize nested agent sessions and recursion depth. (Added: 2026-03-06)
- [ ] **[P0] Contextual Shield Monitor**: Security dashboard for tracking blocked context injections (PleaseFix Shield). (Added: 2026-03-06)
- [ ] **[P1] Identity Chain Inspector**: UI for verifying OAuth token propagation through agent swarms. (Added: 2026-03-06)
