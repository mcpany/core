...
- [ ] **[P0] Universal Trust-Metadata Dashboard**: Visualizer for cross-framework trust translation and attestation status (UAB/A2A/MCP). (Added: 2026-05-19)
- [ ] **[P0] Global Wait-Graph Explorer**: Interactive multi-framework visualization of agent lock status and circular dependency alerts. (Added: 2026-05-19)
- [ ] **[P1] Semantic Contract Auditor**: UI for reviewing inter-agent tool outputs against mission-intent guardrails. (Added: 2026-05-19)
