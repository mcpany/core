...
- [ ] **[P0] Mailbox Hash-Chain Inspector**: (2026-07-25) Forensic UI for visualizing semantic hash-chains in shared teammate mailboxes and identifying splicing attempts.
- [ ] **[P0] SLAA Priority Dashboard**: (2026-07-25) Real-time monitor for system-level attention anchors and KV-cache priority status.
- [ ] **[P1] RaaS Quota & Usage Monitor**: (2026-07-25) Visual tracker for tool-initiated reasoning costs and mission-bound budget consumption.
