...
- [ ] **[P0] MCP Deduplication Viewer**: UI to visualize merged tools and manage conflict resolution. (Added: 2026-03-08)
- [ ] **[P1] Scoped Config Manager**: UI for managing project-level overrides and visualizing configuration hierarchy. (Added: 2026-03-08)
