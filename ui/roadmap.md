...
- [ ] **[P0] Config Trust Approval Dialog**: Security UI for reviewing and approving untrusted project configurations. (Added: 2026-03-03)
- [ ] **[P0] Origin Violation Alerts**: Real-time notification for blocked cross-site agent access attempts. (Added: 2026-03-03)
