...
- [ ] **[P0] Service Mesh Topology Monitor**: (2026-04-17) Real-time visualization of hardware-attested P2P tunnels and inter-node coordination health.
- [ ] **[P0] Mission Lease Manager**: (2026-04-17) Visual tracker for active HLML-bound capability leases and their automated expiration status.
- [ ] **[P0] GC-Immune Anchor Visualizer**: (2026-04-17) Visual indicator for pinned reasoning anchors protected against aggressive context GC.
- [ ] **[P0] Teammate Task List Viewer**: (2026-04-17) High-speed, CRDT-native visualization of the shared task list for Agent Teams.
