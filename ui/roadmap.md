...
- [ ] **[P0] Neural Integrity Dashboard**: (2026-07-25) UI for reviewing and hardware-signing authorized model neural shards and NSA attestation logs.
- [ ] **[P0] Kernel Resource Monitor**: (2026-07-25) Real-time visualization of OS-level cgroup/sandbox throttling events and mission-root budget pinning.
- [ ] **[P0] Ghost Fragment Alert Center**: (2026-07-25) Forensic UI for inspecting state fragments flagged by CSR during mission-state transitions.
- [ ] **[P0] GC-Immunity Policy Editor**: (2026-07-25) Interactive workspace for defining declarative CWPP rules and visualizing "Silent Anchor" health.
