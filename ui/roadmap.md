...
- [ ] **[P0] GNAP Coordination Viewer**: Visualizer for Git-Native Agent Protocol coordination files and decentralized mission status. (Added: 2026-07-25)
- [ ] **[P0] CI/CD Workflow Guard Dashboard**: Real-time visualization of agent action-chains and workflow integrity alerts. (Added: 2026-07-25)
- [ ] **[P0] Infer Hub Routing Monitor**: Dashboard for monitoring multi-provider inference routing, latency, and load balancing. (Added: 2026-07-25)
- [ ] **[P1] Memory-Wiki State Explorer**: UI for browsing versioned agent context and managing compaction strategies. (Added: 2026-07-25)
