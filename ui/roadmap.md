...
- [ ] **[P0] Connection Guard Monitor**: (P0) Visualize blocked cross-origin attempts and manage origin whitelists. (Added: 2026-03-06)
- [ ] **[P1] AHA Handshake Debugger**: (P1) Diagnostic view for local agent attestation status. (Added: 2026-03-06)
