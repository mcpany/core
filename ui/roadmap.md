...
- [ ] **[P0] CSRF Security Dashboard**: Visualize blocked CSRF attempts and manage authorized origins/tokens. (Added: 2026-02-27)
- [ ] **[P1] Speculative Branching UI**: Visual DAG of forked agent sessions and tool execution paths. (Added: 2026-02-27)
- [ ] **[P1] Anomaly Alert System**: Real-time UI notifications for detected behavioral anomalies in tool calls. (Added: 2026-02-27)
