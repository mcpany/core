...
- [ ] **[P0] Speculative Task Monitor**: Real-time visualization of optimistic task assignments and arbiter-mediated conflict resolution. (Added: 2026-07-25)
- [ ] **[P0] Mesh Tunneling Performance Overlay**: Latency metrics and session resumption status for distributed AMT Broker handoffs. (Added: 2026-07-25)
- [ ] **[P1] Hardware Lease Expiration Dashboard**: Visual tracker for active MBHL tokens and automated capability revocation events. (Added: 2026-07-25)
