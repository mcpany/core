...
- [ ] **[P0] Intent Validation Dashboard**: UI for monitoring tool calls and their associated intents. (Added: 2026-03-01)
- [ ] **[P0] Isolated Execution Monitoring**: Real-time view of sandboxed environments (Docker/NSJail containers) being spawned and destroyed. (Added: 2026-03-01)
