...
- [ ] **[P0] Path-Invariant Security Monitor**: UI for visualizing path-traversal attempts and boundary violations. (Added: 2026-03-10)
- [ ] **[P1] Sandbox Runtime Dashboard**: Real-time monitor for "Detached Sandbox" instances and resource usage. (Added: 2026-03-10)
