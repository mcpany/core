...
- [ ] **[P0] Session Revocation Dashboard**: (2026-07-25) Real-time visualization of active sessions and sub-millisecond termination triggers.
- [ ] **[P0] Scope-Lineage Inspector**: (2026-07-25) Visual debugger for verifying the parentage and authorization of agent scope claims.
- [ ] **[P0] Ghost-Hook Violation Viewer**: (2026-07-25) Forensic UI for inspecting blocked natural-language configuration fragments.
