...
- [ ] **[P0] Interactive MCP App Renderer**: Frontend support for rendering UI schemas from the MCP App Gateway. (Added: 2026-02-28)
- [ ] **[P0] Hook Integrity Manager**: Interface for one-time trust attestation of workspace-level initialization commands. (Added: 2026-02-28)
