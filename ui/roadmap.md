...
- [ ] **[P0] Agent Handoff Tracker**: Real-time visualization of MoltHandoff tasks and signed handoff verifications. (Added: 2026-02-27)
- [ ] **[P1] Shadow MCP Warning System**: UI alerts and governance dashboard for undocumented local MCP servers. (Added: 2026-02-27)
- [ ] **[P1] Intelligence-Based Relevance Dashboard**: Monitor how relevance scoring prunes "Context Smog" and improves agent performance. (Added: 2026-02-27)
