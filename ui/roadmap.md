...
*   **[P0] Multi-Node Consensus View**: visual representation of the mesh quorum status and device health. (Added: 2026-07-25)
*   **[P1] Mission Resume Dashboard**: UI for managing and resuming missions via Teammate-Resume-Tokens (TRTs). (Added: 2026-07-25)
