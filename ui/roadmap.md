...
- [ ] **[P0] Shard Migration Heatmap**: (2026-07-25) Real-time visualization of proactive RSM relocation events and MTTC optimization gains.
- [ ] **[P0] Instruction-Density Monitor**: (2026-07-25) Security dashboard for tracking ASF v2 alerts and identifying shard-shadowing attempts.
- [ ] **[P0] Sentinel Reinforcement Pulse**: (2026-07-25) Visual indicator in the Attention Dashboard showing active mission-root reinforcement pulses.
