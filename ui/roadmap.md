...
- [ ] **[P0] Output Scrubbing Monitor**: (2026-07-25) Real-time visualization of semantically redacted tool outputs and EchoLeak alert status.
- [ ] **[P0] Atomic Privilege Inspector**: (2026-07-25) Visual debugger for tracking single-use capability tokens and task-bound privilege expiration.
- [ ] **[P1] Side-Channel Entropy Heatmap**: (2026-07-25) Security UI for monitoring coordination entropy and detecting multi-session exfiltration patterns.
