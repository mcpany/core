...
- [ ] **[P0] Intent Alignment Dashboard**: Visualize "Intent Scores" and policy matches for tool calls. (Added: 2026-03-06)
- [ ] **[P0] Sandbox Resource Monitor**: Real-time CPU/Mem usage for isolated tool runtimes. (Added: 2026-03-06)
- [ ] **[P1] Universal Swarm Explorer**: Cross-framework timeline for tracing tasks across OpenClaw, Gemini, and Claude. (Added: 2026-03-06)
