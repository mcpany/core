...
- [ ] **[P0] Subagent Reaper Dashboard**: real-time visualization of agent heartbeats and termination events (Added: 2026-04-03).
- [ ] **[P0] Metadata Instruction Interdiction UI**: security dashboard for reviewing and approving redacted metadata fragments (Added: 2026-04-03).
- [ ] **[P0] HSNB Auction Monitor**: real-time visual tracker for subagent bidding and broker latency (Added: 2026-04-03).
- [ ] **[P1] Intent-Leased State Inspector**: forensic UI for visualizing speculative branch state in Shadow Tables (Added: 2026-04-03).
