...
- [ ] **[P0] Post-Quantum Security Widget**: (2026-07-25) Status indicator for PQIS-protected mission intents and algorithm strength.
- [ ] **[P0] Blackboard Contention Heatmap**: (2026-07-25) Real-time visualization of lock inheritance events and PIB-resolved stalls.
- [ ] **[P0] Differential Stylometry Inspector**: (2026-07-25) Forensic UI for visualizing DSA contrastive scores and identity-bleed alerts.
- [ ] **[P0] Trust Ticket Monitor**: (2026-07-25) Dashboard for tracking active FPTT tokens and fast-path resumption metrics.

#### Upcoming (2026-07-25 Iteration 2)
- [ ] **[P0] Kernel Lock-Arbiter Monitor**: (2026-07-25) Visual tracker for lock-free task claiming and CRDT convergence.
- [ ] **[P0] Structural Sanitization Dashboard**: (2026-07-25) Real-time visualization of sanitized tool schemas and blocked metadata instructions.
