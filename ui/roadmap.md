...
- [ ] **[P0] Agent Passport Manager**: UI for viewing and verifying active agent identities and goal attestations. (Added: 2026-03-01)
- [ ] **[P1] Swarm Lineage Visualizer**: Interactive graph showing the origin and flow of messages across the A2A mesh. (Added: 2026-03-01)
