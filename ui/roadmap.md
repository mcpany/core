...
- [ ] **[P0] Vulnerability Traffic Monitor**: Real-time visualization of blocked SSRF and Path Traversal attempts in the Policy Firewall. (Added: 2026-02-28 Phase 2)
- [ ] **[P1] DID Identity Manager**: UI for managing and verifying agent Decentralized Identifiers (DIDs). (Added: 2026-02-28 Phase 2)
