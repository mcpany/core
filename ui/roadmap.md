...
- [ ] **[P0] Universal Marketplace Manager**: UI for subscribing to and browsing tool/agent marketplaces (Claude, ClawHub). (Added: 2026-03-06)
- [ ] **[P0] Project Grounding (Agentic Search) Visualizer**: Interface for configuring and monitoring "grounding" search results across the project. (Added: 2026-03-06)
