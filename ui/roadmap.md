...
- [ ] **[P0] Sandbox Security Dashboard**: Monitor isolated tool execution and host violation attempts. (Added: 2026-02-27)
- [ ] **[P0] Config Trust Manager**: UI for admin allowlisting and verifying signed MCP configurations. (Added: 2026-02-27)
