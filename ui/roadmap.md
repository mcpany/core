...
- [ ] **[P0] UMDP Mesh Browser**: (2026-07-25) Unified dashboard for visualizing cross-node UMDP capability beacons and node-lineages.
- [ ] **[P0] Post-Quantum Security Widget**: (2026-07-25) Real-time monitor for NIST-standard handshake status and PQ-enveloping integrity.
- [ ] **[P0] Inter-Mesh Task Visualizer**: (2026-07-25) Visual monitor for cross-node CRDT task synchronization and mesh coordination latency.
