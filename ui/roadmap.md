...
- [ ] **[P0] Agent Identity Dashboard**: UI for managing agent identities, viewing attestation reports, and issuing manual overrides. (Added: 2026-02-27)
- [ ] **[P1] Transactional Flow Visualizer**: Visual representation of atomic multi-node tool calls and their rollback status. (Added: 2026-02-27)
