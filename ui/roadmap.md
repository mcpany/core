...
- [ ] **[P0] Shadow-Guard Config Inspector**: UI for reviewing, diffing, and approving quarantined project-local configurations. (Added: 2026-03-06)
- [ ] **[P1] Cloud Identity Mapping UI**: Interface for managing IAM role assignments for remote tool execution. (Added: 2026-03-06)
