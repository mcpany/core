...
- [ ] **[P0] Behavioral Threat Map**: Real-time visualization of tool call sequences and risk scoring. (Added: 2026-03-11)
- [ ] **[P1] WebMCP Explorer**: UI for browsing tools registered by websites during a browser session. (Added: 2026-03-11)
