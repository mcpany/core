...
- [ ] **[P0] A2A Trust & Identity Dashboard**: Visualize Agent DIDs, signature status, and Trust Registry authorizations. (Added: 2026-03-08)
- [ ] **[P0] Tool Security Inspector (TOS)**: Real-time visualization of tool output sanitization and blocked "System Instruction" injections. (Added: 2026-03-08)
