...
- [ ] **[P0] Summarization Quorum Monitor**: Visual workspace for reviewing multi-agent consensus on context compaction and "Mission-Root Erasure" alerts. (Added: 2026-07-06)
- [ ] **[P1] Adaptive Jitter Control Console**: UI for configuring risk-aware jitter profiles and monitoring coordination latency. (Added: 2026-07-06)
- [ ] **[P1] Attention Anchor Heatmap**: Visualization of ART-reinforced attention drivers in multimodal reasoning traces. (Added: 2026-07-06)
