...
- [ ] **[P1] Managed Proxy Status**: UI for monitoring authenticated tunnels from cloud agents. (Added: 2026-02-28)
- [ ] **[P1] Policy Wildcard Editor**: Visual editor for Rego/CEL policies with wildcard support. (Added: 2026-02-28)
