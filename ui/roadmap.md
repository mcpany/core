...
- [ ] **[P0] Trust Receipt Wallet**: (2026-07-25) UI for reviewing active MRAR trust receipts and their offline-validity status.
- [ ] **[P0] Discovery Jitter Monitor**: (2026-07-25) Real-time visualization of JASCG timing variations and schema sensitivity scores.
- [ ] **[P1] Ephemeral Shard Visualizer**: (2026-07-25) High-speed tracker for MRES-dynamic sharding of the shared task list.
...
*   **[P0] Agent Cognitive Load Monitor**: Interactive "Apple-style" activity rings to visualize real-time agent token usage and context strain. (Added: 2026-11-02)
