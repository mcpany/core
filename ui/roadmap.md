...
- [ ] **[P0] Origin Status Viewer**: UI for monitoring and approving local agent/binary identities and tracking origin-based rejection logs. (Added: 2026-03-06)
- [ ] **[P0] Intent-Scoped Discovery Manager**: Dashboard for managing "Intent-to-Tool" mapping and visualizing lazy-hydrated tool context. (Added: 2026-03-06)
- [ ] **[P1] Agent Identity (SLAIS) Manager**: UI for issuing, revoking, and auditing short-lived agent certificates. (Added: 2026-03-06)
