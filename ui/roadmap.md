...
- [ ] **[P0] Isolated Transport Status**: Indicators in the service list showing if a connection is secured via UDS/Named Pipes. (Added: 2026-02-27)
- [ ] **[P1] IAM Mapping Dashboard**: UI for configuring OIDC/SAML mappings to MCP tool scopes. (Added: 2026-02-27)
