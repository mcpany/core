...
- [ ] **[P0] Context Integrity Dashboard**: Real-time counter of "Smuggling Attempts Blocked" and visualization of attested context lineage. (Added: 2026-03-04)
- [ ] **[P1] Discovery Locality Overlay**: UI hints for tool "locality" (local vs remote vs pinned) to help users optimize agent performance. (Added: 2026-03-04)
