...
- [ ] **[P0] Tunneled Instruction Inspector**: (2026-07-25) Real-time visualization of IBTS-attested instructions traversing mesh tunnels.
- [ ] **[P0] Speculative Task Visualizer**: (2026-07-25) Interactive monitor for SCH speculative commits and DRQ quorum status.
- [ ] **[P0] RAS Guardrail Monitor**: (2026-07-25) Visual indicator for instructions pinned in the hardware-locked Root Attention Segment.
- [ ] **[P0] Identity Lease Status Dashboard**: (2026-07-25) UI for tracking IJM lease refreshes and hardware signing queue latency.
