...
- [ ] **[P0] JIT Escalation Manager**: UI for reviewing and approving dynamic permission requests. (Added: 2026-02-27)
- [ ] **[P1] Tool Sandbox Inspector**: Visual interface for testing agent-proposed tool fixes. (Added: 2026-02-27)
