...
- [ ] **[P0] Layered Config Diff Viewer**: Visual tool for comparing Global, Project, and Local settings layers. (Added: 2026-03-10)
- [ ] **[P1] Security Profile Wizard**: Guided setup for inter-framework security compliance (OpenClaw, Claude Code). (Added: 2026-03-10)
