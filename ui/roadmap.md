...
- [ ] **[P0] Coordination Replay Monitor**: (2026-07-25) Real-time visualization of sequence gaps and blocked replay attempts.
- [ ] **[P0] Epistemic Confidence Heatmap**: (2026-07-25) Visual tracker for subagent uncertainty scores and automated escalation triggers.
- [ ] **[P0] Mirror-Intent Status Widget**: (2026-07-25) Authorization UI for reviewing reflection quorums and mission-root alignment scores.
