...
- [ ] **[P0] API Pinning & Whitelist Manager**: UI for configuring trusted model endpoints and reviewing blocked redirection attempts. (Added: 2026-03-12)
- [ ] **[P1] Agentic Wallet Permission Dashboard**: UI for managing ERC-7710 delegations and transaction limits for agents. (Added: 2026-03-12)
