...
- [ ] **[P0] Security Intent Visualizer**: UI for inspecting and approving "Intent Contracts" and monitoring for intent-drift. (Added: 2026-02-27)
- [ ] **[P0] Team Context Dashboard**: Visual management of shared blackboard state across multi-agent teams. (Added: 2026-02-27)
- [ ] **[P1] Real-time Vulnerability Monitor**: Security feed for connected MCP servers, highlighting potential SSRF/Path Traversal risks. (Added: 2026-02-27)
