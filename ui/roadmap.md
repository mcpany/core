...
- [ ] **[P0] Speculative State Debugger**: visual workspace for monitoring shadow buffers, consistency quorums, and rollback events. (Added: 2026-07-25)
- [ ] **[P0] Mesh Routing Topology**: enhanced map visualization showing hardware-attested identity fragments across mesh nodes. (Added: 2026-07-25)
- [ ] **[P0] Attention Pinning Manager**: UI for marking specific context fragments as "Immutable" to the GC. (Added: 2026-07-25)
- [ ] **[P0] Stylometric Signature Monitor**: real-time visualization of behavioral match scores for workspace writes. (Added: 2026-07-25)
