...
- [ ] **[P0] Distributed Consensus Monitor**: Real-time visualization of multi-node attestation ballots and quorum progress. (Added: 2026-07-25)
- [ ] **[P0] Enclave Budget Tracker**: Visual tracker for hardware-attested budget tickets and real-time consumption per mission. (Added: 2026-07-25)
- [ ] **[P0] Durable Persistence Auditor**: Security UI for reviewing DSPP-compliant environment integrity receipts across mission resume cycles. (Added: 2026-07-25)
