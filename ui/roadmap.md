...
- [ ] **[P0] Shard Migration Heatmap**: Real-time visualization of context shard movement across physical mesh nodes. (Added: 2026-07-25)
- [ ] **[P0] Lease Chain Inspector**: Forensic UI for visualizing the recursive lineage of hardware-attested sub-leases. (Added: 2026-07-25)
- [ ] **[P0] Discovery Interdiction Alert Center**: Security dashboard for reviewing blocked speculative reasoning fragments. (Added: 2026-07-25)
- [ ] **[P1] Multi-Node Handoff Visualizer**: Visual tracker for mission continuity across device boundaries and P2P tunnels. (Added: 2026-07-25)
