...
- [ ] **[P0] Project Attestation Manager**: UI for reviewing and signing project-scoped MCP configurations to prevent RCE. (Added: 2026-03-01)
- [ ] **[P0] Hierarchical Trust Map**: Visual representation of the trust chain between parent agents and nested sub-agents. (Added: 2026-03-01)
