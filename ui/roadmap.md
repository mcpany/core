...
- [ ] **[P0] WebSocket Origin Manager**: UI for whitelisting and monitoring allowed WebSocket Origins. (Added: 2026-03-03)
- [ ] **[P0] Intent Manifest Builder**: Visual tool for orchestrators to define and sign Intent Manifests for subagents. (Added: 2026-03-03)
