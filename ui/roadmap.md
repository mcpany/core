...
- [ ] **[P0] MTR Entropy Dashboard**: Real-time visualization of randomized reasoning salt and shuffled attention anchors. (Added: 2026-04-07)
- [ ] **[P0] FRQ Trust Mesh Viewer**: Decentralized view of collective skill reputation and revocation signals across the mesh. (Added: 2026-04-07)
- [ ] **[P0] Intent-Fragment Debugger**: Visualizer for privacy-preserving A2A handoffs and minimal context exposure. (Added: 2026-04-07)
- [ ] **[P0] ADQ High-Speed Vote Monitor**: Real-time status for automated multi-agent security votes and interdiction events. (Added: 2026-04-07)
