...
- [ ] **[P0] Session Token Manager**: UI for viewing and rotating active local session secrets used for Origin-Bound security. (Added: 2026-03-09)
- [ ] **[P0] Hook Sandbox Monitor**: Real-time view of hook execution status and resource usage within the sandbox. (Added: 2026-03-09)
- [ ] **[P1] Long-Planning Session Visualizer**: Visual timeline for Opus 4.6 agents, showing planning checkpoints and state rollbacks. (Added: 2026-03-09)
