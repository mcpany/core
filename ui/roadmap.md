...
- [ ] **[P0] USH State Explorer**: (P0) Session timeline visualization for state handoffs and USH tokens. (Added: 2026-03-04)
- [ ] **[P1] Sanitization Feedback UI**: (P1) Real-time indicator when tool outputs are summarized, with "view original" capability. (Added: 2026-03-04)
