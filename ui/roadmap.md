...
- [ ] **[P0] Local Transport Security Status**: UI indicator for transport type (HTTP vs UDS/Pipe) and peer identity verification status. (Added: 2026-02-28)
- [ ] **[P0] Project Config Sandbox Approval UI**: Interface for reviewing and attesting to project-specific tool/hook definitions. (Added: 2026-02-28)
- [ ] **[P1] Intent-Aware Policy Editor**: Visual manager for "Seatbelt" profiles and intent-based tool permissions. (Added: 2026-02-28)
