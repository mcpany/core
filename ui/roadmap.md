...
- [ ] **[P0] Anti-Hijack Pairing UI**: Terminal-to-Browser pairing flow for authorizing local WebSocket origins. (Added: 2026-03-10)
- [ ] **[P0] Security Origin Manager**: UI for reviewing and allow-listing trusted browser origins and extensions. (Added: 2026-03-10)
