...
- [ ] **[P0] Multi-Registry Discovery Dashboard**: (2026-07-25) UI for reviewing and aggregated capability cards from heterogeneous registries.
- [ ] **[P0] Subagent Tool Filter Workspace**: (2026-07-25) Interactive interface for configuring role-based tool filtering for specialists.
- [ ] **[P0] Isolated Discovery Sandbox Monitor**: (2026-07-25) Real-time visualization of sandboxed capability mapping events.
