...
- [ ] **[P0] Plan Verification Dashboard**: UI for reviewing, approving, and auditing multi-step agent mission plans. (Added: 2026-07-25)
- [ ] **[P0] Episodic Graph Explorer**: Interactive visualization of the hardware-attested episodic graph for durable mission persistence. (Added: 2026-07-25)
- [ ] **[P1] Epistemic Confidence Monitor**: Real-time visualization of agent uncertainty scores and confidence-proof status. (Added: 2026-07-25)
- [ ] **[P1] Multi-Node Sovereignty Map**: Visual tracker for agent identities as they migrate across local, cloud, and edge nodes. (Added: 2026-07-25)
