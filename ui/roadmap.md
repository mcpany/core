...
- [ ] **[P0] Speculative Buffer Monitor**: Real-time visualization of ephemeral shards and commit/discard status. (Added: 2026-07-25)
- [ ] **[P0] Neural Decompression Auditor**: Security dashboard for reviewing sanitized context kernels and blocked neural injections. (Added: 2026-07-25)
- [ ] **[P0] Trust Ticket Rotation Status**: Monitor for monotonic sequence counters and TTR-enforced rotation events. (Added: 2026-07-25)
