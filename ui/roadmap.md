...
- [ ] **[P0] HITL Approval Gateway**: Real-time interface for policy-driven human approval flows. (Added: 2026-03-01)
- [ ] **[P0] Sandbox Isolation Monitor**: Visual status of tools running in the Low-Trust Sandbox vs. Attested tools. (Added: 2026-03-01)
- [ ] **[P1] Malware Scanning Status**: Real-time display of local attestation service scan results. (Added: 2026-03-01)
