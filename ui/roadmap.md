...
- [ ] **[P0] Alias Resolution Inspector**: Visual debugger for deconstructing tool parameter aliases and underlying path resolution. (Added: 2026-07-25)
- [ ] **[P1] Planning Context Alert Hub**: Real-time visualization of "Instruction Smuggling" attempts in Gemini-style context files. (Added: 2026-07-25)
- [ ] **[P1] ClawHub Profiling Viewer**: Security dashboard for reviewing sandboxed behavioral reports for marketplace plugins. (Added: 2026-07-25)
- [ ] **[P0] LFSS Shard Heatmap**: Visual tracker for CRDT-based state synchronization and conflict resolution performance. (Added: 2026-07-25)
