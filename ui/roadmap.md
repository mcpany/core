...
- [ ] **[P0] Identity-Aware Policy Manager**: UI for creating and managing Agent Identity tokens and role-based policies. (Added: 2026-03-10)
- [ ] **[P0] Skill Sandbox Monitor**: Real-time health and resource tracking for containerized MCP servers. (Added: 2026-03-10)
- [ ] **[P1] Swarm Attestation Flow**: Interactive UI for peer-agents to approve/reject high-risk tool calls. (Added: 2026-03-10)
