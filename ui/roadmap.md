...
- [ ] **[P0] Per-Agent Identity Manager**: UI for reviewing and approving hardware-attested agent identities. (Added: 2026-04-15)
- [ ] **[P0] Reasoning Memory Integrity Monitor**: Real-time visualization of semantic hash-chains and memory discontinuity alerts. (Added: 2026-04-15)
- [ ] **[P1] Framework Trust Overlay**: Visual indicator of Zero-Trust adapter status for connected agent frameworks. (Added: 2026-04-15)
