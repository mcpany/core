...
- [ ] **[P0] Audit Sovereignty Hub**: (2026-07-25) Local log viewer with hardware-attestation verification for agent traces.
- [ ] **[P0] NHI Lifecycle Dashboard**: (2026-07-25) Real-time monitor for tracking agent token activity, lineage, and revocation status.
- [ ] **[P1] Privilege Decay Visualizer**: (2026-07-25) Real-time visualization of agent capability pruning as missions progress toward completion.
