...
- [ ] **[P0] Mission Lineage Visualizer**: (2026-07-25) Real-time graph showing HMA-anchored monotonic counters across deep agent chains.
- [ ] **[P0] Cross-Node Sync Monitor**: (2026-07-25) Visual tracker for CNSS optimistic fragments and hardware-attested reconciliation latency.
- [ ] **[P0] Temporal Lease Manager**: (2026-07-25) UI for reviewing and approving delegated hardware leases in Agent Teams.
