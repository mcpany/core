...
- [ ] **[P0] Semantic Discovery Tuner**: UI for configuring embedding providers and visualizing tool similarity maps. (Added: 2026-02-27)
- [ ] **[P1] Federated Skill Marketplace**: In-app browser for discovering and subscribing to OpenClaw skills. (Added: 2026-02-27)
