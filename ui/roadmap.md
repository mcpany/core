...
- [ ] **[P0] Silent Anchor Monitor**: (2026-07-25) Visual status indicator for hardware-locked anchors and blocked "Shadow-Root" injection attempts.
- [ ] **[P0] Mission Reconstruction Dashboard**: (2026-07-25) Real-time visualization of FIR hit rates and sync latency reduction metrics.
- [ ] **[P0] Recursive Quota Widget**: (2026-07-25) Visual tracker for depth-aware reasoning budgets and RQE-triggered throttling events.
- [ ] **[P1] Metadata Soldering Alert Center**: (2026-07-25) Security UI for inspecting sharded fragments flagged for "Intent Soldering."
