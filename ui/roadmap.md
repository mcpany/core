...
### [2026-11-02 Evolution Updates]
- [ ] **[P0] Constitutional Arbitration Console**: UI for reviewing and signing "Mission Constitutions" and auditing ASA resolution history. (Added: 2026-11-02)
- [ ] **[P0] Reward Integrity Monitor**: Visual tracker for hardware-attested success signals and "Reward Poisoning" alerts. (Added: 2026-11-02)
- [ ] **[P0] Project-Bound Identity Widget**: Status indicator for Merkle-tree identity anchoring and capability revocation alerts. (Added: 2026-11-02)
- [ ] **[P0] Cohesion Drift Dashboard**: Visualization of mission-root anchor strength and eviction alerts across the swarm. (Added: 2026-11-02)
