...
- [ ] **[P0] Origin Attestation Manager**: UI for authorizing local applications and managing Unix Domain Socket connections. (Added: 2026-03-05)
- [ ] **[P1] Swarm Session Browser**: Visual explorer for isolated multi-agent swarm state and history. (Added: 2026-03-05)
- [ ] **[P1] Marketplace Aggregator View**: Unified interface for browsing tools from Anthropic and Google marketplaces. (Added: 2026-03-05)
