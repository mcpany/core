...
- [ ] **[P0] Recursive Reputation Explorer**: (2026-07-25) Forensic UI for visualizing subagent trust scores and parent lineage.
- [ ] **[P0] Teammate Branching Visualizer**: (2026-07-25) Real-time graph showing private mailbox branches and ATB reconciliation status.
- [ ] **[P0] Attention Weight Heatmap**: (2026-07-25) Visual indicator for AWCP-pinned fragments and their dynamic attention priorities.
- [ ] **[P0] Handshake Integrity Monitor**: (2026-07-25) Security widget for tracking HIG session buffer health and blocked coordination DoS attempts.
