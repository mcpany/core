...
- [ ] **[P0] ALI Revocation Monitor**: Real-time visualization of ebpf-mediated tunnel collapses and drift signals. (Added: 2026-07-25)
- [ ] **[P0] RAE Shard Key Manager**: UI for reviewing and managing hardware-enclave keys for encrypted shards. (Added: 2026-07-25)
- [ ] **[P0] CMIR Intent Visualizer**: Visual debugger showing reconstructed semantic intent maps from multimodal traces. (Added: 2026-07-25)
- [ ] **[P0] MRHI Handshake Alert Center**: UI for reviewing and blocking unauthorized agency-initiation signals. (Added: 2026-07-25)
