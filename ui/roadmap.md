...
- [ ] **[P0] Swarm Health Entropy Heatmap**: Real-time visualization of node reasoning entropy and ANQ quarantine status. (Added: 2026-07-25)
- [ ] **[P0] Workspace-Hash Integrity Monitor**: Visual indicator for SBI-bound session health and environment tampering alerts. (Added: 2026-07-25)
- [ ] **[P0] Multimodal Lineage Explorer**: Forensic UI for verifying Zero-Knowledge proofs for non-textual reasoning traces. (Added: 2026-07-25)
- [ ] **[P1] Speculative Shard Prefetcher Dashboard**: Visual monitor for IASS hit rates and predicted next-hop mission intents. (Added: 2026-07-25)
