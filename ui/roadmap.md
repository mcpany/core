...
- [ ] **[P0] CSWSH Policy Manager**: UI for managing authorized WebSocket origins and reviewing rejected handshakes. (Added: 2026-03-10)
- [ ] **[P1] Behavioral Anomaly Timeline**: Visualize tool calls through the lens of Agent-Contextual Telemetry. (Added: 2026-03-10)
