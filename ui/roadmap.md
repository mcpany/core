...
- [ ] **[P0] Memory Integrity Dashboard**: Visualize semantically scrubbed "Belief Injections" and cognitive drift alerts in long-term memory. (Added: 2026-07-25)
- [ ] **[P0] Retrieval Sovereignty Monitor**: Real-time visualization of SRG-redacted PII/IP fragments in the context window. (Added: 2026-07-25)
- [ ] **[P0] Shadow AI Visibility Center**: Comprehensive dashboard for auditing hardware-attested identity and identifying unauthorized agent activity. (Added: 2026-07-25)
- [ ] **[P1] Identity Minter Status**: UI for managing TPM-bound identity tokens and reviewing hardware attestation lineage. (Added: 2026-07-25)
