...
- [ ] **[P0] Intent Governance Dashboard**: UI for monitoring, signing, and auditing "Mission Intents" for autonomous agent swarms. (Added: 2026-03-08)
- [ ] **[P0] Ephemeral Node "Resume" Tracker**: Visual monitor for state checkpointing and restoration in transient sandboxes. (Added: 2026-03-08)
- [ ] **[P1] ATS Sandbox Inspector**: Live log stream and resource utilization viewer for agent-synthesized tools. (Added: 2026-03-08)
