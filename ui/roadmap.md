...
- [ ] **[P0] HS-A2A Throughput Visualizer**: Real-time monitoring of shared-memory bus performance and agent communication frequency. (Added: 2026-03-11)
- [ ] **[P1] Tool Egress Firewall Manager**: UI for reviewing and white-listing external domains for MCP tools. (Added: 2026-03-11)
