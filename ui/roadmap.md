...
- [ ] **[P0] JIT Elevation Request Center**: UI for human operators to review and approve JIT permission requests. (Added: 2026-02-27)
- [ ] **[P1] Self-Healing Staging Dashboard**: Visualize and promote agent-proposed tool fixes. (Added: 2026-02-27)
- [ ] **[P0] Injection Vulnerability Scanner**: UI feedback for potentially malicious tool metadata. (Added: 2026-02-27)
