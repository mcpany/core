...
- [ ] **[P0] JIT Capability Request Center**: UI for approving/denying just-in-time agent requests. (Added: 2026-03-08)
- [ ] **[P0] Project Trust Manager**: UI for verifying and attesting project-level MCP configurations. (Added: 2026-03-08)
