...
- [ ] **[P0] Service Mesh Topology Monitor**: Real-time visualization of cross-cloud P2P tunnels and inter-node health. (Added: 2026-07-25)
- [ ] **[P0] Mission Lease Manager**: Visual tracker for active HLML-bound leases and their recursive revocation status. (Added: 2026-07-25)
- [ ] **[P1] Provenance Lineage Inspector**: Visual debugger for verifying Reasoning-Path Watermarks in multi-hop delegations. (Added: 2026-07-25)
