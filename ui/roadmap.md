...
- [ ] **[P0] Mesh Resumption Dashboard**: (2026-07-25) Real-time visualization of speculative shard loads and background attestation status.
- [ ] **[P1] Intent Budgeting Console**: (2026-07-25) UI for reviewing TPM-bound "Budget Tickets" and multi-cloud quota consumption.
