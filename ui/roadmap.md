...
- [ ] **[P0] Role-Attestation Manager**: (2026-07-25) UI for reviewing and signing functional role tokens for teammates.
- [ ] **[P0] Affinity Shard Heatmap**: (2026-07-25) Visual indicator for CAS-prioritized synchronization branches and mailbox throughput.
- [ ] **[P0] RPW Provenance Inspector**: (2026-07-25) Forensic UI for verifying embedded reasoning-path watermarks in summarized context.
- [ ] **[P0] Reflection Guard Dashboard**: (2026-07-25) Real-time visualization of blocked unauthenticated discovery and reflection attempts.
