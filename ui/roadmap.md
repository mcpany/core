...
- [ ] **[P0] Lease Inheritance Tracer**: (2026-07-25) Visual hierarchical tracer for hardware-bound mission leases across sub-processes.
- [ ] **[P0] ARH Trust Ticket Widget**: (2026-07-25) Real-time monitor for pre-attested session identities and trust ticket health.
- [ ] **[P0] Attention Shard Persistence Heatmap**: (2026-07-25) Visual indicator for ALSP-locked context shards and garbage collection immunity.
- [ ] **[P1] Manifest Translation Debugger**: (2026-07-25) Workspace for reviewing and approving cross-framework manifest transformations.
