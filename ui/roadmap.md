...
- [ ] **[P0] Session Handover Dashboard**: (2026-07-25) UI for initiating and accepting secure session handoffs between disparate controllers.
- [ ] **[P0] Registry Trust Badges**: (2026-07-25) Visual indicators for tools that have been verified against a trusted MCP Registry via RBSA.
- [ ] **[P1] Background Worker Monitor**: (2026-07-25) Real-time visualization of background agents running in Dispatch mode, with drift and resource alerts.
