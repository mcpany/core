...
- [ ] **[P0] Security Origin Inspector**: UI to visualize the provenance of configuration values and highlight blocked overrides. (Added: 2026-02-27)
- [ ] **[P0] Redaction Policy Manager**: Interface for configuring PII and Secret masking rules. (Added: 2026-02-27)
- [ ] **[P1] Wearable Approval Bridge**: UI/Service for syncing HITL actions to Apple Watch and mobile devices. (Added: 2026-02-27)
