...
- [ ] **[P0] Team-Scoped Blackboard Viewer**: UI for viewing and managing shared context within an Agent Team. (Added: 2026-03-04)
- [ ] **[P0] Sandbox Perimeter Monitor**: Real-time visualization of path-traversal blocks and file-system sandbox violations. (Added: 2026-03-04)
