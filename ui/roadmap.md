...
- [ ] **[P0] Local Handshake Approval Portal**: (2026-04-13) Desktop UI for reviewing and approving hardware-attested local tool pairing requests.
- [ ] **[P0] Sandbox Expansion Dashboard**: (2026-04-13) Real-time visualization of "Elastic sovereignty" events and active boundary mounts.
- [ ] **[P0] Mission Chapter Explorer**: (2026-04-13) Visual hierarchical tracer for structured narrative flow and chapter-bound context isolation.
- [ ] **[P0] Agentic Immunity Status Widget**: (2026-04-13) Real-time indicator of an agent's self-verified security posture and policy health.
