...
- [ ] **[P0] Origin & Host Validation Status**: UI indicator for strict listener security status. (Added: 2026-03-09)
- [ ] **[P0] Unified Search Explorer**: Integrated tool search bar in the Playground for lazy-loaded discovery. (Added: 2026-03-09)
- [ ] **[P1] Project-Scoped Policy Editor**: UI for managing wildcard-based tool permissions. (Added: 2026-03-09)
