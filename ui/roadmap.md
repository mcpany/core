...
### Upcoming: [2026-06-18]
- [ ] **[P0] ACR Revocation Workspace**: (2026-06-18) Interface for reviewing and managing autonomous capability revocation and ACR-compliant lock-downs.
- [ ] **[P0] Recursive Handoff Visualizer**: (2026-06-18) High-fidelity visualization of recursive subagent handoffs with hardware-attested depth-limit indicators.
- [ ] **[P1] Reasoning Watermark Inspector**: (2026-06-18) Forensic tool for verifying cryptographically signed reasoning watermarks and mission-root lineage.
