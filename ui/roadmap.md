...
- [ ] **[P0] Sandbox Policy Manager**: UI for configuring Local Runtime Sandbox policies and resource limits. (Added: 2026-03-01)
- [ ] **[P1] Browser Session Viewer**: Real-time view of ephemeral browser tools in action. (Added: 2026-03-01)
- [ ] **[P1] Project Policy Editor**: Visual editor for `.mcp-policy.yaml` files. (Added: 2026-03-01)
