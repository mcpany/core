...
- [ ] **[P0] Policy Firewall Management**: UI for defining and testing Rego/CEL security policies.
- [ ] **[P1] Context Inheritance Visualizer**: Waterfall view showing which context fragments are passed to subagents.
