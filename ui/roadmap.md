...
- [ ] **[P0] AM-DNS Registry Explorer**: Visual dashboard for managing and auditing cryptographically signed agent handles. (Added: 2026-07-25)
- [ ] **[P0] Atomic State Isolation Monitor**: Real-time visualization of hardware-locked memory shards and boundary violation alerts. (Added: 2026-07-25)
- [ ] **[P0] Attention Persistence Widget**: Indicator for "Freeze-Dried" context restoration status and anchor priority levels. (Added: 2026-07-25)
