...
- [ ] **[P0] PR Injection Security Dashboard**: (2026-07-25) Real-time visualization of sanitized metadata and blocked PR-based instruction smuggling.
- [ ] **[P0] EchoLeak Violation Monitor**: (2026-07-25) Visual tracker for detected exfiltration patterns in ingested external content.
- [ ] **[P1] BYOA Identity Status Widget**: (2026-07-25) Monitor for hardware-attested identity and RBAC status of foreign agents (CrewAI, OpenClaw).
