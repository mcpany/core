...
- [ ] **[P0] Semantic Utility Scoreboard**: Real-time visualization of shard utility and R-GC eviction triggers. (Added: 2026-07-25)
- [ ] **[P0] Registry Token Monitor**: Visual tracker for ephemeral discovery tokens and blocked persistence attempts. (Added: 2026-07-25)
- [ ] **[P0] Mesh Shadowing Alert Center**: UI for monitoring and approving inter-node local tunnel requests. (Added: 2026-07-25)
