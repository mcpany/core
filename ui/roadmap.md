...
- [ ] **[P0] Lease Synchronization Dashboard**: Real-time monitor for tracking DLP-mediated lease propagation across the mesh. (Added: 2026-07-25)
- [ ] **[P1] ZKRP Reasoning Inspector**: Privacy-preserving UI for verifying framework-neutral reasoning proofs without context exposure. (Added: 2026-07-25)
- [ ] **[P0] Coordination Anchor Visualizer**: Indicator for GC-immune anchors in teammate mailboxes and their persistence status. (Added: 2026-07-25)
