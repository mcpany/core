...
- [ ] **[P0] Hook Execution Sandbox Manager**: UI for reviewing and approving lifecycle hook execution requests. (Added: 2026-02-27)
- [ ] **[P1] Skill Provenance Badge**: Visual indicator of cryptographic verification and origin for MCP tools. (Added: 2026-02-27)
