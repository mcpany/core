...
- [ ] **[P0] Audit-in-the-Middle (AitM) Security Dashboard**: Real-time visualization of indirect injection attempt blocking and document sanitization status. (Added: 2026-02-27)
- [ ] **[P1] Agent Heartbeat Monitor**: Visual tracking of session keep-alives and state resumption status for persistent agent swarms. (Added: 2026-02-27)
