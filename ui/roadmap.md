...
- [ ] **[P0] Caller Identity Attestation Status**: Dashboard indicator showing the verified identity of active gateway clients. (Added: 2026-03-11)
- [ ] **[P1] MFA Configuration Guard Flow**: UI for approving project-local config changes via MFA-backed signatures. (Added: 2026-03-11)
