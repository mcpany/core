...
- [ ] **[P0] MCP Vulnerability Alerts**: Real-time security notifications for compromised or vulnerable MCP servers (Added: 2026-03-05).
- [ ] **[P1] Intent Manifest Visualizer**: UI for inspecting and approving "Intent Scopes" during agent handoffs (Added: 2026-03-05).
