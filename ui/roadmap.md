...
- [ ] **[P0] Config Sandbox Auditor**: Visualization of blocked hooks and sandboxed execution logs. (Added: 2026-03-01)
- [ ] **[P1] Managed Identity Manager**: UI for issuing and revoking A2A/A2T identity tokens. (Added: 2026-03-01)
