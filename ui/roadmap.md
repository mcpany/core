...
- [ ] **[P0] Attestation Compression Monitor**: (2026-07-25) UI for visualizing RAC-driven compression ratios and latency gains across the mesh.
- [ ] **[P0] Speculative Shard Heatmap**: (2026-07-25) Real-time visualization of SSP prefetch hit rates and trajectory accuracy.
- [ ] **[P0] Probabilistic Buffer Inspector**: (2026-07-25) Security dashboard for reviewing PBH-isolated speculative state and purge events.
