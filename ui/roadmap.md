...
- [ ] **[P0] Nested HITL Approval Dialogs**: Dedicated UI components for handling multi-level subagent interactive prompts. (Added: 2026-02-27)
- [ ] **[P0] Security Contract Compliance Dashboard**: Visual indicator of which MCP servers satisfy machine-readable safety contracts. (Added: 2026-02-27)
- [ ] **[P1] Context Branching (Fork) Visualizer**: Diagrammatic view of session forks and their respective state isolations. (Added: 2026-02-27)
