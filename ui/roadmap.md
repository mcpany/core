...
- [ ] **[P1] Verified Skill Quarantine**: UI for reviewing and managing tools blocked by the Verified Skill Proxy (VSP). (Added: 2026-03-05)
- [ ] **[P0] Origin Trust Manager**: UI for authorizing and managing verified agent host origins. (Added: 2026-03-05)
