...
- [ ] **[P0] Mission Lease Manager**: Real-time visual tracker for active HLML/MBHL leases and automated revocation status. (Added: 2026-07-25)
- [ ] **[P0] Mesh Handshake Auditor**: UI for reviewing and approving hardware-attested inter-node handshake tokens. (Added: 2026-07-25)
- [ ] **[P1] ZK-Audit Proof Viewer**: Security workspace for visualizing recursive reason proofs generated by the ZKA Hub. (Added: 2026-07-25)
