...
- [ ] **[P0] Speculative Intent Workspace**: (2026-07-25) UI for reviewing conflicting speculative branches and monitoring intent reconciliation quorums.
- [ ] **[P0] Cognitive Load Balancer Dashboard**: (2026-07-25) Real-time visualization of mesh-node "Cognitive Intensity" and autonomous reasoning offload events.
- [ ] **[P0] Anchor Importance Heatmap**: (2026-07-25) Forensic UI showing semantic importance scores for pinned context fragments and CEG status.
