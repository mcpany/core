...
- [ ] **[P0] Context Compaction Monitor**: Visualize session token usage and background compaction status. (Added: 2026-03-03)
- [ ] **[P0] Semantic Discovery Interface**: Advanced UI for testing and monitoring vector-based tool search. (Added: 2026-03-03)
- [ ] **[P1] Workspace Scoping Editor**: UI for managing tool visibility and boundaries for agent workspaces. (Added: 2026-03-03)
