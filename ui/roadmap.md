...
- [ ] **[P0] Local Token Management UI**: CLI/UI bridge for generating and managing non-guessable session tokens for local API access. (Added: 2026-03-07)
- [ ] **[P1] A2A Mesh Health Dashboard**: Real-time status indicators for all A2A nodes, showing health check history and circuit-break status. (Added: 2026-03-07)
- [ ] **[P1] Intent-Driven Search Overlay**: Integrated search UI that allows agents to provide "Intent Context" when searching for tools. (Added: 2026-03-07)
