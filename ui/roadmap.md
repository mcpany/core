...
- [ ] **[P0] Tunnel-Splitting Visualizer**: (2026-07-25) Real-time tracking and alerting for lateral movement attempts within P2P tunnels.
- [ ] **[P1] Biometric Attestation Dialog**: (2026-07-25) Secure UI component for physical biometric re-attestation during mission-root migration.
- [ ] **[P1] EABSA Entropy Heatmap**: (2026-07-25) Visual indicator for reasoning-path entropy levels and cognitive fingerprint verification.
