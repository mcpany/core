...
- [ ] **[P0] Parallel Swarm Visualizer**: Real-time view of concurrent agent tasks and shared blackboard state. (Added: 2026-03-07)
- [ ] **[P0] Semantic Security Dashboard**: Monitoring for intent deviations and "A2A Contagion" alerts. (Added: 2026-03-07)
- [ ] **[P1] MCP Icon Support**: Visual rendering of service/tool icons in the explorer and playground. (Added: 2026-03-07)
