...
- [ ] **[P0] Resident Agent Dashboard**: Monitor and manage persistent agent identities and network presence (Added: 2026-03-06).
- [ ] **[P0] Economical Reasoning Overlay**: Visualize tool cost estimates and token efficiency directly in the UI (Added: 2026-03-06).
- [ ] **[P1] Unified Discovery Explorer**: Integrated UI for searching and discovering both MCP tools and A2A agents (Added: 2026-03-06).
