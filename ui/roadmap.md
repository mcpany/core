...
- [ ] **[P0] Bridge Sovereignty Status Monitor**: Real-time visualization of hardware-attested cross-environment tool calls. (Added: 2026-04-09)
- [ ] **[P0] Privacy-Preserving Handoff Workspace**: UI for reviewing anonymized task handoffs and ZK-proof status. (Added: 2026-04-09)
- [ ] **[P1] FRQ Node Reputation Browser**: Visual interface for monitoring collective tool safety scores across the mesh. (Added: 2026-04-09)
