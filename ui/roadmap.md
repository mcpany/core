...
- [ ] **[P0] Zero-Knowledge Discovery Proxy**: Secure UI for discovery-request filtering and ZKD-attestation status. (Added: 2026-06-28)
- [ ] **[P0] CRDT-Native Mailbox Dashboard**: Real-time visualization of gossip-based state propagation and sharded mailbox health. (Added: 2026-06-28)
