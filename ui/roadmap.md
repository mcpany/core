...
- [ ] **[P0] Privacy Masking Dashboard**: UI to configure masking rules and visualize tokenized data flows. (Added: 2026-03-07)
- [ ] **[P0] A2A Transaction Monitor**: Visual tracking of atomic agent handoffs and rollback events. (Added: 2026-03-07)
- [ ] **[P1] Goal-Verification Inspector**: Dashboard to compare swarm's current progress against original user intent. (Added: 2026-03-07)
