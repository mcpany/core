...
* [x] **Preset Sharable URL**: Generate a link to the playground with pre-
  filled arguments (using presets or query params) to easily share
...
* [ ] **[P0] Swarm Rollback Dashboard**: (2026-03-28) UI for managing swarm-
  wide state checkpoints and visualizing rollback effects.
...
* [ ] **[P1] CLAW-10 Compliance Dashboard**: Interactive matrix for
  visualizing system compliance with the CLAW-10 Enterprise Evaluation Matrix.
  (Added: 2026-04-13)
...
* [ ] **[P0] ASH Rollback Manager**: Visual workspace for managing swarm
  checkpoints and reviewing autonomous self-healing events. (Added:
  2026-04-19)
...
* [ ] **[P0] VTD Automation Workspace**: Dashboard for configuring autonomous
  delegation rules and reviewing automated handoff history. (Added:
  2026-04-15)
...
* [ ] **[P0] ContextEngine Lifecycle Visualizer**: Debugger for OpenClaw-
  native context hooks and state transitions (Added: 2026-04-23).
...
* [ ] **[P1] DSM Delegation Graph**: Interactive visualization of
  decentralized supervisor meshes and mission-root anchors. (Added:
  2026-05-07)
...
* [ ] **[P0] RAMS Isolation Monitor**: Enhanced visualization for intent-
  sealed Blackboard shards and memory boundary violations. (Added: 2026-05-06)
...
* [ ] **[P0] A2UI Delegation Approval Hub**: Hardened UI fragment for
  reviewing and signing high-risk multi-agent task delegations. (Added:
  2026-04-26)
...
* [ ] **[P0] DAP Enforcement Status Widget**: Security indicator for mandatory
  Deterministic Absence Proof compliance during agent boot. (Added:
  2026-04-25)
...
* [ ] **[P0] ContextEngine Plugin Manager**: UI for managing and monitoring
  pluggable ContextEngine strategies and sovereignty status. (Added:
  2026-04-24)

* [ ] **[P1] Zero-Trust Discovery Audit Log**: Visual log for tracking A2A
  capability card discovery requests and auth-gate actions. (Added:
  2026-04-24)
...
* [ ] **[P0] Mission-Root Persistence Monitor**: Real-time visual indicator
  for pinned intents and re-injection events (MRE defense). (Added:
  2026-05-18)
...
* [ ] **[P1] Intent-Weighted Compression Debugger**: UI for visualizing
  mission-anchored context summarization and token density. (Added:
  2026-05-18)
...
* [ ] **[P0] A2A Authenticated Discovery Manager**: Enhanced UI for managing
  and approving identity-bound agent cards in the A2A mesh. (Added:
  2026-05-17)
...
* [ ] **[P0] Swarm Attack Visualizer**: Real-time Gantt-style chart showing
  coordinated agent behavior and SAAD neutralization events. (Added:
  2026-05-14)
...
* [ ] **[P0] Routing Firewall Security Hub**: Dashboard for managing "Auth-at-
  the-Pipe" tokens and visualizing blocked routing attempts. (Added:
  2026-05-12)
...
* [ ] **[P0] Discovery Sandbox Monitor**: Real-time visualization of sandboxed
  discovery command execution and safety attestation status. (Added:
  2026-05-10)

* [ ] **[P0] DAP Continuous Audit Viewer**: UI for monitoring hardware-
  attested non-existence proofs across the session lifecycle. (Added:
  2026-05-10)
...
* [ ] **[P0] Permission Enforcement Monitor**: Real-time tracker for DPG-
  blocked tool calls and project-local policy violations. (Added: 2026-05-08)
...
* [ ] **[P0] Adaptive Reasoning Monitor**: Real-time visualization of
  `x-gemini-reasoning-effort` levels and dynamic compaction efficiency.
  (Added: 2026-04-22)
...
* [ ] **[P0] Foundation Governance Dashboard**: UI for reviewing cross-
  framework mission-root sovereignty and governance events. (Added:
  2026-05-26)
...
* [ ] **[P0] FAMI Fragment Auditor**: Security UI for inspecting and approving
  sharded mailbox fragments flagged by the isolation engine. (Added:
  2026-05-27)
...
* [ ] **[P0] Command Traceability Dashboard**: Visual "Chain of Command"
  tracer for auditing the hardware-attested lineage of agent tool calls.
  (Added: 2026-05-28)
...
* [ ] **[P0] Task-List Arbiter Workspace**: Real-time visualization of lock-
  free task-claiming in horizontal meshes. (Added: 2026-05-30)
...
* [ ] **[P0] Swarm Anomaly Visualizer**: Real-time Gantt-style chart showing
  coordinated agent behavior and CSAD neutralization events. (Added:
  2026-05-29)
...
* [ ] **[P0] Context Fragment Auditor**: UI for inspecting and approving
  sharded mailbox fragments flagged by the mesh-bound isolation engine.
  (Added: 2026-05-29)
...
* **Mission-Locked Execution (MLE) Visualizer**: (P0) Security UI for viewing and
auditing cryptographically locked tool calls and their mission-root lineage.
...
* [ ] **[P0] ARI Lineage Visualizer**: (P0) Real-time visualization of
  semantic hash-chains and logic grafting alerts in shared shards. (Added:
  2026-06-11)
...
* [ ] **[P0] Shadow Coordination Monitor**: (Re-affirmed P0) Enhanced
  dashboard for real-time visualization of entropy spikes in T2T transport
  metadata.
...
* **[P0] Side-Channel Entropy Monitor**: Real-time visualization of
steganographic coordination noise. (Added: 2026-06-14)

* **[P1] IDA Variance Dashboard**: Behavioral tracking of subagent stylometric
mimicry. (Added: 2026-06-14)
