...
- [ ] **[P0] Sandbox Security Dashboard**: Monitor and control sandboxed tool execution. (Added: 2026-02-27)
- [ ] **[P1] Local-First Memory Explorer**: UI for managing the agentic memory standard. (Added: 2026-02-27)
