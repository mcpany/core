...
- [ ] **[P0] Anomalous Activity Feed**: Dashboard widget for monitoring flagged tool calls and blocked hijacking attempts. (Added: 2026-03-02)
- [ ] **[P1] Tool Annotation Governance UI**: Visual editor for managing policies based on tool semantic annotations. (Added: 2026-03-02)
