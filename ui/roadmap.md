...
- [ ] **[P0] Shard Migration Manager**: (2026-07-25) UI for initiating and monitoring hardware-attested shard handovers.
- [ ] **[P0] Teammate Reflection Dashboard**: (2026-07-25) Real-time visualization of TRQ-mediated monologue cross-verification.
- [ ] **[P0] Attention Salience Map**: (2026-07-25) Visual tracker for SSAM-salted attention masks and blocked probing attempts.
- [ ] **[P1] Value-of-Thought Explorer**: (2026-07-25) Visualizer for hardware-attested EVoT metrics and economic reasoning efficiency.
