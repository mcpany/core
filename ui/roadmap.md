...
- [ ] **[P0] Wait-Graph Visualizer**: Real-time visualization of teammate dependencies and cycle-break resolution events. (Added: 2026-07-25)
- [ ] **[P0] Tunnel Latency Heatmap**: Visual monitor for STP-prefetched tunnels and mesh handshake efficiency. (Added: 2026-07-25)
- [ ] **[P0] GC-Immunity Manager**: UI for reviewing and pinning "Silent Anchors" to the attention window. (Added: 2026-07-25)
