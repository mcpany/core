...
- [ ] **[P0] Hardware Secret Manager**: UI for configuring TPM/Enclave-backed API keys. (Added: 2026-03-11)
- [ ] **[P0] A2A Protocol Monitor**: Real-time traffic monitoring for inter-agent A2A messages. (Added: 2026-03-11)
