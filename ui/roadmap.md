...
- [ ] **[P0] Mesh Revocation Workspace**: UI for reviewing and triggering consensus-bound tunnel revocation (CBTR). (Added: 2026-07-25)
- [ ] **[P0] Nested Lease Inspector**: Visual debugger for recursive capability leases and NLA-compliant lineage. (Added: 2026-07-25)
- [ ] **[P0] SRD Behavioral Dashboard**: Real-time visualization of high-dimensional reasoning manifolds and log-probability entropy. (Added: 2026-07-25)
- [ ] **[P1] Shard Prefetch Monitor**: Real-time visualization of speculative context loading and warmup efficiency. (Added: 2026-07-25)
