...
- [ ] **[P0] Ephemeral Secret Dashboard**: (2026-07-25) Visual tracker for shard-bound credentials and automated memory-wipe events.
- [ ] **[P0] Mission Reflection Auditor**: (2026-07-25) Authorization UI for reviewing and signing recursive subagent self-reflection audits.
- [ ] **[P0] Context Shifting Permanence Monitor**: (2026-07-25) Real-time visualization of CWSA-attested anchor stability during window shifts.
