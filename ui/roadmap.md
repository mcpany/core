...
- [ ] **[P0] Shard Rotation Dashboard**: (2026-07-25) Visualize Contextual Ephemerality, reasoning-path depth, and active shards.
- [ ] **[P0] Monologue Injection Alert Center**: (2026-07-25) Forensic UI for ARI v3 detected instruction injections and blocked intent merges.
- [ ] **[P1] Reflective Guardrail Manager**: (2026-07-25) UI for defining and monitoring hardware-attested non-negotiable mission constraints.
- [ ] **[P0] Specialist Privacy Console**: (2026-07-25) Authorization and audit UI for semantically redacted reasoning traces and mailbox fragments.
