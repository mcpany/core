...
- [ ] **[P0] Context Pressure Monitor**: Real-time visualization of tool schema token volume and threshold triggers. (Added: 2026-03-03)
- [ ] **[P0] Tool Annotation Editor**: UI for managing metadata and risk scores for registered MCP tools. (Added: 2026-03-03)
