...
- [ ] **[P0] Skill Passport Registry**: (2026-07-25) UI for browsing and verifying hardware-attested behavioral manifests for AI agent skills.
- [ ] **[P0] Epistemic Truth Receipts Viewer**: (2026-07-25) Dashboard for inspecting hardware-signed truth receipts and verifying tool state transitions.
- [ ] **[P1] Stylometric Phishing Alert Hub**: (2026-07-25) Real-time security dashboard for monitoring and responding to mimicry-based hijacking attempts.
