...
- [ ] **[P0] Session Migration Manager**: UI for initiating and tracking hardware-attested EASM session handovers. (Added: 2026-07-25)
- [ ] **[P1] Compact Token Status Widget**: Visual indicator for CCT compression rates and TPM attestation savings. (Added: 2026-07-25)
- [ ] **[P1] Reflection Quorum Workspace**: Dashboard for monitoring asynchronous teammate audits and speculative state commits. (Added: 2026-07-25)
- [ ] **[P0] Nested Shard Visualizer**: Interactive tree view for monitoring RSN nesting depths and intent-inversion alerts. (Added: 2026-07-25)
