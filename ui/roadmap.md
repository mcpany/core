...
- [ ] **[P0] RSR Redaction Auditor**: Visual workspace for reviewing and approving semantically redacted context shards. (Added: 2026-07-25)
- [ ] **[P0] Workspace Snapshot Gallery**: UI for managing hardware-locked EWS snapshots and performing point-in-time recovery. (Added: 2026-07-25)
- [ ] **[P1] Attention-Priority Quota Widget**: Real-time visualization of AAQ-scaled token budgets and attention heatmaps. (Added: 2026-07-25)
