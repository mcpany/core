...
- [ ] **[P0] PITTO Security Center**: Monitor and configure output sanitization rules and intercepted injection attempts. (Added: 2026-03-04)
- [ ] **[P0] Agent Identity Manager**: UI for issuing and revoking agent identities and auditing "On-Behalf-Of" actions. (Added: 2026-03-04)
- [ ] **[P1] ClawMesh Topology Map**: Visual representation of the P2P agent mesh and discovered tools. (Added: 2026-03-04)
