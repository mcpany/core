...
- [ ] **[P0] Intent Violation Dashboard**: Real-time alerts and reasoning traces for blocked "out-of-intent" tool calls. (Added: 2026-02-27)
- [ ] **[P1] Subagent Interactive Prompt**: Dedicated UI component for handling "Ask-the-User" requests from remote subagents. (Added: 2026-02-27)
- [ ] **[P2] State Branch Explorer**: Visual tree of parallel agent execution branches and their inherited state. (Added: 2026-02-27)
