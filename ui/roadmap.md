...
- [ ] **[P0] Reasoning Integrity & CAP Dashboard**: (2026-07-25) Real-time visualization of hardware-attested reasoning anchors and criteria-override events.
- [ ] **[P0] Teammate Barrier Monitor**: (2026-07-25) Visual tracker for kernel-mediated TBO barriers and epoch-based state synchronization.
- [ ] **[P0] HLDP Path Auditor**: (2026-07-25) Forensic UI for reviewing cryptographically bound decision paths against the mission-root manifest.
- [ ] **[P1] EMT Performance Overlay**: (2026-07-25) Real-time monitor for zero-copy mesh ticket performance and tunnel resumption latency.
