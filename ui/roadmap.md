...
- [ ] **[P0] Speculative Handoff Monitor**: (2026-07-25) Visual tracker for SHT issuance and background attestation status.
- [ ] **[P0] Task Dependency Shard Viewer**: (2026-07-25) Real-time visualization of the sharded teammate mailbox and lock-free claiming events.
- [ ] **[P0] Attention-Priority Status Widget**: (2026-07-25) Visual indicator for GC-Immune status of mission-root anchors.
