...
- [ ] **[P0] Hardened Schema Middleware Configuration**: UI for defining sanitization and redaction rules for tool outputs. (Added: 2026-02-27)
- [ ] **[P1] Virtual FS Explorer**: Audited explorer for the VFS bus, allowing developers to inspect A2A state. (Added: 2026-02-27)
