...
- [ ] **[P0] JIT Lease Manager**: UI for reviewing and approving dynamic capability lease requests. (Added: 2026-02-27)
- [ ] **[P0] Intent-Aware Tool Scorer**: Visual dashboard for monitoring tool relevance scores and discovery hits. (Added: 2026-02-27)
- [ ] **[P1] Swarm Data Mesh Explorer**: File browser for shared agent-to-agent data volumes. (Added: 2026-02-27)
