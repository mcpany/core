...
- [ ] **[P0] Anti-Hijack Security Monitor**: UI for managing trusted Origins and viewing blocked side-channel attempts. (Added: 2026-03-04)
- [ ] **[P0] Swarm Task Board**: A high-level view of all active agent-to-agent delegations and their status. (Added: 2026-03-04)
