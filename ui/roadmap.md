...
- [ ] **[P0] PoA Alignment Monitor**: Real-time visualization of Proof-of-Alignment (🦞/🦀) heartbeats across subagent tool calls. (Added: 2026-03-03)
- [ ] **[P0] Shadow-MCP Quarantine View**: UI for managing and approving/rejecting unauthorized MCP server connections. (Added: 2026-03-03)
