...
- [ ] **[P0] Agent Budget & Cost Dashboard**: Real-time visualization of agent session costs and budget enforcement status. (Added: 2026-03-09)
- [ ] **[P0] Mesh Capability Map**: Visual explorer for discovering agents and tools across the P2P mesh. (Added: 2026-03-09)
