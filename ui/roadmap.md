...
- [ ] **[P0] Swarm Migration Tracker**: Real-time visualization of agents "teleporting" between nodes in the mesh. (Added: 2026-07-25)
- [ ] **[P0] Proof Compression Dashboard**: Monitor for AAH latency savings and aggregate attestation health. (Added: 2026-07-25)
- [ ] **[P0] Multi-modal Lineage Auditor**: Forensic UI for inspecting RMP-signed visual and audio reasoning traces. (Added: 2026-07-25)
