...
- [ ] **[P0] SMA Identity Manager**: (2026-07-25) UI for reviewing and approving hardware-attested, mesh-resident agent identities.
- [ ] **[P0] RCP Logic Explorer**: (2026-07-25) Visualizer for semantic probability scores and "Context-Splicing v2" alerts.
- [ ] **[P0] Mailbox Lifecycle Auditor**: (2026-07-25) Forensic UI for monitoring hardware-locked mailbox cleanup events.
- [ ] **[P1] Root-Token Vault Monitor**: (2026-07-25) Status widget for visualizing hardware-bound mission-root token isolation.
