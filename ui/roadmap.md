...
- [ ] **[P0] Skill Attestation Viewer**: UI for checking tool verification status, behavioral contracts, and community reputation scores. (Added: 2026-03-03)
- [ ] **[P0] Sandbox Isolation Manager**: Interface for configuring Sidecar Execution settings per-tool or per-service. (Added: 2026-03-03)
- [ ] **[P1] Intent Token Explorer**: Visualization of the "High-Level Intent" hierarchy for multi-stage agent tasks. (Added: 2026-03-03)
