...
- [ ] **[P0] Project Trust Dashboard**: UI for managing project-aware tool scopes and trusting new repository directories. (Added: 2026-03-07)
- [ ] **[P0] Immutable Config Visualizer**: High-visibility indicator for settings protected by Config-Guard (e.g., restricted `BASE_URL`). (Added: 2026-03-07)
