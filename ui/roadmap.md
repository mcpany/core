...
- [ ] **[P0] Attention Heatmap Visualizer**: (2026-07-25) Real-time visualization of agent attention density and speculative shard migration events.
- [ ] **[P0] Lease Chain Explorer**: (2026-07-25) Visual debugger for hardware-chained sub-leases and recursive delegation hierarchies.
- [ ] **[P0] Shard Migration Status Widget**: (2026-07-25) Monitor for MTA-verified shard transfers and physical boundary attestation.
