...
- [ ] **[P0] Mesh Identity Manager**: UI for reviewing and approving hardware-attested, mesh-resident agent identities (MRIH). (Added: 2026-07-25)
- [ ] **[P0] Mailbox Integrity Auditor**: Forensic dashboard for reviewing coordinate messages and TMI-blocked injection attempts. (Added: 2026-07-25)
- [ ] **[P0] Mission Continuity Console**: Visual workspace for managing MRCB-mediated mission recovery and sovereignty persistence. (Added: 2026-07-25)
- [ ] **[P0] Sovereign Discovery Hub**: UI for reviewing masked capability cards and unmasking schemas via mission-handshakes. (Added: 2026-07-25)
