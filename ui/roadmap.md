...
- [ ] **[P0] Hardware Attestation Manager**: UI for managing hardware-bound identities and viewing attestation logs. (Added: 2026-03-01)
- [ ] **[P0] Sandbox Policy Editor**: Visual whitelist manager for the Fail-Closed Sandbox Guard. (Added: 2026-03-01)
