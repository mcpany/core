...
- [ ] **[P0] Identity-Based Policy Editor**: UI for defining and managing role-based tool access rules. (Added: 2026-03-03)
- [ ] **[P0] Tool Security Audit Dashboard**: Visualize "Hijack Scores" and quarantine status for discovered tools. (Added: 2026-03-03)
