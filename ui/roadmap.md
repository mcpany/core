...
- [ ] **[P0] Config Integrity Dashboard**: Visual verification of immutable configuration state and "Root of Trust" attestation. (Added: 2026-02-27)
- [ ] **[P1] Governor-Agent Triage View**: Dedicated interface for monitoring Governor-Agent decisions and overrides. (Added: 2026-02-27)
- [ ] **[P1] LSP Semantic Search Bar**: Enhanced tool search bar with support for LSP-based symbol and reference discovery. (Added: 2026-02-27)
