...
- [ ] **[P0] Local IPC Status Indicator**: Visual confirmation of secure socket/pipe connectivity (vs vulnerable TCP). (Added: 2026-03-01)
- [ ] **[P0] Untrusted Config Trust Flow**: Interactive modal for approving/rejecting project-local configurations. (Added: 2026-03-01)
