...
- [ ] **[P0] Action-Chain Sovereignty Monitor**: Real-time visualization of automated workflow sequences. (Added: 2026-07-25)
- [ ] **[P0] Metadata Sanitization Log**: Security dashboard for reviewing redacted coordination messages. (Added: 2026-07-25)
- [ ] **[P1] Post-Quantum Status Widget**: Monitor for quantum-resistant handshake status and mesh integrity. (Added: 2026-07-25)
