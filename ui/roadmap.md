...
- [ ] **[P0] Sanitization Violation Dashboard**: Real-time visualization and forensic analysis of blocked malicious tool calls. (Added: 2026-03-11)
- [ ] **[P1] Tool Fingerprint Inspector**: UI for verifying and managing cryptographic signatures of connected tools. (Added: 2026-03-11)
