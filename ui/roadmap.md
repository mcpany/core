...
- [ ] **[P0] Skill Reputation & Safety Score Overlay**: Display community reputation scores and safety ratings for discovered tools. (Added: 2026-03-11)
- [ ] **[P0] Cross-Environment Attestation Manager**: UI for managing Ed25519-signed handshakes and authorized cloud-to-local intent bridges. (Added: 2026-03-11)
