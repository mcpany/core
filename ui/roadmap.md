...
- [ ] **[P0] Ephemeral Tool Monitor**: Real-time tracking of short-lived MCP servers and their lifecycle. (Added: 2026-03-02)
- [ ] **[P0] Metadata Sanitization Logs**: Dedicated view for monitoring intercepted and sanitized tool metadata. (Added: 2026-03-02)
- [ ] **[P1] Side-Effect Policy Manager**: UI for configuring and verifying Zero-IO attestation policies. (Added: 2026-03-02)
