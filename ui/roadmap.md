...
- [ ] **[P0] Isolated Workspace Manager**: UI for tracking ephemeral agent workspaces, disk usage, and trust status. (Added: 2026-03-09)
- [ ] **[P1] Router Activity Monitor**: Real-time visualization of "Generalist" delegation decisions and sub-agent task routing. (Added: 2026-03-09)
