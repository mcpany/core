...
- [ ] **[P0] Intent-Aware Chain Visualizer**: Visualization of tool call sequences with security "drift" alerts. (Added: 2026-02-27)
- [ ] **[P1] Multimodal Threat Dashboard**: Security view for results of image/PDF payload sanitization. (Added: 2026-02-27)
