...
- [ ] **[P0] Trust Escalation Dashboard**: Real-time visualization of agent "Probation" timers and "Time-to-Trust" status. (Added: 2026-03-02)
- [ ] **[P1] Wildcard Policy Editor**: Visual interface for managing pattern-based tool and server ACLs. (Added: 2026-03-02)
