...
- [ ] **[P0] Compliance Sovereignty Dashboard**: (2026-07-25) Real-time visual tracker for ASIA-attested AI inventory and regulatory risk classification.
- [ ] **[P0] Plugin Provenance Explorer**: (2026-07-25) Visual debugger for reviewing the cryptographic lineage of dynamic plugin upgrades.
- [ ] **[P1] Audit-Aware Metadata Inspector**: (2026-07-25) Forensic UI for inspecting compliance-bound metadata on inter-node tool calls.
