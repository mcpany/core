...
- [ ] **[P0] WebSocket Origin Manager**: UI for configuring and monitoring strict origin validation for WebSocket connections. (Added: 2026-03-08)
- [ ] **[P0] Egress Policy Viewer**: Interactive dashboard to view and manage network allow-lists for specific tools. (Added: 2026-03-08)
- [ ] **[P1] "Sugar-Coated Poison" Alerts**: Security notification system for flagging tools with suspicious signatures. (Added: 2026-03-08)
