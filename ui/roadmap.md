...
- [ ] **[P0] Memory Poisoning Alerts**: Real-time notification and visualization of quarantined state in the Blackboard Immune System. (Added: 2026-03-10)
- [ ] **[P0] Confused Deputy Visualization**: Visual audit trail showing how tool calls map to human-attested session intents. (Added: 2026-03-10)
- [ ] **[P1] Encrypted State Manager**: UI for managing local encryption keys and viewing encrypted persistence status. (Added: 2026-03-10)
