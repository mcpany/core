...
- [ ] **[P1] Cost & Budget Dashboard**: Visualize estimated vs actual tool call costs and session budgets. (Added: 2026-03-07)
- [ ] **[P1] Semantic Memory Browser**: Search and inspect tool outputs stored in the semantic cache. (Added: 2026-03-07)
