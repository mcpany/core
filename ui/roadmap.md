...
- [ ] **[P0] Tunnel Chain Inspector**: (2026-07-25) Visual debugger for verifying the nested hardware signatures of multi-hop RTA tunnels.
- [ ] **[P0] Entanglement Risk Heatmap**: (2026-07-25) Real-time visualization of CES scores and blocked logic-ghosting attempts.
- [ ] **[P0] Agency Initiation Dashboard**: (2026-07-25) UI for monitoring and approving mission-root handshakes and interdicted shadow-handshakes.
- [ ] **[P0] Priority Coordination Monitor**: (2026-07-25) Visual tracker for PAMS-driven interrupt signals and mailbox contention gains.
