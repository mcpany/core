...
- [ ] **[P0] Background Task Monitor**: (Added: 2026-02-27) UI for tracking asynchronous tool jobs and detached workers.
- [ ] **[P0] Security Origin Dashboard**: (Added: 2026-02-27) Visibility into client origins and request signing status.
