...
- [ ] **[P0] RIP Swarm Reaper Dashboard**: (2026-07-25) Real-time visualization of pruned branches, reclaimed mission budgets, and termination reasons.
- [ ] **[P0] Federated Scratchpad Monitor**: (2026-07-25) Visual tracker for cross-node scratchpad synchronization and SNT tunnel throughput.
- [ ] **[P0] Multimodal Anchor Heatmap**: (2026-07-25) Visual indicator for MMIA-pinned fragments and their relative attention-priority in the window.
- [ ] **[P1] Speculative Probe Alert Center**: (2026-07-25) Security UI for reviewing blocked tool-probes and metadata leaks from speculative branches.
