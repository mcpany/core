...
- [ ] **[P0] Secure Transport Monitor**: UI indicator for tool connection type (e.g., "Isolated Pipe" vs "Networked"). (Added: 2026-02-27)
- [ ] **[P0] Attestation Verification Badge**: Visual "Verified" badge on tool cards with drill-down to publisher identity and signature details. (Added: 2026-02-27)
