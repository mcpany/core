...
- [ ] **[P0] Identity Pulse Monitor (UI-2026-06-21)**: Real-time visualization of CAP heartbeats and session binding health.
- [ ] **[P1] Consensus Deadlock Visualizer (UI-2026-06-21)**: Graph view showing circular reasoning dependencies and resolution paths.
- [ ] **[P0] HAIR Lineage Visualizer (UI-2026-06-20)**: Forensic UI for reconstructing and verifying mission-root intents.
