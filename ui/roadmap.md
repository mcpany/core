...
- [ ] **[P0] Skill Sandbox & Approval UI**: Granular permission management and real-time approval flow for agent skills. (Added: 2026-03-09)
- [ ] **[P1] Omni-Context Synchronization Dashboard**: Visual management of cross-framework instruction files (`CLAUDE.md`, etc.). (Added: 2026-03-09)
- [ ] **[P1] Universal Command Mapping Interface**: UI for configuring how MCP tools map to native slash commands and hooks. (Added: 2026-03-09)
