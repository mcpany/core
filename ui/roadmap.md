...
- [ ] **[P0] Intent Routing Visualizer**: Dashboard to monitor how intent affects tool ranking and selection. (Added: 2026-03-03)
- [ ] **[P0] Secure Import Portal**: UI for verifying and authorizing "One-Click" configuration imports via attested deeplinks. (Added: 2026-03-03)
- [ ] **[P1] Cost/Performance Tooltip Extensions**: Live telemetry overlays for tool execution cards. (Added: 2026-03-03)
