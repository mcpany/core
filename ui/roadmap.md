...
- [ ] **[P0] Swarm Pulse Dashboard**: Real-time visualization of parallel tool calls, throttling events, and swarm quota usage. (Added: 2026-03-11)
- [ ] **[P1] Skill Playbook Manager**: UI for uploading, validating, and activating `.SKILL.md` files. (Added: 2026-03-11)
