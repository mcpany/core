...
- [ ] **[P0] Schema Harmonization Configurator**: UI for managing model-specific tool transformation rules. (Added: 2026-03-01)
- [ ] **[P0] A2A Message Residency UI**: Persistent mailbox viewer for A2A messages across the agent mesh. (Added: 2026-03-01)
- [ ] **[P1] Swarm Snapshot Manager**: UI for creating and restoring full swarm state snapshots. (Added: 2026-03-01)
