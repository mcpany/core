...
- [ ] **[P0] Shard-Level Rollback Manager**: (2026-07-25) UI for reviewing and triggering ARC-mediated task-specific state rollbacks.
- [ ] **[P0] Entropy Heatmap Visualizer**: (2026-07-25) Dashboard for monitoring CES-mediated memory isolation and reasoning entropy scores.
- [ ] **[P1] ZK-Intent Justification Console**: (2026-07-25) Workspace for reviewing hardware-attested justification tokens during remote discovery.
