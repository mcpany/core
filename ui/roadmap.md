...
- [ ] **[P0] Security Perimeter Dashboard**: Visualize WebSocket origin filtering status and blocked unauthorized local attempts. (Added: 2026-03-06)
- [ ] **[P0] A2A Identity Manager**: UI for managing and verifying authenticated agent identities for A2A discovery. (Added: 2026-03-06)
