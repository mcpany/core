...
- [ ] **[P0] Attention-Splicing Entropy Map**: (2026-07-25) Real-time heatmap for visualizing linguistic entropy anomalies and ASF detection alerts.
- [ ] **[P0] Predictive Prefetch Dashboard**: (2026-07-25) Visual tracker for PCP prefetch hit rates and speculative buffer status.
- [ ] **[P0] Provenance Watermark Inspector**: (2026-07-25) Forensic UI for verifying RPW-compliant watermarks in compacted reasoning traces.
- [ ] **[P0] Mission Ticket Monitor**: (2026-07-25) Status indicator for FPMR-bound mission tickets and cold-start latency gains.
