...
- [ ] **[P0] Local Sovereignty Status Hub**: (2026-03-22) Real-time visualization of LSG authentication status and origin validation alerts.
- [ ] **[P0] Reasoning-Action Lineage Explorer**: (2026-03-22) Forensic UI for visualizing the RAC-attested correlation between reasoning and tools.
- [ ] **[P0] Spectral Jitter Monitor**: (2026-03-22) Monitor for hardware-attested timing jitter injected by the SCTM.
