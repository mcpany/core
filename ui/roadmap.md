...
- [ ] **[P0] Security Audit Dashboard**: UI for visualizing results of deep MCP upstream audits. (Added: 2026-02-27)
- [ ] **[P0] Seatbelt Profile Manager**: Interface for configuring and toggling session-bound safety seatbelts. (Added: 2026-02-27)
- [ ] **[P1] SessionContext Inspector**: Visual debugger for tracking session-bound context propagation. (Added: 2026-02-27)
- [ ] **[P1] Compaction Performance Overlay**: Real-time stats on token savings from auto-compaction. (Added: 2026-02-27)
