...
- [ ] **[P0] Workload Identity Monitor**: (2026-07-25) Real-time visualization of AWI token rotation and semantic workload transitions.
- [ ] **[P0] Shadow-Tunnel Sanitization Log**: (2026-07-25) Security dashboard for reviewing metadata stripped by the STI middleware.
- [ ] **[P1] Sharded Budget Heatmap**: (2026-07-25) Visual tracker for CBTS-bound reasoning budgets and cross-mission consumption alerts.
