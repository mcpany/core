...
- [ ] **[P0] Sanitization Audit Log Viewer**: Detailed view of blocked tool calls and sanitization triggers. (Added: 2026-03-04)
- [ ] **[P0] Subagent Sandbox Manager**: UI for monitoring and managing ephemeral sandbox lifecycles. (Added: 2026-03-04)
