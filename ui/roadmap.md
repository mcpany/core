...
- [ ] **[P1] RAMR Status Overlay**: (2026-07-25) Visual indicator of current inter-node routing path (Fast-Path vs. Sovereign).
- [ ] **[P0] Collaborative Conflict Visualizer**: (2026-07-25) CRDT-aware diff viewer for shared teammate workspaces, highlighting hardware-attested edits.
- [ ] **[P0] Intent Bundle Inspector**: (2026-07-25) UI for reviewing ZTIP-isolated environment variables before sub-agent delegation.
- [ ] **[P0] Risk-Adaptive Attestation Widget**: (2026-07-25) Real-time monitor for dynamic attestation depth and coordination latency gains.
