...
- [ ] **[P0] Worktree Enclave Monitor**: (2026-07-25) Visual indicator for hardware-locked worktree status and blocked hook executions.
- [ ] **[P0] Reasoning-Echo Alert Center**: (2026-07-25) Real-time visualization of mimicry scores and redacted reasoning fragments.
- [ ] **[P0] Phase-Locked Coordination Tracker**: (2026-07-25) Forensic UI for visualizing monotonic coordination tokens and identifying replay attempts.
