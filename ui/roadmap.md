...
- [ ] **[P0] Agentic Loop Visualizer**: Waterfall and cycle detection UI for ALOD. (Added: 2026-03-01)
- [ ] **[P0] Context Attestation Status**: Security badges for signed/verified context in the trace view. (Added: 2026-03-01)
- [ ] **[P1] State Rollback Controls**: UI to manually trigger or confirm automated state rollbacks. (Added: 2026-03-01)
