...
- [ ] **[P0] Hook Sandbox Monitor**: Real-time visualization of sandboxed hook execution and security violations. (Added: 2026-03-09)
- [ ] **[P1] Semantic Policy Designer**: UI for creating policies based on tool annotations and semantic categories. (Added: 2026-03-09)
- [ ] **[P1] Interactive Terminal Proxy**: Web-based terminal component for interacting with proxied CLI tools. (Added: 2026-03-09)
