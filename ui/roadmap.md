...
- [ ] **[P0] JIT Permission Manager**: UI for reviewing active session escalations and managing temporary capability grants. (Added: 2026-03-05)
- [ ] **[P1] Sanitization Audit Log**: Visualizer for redacted tool outputs to allow admins to see what was scrubbed. (Added: 2026-03-05)
