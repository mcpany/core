...
- [ ] **[P0] A2A Handoff Visualizer**: Sequence diagrams for multi-agent task handoffs via the A2A Adapter. (Added: 2026-02-27)
- [ ] **[P1] Discovery Latency Heatmap**: Visual visualization of tool discovery performance across federated nodes. (Added: 2026-02-27)
- [ ] **[P1] Privacy Redaction Monitor**: UI for auditing and configuring context pruning rules for A2A handoffs. (Added: 2026-02-27)
