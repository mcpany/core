...
- [ ] **[P0] IBAC Intent Violation Monitor**: Real-time dashboard for semantic security alerts and blocked "Out-of-Intent" actions. (Added: 2026-03-03)
- [ ] **[P1] OpenClaw Capability Shield**: Dedicated UI for configuring system-level permission bounds for OpenClaw adapters. (Added: 2026-03-03)
