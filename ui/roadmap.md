...
- [ ] **[P0] EMI Rotation Monitor**: (2026-07-25) Real-time visualization of per-call identity rotation and monotonic counter status.
- [ ] **[P0] Entropy-Convergence Dashboard**: (2026-07-25) Visual tracker correlating reasoning entropy spikes with mission convergence to flag squatted leases.
- [ ] **[P0] OLP Attestation Viewer**: (2026-07-25) Security workspace for verifying output-linked ZK-proofs and detecting context-grafting attempts.
