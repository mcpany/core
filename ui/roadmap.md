...
### Upcoming: [2026-07-25]
- [ ] **[P0] Swarm Rollback Dashboard**: Visual workspace for DRC-mediated state recovery and rewinding. (Added: 2026-07-25)
- [ ] **[P0] Contextual Entropy Monitor**: Real-time visualization of CEG-filtered tool outputs and noise levels. (Added: 2026-07-25)
- [ ] **[P0] Economic Provenance Viewer**: Visual tracker for HATL-bound token consumption and mission-root budgets. (Added: 2026-07-25)
- [ ] **[P0] Hardware Lease Status Hub**: Real-time monitor for active and expired MBHL leases. (Added: 2026-07-25)
