...
- [ ] **[P0] Skill Workspace Sandbox Monitor**: Real-time visualization of filesystem access and sandbox violation alerts. (Added: 2026-03-03)
- [ ] **[P1] Multimodal Transport Viewer**: UI components for previewing rich tool data (Audio waveforms, PDF embeds) in the playground. (Added: 2026-03-03)
- [ ] **[P1] SecretRef Credential Manager**: Interface for securely managing and referencing credentials within tool configurations. (Added: 2026-03-03)
