...
- [ ] **[P0] Swarm Consistency Heatmap**: Visualize tool version drift and unverified schemas across decentralized swarms. (Added: 2026-03-05)
- [ ] **[P1] State Handoff Inspector**: Debugger for cross-framework state snapshots and handoff tokens. (Added: 2026-03-05)
