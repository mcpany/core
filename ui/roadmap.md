...
- [ ] **[P0] Ephemeral Discovery Monitor**: (2026-07-25) Real-time visualization of single-use discovery tokens and their expiration status.
- [ ] **[P0] Atomic Scratchpad Inspector**: (2026-07-25) UI for visualizing kernel-level locks and write-access on shared teammate workspaces.
- [ ] **[P0] Attention Entropy Scoreboard v2**: (2026-07-25) Advanced dashboard for monitoring noise-pruning in 2M+ token context windows.
- [ ] **[P1] Identity Resumption Dashboard**: (2026-07-25) Monitor for hardware-locked trust renewals and mission continuity events.
