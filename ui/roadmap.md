...
- [ ] **[P0] Epistemic Governance Console**: (2026-07-25) Workspace for monitoring reflection quorums and EUM confidence scores.
- [ ] **[P0] Attention Persistence Monitor**: (2026-07-25) Real-time visualization of re-injected guardrail anchors and attention-health scores.
- [ ] **[P0] Hierarchical Continuity Dashboard**: (2026-07-25) Visual indicator for HIL-bound mission branches and their persistent state status.
- [ ] **[P1] Autonomous Compliance Stream**: (2026-07-25) Real-time feed of ACA audit events and manifest-matching alerts.
