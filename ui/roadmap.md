...
- [ ] **[P0] Predictive Tunnel Heatmap**: (2026-07-25) Real-time visualization of intent-driven tunnel pre-warming and latency reduction.
- [ ] **[P0] Attention Refresh Monitor**: (2026-07-25) Status indicator for active AAR Controller cycles and anchor retention scores.
- [ ] **[P0] Mission Priority Dashboard**: (2026-07-25) Visual tracker for DCP urgency tokens and circular dependency resolution events.
- [ ] **[P0] Replay Shield Status Widget**: (2026-07-25) Real-time monitor of monotonic nonce validation for mesh resumption tickets.
