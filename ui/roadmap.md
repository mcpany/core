...
- [ ] **[P0] Audit-First Violation Feed**: Real-time view of sanitized or blocked tool calls with security insights. (Added: 2026-03-01)
- [ ] **[P0] Provenance-Aware State Explorer**: Visualize the Shared Blackboard with agent trust scores and ownership metadata. (Added: 2026-03-01)
- [ ] **[P1] Local Network Quarantine Map**: Dashboard showing discovered "Shadow" MCP servers and their security status. (Added: 2026-03-01)
