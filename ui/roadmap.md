...
- [ ] **[P0] Memory Protection Heatmap**: (2026-07-25) Real-time visualization of "Frozen" memory regions and KRTP lock status.
- [ ] **[P0] Refinement Entropy Dashboard**: (2026-07-25) Visual tracker for mission-drift entropy scores and turn-limit consumption.
- [ ] **[P0] Attention Snapshot Manager**: (2026-07-25) Workspace for reviewing and restoring hardware-attested CNAR context recovery maps.
