...
- [ ] **[P0] Local Trust Verification Dashboard**: UI for reviewing and signing local MCP server identity claims. (Added: 2026-04-05)
- [ ] **[P0] Optimistic Loading Debugger**: Visual timeline of speculative vs. attested tool loading events. (Added: 2026-04-05)
- [ ] **[P1] RL Feedback Stream Viewer**: Real-time telemetry dashboard for monitoring RL training data export. (Added: 2026-04-05)
- [ ] **[P0] DCA Negotiation Dashboard**: Real-time visualization of subagent bidding and HAN broker latency. (Added: 2026-04-04)
- [ ] **[P0] Metadata Provenance Viewer**: UI for verifying the cryptographic lineage and signing status of tool metadata. (Added: 2026-04-04)
- [ ] **[P0] Metadata Poisoning Alert Hub**: Security dashboard for reviewing and approving redacted metadata fragments. (Added: 2026-04-04)
- [ ] **[P1] Lifecycle Synchronization Monitor**: Visual tracker for cross-framework state commit/rollback events. (Added: 2026-04-04)
- [ ] **[P0] Subagent Reaper Dashboard**: Real-time visualization of agent heartbeats and termination events for "Ghost" subagents. (Added: 2026-04-03)
- [ ] **[P0] Metadata Poisoning Alert Center**: Security UI for inspecting tool structural metadata flagged for context poisoning instructions. (Added: 2026-04-03)
- [ ] **[P1] DCA Auction Monitor**: Visual tracker for agent capability bidding and allocation latency. (Added: 2026-04-03)
- [ ] **[P0] Speculative State Inspector**: UI for visualizing speculative tool results and tracking rollback events. (Added: 2026-04-02)
- [ ] **[P0] Inode Pinning Dashboard**: Real-time monitor of pinned hardware Inodes and blocked racing attempts. (Added: 2026-04-02)
- [ ] **[P0] Branch Purity Visualizer**: Gantt-style view of reasoning branches with state leakage alerts. (Added: 2026-04-02)
- [ ] **[P1] Consensus Delegation Console**: UI for managing and reviewing delegated authority tokens for time-critical tasks. (Added: 2026-04-02)
- [ ] **[P0] Path Normalization Guard**: (2026-04-01) Visual debugger for symlink resolution and path normalization traces. (Added: 2026-04-01)
- [ ] **[P0] Context Shifting Timeline**: (2026-04-01) Real-time visualization of Reasoning-Bound Context shifts and alignment scores. (Added: 2026-04-01)
- [ ] **[P1] Optimistic Loading Monitor**: (2026-04-01) Dashboard for tracking pre-loaded capabilities and their final attestation status. (Added: 2026-04-01)
- [ ] **[P0] IPSC Correction Monitor**: (2026-03-30) Real-time dashboard for visualizing agent self-correction cycles, budget consumption, and "Cognitive Lock" alerts. (Added: 2026-03-30)
- [ ] **[P0] BSH Continuous Integrity Viewer**: (2026-03-30) Forensic UI for inspecting Binary State Handoffs for "Dormant" or "Ghost" fragments. (Added: 2026-03-30)
- [ ] **[P1] Beacon Discovery Dashboard**: (2026-03-30) UI for monitoring reactive "Capability Beacons" and managing discovery noise filters. (Added: 2026-03-30)
- [ ] **[P0] RIS Hierarchical Intent Viewer**: (2026-03-29) Visual debugger for UACO v2.0 hierarchical intent trees and mutation boundaries. (Added: 2026-03-29)
- [ ] **[P0] Hardware Trust Status Widget**: (2026-03-29) Real-time monitor for SEP/TPM attestation status and HAFP session health. (Added: 2026-03-29)
- [ ] **[P1] State Alignment Monitor**: (2026-03-29) Visualization of agent-local state vs. global Blackboard, highlighting drift and alignment events. (Added: 2026-03-29)
- [ ] **[P1] Context Pinning Configuration UI**: (2026-03-29) Dashboard for defining and managing immutable prompt segments. (Added: 2026-03-29)
- [ ] **[P0] Parallel Intent Visualizer**: (2026-03-31) Real-time Gantt-style chart showing parallel sub-intent branches, barrier status, and merge events. (Added: 2026-03-31)
- [ ] **[P0] Symlink Security Inspector**: (2026-03-31) Dashboard for visualizing resolved project paths and flagging unauthorized symlink traversals. (Added: 2026-03-31)
- [ ] **[P1] Federated Quorum Monitor**: (2026-03-31) Security UI for tracking CDQ attestation progress and consensus status for remote tool beacons. (Added: 2026-03-31)
- [ ] **[P0] Swarm Rollback Dashboard**: (2026-03-28) UI for managing swarm-wide state checkpoints and visualizing rollback effects. (Added: 2026-03-28)
- [ ] **[P0] UACO-MAQ Quorum Monitor**: (2026-03-28) Security dashboard for orchestrating multi-agent approval quorums across frameworks. (Added: 2026-03-28)
- [ ] **[P0] Fast-Path Attestation Visualizer**: (2026-03-28) Real-time monitor of hardware-accelerated trust sessions and latency gains. (Promoted to P0 on 2026-03-29) (Added: 2026-03-28)
- [ ] **[P1] Context Smearing Alert Center**: (2026-03-28) UI for inspecting BSH fragments flagged for potential "Ghost Fragment" injections. (Added: 2026-03-28)
- [ ] **[P0] Live Context Shard Manager**: (2026-03-27) Dashboard for visualizing addressable shards, active mounts, and memory usage. (Added: 2026-03-27)
- [ ] **[P0] Consensus Attestation Workspace**: (2026-03-27) Workspace for monitoring multi-agent approvals and consensus status for high-risk actions. (Added: 2026-03-27)
- [ ] **[P1] PNTD Registry Browser**: (2026-03-27) Unified UI for browsing capabilities across MCP, gRPC, and UACO transports. (Added: 2026-03-27)
- [ ] **[P1] Shard-Aware Performance Heatmap**: (2026-03-27) Real-time visualization of shard hit/miss rates and transport latency. (Added: 2026-03-27)
- [ ] **[P0] Context Hook Interop Viewer**: (2026-03-26) Visualize how MCP Any state maps to external framework lifecycle hooks (e.g., OpenClaw). (Added: 2026-03-26)
- [ ] **[P0] RID Delegation Graph**: (2026-03-26) Interactive visualization of UACO v1.8 intent lineages, showing depth limits and mutation boundaries. (Added: 2026-03-26)
- [ ] **[P0] WASM Sanitization Dashboard**: (2026-03-26) Monitor and configure active WASM-BSH sanitization rules and rejected buffers. (Added: 2026-03-26)
- [ ] **[P0] WASM-BSH Sanitizer Dashboard**: (2026-03-25) UI for managing WASM sanitization rules and viewing rejected binary context fragments. (Added: 2026-03-25)
- [ ] **[P0] Zero-Copy Transport Monitor**: (2026-03-25) Real-time performance metrics for memory-mapped BSH buffers. (Added: 2026-03-25)
- [ ] **[P0] RID Lineage Inspector**: (2026-03-25) Security UI for visualizing UACO v1.8 recursive delegation depths and mutation boundaries. (Added: 2026-03-25)
- [ ] **[P1] Predictive Locking Visualizer**: (2026-03-25) Gantt-style view of projected Blackboard resource locks based on agent intents. (Added: 2026-03-25)
...
- [ ] **[P0] Ghost Shell Safety Reporter**: (2026-03-24) UI for viewing behavioral profiling results and safety scores for un-attested configuration hooks. (Added: 2026-03-24)
- [ ] **[P1] BSH Delta Debugger**: (2026-03-24) Developer tool for inspecting binary state differentials during agent handoffs. (Added: 2026-03-24)
- [ ] **[P0] Proof-of-Intent (PoI) Inspector**: (2026-03-23) Security dashboard for visualizing the cryptographic link between signed intents and tool calls. (Added: 2026-03-23)
- [ ] **[P0] Skill Grafting Attestation UI**: (2026-03-23) Multi-signature approval flow for dynamic tool loading and skill grafting. (Added: 2026-03-23)
- [ ] **[P0] Binary Handoff Performance Monitor**: (2026-03-23) Real-time metrics for BSH transport. (Promoted to P0 on 2026-03-24) (Added: 2026-03-23)
- [ ] **[P0] Agentic SLA Monitor**: (2026-03-22) Real-time tracking of token budgets and reasoning timeouts during UACO delegations. (Added: 2026-03-22)
- [ ] **[P0] Ghost Shell Profiling Viewer**: (2026-03-22) Security dashboard for reviewing behavioral reports generated by the Ghost Shell sandbox. (Added: 2026-03-22)
- [ ] **[P1] Federated Governance Dashboard**: (2026-03-22) UI for managing policy synchronization across multiple MCP Any nodes. (Added: 2026-03-22)
- [ ] **[P0] CAC Attestation Workspace**: (2026-03-21) UI for hashing and approving project-local configuration fragments (hooks/WASM). (Added: 2026-03-21)
- [ ] **[P0] UACO v1.5 RCC Monitor**: (2026-03-21) Security dashboard for reviewing agent Resource Capability Claims during handoffs. (Added: 2026-03-21)
- [ ] **[P1] L4 Traffic Security Heatmap**: (2026-03-21) Real-time visualization of DNS/ICMP packets from agents, flagged by anomaly detection. (Added: 2026-03-21)
- [ ] **[P1] Hardware Trust Status Widget**: (2026-03-21) Monitor for TPM/Secure Enclave attestation status for headless agents. (Added: 2026-03-21)
- [ ] **[P0] Ephemeral Trust Status Monitor**: (2026-03-20) Visual dashboard for monitoring active desktop-session bridges and headless agent attestation status. (Added: 2026-03-20)
- [ ] **[P0] Blackboard Lineage Inspector**: (2026-03-20) Forensic UI for visualizing the cryptographic audit trail of Shared KV Store operations. (Added: 2026-03-20)
- [ ] **[P1] UACO Bid Safety Analyzer**: (2026-03-20) Real-time visualization of agent bid profiles and behavioral anomaly scores during task negotiation. (Added: 2026-03-20)
- [ ] **[P1] Config Smuggling Alert Center**: (2026-03-20) Detailed scanner output for project-local configurations, highlighting hidden metadata/binary hooks. (Added: 2026-03-20)
- [ ] **[P0] UACO Negotiation Dashboard**: (2026-03-19) Visual interface for monitoring agent task bidding and handoffs. (Added: 2026-03-19)
- [ ] **[P1] RL Feedback & Telemetry Viewer**: (2026-03-19) Real-time stream of conversation-feedback and performance metrics for RL training. (Added: 2026-03-19)
- [ ] **[P1] Enterprise Governance Center**: (2026-03-19) UI for managing organization-wide security policies and synchronizing allowed-origin lists. (Added: 2026-03-19)
- [ ] **[P0] Local Security Violation Monitor**: (2026-03-18) Real-time visualization of blocked origin requests and loopback violations. (Added: 2026-03-18)
- [ ] **[P0] Recursive Loop Circuit Breaker UI**: (2026-03-18) Interactive dashboard for visualizing and managing recursive call limits in swarms. (Added: 2026-03-18)
- [ ] **[P0] UAB Task Verification Workspace**: (2026-03-18) Tool for reviewing and attesting to UAB-native task cards during delegation. (Added: 2026-03-18)
...
- [ ] **[P0] Inter-Agent Mailbox Monitor**: (2026-03-17) Visual tracking and security auditing of teammate-to-teammate coordination messages. (Added: 2026-03-17)
- [ ] **[P1] RL Reward Attestation Viewer**: (2026-03-17) UI for monitoring verifiable binary rewards and reasoning optimization metrics. (Added: 2026-03-17)
- [ ] **[P0] Cross-Framework Identity Map**: (2026-03-16) UI for managing and visualizing agent identity mappings between frameworks. (Added: 2026-03-16)
- [ ] **[P0] Origin Violation Real-time Monitor**: (2026-03-16) Security dashboard for tracking and approving blocked browser-origin requests. (Added: 2026-03-16)
- [ ] **[P1] UAB Task Card Inspector**: (2026-03-16) Visual tool for inspecting and debugging UAB-native task cards during delegation. (Added: 2026-03-16)
- [ ] **[P0] Recursive Loop Heatmap**: (2026-03-15) Visualization of tool-to-tool call graphs with real-time loop detection alerts. (Added: 2026-03-15)
- [ ] **[P0] Context Chain Inspector**: (2026-03-15) Security UI for verifying the cryptographic signatures of subagent context lineages. (Added: 2026-03-15)
- [ ] **[P1] UAB Protocol Bridge Status**: (2026-03-15) Monitor for task handoffs across different agent frameworks using the UAB adapter. (Added: 2026-03-15)
- [ ] **[P0] Browser Security Status Widget**: (2026-03-14) Real-time monitor of Origin-Validation status and blocked cross-site attempts. (Added: 2026-03-14)
...
- [ ] **[P0] Config Attestation Signature Reviewer**: (2026-03-11) UI for verifying and signing project-local configuration blocks. (Added: 2026-03-11)
- [ ] **[P0] Config Sandbox Monitor**: (2026-03-10) Real-time visualization of sandboxed hook execution, logs, and resource limits. (Added: 2026-03-10)
- [ ] **[P1] Config Drift Alert System**: (2026-03-10) UI notification and diff viewer for modified project-local configuration files requiring re-attestation. (Added: 2026-03-10)
- [ ] **[P0] Project Config Attestation Dashboard**: (2026-03-09) UI for reviewing and approving project-local configuration blocks (hooks/auto-execute). (Added: 2026-03-09)
- [ ] **[P0] Blackboard Isolation Inspector**: (2026-03-09) Visualize and debug Agent-Bound Blackboard data across different "Intent Scopes." (Added: 2026-03-09)
- [ ] **[P0] Connectivity & Security Dashboard**: (2026-02-28) Visualize local-only vs remote exposure, attestation status, and active MFA sessions. (Added: 2026-02-28)
- [ ] **[P0] Stateful A2A Mailbox**: (2026-02-28) UI for viewing queued and delivered A2A messages across the agent mesh. (Added: 2026-02-28)
- [ ] **[P0] Agent Chain Tracer (A2A)**: (2026-02-26) Visual timeline of multi-agent handoffs and message passing. (Added: 2026-02-26)
- [ ] **[P1] Federated Node Manager**: (2026-02-26) UI for peering with remote MCP Any instances and managing shared tool access. (Added: 2026-02-26)
- [ ] **[P1] Resource Cost/Latency Overlay**: (2026-02-26) Real-time performance metrics displayed directly on tool cards. (Added: 2026-02-26)
- [ ] **[P0] Lazy-MCP Tool Search Dashboard**: (2026-02-25) UI for managing the on-demand tool index and monitoring search hits/misses. (Added: 2026-02-25)
- [ ] **[P0] Supply Chain Attestation Viewer**: (2026-02-25) Security dashboard for verifying the provenance and cryptographic signatures of connected MCP servers. (Added: 2026-02-25)
- [ ] **[P0] Multi-Agent Session Timeline**: (2026-02-24) Visual tracking of agent handoffs and shared tool state. (Added: 2026-02-24)
- [ ] **[P1] Unified Discovery Manager**: (2026-02-24) UI for managing and auto-discovering MCP servers across transports. (Added: 2026-02-24)
- [ ] **[P0] Recursive Context Dashboard**: (2026-02-23) Visualize state inheritance and session tokens across agent swarms. (Added: 2026-02-23)
...
- [ ] **Robust Mocking Strategy**: Extend the mocking strategy used in Settings E2E tests to other critical E2E flows (Services, Tools) so that the UI can be developed and tested without a running backend.
