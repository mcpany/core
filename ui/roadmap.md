...
- [ ] **[P0] Isolated Execution Monitor**: UI for managing Docker-bound MCP servers and inspecting resource limits/mounts. (Added: 2026-02-26)
- [ ] **[P0] MCP App Component Renderer**: Support for rendering interactive UI components (dashboards/forms) returned by tools. (Added: 2026-02-26)
