...
- [ ] **[P0] Chapter-Bound Sovereignty Manager**: (2026-07-25) UI for reviewing and signing chapter-local tool manifests and context shards.
- [ ] **[P0] NHI Rotation Timeline**: (2026-07-25) Visual tracker for autonomous NHI identity rotation events and receipt-bound issuance.
- [ ] **[P1] Chapter Resumption Debugger**: (2026-07-25) Forensic UI for inspecting recovered chapter-specific intent anchors after session loss.
