...
- [ ] **[P0] IPS Stack Guard Dashboard**: (2026-07-25) Real-time visualization of hardware-locked reasoning stacks and divergence alerts.
- [ ] **[P0] Deterministic Arbitration Monitor**: (2026-07-25) Visual tracker for DCA priority voting and task claiming resolution.
- [ ] **[P0] Token-Bound Identity Widget**: (2026-07-25) Status indicator for shard-bound session tokens and exfiltration alerts.
