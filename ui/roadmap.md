...
- [ ] **[P0] Swarm Trace Explorer (A2A Observability)**: A visual timeline for tracking hierarchical agent calls and state handoffs in a swarm. (Added: 2026-03-08)
- [ ] **[P0] Hook Policy & Quarantine UI**: Interface for reviewing and approving blocked repository-local hooks. (Added: 2026-03-08)
