...
- [ ] **[P0] ZTMP Security Dashboard**: Real-time visualization of semantically sanitized tool responses and blocked RCE attempts. (Added: 2026-07-25)
- [ ] **[P0] Active Discovery Monitor**: UI for reviewing masked capability cards and approving unmasking handshakes. (Added: 2026-07-25)
- [ ] **[P1] Attention-Reinforcement Heatmap**: Visual indicator of mission-root anchor strength and attention-density scores. (Added: 2026-07-25)
