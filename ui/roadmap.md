...
- [ ] **[P0] Event-Driven Signal Map**: Real-time visualization of pub/sub event flow between agent teammates. (Added: 2026-07-25)
- [ ] **[P0] Workspace Isolation Inspector**: Visual tracker for Git worktrees and container mounts assigned to specialist agents. (Added: 2026-07-25)
- [ ] **[P0] Shard Scrubbing Auditor**: Forensic UI for monitoring hardware-attested memory cleanup events. (Added: 2026-07-25)
- [ ] **[P1] MTTC Performance Dashboard**: Visualizer for "Mean Time To Coordinate" metrics and PTP prefetching efficiency. (Added: 2026-07-25)
