...
- [ ] **[P0] Context Budget Visualization**: Dashboard to see which tools are "Active" vs "Evicted" in the current session. (Added: 2026-02-27)
- [ ] **[P1] Dynamic Tool List Updates**: UI elements that reflect real-time `list_changed` notifications without page refresh. (Added: 2026-02-27)
