...
- [ ] **[P0] Reflection Policy Dashboard**: (2026-07-25) UI for defining and monitoring MBR-compliant subagent reflection cycles.
- [ ] **[P0] Metadata Tag Auditor**: (2026-07-25) Security dashboard for reviewing semantically validated state fragments and blocked metadata probes.
- [ ] **[P0] Protected Attention Heatmap**: (2026-07-25) Real-time visualization of pinned reasoning anchors and GC-immune context fragments.
