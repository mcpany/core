...
- [ ] **[P0] Tool Egress Monitoring Dashboard**: Visualize and manage network capabilities and blocked requests per tool. (Added: 2026-03-10)
- [ ] **[P0] Local Attestation Manager**: UI for viewing and managing cryptographic trust for MCP servers. (Added: 2026-03-10)
- [ ] **[P1] Binary Asset Explorer**: Secure viewer for ephemeral files (PDFs, Audio) generated by agent tool calls. (Added: 2026-03-10)
