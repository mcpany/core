...
- [ ] **[P0] Origin Attestation Dashboard**: Visual status of trusted vs untrusted incoming tool requests, and origin-based block logs. (Added: 2026-03-08)
- [ ] **[P1] Universal Command Mapper**: UI to map MCP prompts to native framework slash commands. (Added: 2026-03-08)
