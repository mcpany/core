...
- [ ] **[P0] Optimistic Context Monitor**: (2026-07-25) Real-time visualization of speculative fragments and background attestation status.
- [ ] **[P0] Hierarchical Lease Manager**: (2026-07-25) UI for reviewing pooled mission leases and their inherited sub-lease lineage.
- [ ] **[P1] Entropy Jitter Auditor**: (2026-07-25) Forensic UI for visualizing linguistic entropy variations in agent reasoning traces.
