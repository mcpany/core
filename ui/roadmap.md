...
- [ ] **[P0] Shard Replication Monitor**: (2026-07-25) Real-time visualization of CSR replication status and RDMA buffer throughput.
- [ ] **[P0] Ghost Intent Loop Visualizer**: (2026-07-25) Interactive graph viewer for identifying circular task dependencies and GII-pruned loops.
- [ ] **[P0] Attention-Stickiness Indicator**: (2026-07-25) Visual highlight for "Attention-Sticky" fragments in the context window.
