...
- [ ] **[P0] Ephemeral Context Dashboard**: UI for monitoring and manually flushing session-bound context. (Added: 2026-02-27)
- [ ] **[P0] Sandbox Health & Isolation Monitor**: Real-time status of Docker-bound tool runtimes. (Added: 2026-02-27)
- [ ] **[P1] Behavioral Threat Map**: Visualizing suspicious agent behavior sequences. (Added: 2026-02-27)
