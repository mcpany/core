...
- [ ] **[P0] Cross-Node Lease Manager**: (2026-07-25) Visual tracker for TPM-signed capability leases across physical mesh boundaries.
- [ ] **[P1] Epistemic Confidence Monitor**: (2026-07-25) Real-time visualization of agent uncertainty signals and EQG-triggered escalation events.
- [ ] **[P0] Instruction Anchor Health Dashboard**: (2026-07-25) Heatmap of mission-root anchor priority and IAR reinforcement event logs.
