...
- [ ] **[P0] WebSocket Origin Inspector**: Visualization of connected origins and security status to prevent browser-bridge exploits. (Added: 2026-03-01)
- [ ] **[P1] Vulnerability Sandbox Manager**: UI for launching and monitoring ephemeral agent sandboxes. (Added: 2026-03-01)
