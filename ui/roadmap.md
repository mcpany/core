...
- [ ] **[P0] PME Memory Inspector**: Visualize hardware-encrypted memory shards and retrieval similarity scores. (Added: 2026-07-25)
- [ ] **[P0] SDA Proof Viewer**: Real-time visualization of semantic diff attestation proofs for code-modifying tool calls. (Added: 2026-07-25)
- [ ] **[P0] Visual RPW Heatmap**: Overlay showing steganographic watermarks on generated diagrams and UI interactions. (Added: 2026-07-25)
- [ ] **[P0] FPIR v2 Ticket Monitor**: Status indicator for active "Trust Tickets" and enclave resumption latency. (Added: 2026-07-25)
