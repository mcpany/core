...
- [ ] **[P0] Hierarchical Agent Tree Viewer**: Visual topology of nested agent swarms and delegation paths. (Added: 2026-03-01)
- [ ] **[P1] Alignment Critic Debugger**: UI to inspect "Critic" decisions and adjust alignment sensitivity. (Added: 2026-03-01)
- [ ] **[P1] Project Policy Editor**: Local UI for managing project-specific security and discovery rules. (Added: 2026-03-01)
