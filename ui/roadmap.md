...
- [ ] **[P0] Model Cost Dashboard**: Real-time visualization of model-routing decisions, token costs, and savings (ClawRouter Interop). (Added: 2026-03-10)
- [ ] **[P0] Security Attestation UI (Origin & Skills)**: UI for managing WebSocket origin allowlists and reviewing Skill Scanner results. (Added: 2026-03-10)
