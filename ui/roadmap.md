...
- [ ] **[P0] Nano-Isolation Monitor**: Real-time visualization of ephemeral tool runtimes and resource budgets. (Added: 2026-03-01)
- [ ] **[P0] Task Attestation Debugger**: UI for inspecting cryptographic proofs and task-integrity status of subagents. (Added: 2026-03-01)
- [ ] **[P1] Spec-Alignment Dashboard**: Visual comparison between formal specifications (Conductor) and actual tool execution traces. (Added: 2026-03-01)
