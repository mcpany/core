...
- [ ] **[P0] Intent-Bound Security Console**: Visualize Goal Manifests and real-time IVM alignment checks. (Added: 2026-02-27)
- [ ] **[P0] A2A Swarm Explorer**: Bridge visualization between A2A messages and MCP tool calls. (Added: 2026-02-27)
- [ ] **[P1] Autonomous Triage Dashboard**: Manage auto-approval rules and triage high-priority agent escalations. (Added: 2026-02-27)
