...
- [ ] **Service Dependency Visualization**: Visualize dependencies between services (e.g. if one service calls another via MCP) in the Topology Graph.
- [ ] **Automated Service Health Checks**: Periodic background health checks for configured services with configurable alert thresholds and UI notifications.
