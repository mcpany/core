...
- [ ] **[P0] Agent Channel Inspector**: (2026-04-13) Visual dashboard for monitoring asynchronous pub/sub events in the swarm.
- [ ] **[P0] Dispatch Lifecycle Visualizer**: (2026-04-13) Replay-ready timeline for tracking and restarting complex agent workflows.
