...
- [ ] **[P0] Agent Mesh Topology Viewer**: Real-time visualization of the AMS decentralized mesh and peer node status. (Added: 2026-03-05)
- [ ] **[P0] Identity & Attestation Manager**: UI for managing OIDC providers and DID-based agent identities. (Added: 2026-03-05)
- [ ] **[P1] Context Scope Visualizer**: Dashboard for monitoring context immutability rules and detecting blocked "Shadow" injections. (Added: 2026-03-05)
