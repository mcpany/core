...
- [ ] **[P0] Shared Task Board Dashboard**: Real-time visualization of task ownership, claims, and TCA-blocked hijacking attempts. (Added: 2026-07-25)
- [ ] **[P0] Reasoning Effort Heatmap**: Visual monitor for RARL-throttled subagents and real-time reasoning-quota consumption. (Added: 2026-07-25)
- [ ] **[P0] Semantic Handoff Inspector**: Forensic UI for verifying mission-root anchor persistence during teammate handoffs. (Added: 2026-07-25)
- [ ] **[P0] KLPI Namespace Monitor**: Security widget for visualizing TPM-pinned named pipes and container isolation health. (Added: 2026-07-25)
