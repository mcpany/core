...
- [ ] **[P0] Shadow Discovery Monitor**: Dashboard for "Adopting" detected unmanaged local MCP servers. (Added: 2026-03-08)
- [ ] **[P0] Intent-Scoping Visualizer**: UI for defining and visualizing "Intent-Aware" tool filters for agent swarms. (Added: 2026-03-08)
