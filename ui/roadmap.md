...
### Upcoming: [2026-06-05]
- [ ] **[P0] Supply Chain Provenance Viewer**: Security dashboard for verifying tool lineage and hardware signatures.
- [ ] **[P0] RAG Retrieval Integrity Monitor**: Real-time visualization of semantically redacted retrieval fragments.
- [ ] **[P0] Upstream Signature Auditor**: UI for inspecting provenance tokens during A2A mesh handshakes.
- [ ] **[P0] Provenance-Aware Bidding UI**: Visual indicators for tool library provenance strength in the negotiation broker.
