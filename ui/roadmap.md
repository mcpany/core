...
- [ ] **[P0] Policy Translation Debugger**: Visual editor for mapping external agent policies to MCP Any Rego rules. (Added: 2026-02-27)
- [ ] **[P0] ASB Traffic Monitor**: Real-time visualization of IPC bus traffic, shared memory usage, and agent heartbeats. (Added: 2026-02-27)
- [ ] **[P1] VAID Token Manager**: Dashboard for issuing and revoking cryptographic identity tokens for agents. (Added: 2026-02-27)
