...
- [ ] **[P0] Epistemic Certainty Scoreboard**: (2026-07-25) Real-time dashboard for visualizing ECA-quarantined reasoning fragments and confidence thresholds.
- [ ] **[P0] Attestation Quota Visualizer**: (2026-07-25) Visual monitor for tracking AAQ lease efficiency and hardware attestation "burst" events.
- [ ] **[P0] Anchor Shard Inspector**: (2026-07-25) Forensic UI for verifying the immutability of mission-root anchors across dynamic sharding cycles.
- [ ] **[P0] Memory Stitching Alert Hub**: (2026-07-25) Security workspace for reviewing ARR-blocked redaction bypass attempts.
