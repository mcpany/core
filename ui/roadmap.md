...
- [ ] **[P0] Path Sandbox Policy Editor**: (P0) UI for managing binary whitelists and viewing path violation alerts. (Added: 2026-03-08)
- [ ] **[P1] Configuration Signature Wizard**: (P1) Guided flow for setting up and rotating administrative configuration signatures. (Added: 2026-03-08)
