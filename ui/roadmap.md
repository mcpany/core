...
- [ ] **[P0] Recursion Depth Monitor**: Dashboard to visualize and manage subagent nesting levels and context pruning. (Added: 2026-02-27)
- [ ] **[P1] Dynamic Guardrail Simulator**: UI for testing stateful policies against hypothetical conversation flows. (Added: 2026-02-27)
- [ ] **[P1] WASM Sandbox Manager**: Interface for monitoring and managing ephemeral WASM tool instances. (Added: 2026-02-27)
