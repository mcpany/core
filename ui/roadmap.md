...
- [ ] **[P0] Decision-Path Integrity Visualizer**: (2026-07-25) Real-time monitor for automated workflow sequences and DPS-interdiction events.
- [ ] **[P0] Epistemic Safety Dashboard**: (2026-07-25) Visual tracker for ECB checkpoints, risk scores, and consensus quorum status.
- [ ] **[P0] Mesh Handshake Optimizer**: (2026-07-25) Visual indicator for FPMH trust-ticket status and inter-node latency gains.
- [ ] **[P0] Metadata Sanitization Log**: (2026-07-25) Security dashboard for reviewing MSH-redacted fragments and external injection alerts.
