...
- [ ] **[P0] Origin Authorization Prompt**: UI to prompt users to authorize new origins or "pair" new local applications. (Added: 2026-03-06)
- [ ] **[P0] Filesystem Sandbox Visualizer**: View which repositories are jailed and monitor attempted path traversal events. (Added: 2026-03-06)
- [ ] **[P1] Search Index Status & Metrics**: Dashboard for the Universal Search Proxy to monitor index health and search performance. (Added: 2026-03-06)
