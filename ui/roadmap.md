...
- [ ] **[P0] Runtime Sandbox Monitor**: (2026-07-25) Real-time visualization of HARS-isolated interpreters and blocked command-ingestion alerts.
- [ ] **[P1] Tunnel Resumption Dashboard**: (2026-07-25) Visual tracker for session-bound "Mesh Tickets" and SNT coordination latency gains.
- [ ] **[P0] Interpreter Lifecycle Tracker**: (2026-07-25) Visual debugger for mission-bound runtime leases and forceful termination events.
