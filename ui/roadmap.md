...
- [ ] **[P0] COAP Origin Verifier**: UI for managing authorized agent identities and monitoring cross-origin tool requests. (Added: 2026-03-07)
- [ ] **[P1] Swarm Attack Visualizer**: Real-time graph showing coordinated tool call patterns and SARL throttling status. (Added: 2026-03-07)
