...
- [ ] **[P0] Action Cascade Visualizer**: Real-time visualization of simulated tool side-effects and "reasonability" scores. (Added: 2026-03-01)
- [ ] **[P1] Adaptive Context Metrics**: Token usage trends with "Compaction Gain" visualization. (Added: 2026-03-01)
