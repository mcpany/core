...
- [ ] **[P0] Focused Context Monitor**: Visualize pruned context windows and isolation status for swarm specialists. (Added: 2026-07-25)
- [ ] **[P1] Inter-Agent Message Inspector**: Real-time visualization of @mentions and back-channel swarm coordination. (Added: 2026-07-25)
- [ ] **[P0] Discovery Handshake Dashboard**: Status indicator for hardware-attested handshakes and masked capability cards. (Added: 2026-07-25)
- [ ] **[P0] FPIR Lease Monitor**: Track Mesh Ticket lifetimes and fast-path vs. full-attestation ratios. (Added: 2026-07-25)
