...
- [ ] **[P0] PITTO Shield Alerts**: Real-time visualization of blocked/sanitized tool outputs. (Added: 2026-02-27)
- [ ] **[P1] Sticky Session Monitor**: UI for viewing and managing pinned agent-tool sessions. (Added: 2026-02-27)
