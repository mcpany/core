...
- [ ] **[P0] Parallel Agent Team Dashboard**: Real-time visualization of concurrent agent actions and shared blackboard state. (Added: 2026-03-09)
- [ ] **[P0] Origin Security Settings**: Configuration UI for managing allowed origins and hostnames for the gateway. (Added: 2026-03-09)
