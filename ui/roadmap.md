...
- [ ] **[P0] Sandbox Security Dashboard**: Visualize isolated tool execution, resource usage, and security violations. (Added: 2026-02-27)
- [ ] **[P1] Masked Trace Viewer**: Enhanced log viewer that highlights redacted secrets and sensitive data patterns. (Added: 2026-02-27)
- [ ] **[P1] Input Schema Policy Editor**: UI for defining and enforcing strict argument validation rules for tools. (Added: 2026-02-27)
