...
- [ ] **[P0] Agent Spawning & Branching Timeline**: Visual representation of parent-to-subagent lineage and state snapshots. (Added: 2026-03-01)
- [ ] **[P1] Token Budgeting Optimizer**: UI for configuring tool-specific importance scores and token caps. (Added: 2026-03-01)
- [ ] **[P0] IPC Isolation Health Monitor**: Dashboard to verify secure named-pipe/UDS status for containerized agents. (Added: 2026-03-01)
