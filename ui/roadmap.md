...
- [ ] **[P0] Speculative Coordination Monitor**: Visual indicator for pre-emptively locked shards and SSO-broker efficiency. (Added: 2026-07-25)
- [ ] **[P0] Lineage-Bound Lease Auditor**: UI for reviewing hardware-attested lineage proofs and blocked lease-shadowing attempts. (Added: 2026-07-25)
- [ ] **[P0] Attention Priority Heatmap**: Enhanced ALRA visualizer showing fragments protected by APGC. (Added: 2026-07-25)
