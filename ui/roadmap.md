...
- [ ] **[P0] Origin Handshake Manager**: Visual interface for authorizing local apps and managing origin-attestation tokens. (Added: 2026-03-02)
- [ ] **[P0] Semantic Scope Visualizer**: UI for defining and visualizing "Allowed Paths" and "Intent Policies" for active agent sessions. (Added: 2026-03-02)
