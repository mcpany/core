...
- [ ] **[P0] Project Scoping UI**: Interface for managing project-level security policies and tool visibility. (Added: 2026-03-02)
- [ ] **[P1] Reasoning Telemetry Visualizer**: Display "Thinking" tokens vs "Output" tokens in the activity feed. (Added: 2026-03-02)
