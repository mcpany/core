...
- [ ] **[P0] GC-Immune Anchor Visualizer**: Visual indicator for pinned reasoning anchors and their protection status against CWGC. (Added: 2026-04-02)
- [ ] **[P0] Speculative Buffer Monitor**: Real-time dashboard for tracking speculative tool results and sanitization status. (Added: 2026-04-02)
- [ ] **[P0] Inode Security Inspector**: Visual debugger for hardware-pinned project configuration Inodes and blocked escape attempts. (Added: 2026-04-02)
