...
- [ ] **[P0] Intent-Alignment Guard**: UI indicator for tool-call safety scores and real-time misalignment alerts. (Added: 2026-02-27)
- [ ] **[P0] Unified Identity (UAI) Manager**: View and manage cryptographically verified identities for all agents in the mesh. (Added: 2026-02-27)
- [ ] **[P1] Trust Domain Settings**: UI for configuring and auditing allowed MCP server origins and trust domains. (Added: 2026-02-27)
