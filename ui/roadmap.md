...
- [ ] **[P0] IBT Session Manager**: Dashboard for managing Identity-Bound Tooling sessions and viewing active attestation proofs. (Added: 2026-03-11)
- [ ] **[P0] Config Attestation Reviewer**: UI component for reviewing and cryptographically signing project-local configuration hooks. (Added: 2026-03-11)
