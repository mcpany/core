...
- [ ] **[P0] Shard Migration Visualizer**: Real-time map showing context fragment movement across the SNT mesh. (Added: 2026-07-25)
- [ ] **[P0] HAMR Rollback Manager**: Interactive console for reviewing and triggering hardware-attested mission rollbacks. (Added: 2026-07-25)
- [ ] **[P0] Aggregated Provenance Explorer**: UI for inspecting compressed RRPA reason-proof trees. (Added: 2026-07-25)
- [ ] **[P0] Migration Latency Heatmap**: Real-time visualization of Shard-Migration Jitter across mesh nodes. (Added: 2026-07-25)
