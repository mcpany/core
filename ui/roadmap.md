...
- [ ] **[P0] Universal Identity Manager**: Dashboard for managing identity mappings and active session tokens across the mesh. (Added: 2026-03-03)
- [ ] **[P0] Cost Guard & Budgeting UI**: Visual controls for setting per-intent budgets and viewing deduplication savings. (Added: 2026-03-03)
