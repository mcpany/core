...
- [ ] **[P0] Control Plane Security Monitor**: (New) Audit view for blocked CSRF/Origin-mismatch attempts. (Added: 2026-03-05)
- [ ] **[P0] DTI Egress Visualizer**: (New) Real-time visualization of tool-initiated network calls and blocked domains. (Added: 2026-03-05)
- [ ] **[P1] Hierarchical Swarm Topology**: (New) Specialized view for Mayor/Deacon agent relationships. (Added: 2026-03-05)
