...
- [ ] **[P0] Policy Rule Editor**: Visual Rego/CEL policy builder for the Policy Firewall. (Added: 2026-02-27)
- [ ] **[P1] AST Discovery Navigator**: UI for exploring tools via code-structure relationships. (Added: 2026-02-27)
- [ ] **[P1] Swarm Session Visualizer**: Real-time view of "Execute-Switch-Update" agent loops. (Added: 2026-02-27)
