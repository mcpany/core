...
- [ ] **[P0] Agent Identity Registry**: UI for managing and verifying cryptographic identities of agents in the swarm. (Added: 2026-03-06)
- [ ] **[P1] Security Attestation Viewer**: Visual dashboard for monitoring autonomous security proofs and policy compliance. (Added: 2026-03-06)
- [ ] **[P1] A2A Interaction Map**: Real-time visualization of agent-to-agent communication flows and identities. (Added: 2026-03-06)
