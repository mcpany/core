...
- [ ] **[P0] Obfuscated Command Warning**: UI alerts and "De-obfuscate" preview for suspicious tool calls. (Added: 2026-03-08)
- [ ] **[P0] Context Threshold Visualizer**: Real-time gauge showing if current toolset is in "Eager" or "Lazy" mode based on model context. (Added: 2026-03-08)
