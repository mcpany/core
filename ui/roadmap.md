...
- [ ] **[P0] Intent Barrier Contention Monitor**: real-time visualization of MMIB pointer updates and atomic signaling contention. (Added: 2026-07-25)
- [ ] **[P0] Consent Relay Chain Inspector**: visual debugger for hardware-attested user consent inheritance across subagents. (Added: 2026-07-25)
- [ ] **[P0] Mirror-Splice Threat Dashboard**: real-time visualization of background buffer validation and blocked recovery events. (Added: 2026-07-25)
- [ ] **[P1] Step-Up Attestation Dialog**: interactive UI component for dynamic hardware re-verification during high-entropy missions. (Added: 2026-07-25)
