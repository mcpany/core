...
- [ ] **[P0] Attestation-Aware UI Bridge**: (2026-07-25) Security upgrade for A2UI fragments mandating visual "Cognitive Badges" for reasoning confidence.
- [ ] **[P0] Key Orchestration Status Hub**: (2026-07-25) Real-time visualization of mesh-wide key rotation events and UKOB health.
- [ ] **[P1] Cold-Storage Audit Explorer**: (2026-07-25) Interactive browser for immutable reasoning traces archived in the MRCS Sink.
