...
- [ ] **[P0] Multi-Hop Trust Tracer**: (2026-07-25) Visual debugger for tracking Recursive Trust Ticket (RTT) propagation across multi-node meshes.
- [ ] **[P0] Inode Security Monitor**: (2026-07-25) Real-time visualization of task-bound Inode locks and blocked racing attempts (TBIL status).
- [ ] **[P0] Distributed Lease Dashboard**: (2026-07-25) High-priority tracker for Kernel-Resident Reaper events and automated lease reclamations.
- [ ] **[P1] Attestation Queue Visualizer**: (2026-07-25) Dashboard for monitoring ALB-prioritized hardware signals and attestation storm alerts.
