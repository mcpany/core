...
- [ ] **[P0] Loopback Security Monitor**: Real-time monitoring of WebSocket origins and loopback rate-limit events. (Added: 2026-03-02)
- [ ] **[P0] Hook Approval Interface**: UI for reviewing and approving/denying automated hooks and commands. (Added: 2026-03-02)
- [ ] **[P1] Context Fragment Explorer**: Visualizer for immutable context fragments and session state history. (Added: 2026-03-02)
