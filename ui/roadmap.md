...
- [ ] **[P0] Localhost Security Attestation Flow**: Interactive pairing and handshake UI for secure local tool access. (Added: 2026-03-08)
- [ ] **[P1] Wasm Sandbox Monitor**: UI for monitoring and managing isolated Wasm tool runtimes. (Added: 2026-03-08)
