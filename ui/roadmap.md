...
- [ ] **[P0] PC-AMT Security Widget**: Real-time status for per-call mission-bound remote invocations and blocked session-reuse attempts. (Added: 2026-07-25)
- [ ] **[P0] Reasoning-Lease Correlation Viewer**: Visual tracker correlating hardware leases with verified reasoning traces from the AIA Broker. (Added: 2026-07-25)
- [ ] **[P1] CI/CD Compliance Auditor**: UI for reviewing multi-framework PPA/PPRP proofs within CI/CD pipelines. (Added: 2026-07-25)
