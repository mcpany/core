...
- [ ] **[P0] WebSocket Origin Monitor**: Security widget to track and alert on blocked unauthorized WebSocket origin attempts. (Added: 2026-03-04)
- [ ] **[P1] HTTP Hook Configurator**: Visual editor for defining and testing HTTP-based lifecycle hooks for tools. (Added: 2026-03-04)
