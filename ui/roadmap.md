...
- [ ] **[P0] Shadowing Attempt Monitor**: Real-time visualization of blocked discovery collisions and lineage alerts. (Added: 2026-07-25)
- [ ] **[P0] Intent-Bound Budget Tracker**: Visual tracker for reasoning effort consumption pinned to mission intents. (Added: 2026-07-25)
- [ ] **[P1] FMS Sync Visualizer**: Monitor for gossiped state consistency across federated memory shards. (Added: 2026-07-25)
