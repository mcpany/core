...
- [ ] **[P0] Swarm Trust Domain Manager**: UI for creating, managing, and visualizing agent trust domains and their shared resources. (Added: 2026-03-01)
- [ ] **[P0] Universal Remote Bridge Status**: Dashboard for monitoring E2EE bridge connections from mobile/cloud agents to local tools. (Added: 2026-03-01)
- [ ] **[P1] Policy Wildcard Editor**: Visual editor for managing declarative policy wildcards and inheritance rules. (Added: 2026-03-01)
