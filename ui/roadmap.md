...
- [ ] **[P0] Config Trust Manager**: UI for reviewing and approving project-level configuration signatures and trust status. (Added: 2026-03-06)
- [ ] **[P0] Credential Isolation Monitor**: Dashboard for tracking credential proxy usage and ephemeral token lifecycle. (Added: 2026-03-06)
- [ ] **[P1] Swarm Governance Dashboard**: Real-time visualization of swarm economic guardrails, recursion depths, and token spend. (Added: 2026-03-06)
