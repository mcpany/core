...
- [ ] **[P0] WebSocket Security Guard Dashboard**: UI for managing Origin whitelists and monitoring Anti-CSRF token usage. (Added: 2026-03-10)
- [ ] **[P0] Orchestration Bus Monitor**: Real-time visualization of the Inter-Agent Message Bus, topics, and message flow. (Added: 2026-03-10)
- [ ] **[P1] Agent Delegation Tracker**: UI for monitoring cross-framework task delegation and callback status. (Added: 2026-03-10)
