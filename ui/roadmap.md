...
- [ ] **[P0] Mission Lease Manager**: (2026-07-24) Visual tracker for active MBHL-bound capability leases and their automated expiration status.
...
- [ ] **[P0] Credential Broker Status Widget**: (2026-07-25) Visual indicator for hardware-attested credential brokering and task-bound session health.
- [ ] **[P0] Mesh Exposure Alert Center**: (2026-07-25) Real-time dashboard for visualizing quarantined MCP endpoints and non-loopback violation alerts.
- [ ] **[P0] Multi-Signature Approval Portal**: (2026-07-25) Authorization workspace for reviewing and signing dynamic tool grafts via auditor quorums.
