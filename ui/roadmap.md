...
- [ ] **[P0] ATR Refinement Manager**: UI for reviewing and approving autonomous tool schema refinements. (Added: 2026-03-05)
- [ ] **[P1] Multi-Modal Context Preview**: Visual viewer for non-textual discovery context (e.g., indexed screenshots). (Added: 2026-03-05)
