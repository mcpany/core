...
- [ ] **[P0] Project Attestation Manager**: UI for auditing and approving project-local configurations. (Added: 2026-03-07)
- [ ] **[P0] Origin & Hijack Monitor**: Security dashboard for monitoring and managing WebSocket handshake tickets and origin whitelists. (Added: 2026-03-07)
