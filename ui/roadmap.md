...
- [ ] **[P0] Sub-agent Lineage Tree**: Visual representation of parent-child agent relationships and deterministic routing paths. (Added: 2026-03-08)
- [ ] **[P1] WASM Sandbox Monitor**: Real-time observability for sandboxed tool resource usage (CPU/Memory). (Added: 2026-03-08)
