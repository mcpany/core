...
- [ ] **[P0] Mesh Topology & Latency Map**: Real-time visualization of masked vs. real node latencies and MTM jitter status. (Added: 2026-07-25)
- [ ] **[P0] Reflection Quorum Workspace**: Interactive UI for reviewing peer-attestation status and TRQ reasoning audits. (Added: 2026-07-25)
- [ ] **[P0] AFP Batch Monitor**: Dashboard for tracking batch-signing efficiency and attestation-latency gains. (Added: 2026-07-25)
