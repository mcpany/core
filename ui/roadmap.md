...
- [ ] **[P0] Multi-Hop Trust Lineage Inspector**: (2026-07-25) Forensic UI for visualizing hardware-attested lineage across deep delegation chains.
- [ ] **[P0] CRDT Mailbox Performance Monitor**: (2026-07-25) High-speed visualization of lock-free teammate synchronization and CRDT conflict resolution.
- [ ] **[P0] Attention Sovereignty Dashboard**: (2026-07-25) Heatmap visualization of context-window drivers and attention-locking status.
- [ ] **[P0] Temporal Jitter Security Hub**: (2026-07-25) Monitor for TSI-injected jitter and shared-memory access windows.
