...
- [ ] **[P0] HITL Unified Approval Inbox**: Unified view for protocol-native approval requests, including "Diff" views for risky actions. (Updated: 2026-03-02)
- [ ] **[P1] Edge-Logic Console**: Monitoring and debugging interface for Wasm/Python-based edge functions. (Added: 2026-03-02)
- [ ] **[P0] Security Event Timeline**: Visualization of WebSocket protocol violations and blocked "Gateway Hopping" attempts. (Added: 2026-03-02)
