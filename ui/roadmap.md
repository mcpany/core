...
*   **[P0] RAC Lineage Visualizer**: (2026-07-25) Visual tool for inspecting multi-layered cryptographic proofs and agent parentage.
*   **[P0] Workspace Trust Dashboard**: (2026-07-25) Real-time monitor for hardware-attested project configurations and WTA status.
*   **[P0] Stitch-Entropy Heatmap**: (2026-07-25) Forensic UI for monitoring fragment-level correlation risks in shared workspaces.
