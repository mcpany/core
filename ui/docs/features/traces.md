...
- **Overview**: Contains the **Execution Waterfall** (timeline), **Sequence Diagram**, and a summary of input/output.
- **Payload**: Detailed view of the **Request** (arguments) and **Response** (results) JSON.
