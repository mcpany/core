...
MCP Any now supports granular control over which tools, prompts, and resources
are exposed to the AI client. This is a critical security feature for enterprise
deployments, allowing administrators to define Allow/Deny lists using regex
patterns.

## Features

- **Default Action**: Set the default behavior to "Allow All" (Export) or "Deny
  All" (Unexport).
...
4. Configure the **Tool Export Policy**, **Prompt Export Policy**, and
   **Resource Export Policy**.
