...
2. A **Tool Configuration Dialog** opens, showing the **Tool Description** and a dynamically generated **Input Form**.
...
2. Click **"Build Command"** (or press Enter).
3. The command is populated in the chat input. Press **Enter** or click **Send** to execute.
...
- **JSON Mode**: Inside the Tool Configuration Dialog, toggle to the "JSON" tab to input raw parameters if the form is too constraining.
