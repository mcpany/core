...
2. A configuration dialog opens, displaying the **Tool Description** and a dynamically generated **Input Form**.
...
3. The command is populated in the console input area.
4. Press **Enter** or click the **Send** button to execute the tool.
