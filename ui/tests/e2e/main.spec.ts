...
test.describe('MCP Any UI E2E', () => {
  ...
  test.beforeEach(async ({ page, request }) => {
    // Seed data for Real Data Policy
  ...
  test('Dashboard loads and shows metrics', async ({ page }) => {
    ...
    // Verify that metrics cards are displayed (checking for values loosely as they depend on seeding)
    // We expect some numeric value or percentage
