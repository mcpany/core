...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      "connect-src 'self' https://cdn.jsdelivr.net https://raw.githubusercontent.com", // Added cdn.jsdelivr.net and raw.githubusercontent.com for marketplace. Restricted http/https wildcards for security.
