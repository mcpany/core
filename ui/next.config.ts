...
const nextConfig: NextConfig = {
  ...
  webpack: (config) => {
    ...
    // Explicitly check for Docker environment path first
    // In Dockerfile: COPY proto/ /proto/
    ...
    // We prioritize the Docker path if it exists, as that is the source of truth in the container
