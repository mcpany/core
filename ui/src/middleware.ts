...
export function middleware(request: NextRequest) {
  ...
  if (pathname.startsWith('/api/v1') || pathname.startsWith('/mcpany.') || pathname.startsWith('/doctor') || pathname.startsWith('/v1/') || pathname.startsWith('/auth/oauth/') || pathname === '/auth/login' || pathname.startsWith('/debug/') || pathname.startsWith('/sse') || pathname.startsWith('/messages') || pathname.startsWith('/mcp/')) {
