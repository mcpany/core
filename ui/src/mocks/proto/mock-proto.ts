...
/**
 * Mock type placeholder for CallPolicyRule used in tests.
 */
export const CallPolicyRule = {};
/**
 * Mock type placeholder for ExportPolicy used in tests.
 */
export const ExportPolicy = {};
/**
 * Mock type placeholder for ExportRule used in tests.
 */
