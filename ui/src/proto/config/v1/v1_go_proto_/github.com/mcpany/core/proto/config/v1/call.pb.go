...
const (
	OutputTransformer_JSON      OutputTransformer_OutputFormat = 0
	OutputTransformer_XML       OutputTransformer_OutputFormat = 1
	OutputTransformer_TEXT      OutputTransformer_OutputFormat = 2
	OutputTransformer_RAW_BYTES OutputTransformer_OutputFormat = 3
	OutputTransformer_JQ        OutputTransformer_OutputFormat = 4
)
