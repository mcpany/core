...
func (UnimplementedRegistrationServiceServer) ValidateService(context.Context, *ValidateServiceRequest) (*ValidateServiceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ValidateService not implemented")
}
...
func (UnimplementedRegistrationServiceServer) InitiateOAuth2Flow(context.Context, *InitiateOAuth2FlowRequest) (*InitiateOAuth2FlowResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method InitiateOAuth2Flow not implemented")
}
