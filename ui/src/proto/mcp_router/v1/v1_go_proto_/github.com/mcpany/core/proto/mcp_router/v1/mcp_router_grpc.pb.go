...
// All implementations should embed UnimplementedMcpRouterServer
...
// UnimplementedMcpRouterServer should be embedded to have
...
func RegisterMcpRouterServer(s grpc.ServiceRegistrar, srv McpRouterServer) {
	// If the following call panics, it indicates UnimplementedMcpRouterServer was
