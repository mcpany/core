...
/**
 * Hook for managing pinned tools.
 *
 * Summary: Manages a list of pinned tools persisted in local storage.
 *
 * @returns Object. An object containing the pinned tools list and helper functions.
 *
 * Side Effects:
