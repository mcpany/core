...
/**
 * useLocalStorage is a custom hook that persists state to localStorage.
 * It synchronizes the state with the browser's local storage, ensuring data persistence across sessions.
 *
