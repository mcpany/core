  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-bold tracking-tight">Universal Agent Bus</h2>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Agent Chain Tracer (A2A)</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-12 text-center text-muted-foreground">
            <p>No active agent interactions detected.</p>
          </div>
        </CardContent>
      </Card>
    </div>
