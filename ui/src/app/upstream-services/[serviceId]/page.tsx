...
import { ServiceProvenance } from "@/components/services/service-provenance";
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden">
                <div className="border-b px-4 flex-none bg-background/50 backdrop-blur-sm z-10">
                    <TabsList className="bg-transparent h-12">
                        ...
                        <TabsTrigger value="provenance" className="data-[state=active]:bg-primary/10 data-[state=active]:text-primary">
                ...
                <div className="flex-1 overflow-hidden bg-muted/5">
                    ...
                    <TabsContent value="provenance" className="h-full p-6 overflow-y-auto m-0">
                        <ServiceProvenance service={service} />
                    </TabsContent>
