...
export default function ToolsPage() {
  ...
  const { pinnedTools, isPinned, togglePin, bulkPin, bulkUnpin, isLoaded } = usePinnedTools();
  ...
  // ⚡ BOLT: Memoize expensive filtering and sorting operations
  ...
  const filteredTools = useMemo(() => tools
    ...
    }), [tools, showPinnedOnly, selectedService, searchQuery, pinnedTools]);

  // ⚡ BOLT: Memoize grouping logic to avoid re-computation on every render
