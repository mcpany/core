...
export default function ToolsPage() {
  ...
  // ⚡ BOLT: Memoized filteredTools and groupedTools to prevent redundant sorting and filtering of large tool arrays on every render (Algorithmic / React/View optimization).
