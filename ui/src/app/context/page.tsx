...
export default function ContextPage() {
  ...
  const handleSeedData = async () => {
    ...
    try {
      ...
      toast({
        title: "Seeded Mock Service",
        description: "Registered 'Context Heavy Mock'.",
      });
      ...
      toast({
        ...
        description:
          "Could not register mock service. Ensure 'go' is in the server path or use an existing service.",
        variant: "destructive",
      });
    } finally {
      setSeeding(false);
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Visualize and optimize your agent's context window.
            </p>
          </div>
