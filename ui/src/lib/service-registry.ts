...
/**
 * Registry of known services for the marketplace wizard and community detection.
 * Provides metadata and default configuration schemas for popular MCP servers.
 */
