...
/**
 * Registry of available MCP services that can be installed or configured.
 * This list includes database connectors, cloud platform integrations, developer tools, and more.
 */
