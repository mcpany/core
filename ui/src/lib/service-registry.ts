...
/**
 * Registry of known/verified community MCP servers.
 * This list is used to provide rich metadata and simplified installation commands
 * for popular servers in the Marketplace.
 */
