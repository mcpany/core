...
/**
 * SERVICE_REGISTRY contains the list of built-in service templates available in the marketplace.
 * These are used to populate the "Popular" section and provide default configurations.
 */
