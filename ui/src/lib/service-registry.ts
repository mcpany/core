...
/**
 * Registry of all available services that can be added via the marketplace.
 *
 * This list is used to populate the marketplace UI and provide default configurations.
 */
