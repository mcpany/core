...
/**
 * SERVICE_REGISTRY is a curated list of popular MCP servers available for one-click configuration.
 * Each item defines the repository, installation command, and required configuration schema.
 */
