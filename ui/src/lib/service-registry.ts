...
/**
 * Registry of known services with their configuration schemas and repository information.
 * Used for auto-detecting and configuring services from the marketplace.
 */
