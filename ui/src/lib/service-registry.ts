...
/**
 * SERVICE_REGISTRY contains a curated list of MCP services available for installation.
 * It includes metadata such as repository URL, installation command, and configuration schema.
 */
