...
/**
 * ServiceRegistryItem defines the structure for an item in the service registry.
 */
...
/**
 * SERVICE_REGISTRY contains the list of known community MCP servers and their configurations.
 */
