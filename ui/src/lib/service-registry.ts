...
/**
 * ServiceRegistryItem represents a service definition in the marketplace.
 */
...
/**
 * SERVICE_REGISTRY contains the list of built-in services available in the marketplace.
 */
