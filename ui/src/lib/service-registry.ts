...
/**
 * Service Registry containing definitions for community MCP servers.
 * This list is used to populate the marketplace and provide auto-configuration templates.
 */
