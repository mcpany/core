...
/**
 * Interface representing a service available in the registry.
 */
...
/**
 * A registry of predefined MCP services that can be easily instantiated.
 * This list includes popular databases, cloud platforms, and developer tools.
 */
