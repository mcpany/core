...
/**
 * Registry of known services with their configuration schemas and default commands.
 * This list is used to populate the Marketplace and provide templates for service creation.
 */
