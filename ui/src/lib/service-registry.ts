...
/**
 * SERVICE_REGISTRY is the central registry of supported community MCP servers.
 * It defines the metadata and configuration schema for each service available in the Marketplace.
 */
