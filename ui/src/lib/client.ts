...
export const apiClient = {
     ...
     *
     * Summary: Fetches available services from the global catalog.
     *
     ...
     *
     * Summary: Enables or disables an upstream service.
     *
     ...
     *
     * Summary: Deletes an upstream service.
     *
     ...
     *
     * Summary: Checks if a service configuration is valid without saving it.
     *
     ...
     *
     * Summary: Reads the content of a specific resource.
     *
     ...
     * @throws {Error} If the request fails.
     *
     * Side Effects: Fetches from the backend /api/v1/templates endpoint.
     */
     ...
     *
     * Summary: Starts the OAuth authentication flow.
     *
     ...
     *
     * Summary: Tests if an auth configuration works.
     *
     ...
     *
     * Summary: Handles the OAuth callback.
     *
     ...
     * @throws {Error} If the handling fails.
     */
    ...
    */
     ...
     *
     * Summary: Reveals a secret value.
     *
     ...
     *
     * Summary: Saves the global configuration settings.
     *
     ...
     *
     * Summary: Retrieves traffic history for the dashboard.
     *
     ...
     *
     * Summary: Retrieves the top used tools.
     *
     * @param serviceId - Optional service ID to filter by.
     ...
     *
     * Summary: Retrieves the system status.
     *
     ...
     *
     * Summary: Retrieves dashboard health metrics.
     *
     ...
     *
     * Summary: Retrieves the network topology.
     *
     ...
     *
     * Summary: Seeds dashboard traffic data.
     *
     ...
     *
     * Summary: Retrieves stack configuration as YAML.
     *
     * @param stackId - The ID of the stack.
     ...
     *
     * Summary: Lists marketplace templates.
     *
     * @returns A promise that resolves to a list of service templates.
     * @throws {Error} If the request fails.
     */
     ...
     *
     * Summary: Saves a template to the marketplace.
     *
     ...
     *
     * Summary: Deletes a template from the marketplace.
     *
     ...
     * Lists audit logs.
     *
     * Summary: Lists audit logs based on filters.
     *
