...
export const apiClient = {
     ...
     * @remarks Side Effects: Performs a network request to /api/v1/services.
     */
    listServices: async () => {
     ...
     * @remarks Side Effects: Performs a network request to /api/v1/services/{id}.
     */
     ...
     * @remarks Side Effects: Modifies the service state via /api/v1/services/{name}.
     */
     ...
     * @remarks Side Effects: Performs a network request to /api/v1/services/{name}/status.
     */
     ...
     * @throws {Error} If the restart action fails.
     * @remarks Side Effects: Triggers a service restart via /api/v1/services/{name}/restart.
     */
     ...
     * @remarks Side Effects: Creates a new service via /api/v1/services.
     */
     ...
     * @throws {Error} If the update fails.
     * @remarks Side Effects: Updates service configuration via /api/v1/services/{name}.
     */
     ...
     * @remarks Side Effects: Deletes service via /api/v1/services/{id}.
     */
     ...
     * @remarks Side Effects: Performs a network request to /api/v1/services/validate.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/tools.
     */
    listTools: async () => {
     ...
     * @remarks Side Effects: Executes a tool on the server, which may have side effects depending on the tool.
     */
     ...
     * @throws {Error} If the update fails.
     * @remarks Side Effects: Modifies the tool state via /api/v1/tools.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/resources.
     */
    listResources: async () => {
     ...
     * @remarks Side Effects: Performs a network request to /api/v1/resources/read.
     */
     ...
     * @throws {Error} If the update fails.
     * @remarks Side Effects: Modifies the resource state via /api/v1/resources.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/prompts.
     */
    listPrompts: async () => {
     ...
     * @throws {Error} If the update fails.
     * @remarks Side Effects: Modifies the prompt state via /api/v1/prompts.
     */
     ...
     * @throws {Error} If the prompt execution fails.
     * @remarks Side Effects: Executes a prompt on the server via /api/v1/prompts/{name}/execute.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/secrets.
     */
    listSecrets: async () => {
     ...
     * @throws {Error} If the reveal fails.
     * @remarks Side Effects: Performs a network request to /api/v1/secrets/{id}/reveal.
     */
     ...
     * @remarks Side Effects: Creates or updates a secret via /api/v1/secrets.
     */
     ...
     * @remarks Side Effects: Deletes a secret via /api/v1/secrets/{id}.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/settings.
     */
     ...
     * @throws {Error} If the save fails.
     * @remarks Side Effects: Updates global settings via /api/v1/settings.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/dashboard/traffic.
     */
     ...
     * @throws {Error} If the fetch fails (returns empty list).
     * @remarks Side Effects: Performs a network request to /api/v1/dashboard/top-tools.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/alerts.
     */
    listAlerts: async () => {
     ...
     * @throws {Error} If the fetch fails (returns empty list).
     * @remarks Side Effects: Performs a network request to /api/v1/dashboard/tool-failures.
     */
     ...
     * @throws {Error} If the fetch fails (returns empty list).
     * @remarks Side Effects: Performs a network request to /api/v1/dashboard/tool-usage.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/system/status.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/dashboard/metrics.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/traces.
     */
     ...
     * @throws {Error} If the seed request fails.
     * @remarks Side Effects: Performs a network request to /api/v1/debug/seed_traffic.
     */
     ...
     * @throws {Error} If the update fails.
     * @remarks Side Effects: Updates alert status via /api/v1/alerts/{id}.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/collections.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/collections/{name}.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Maps to getCollection.
     */
     ...
     * @throws {Error} If the save fails.
     * @remarks Side Effects: Maps to saveCollection.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/profiles.
     */
    listProfiles: async () => {
     ...
     * @throws {Error} If the create fails.
     * @remarks Side Effects: Performs a network request to /api/v1/profiles.
     */
     ...
     * @throws {Error} If the update fails.
     * @remarks Side Effects: Performs a network request to /api/v1/profiles/{name}.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/users.
     */
    listUsers: async () => {
     ...
     * @throws {Error} If the update fails.
     * @remarks Side Effects: Performs a network request to /api/v1/users/{id}.
     */
     ...
     * @remarks Side Effects: Performs a network request to /auth/oauth/initiate.
     */
     ...
     * @throws {Error} If the callback handling fails.
     * @remarks Side Effects: Performs a network request to /auth/oauth/callback.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/credentials.
     */
     ...
     * @throws {Error} If the save fails.
     * @remarks Side Effects: Maps to createCredential.
     */
     ...
     * @throws {Error} If the update fails.
     * @remarks Side Effects: Performs a network request to /api/v1/credentials/{id}.
     */
     ...
     * @throws {Error} If the test request fails (though the function returns JSON even on error).
     * @remarks Side Effects: Performs a network request to /api/v1/debug/auth-test.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/templates.
     */
    listTemplates: async () => {
     ...
     * @throws {Error} If the delete fails.
     * @remarks Side Effects: Performs a network request to /api/v1/templates/{id}.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/doctor.
     */
     ...
     * @throws {Error} If the fetch fails.
     * @remarks Side Effects: Performs a network request to /api/v1/audit/logs.
     */
