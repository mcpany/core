 ...
 *
 * This function performs a deep clone of the configuration and iterates through
 * known secret fields and environment variables, replacing them based on the
 * provided mode.
 *
