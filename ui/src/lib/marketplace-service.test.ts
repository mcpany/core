...
`;
  ...
  describe("fetchExternalServers", () => {
    it("should return linear server for mcpmarket", async () => {
      const servers =
        await marketplaceService.fetchExternalServers("mcpmarket");
  ...
  describe("importCollection", () => {
    it("should return a mock collection", async () => {
      const collection = await marketplaceService.importCollection(
        "http://example.com/collection.json",
      );
