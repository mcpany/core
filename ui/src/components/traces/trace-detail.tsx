...
import { InteractiveTimeline } from "@/components/traces/interactive-timeline";
    ...
    return (
        <div className="h-full flex flex-col bg-background">
            ...
            <Tabs defaultValue="overview" className="flex-1 flex flex-col overflow-hidden">
                ...
                <TabsContent value="timeline" className="flex-1 p-0 overflow-hidden m-0">
                    <ScrollArea className="h-full p-6">
                        <InteractiveTimeline trace={trace} />
                    </ScrollArea>
                </TabsContent>
