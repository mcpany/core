                ...
                <Card className="border p-4 shadow-sm">
                    ...
                    <div className="space-y-4">
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                                    <div className="space-y-0.5">
                                        <FormLabel className="text-sm">Enable Alerts</FormLabel>
                                        <FormDescription className="text-xs">
                                            Monitor system health and trigger notifications.
                                        </FormDescription>
                                    </div>
                                    <FormControl>
                                        <Switch
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>Global Webhook URL</FormLabel>
                                    <FormControl>
                                        <Input placeholder="https://..." {...field} disabled={isReadOnly || !form.watch("alerts_enabled")} />
                                    </FormControl>
                                    <FormDescription>
                                        Send health status changes to this URL (POST).
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
