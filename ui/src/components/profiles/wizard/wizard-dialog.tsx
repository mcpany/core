...
export interface WizardService {
    /** The ID of the service template being used. */
    templateId: string;
    /** The user-provided name for this service instance (e.g., "my-google-cal"). */
    instanceName: string;
 ...
 * @param props.onProfileCreated - Callback function triggered when a profile is successfully created.
 */
