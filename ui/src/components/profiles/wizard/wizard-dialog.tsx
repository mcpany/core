 ...
 *
 * Summary: Configuration for a service instance being created.
 */
export interface WizardService {
    /** The ID of the template being used. */
    templateId: string;
    /** The instance name (e.g., "my-google-cal"). */
...
/**
 * WizardDialog is a multi-step dialog for creating a new profile.
 *
 * Summary: Profile creation wizard component.
 *
