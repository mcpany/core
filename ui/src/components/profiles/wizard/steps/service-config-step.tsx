...
/**
 * ServiceConfigStep allows users to configure details of selected services (e.g. names).
 *
 * @param props - Component props
 * @param props.services - List of services to configure
 * @param props.onNext - Callback for next step
 * @param props.onBack - Callback for previous step
 */
