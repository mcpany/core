...
/**
 * AuthStep handles the authentication configuration for selected services.
 * @param props - The component props.
 * @param props.services - The list of services to configure authentication for.
 * @param props.onNext - Callback function called when proceeding to the next step.
