              ...
              return (
                <div key={tool.name} className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    checked={!isDisabled}
                    onCheckedChange={(c) =>
                      toggleTool(svc.name, tool.name, !!c)
                    }
                    className="h-3 w-3"
                  />
                  <label
      ...
      if (!serviceTools[svcName]) {
        try {
          ...
          const tools = res.tools.filter(
            (t: ToolDefinition) => t.serviceId === svcName,
          );
        ...
        <div className="flex-1 py-6 space-y-6 overflow-y-auto pr-2">
          <div className="space-y-4">
            <div className="grid gap-2">
              ...
              {profile && (
                <p className="text-[10px] text-muted-foreground">
                  Profile ID cannot be changed once created.
                </p>
              )}
            </div>
            ...
            <div className="grid gap-2">
              ...
              <p className="text-[10px] text-muted-foreground">
                Services matching these tags will be automatically available to
                this profile.
              </p>
            </div>
