 ...
 */
export function ResourceSafetyTable({
  resources,
  onUpdate,
}: ResourceSafetyTableProps) {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Database className="h-5 w-5" /> Resource Safety
          </CardTitle>
          <CardDescription>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Control access to resources.</CardDescription>
      </CardHeader>
      <CardContent>
        <Table>
          <TableHeader>
                  ...
                  <TableCell className="w-[150px]">
                    <div className="flex items-center space-x-2">
                      <Switch
                        checked={isEnabled}
                        onCheckedChange={() =>
                          handleToggle(resource.uri, isEnabled)
                        }
