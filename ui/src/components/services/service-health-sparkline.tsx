 ...
 */
export const ServiceHealthSparkline = memo(function ServiceHealthSparkline({
  serviceName,
  disabled,
}: ServiceHealthSparklineProps) {
  ...
  const healthColor = useMemo(() => {
    ...
    if (latest.status === "NODE_STATUS_ERROR" || latest.errorRate > 0.1)
