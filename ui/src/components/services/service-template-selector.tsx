            ...
            >
              <div className="flex w-full justify-between items-start">
                ...
                {template.featured && (
                  <Badge
                    variant="secondary"
                    className="bg-yellow-500/10 text-yellow-600 hover:bg-yellow-500/20 border-yellow-200 gap-1 text-[10px] px-1.5"
                  >
              ...
              {template.category && (
                <Badge
                  variant="outline"
                  className="mt-auto text-[10px] h-5 px-1.5 bg-background/50"
                >
                  {template.category}
                </Badge>
              )}
