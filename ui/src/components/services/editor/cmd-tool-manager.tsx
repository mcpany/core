        ...
        <div className="space-y-4">
            ...
            <div className="grid gap-4">
                ...
                {tools.map((tool, index) => {
                    ...
                    const argsDisplay = call.args && call.args.length > 0
                        ? call.args.join(" ")
                        : "(no args)";
                    ...
                    return (
                        <Card key={index} className="flex items-center justify-between p-4">
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="text-sm text-muted-foreground font-mono truncate max-w-[400px]" title={argsDisplay}>
                                    {service.commandLineService?.command} {argsDisplay}
                                </div>
