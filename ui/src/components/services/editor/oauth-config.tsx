...
export function OAuthConfig({ auth, onChange }: OAuthConfigProps) {
  const updateAuth = (
    updates: Partial<NonNullable<Authentication["oauth2"]>>,
  ) => {
    ...
    <div className="space-y-4 border-l-2 border-primary/20 pl-4">
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) =>
            updateAuth({
              clientId: { value: { plainText: e.target.value } } as any,
            })
          }
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) =>
            updateAuth({
              clientSecret: { value: { plainText: e.target.value } } as any,
            })
          }
