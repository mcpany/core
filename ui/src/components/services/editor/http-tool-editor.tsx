                ...
                {localCall.parameters?.map((param, index) => (
                    <Card key={index} className="relative">
                        ...
                        <CardContent className="p-4 grid grid-cols-12 gap-4">
                            ...
                            <div className="col-span-3 space-y-2">
                                <Label htmlFor={`param-location-${index}`}>Location</Label>
                                <Select
                                    value={param.location?.toString() || "0"}
                                    onValueChange={(val) => updateParameter(index, { location: parseInt(val) })}
                                >
                                    <SelectTrigger id={`param-location-${index}`}>
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                                        <SelectItem value={ParameterLocation.AUTO.toString()}>Auto (Default)</SelectItem>
                            ...
                            <div className="col-span-3 flex items-center justify-start pt-8 space-x-2">
                                <Switch
