 ...
 */
export function InputTransformerEditor({
  transformer,
  onChange,
  parameters = [],
}: InputTransformerEditorProps) {
        ...
        <Card className="bg-muted/50">
          <CardContent className="pt-6">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <Info className="h-4 w-4" />A webhook is configured for input
              transformation. The template above will be ignored if the webhook
              is active.
            </div>
          </CardContent>
        </Card>
