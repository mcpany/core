      ...
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <SelectContent>
              <SelectItem value={ExportPolicy_Action.EXPORT.toString()}>
                Allow All (Export)
              </SelectItem>
              <SelectItem value={ExportPolicy_Action.UNEXPORT.toString()}>
                Deny All (Unexport)
              </SelectItem>
            </SelectContent>
          </Select>
            ...
            <div key={index} className="flex gap-2 items-start">
              <div className="flex-1">
                <Input
                  ...
                  onChange={(e) =>
                    updateRule(index, { nameRegex: e.target.value })
                  }
              ...
              <Select
                ...
                onValueChange={(val) =>
                  updateRule(index, {
                    action: parseInt(val) as ExportPolicy_Action,
                  })
                }
              >
