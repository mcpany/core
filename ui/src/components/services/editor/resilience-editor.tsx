 ...
 */
export function ResilienceEditor({
  resilience,
  onChange,
}: ResilienceEditorProps) {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Maximum duration for a request before it is cancelled.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label>
                ...
                {(
                  (resilience?.circuitBreaker?.failureRateThreshold || 0.5) *
                  100
                ).toFixed(0)}
                %)
              </Label>
              <Slider
                ...
                step={0.05}
                onValueChange={(vals) =>
                  updateCircuitBreaker({ failureRateThreshold: vals[0] })
                }
              />
              <p className="text-[10px] text-muted-foreground">
                Open circuit if error rate exceeds this ratio.
              </p>
            </div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateCircuitBreaker({
                    consecutiveFailures: parseInt(e.target.value) || 0,
                  })
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                value={durationToString(
                  resilience?.circuitBreaker?.openDuration,
                )}
                onChange={(e) =>
                  updateCircuitBreaker({ openDuration: e.target.value })
                }
              />
              <p className="text-[10px] text-muted-foreground">
                Time to wait before testing connectivity (Half-Open).
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateCircuitBreaker({
                    halfOpenRequests: parseInt(e.target.value) || 1,
                  })
                }
              />
            </div>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateRetryPolicy({
                    numberOfRetries: parseInt(e.target.value) || 0,
                  })
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateRetryPolicy({ baseBackoff: e.target.value })
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateRetryPolicy({ maxBackoff: e.target.value })
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g. 10s"
                value={durationToString(
                  resilience?.retryPolicy?.maxElapsedTime,
                )}
                onChange={(e) =>
                  updateRetryPolicy({ maxElapsedTime: e.target.value })
                }
              />
            </div>
          </CardContent>
