...
export function SmartTemplateEditor({
  ...
  return (
    <div
      className={`grid grid-cols-1 lg:grid-cols-2 gap-4 h-full ${className}`}
    >
        ...
        <div className="space-y-2 flex-1 flex flex-col min-h-[150px]">
          <div className="flex justify-between items-center">
            ...
            {error ? (
              ...
              <Badge
                variant="outline"
                className="h-5 text-[10px] text-green-600 border-green-200 bg-green-50"
              >
                Valid
              </Badge>
            )}
          ...
          <Card
            className={`flex-1 overflow-hidden ${error ? "border-destructive/50 bg-destructive/5" : "bg-muted/10"}`}
          >
