...
export function AuditLogViewer() {
    ...
    const parseJson = (jsonStr: string) => {
        ...
        try {
            ...
            return jsonStr; // Fallback to raw string if it's not valid JSON
        }
    };
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="rounded-md overflow-hidden border p-4 bg-muted/20">
                                    <JsonTree data={parseJson(selectedLog.arguments) || {}} defaultExpandedLevel={2} />
                                </div>
                            </div>

                            <div>
                                <h4 className="text-sm font-medium mb-2">Result</h4>
                                <div className="rounded-md overflow-auto border p-4 bg-muted/20 max-h-[300px]">
                                    <JsonTree data={parseJson(selectedLog.result) || (selectedLog.error ? null : {})} defaultExpandedLevel={3} />
                                </div>
                            </div>
                        </div>
                    )}
