                    ...
                    {selectedLog && (
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <JsonView data={selectedLog.arguments || "{}"} maxHeight={300} defaultExpandedLevel={2} />
                            </div>

                            <div>
                                <h4 className="text-sm font-medium mb-2">Result</h4>
                                <JsonView data={selectedLog.result || (selectedLog.error ? "null" : "{}")} maxHeight={300} smartTable={true} />
                            </div>
                        </div>
                    )}
                </DialogContent>
