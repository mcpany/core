                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="rounded-md overflow-hidden border">
                                    <JsonView data={parseJsonSafe(selectedLog.arguments) || {}} maxHeight={300} defaultExpandedLevel={2} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="rounded-md overflow-hidden border">
                                    <JsonView data={parseJsonSafe(selectedLog.result) || (selectedLog.error ? null : {})} maxHeight={300} defaultExpandedLevel={2} />
                                </div>
                            </div>
                        </div>
                    )}
