...
export function AuditLogViewer() {
    ...
    const safeParseJson = (jsonStr: string) => {
        ...
        try {
            ...
            return jsonStr; // Return as string if parsing fails
        }
    };
                    ...
                    {selectedLog && (
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <JsonView data={safeParseJson(selectedLog.arguments)} />
                            </div>

                            <div>
                                <h4 className="text-sm font-medium mb-2">Result</h4>
                                <JsonView data={selectedLog.error ? null : safeParseJson(selectedLog.result)} maxHeight={300} />
                            </div>
                        </div>
                    )}
                </DialogContent>
