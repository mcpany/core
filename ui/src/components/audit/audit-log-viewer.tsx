...
export function AuditLogViewer() {
    ...
    const safeParseJson = (jsonStr: string) => {
        ...
        try {
            ...
            return jsonStr; // Return as raw string if parsing fails
        }
    };
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="rounded-md overflow-hidden">
                                    <JsonTree data={safeParseJson(selectedLog.arguments) || {}} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="rounded-md overflow-hidden">
                                    <JsonTree data={safeParseJson(selectedLog.result) || (selectedLog.error ? null : {})} />
                                </div>
                            </div>
                        </div>
                    )}
