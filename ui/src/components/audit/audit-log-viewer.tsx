                    ...
                    {selectedLog && (
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="rounded-md overflow-hidden border">
                                    {selectedLog.result ? (
                                        <RichResultViewer result={typeof selectedLog.result === 'string' ? (formatJson(selectedLog.result) ? JSON.parse(selectedLog.result) : selectedLog.result) : selectedLog.result} />
                                    ) : (
                                        <div className="bg-muted p-4 text-muted-foreground text-xs font-mono">
