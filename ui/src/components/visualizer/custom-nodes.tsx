  ...
  return (
    ...
    >
      ...
      {data.status && (
        <Badge
          variant="outline"
          className="mt-2 text-[10px] w-full justify-center bg-background/50"
        >
          {data.status}
        </Badge>
      )}
...
export const ResourceNode = memo(({ data, selected }: any) => {
  return (
    <NodeWrapper
      className="bg-cyan-50 dark:bg-cyan-950/20 border-cyan-200 dark:border-cyan-800"
      selected={selected}
    >
      <Handle
        type="target"
...
export const ServiceNode = memo(({ data, selected }: any) => {
  return (
    <NodeWrapper
      className="bg-indigo-50 dark:bg-indigo-950/20 border-indigo-200 dark:border-indigo-800"
      selected={selected}
    >
      <Handle
        type="target"
