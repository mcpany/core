...
export function KeyboardShortcutsDialog({
  ...
  const { shortcuts, overrides, updateOverride, resetOverride } =
    useKeyboardShortcuts();
    ...
    >
      <DialogContent className="max-w-2xl max-h-[80vh] flex flex-col p-0 gap-0 overflow-hidden">
        <DialogHeader className="p-6 border-b">
          ...
          <DialogDescription>
            View and customize keyboard shortcuts. Click on a shortcut to edit
            it.
          </DialogDescription>
        </DialogHeader>
                          ...
                          <div className="flex items-center gap-2">
                            <div className="flex gap-1">
                              {activeKeys.map((k, i) => (
                                <kbd
                                  key={i}
                                  className="pointer-events-none inline-flex h-6 select-none items-center gap-1 rounded border bg-muted px-2 font-mono text-[10px] font-medium text-muted-foreground opacity-100"
                                >
