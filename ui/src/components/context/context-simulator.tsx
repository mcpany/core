      ...
      <CardContent className="flex-1 overflow-hidden flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 gap-4 bg-muted/30 p-3 rounded-lg">
          ...
          <div>
            ...
            <div
              className={`text-2xl font-bold font-mono ${savings > 0 ? "text-green-500" : ""}`}
            >
                    ...
                    return (
                      ...
                      >
                        <Checkbox
                          ...
                          checked={!disabled}
                          onCheckedChange={() =>
                            toggleTool(tool.serviceId, tool.name)
                          }
                          className="mt-1"
                        />
                        <div className="grid gap-1.5 leading-none w-full">
                          <div className="flex items-center justify-between">
                            ...
                            <span
                              className={`text-xs font-mono ${isGhost && !disabled ? "text-amber-500 font-bold" : "text-muted-foreground"}`}
                            >
