          ...
          <Tabs defaultValue="claude" className="w-full">
            ...
            <TabsContent value="claude" className="space-y-4 pt-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Edit your <code>claude_desktop_config.json</code> and add this
                  entry. Note: Requires Node.js installed to run the SSE client
                  bridge.
                </p>
              </div>
            ...
            <TabsContent value="cursor" className="space-y-4 pt-4">
              <div className="space-y-2">
                ...
                <ol className="list-decimal pl-4 text-sm space-y-2 text-muted-foreground">
                  ...
                  <li>
                    Select Type: <strong>SSE</strong>
                  </li>
                  <li>
                    Enter Name: <code>MCP Any</code>
                  </li>
              ...
              <div className="flex items-center space-x-2">
                <Input
                  readOnly
                  value={authenticatedUrl}
                  className="font-mono text-xs"
                />
                <Button
                  size="icon"
                  variant="outline"
                  onClick={() => copyToClipboard(authenticatedUrl)}
                >
            ...
            <TabsContent value="vscode" className="space-y-4 pt-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Add this to your VS Code <code>settings.json</code> if you are
                  using an MCP extension that supports generic servers.
                </p>
              </div>
