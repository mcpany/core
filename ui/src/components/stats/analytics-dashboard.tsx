...
export function AnalyticsDashboard() {
    ...
    const { totalRequests, avgLatency, errorCount, errorRate, avgRps } = useMemo(() => {
        // ⚡ BOLT: [Algorithmic] Combined multiple O(N) array passes into a single iteration to calculate traffic statistics, reducing CPU overhead for large datasets.
        ...
        const avgLatency = trafficData.length > 0 ? Math.floor(totalLatency / trafficData.length) : 0;
