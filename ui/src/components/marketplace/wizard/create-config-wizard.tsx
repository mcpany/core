...
function WizardContent({
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case WizardStep.REVIEW:
        return <StepReview onComplete={onComplete} />;
      default:
        return null;
    }
  };
  ...
  const getStepTitle = () => {
    switch (step) {
      ...
      case WizardStep.WEBHOOKS:
        return "3. Webhooks & Transformers";
      case WizardStep.AUTH:
        return "4. Authentication";
      case WizardStep.REVIEW:
        return "5. Review & Finish";
      default:
        return "";
    }
  };
  ...
  return (
    <>
      ...
      <DialogFooter className="mt-4 gap-2">
        ...
        {step < WizardStep.REVIEW && <Button onClick={handleNext}>Next</Button>}
      </DialogFooter>
    </>
  );
}
