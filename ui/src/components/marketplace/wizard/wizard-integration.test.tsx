...
describe('CreateConfigWizard Integration', () => {
    it('should allow selecting a registry template and filling schema form', async () => {
        ...
        expect(trigger).toHaveTextContent('Manual / Custom');
        ...
        // Adjust regex to be flexible with * for required
        ...
        // The Finish button is likely "Create Service" or similar.
        // Checking StepReview component... it says "Create Service" usually?
        // Let's check the text content of the button.
        // In CreateConfigWizard, it renders StepReview.
        // StepReview usually has a button "Create Service".
        // But CreateConfigWizard passes onComplete to StepReview.
        // StepReview calls onComplete.

        // Let's try to find "Finish"
