...
/**
 * A dynamic form component that renders fields based on a JSON Schema.
 *
 * It supports basic types like strings, booleans, and enums (selects),
 * and automatically masks fields that appear to be secrets.
 *
