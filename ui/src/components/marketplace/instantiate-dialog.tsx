    ...
    if (open && templateConfig) {
      ...
      if (templateConfig.commandLineService) {
        ...
        if (templateConfig.commandLineService.env) {
          Object.entries(templateConfig.commandLineService.env).forEach(
            ([k, v]) => {
              const sv = v as any;
              let val = "";
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <>
              <div className="grid gap-2">
                ...
                <p className="text-xs text-muted-foreground">
                  The command to run the MCP server. Use absolute paths for
        ...
        <DialogFooter>
          <Button
            ...
            disabled={loading || (parsedSchema && !isSchemaValid)}
          >
