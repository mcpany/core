      ...
      return (
        <Popover>
          <PopoverTrigger asChild>
            <Badge
              variant="secondary"
              className="cursor-pointer hover:bg-secondary/80 flex items-center gap-1 w-fit font-mono text-xs"
            >
              <Icon className="h-3 w-3" />
              {label}
            </Badge>
          </PopoverTrigger>
          <PopoverContent className="w-[400px] p-0 shadow-lg border-border/50 backdrop-blur-md bg-background/95">
