 ...
 */
export const FileConfigCard = memo(function FileConfigCard({
  service,
}: {
      ...
      <CardContent>
        <div className="mb-4">
          <p className="text-sm text-muted-foreground">
            Filesystem services allow defining specific allowed and denied
            paths. You can edit these in the configuration JSON below.
          </p>
        </div>
