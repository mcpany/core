...
/**
 * LazyMcpDashboard provides an interactive UI for monitoring and searching the on-demand tool index.
 *
 * Summary: Renders the Lazy-MCP dashboard.
 *
 * Returns:
 *   React.ReactElement: The dashboard UI component.
 */
