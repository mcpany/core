    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            const report = {
                ...
                metrics,
                services: services.map((s: { name: string, version: string, httpService?: boolean, grpcService?: boolean }) => ({ name: s.name, version: s.version, type: s.httpService ? "HTTP" : s.grpcService ? "gRPC" : "Other" })),
                topTools: tools,
