...
import { ToolRunHistoryItem } from "./tool-run-history-item";
        ...
        <Tabs defaultValue="builder" className="flex-1 flex flex-col overflow-hidden">
             ...
             <TabsContent value="metrics" className="flex-1 overflow-y-auto p-6 m-0">
                ...
                <div className="grid gap-6">
                    ...
                    <div className="space-y-2">
                        <Label className="flex items-center gap-2 font-semibold">
                            <HistoryIcon className="h-4 w-4" /> Execution History
                        </Label>
                        <div className="rounded-xl border border-white/10 shadow-sm backdrop-blur-md bg-card/50 overflow-hidden transition-all divide-y divide-border/50">
                            {auditLogs.length === 0 && (
