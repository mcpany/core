...
const ExternalMarketplacePage = lazy(
  () => import("./app/marketplace/external/[id]/page"),
);
...
const ServicePromptPage = lazy(
  () => import("./app/service/[id]/prompt/[name]/page"),
);
const ServiceResourcePage = lazy(
  () => import("./app/service/[id]/resource/[name]/page"),
);
const ServiceToolPage = lazy(
  () => import("./app/service/[id]/tool/[name]/page"),
);
const SettingsMiddlewarePage = lazy(
  () => import("./app/settings/middleware/page"),
);
...
const UpstreamServiceDetailPage = lazy(
  () => import("./app/upstream-services/[serviceId]/page"),
);
    ...
    <Suspense fallback={<PageFallback />}>
      <Routes>
        ...
        <Route element={<Layout />}>
          ...
          <Route
            path="/marketplace/external/:id"
            element={<ExternalMarketplacePage />}
          />
          ...
          <Route
            path="/service/:id/resource/:name"
            element={<ServiceResourcePage />}
          />
          <Route
            path="/service/:id/prompt/:name"
            element={<ServicePromptPage />}
          />
          <Route path="/settings" element={<SettingsPage />} />
          <Route
            path="/settings/middleware"
            element={<SettingsMiddlewarePage />}
          />
          ...
          <Route
            path="/upstream-services/:serviceId"
            element={<UpstreamServiceDetailPage />}
          />
