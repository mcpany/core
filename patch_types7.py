...
if "IsStreaming() bool" not in content:
    content = content.replace("""\tExecute(ctx context.Context, req *ExecutionRequest) (any, error)

	// GetCacheConfig returns the cache configuration for the tool.""", """\tExecute(ctx context.Context, req *ExecutionRequest) (any, error)
...
// Action defines the decision made by a pre-call hook.""", """\tCall(ctx context.Context, req *ExecutionRequest) (any, error)
}
