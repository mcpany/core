...
func TestAutoGenStreamTaskDirect(t *testing.T) {
	adapter := interop.NewAutoGenAdapter()

	task := &interop.Task{
		ID:        "task-ag-streamtask",
		Framework: "AutoGen",
...
func TestAutoGenStreamTaskDirectContextCancel1(t *testing.T) {
	adapter := interop.NewAutoGenAdapter()
...
func TestAutoGenStreamTaskDirectContextCancel2(t *testing.T) {
	adapter := interop.NewAutoGenAdapter()
...
func TestAutoGenStreamTaskUnsupported(t *testing.T) {
	adapter := interop.NewAutoGenAdapter()

	task := &interop.Task{
		ID:        "task-ag-streamtask-unsupported",
		Framework: "AutoGen",
