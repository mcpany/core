...
### Linting
Ensure code adheres to our style guides (Structured Godoc for Go, TSDoc for TypeScript). We strictly enforce **100% documentation coverage** for all public APIs.
