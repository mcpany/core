...
Follow these exact commands to clone, install dependencies, and run the application.
...
# 2. Install dependencies (Go modules, tools, etc.)
make prepare

# 3. Build the server binary and UI assets
make build

# 4. Run the server with a minimal configuration
