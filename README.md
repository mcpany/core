...
### Linting
Ensure code adheres to our style guides (Godoc for Go, TSDoc for TypeScript). We strictly enforce **100% documentation coverage** for all public APIs. This is verified by our custom `check-doc` tool.
