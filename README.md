...
- **Advanced Service & Safety Policies**:
  ...
  - **Performance**: Configure [Caching](server/docs/caching.md) (including **Semantic Caching**) and Rate Limiting to optimize performance and protect upstream services.
