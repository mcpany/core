...
Follow these exact commands to get up and running immediately.
...
Ensure code style compliance. We enforce **100% documentation coverage** for all public interfaces.
```bash
make lint
```
...
MCP Any acts as a centralized middleware between AI Agents (Clients) and your Upstream Services. It is built with **Go** for high performance and uses a modular architecture.
...
*   **Sidecar/Gateway**: Deployable as a standalone gateway or Kubernetes sidecar.
