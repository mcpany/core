...
def scan_dir(root_dir):
    ...
    for root, dirs, files in os.walk(root_dir):
        ...
        for file in files:
            if file.endswith('.go') and not file.endswith('_test.go') and not file.endswith('.pb.go') and not file.endswith('.pb.gw.go') and not file.endswith('.pb.go') and not file.endswith('.pb.gw.go'):
