...
- **Response**: `ListServicesResponse` containing a list of `ServiceState` (which includes `UpstreamServiceConfig` and status).
...
- **Response**: `GetServiceResponse` containing `ServiceState` (which includes `UpstreamServiceConfig` and status).
