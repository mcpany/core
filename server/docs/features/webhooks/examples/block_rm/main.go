...
//
// Summary: Data structure for the incoming webhook request.
...
//
// Summary: Data structure for the webhook response.
...
//
// Summary: Data structure for the status field in webhook response.
