...
func (x *CreateServiceResponse) GetService() *v1.UpstreamServiceConfig {
	if x != nil {
		return x.xxx_hidden_Service
	}
	return nil
...
func (x *CreateServiceResponse) SetService(v *v1.UpstreamServiceConfig) {
	x.xxx_hidden_Service = v
}

func (x *CreateServiceResponse) HasService() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_Service != nil
...
func (x *CreateServiceResponse) ClearService() {
	x.xxx_hidden_Service = nil
}
...
func (x *UpdateServiceRequest) GetService() *v1.UpstreamServiceConfig {
	if x != nil {
		return x.xxx_hidden_Service
	}
	return nil
...
func (x *UpdateServiceRequest) SetService(v *v1.UpstreamServiceConfig) {
	x.xxx_hidden_Service = v
}

func (x *UpdateServiceRequest) HasService() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_Service != nil
...
func (x *UpdateServiceRequest) ClearService() {
	x.xxx_hidden_Service = nil
}
...
func (x *UpdateServiceResponse) GetService() *v1.UpstreamServiceConfig {
	if x != nil {
		return x.xxx_hidden_Service
	}
	return nil
...
func (x *UpdateServiceResponse) SetService(v *v1.UpstreamServiceConfig) {
	x.xxx_hidden_Service = v
}

func (x *UpdateServiceResponse) HasService() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_Service != nil
...
func (x *UpdateServiceResponse) ClearService() {
	x.xxx_hidden_Service = nil
}
...
const file_proto_admin_v1_admin_proto_rawDesc = "" +
	...
	"\aservice\x18\x01 \x01(\v2'.mcpany.config.v1.UpstreamServiceConfigR\aservice\"Y\n" +
	"\x14CreateServiceRequest\x12A\n" +
	"\aservice\x18\x01 \x01(\v2'.mcpany.config.v1.UpstreamServiceConfigR\aservice\"Z\n" +
	"\x15CreateServiceResponse\x12A\n" +
	"\aservice\x18\x01 \x01(\v2'.mcpany.config.v1.UpstreamServiceConfigR\aservice\"Y\n" +
	"\x14UpdateServiceRequest\x12A\n" +
	"\aservice\x18\x01 \x01(\v2'.mcpany.config.v1.UpstreamServiceConfigR\aservice\"Z\n" +
	"\x15UpdateServiceResponse\x12A\n" +
	"\aservice\x18\x01 \x01(\v2'.mcpany.config.v1.UpstreamServiceConfigR\aservice\"5\n" +
	...
	"\x04tool\x18\x01 \x01(\v2\x1a.mcpany.mcp_router.v1.ToolR\x04tool2\xdb\x05\n" +
	"\fAdminService\x12U\n" +
	"\n" +
	...
	"\n" +
	"GetService\x12\".mcpany.admin.v1.GetServiceRequest\x1a#.mcpany.admin.v1.GetServiceResponse\x12^\n" +
	"\rCreateService\x12%.mcpany.admin.v1.CreateServiceRequest\x1a&.mcpany.admin.v1.CreateServiceResponse\x12^\n" +
	"\rUpdateService\x12%.mcpany.admin.v1.UpdateServiceRequest\x1a&.mcpany.admin.v1.UpdateServiceResponse\x12^\n" +
	"\rDeleteService\x12%.mcpany.admin.v1.DeleteServiceRequest\x1a&.mcpany.admin.v1.DeleteServiceResponse\x12R\n" +
...
var file_proto_admin_v1_admin_proto_goTypes = []any{
	...
	(*CreateServiceRequest)(nil),     // 6: mcpany.admin.v1.CreateServiceRequest
	(*CreateServiceResponse)(nil),    // 7: mcpany.admin.v1.CreateServiceResponse
	(*UpdateServiceRequest)(nil),     // 8: mcpany.admin.v1.UpdateServiceRequest
	(*UpdateServiceResponse)(nil),    // 9: mcpany.admin.v1.UpdateServiceResponse
	(*DeleteServiceRequest)(nil),     // 10: mcpany.admin.v1.DeleteServiceRequest
	(*DeleteServiceResponse)(nil),    // 11: mcpany.admin.v1.DeleteServiceResponse
	(*ListToolsRequest)(nil),         // 12: mcpany.admin.v1.ListToolsRequest
	(*ListToolsResponse)(nil),        // 13: mcpany.admin.v1.ListToolsResponse
	(*GetToolRequest)(nil),           // 14: mcpany.admin.v1.GetToolRequest
	(*GetToolResponse)(nil),          // 15: mcpany.admin.v1.GetToolResponse
	(*v1.UpstreamServiceConfig)(nil), // 16: mcpany.config.v1.UpstreamServiceConfig
	(*v11.Tool)(nil),                 // 17: mcpany.mcp_router.v1.Tool
}
var file_proto_admin_v1_admin_proto_depIdxs = []int32{
	16, // 0: mcpany.admin.v1.ListServicesResponse.services:type_name -> mcpany.config.v1.UpstreamServiceConfig
	16, // 1: mcpany.admin.v1.GetServiceResponse.service:type_name -> mcpany.config.v1.UpstreamServiceConfig
	16, // 2: mcpany.admin.v1.CreateServiceRequest.service:type_name -> mcpany.config.v1.UpstreamServiceConfig
	16, // 3: mcpany.admin.v1.CreateServiceResponse.service:type_name -> mcpany.config.v1.UpstreamServiceConfig
	16, // 4: mcpany.admin.v1.UpdateServiceRequest.service:type_name -> mcpany.config.v1.UpstreamServiceConfig
	16, // 5: mcpany.admin.v1.UpdateServiceResponse.service:type_name -> mcpany.config.v1.UpstreamServiceConfig
	17, // 6: mcpany.admin.v1.ListToolsResponse.tools:type_name -> mcpany.mcp_router.v1.Tool
	17, // 7: mcpany.admin.v1.GetToolResponse.tool:type_name -> mcpany.mcp_router.v1.Tool
	0,  // 8: mcpany.admin.v1.AdminService.ClearCache:input_type -> mcpany.admin.v1.ClearCacheRequest
	2,  // 9: mcpany.admin.v1.AdminService.ListServices:input_type -> mcpany.admin.v1.ListServicesRequest
	4,  // 10: mcpany.admin.v1.AdminService.GetService:input_type -> mcpany.admin.v1.GetServiceRequest
	6,  // 11: mcpany.admin.v1.AdminService.CreateService:input_type -> mcpany.admin.v1.CreateServiceRequest
	8,  // 12: mcpany.admin.v1.AdminService.UpdateService:input_type -> mcpany.admin.v1.UpdateServiceRequest
	10, // 13: mcpany.admin.v1.AdminService.DeleteService:input_type -> mcpany.admin.v1.DeleteServiceRequest
	12, // 14: mcpany.admin.v1.AdminService.ListTools:input_type -> mcpany.admin.v1.ListToolsRequest
	14, // 15: mcpany.admin.v1.AdminService.GetTool:input_type -> mcpany.admin.v1.GetToolRequest
	1,  // 16: mcpany.admin.v1.AdminService.ClearCache:output_type -> mcpany.admin.v1.ClearCacheResponse
	3,  // 17: mcpany.admin.v1.AdminService.ListServices:output_type -> mcpany.admin.v1.ListServicesResponse
	5,  // 18: mcpany.admin.v1.AdminService.GetService:output_type -> mcpany.admin.v1.GetServiceResponse
	7,  // 19: mcpany.admin.v1.AdminService.CreateService:output_type -> mcpany.admin.v1.CreateServiceResponse
	9,  // 20: mcpany.admin.v1.AdminService.UpdateService:output_type -> mcpany.admin.v1.UpdateServiceResponse
	11, // 21: mcpany.admin.v1.AdminService.DeleteService:output_type -> mcpany.admin.v1.DeleteServiceResponse
	13, // 22: mcpany.admin.v1.AdminService.ListTools:output_type -> mcpany.admin.v1.ListToolsResponse
	15, // 23: mcpany.admin.v1.AdminService.GetTool:output_type -> mcpany.admin.v1.GetToolResponse
