...
func (x *UpdateServiceResponse) GetServiceId() string {
	if x != nil {
		if x.xxx_hidden_ServiceId != nil {
			return *x.xxx_hidden_ServiceId
		}
...
func (x *UpdateServiceResponse) SetServiceId(v string) {
	x.xxx_hidden_ServiceId = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 1)
}

func (x *UpdateServiceResponse) HasServiceId() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *UpdateServiceResponse) ClearServiceId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_ServiceId = nil
}
...
func (x *DeleteServiceRequest) SetServiceName(v string) {
	x.xxx_hidden_ServiceName = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 1)
}

func (x *DeleteServiceRequest) HasServiceName() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *DeleteServiceRequest) ClearServiceName() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
...
const file_proto_admin_v1_admin_proto_rawDesc = "" +
	...
	"\aservice\x18\x01 \x01(\v2'.mcpany.config.v1.UpstreamServiceConfigR\aservice\"6\n" +
	"\x15CreateServiceResponse\x12\x1d\n" +
	"\n" +
	"service_id\x18\x01 \x01(\tR\tserviceId\"Y\n" +
	"\x14UpdateServiceRequest\x12A\n" +
	"\aservice\x18\x01 \x01(\v2'.mcpany.config.v1.UpstreamServiceConfigR\aservice\"6\n" +
	"\x15UpdateServiceResponse\x12\x1d\n" +
	"\n" +
	"service_id\x18\x01 \x01(\tR\tserviceId\"9\n" +
	"\x14DeleteServiceRequest\x12!\n" +
	"\fservice_name\x18\x01 \x01(\tR\vserviceName\"\x17\n" +
	"\x15DeleteServiceResponse2\xdb\x05\n" +
	"\fAdminService\x12U\n" +
	"\n" +
...
var file_proto_admin_v1_admin_proto_goTypes = []any{
	...
	(*UpdateServiceRequest)(nil),     // 12: mcpany.admin.v1.UpdateServiceRequest
	(*UpdateServiceResponse)(nil),    // 13: mcpany.admin.v1.UpdateServiceResponse
	(*DeleteServiceRequest)(nil),     // 14: mcpany.admin.v1.DeleteServiceRequest
	(*DeleteServiceResponse)(nil),    // 15: mcpany.admin.v1.DeleteServiceResponse
...
var file_proto_admin_v1_admin_proto_depIdxs = []int32{
	...
	17, // 2: mcpany.admin.v1.ListToolsResponse.tools:type_name -> mcpany.mcp_router.v1.Tool
	17, // 3: mcpany.admin.v1.GetToolResponse.tool:type_name -> mcpany.mcp_router.v1.Tool
	16, // 4: mcpany.admin.v1.CreateServiceRequest.service:type_name -> mcpany.config.v1.UpstreamServiceConfig
	16, // 5: mcpany.admin.v1.UpdateServiceRequest.service:type_name -> mcpany.config.v1.UpstreamServiceConfig
	0,  // 6: mcpany.admin.v1.AdminService.ClearCache:input_type -> mcpany.admin.v1.ClearCacheRequest
	2,  // 7: mcpany.admin.v1.AdminService.ListServices:input_type -> mcpany.admin.v1.ListServicesRequest
	4,  // 8: mcpany.admin.v1.AdminService.GetService:input_type -> mcpany.admin.v1.GetServiceRequest
	6,  // 9: mcpany.admin.v1.AdminService.ListTools:input_type -> mcpany.admin.v1.ListToolsRequest
	8,  // 10: mcpany.admin.v1.AdminService.GetTool:input_type -> mcpany.admin.v1.GetToolRequest
	10, // 11: mcpany.admin.v1.AdminService.CreateService:input_type -> mcpany.admin.v1.CreateServiceRequest
	12, // 12: mcpany.admin.v1.AdminService.UpdateService:input_type -> mcpany.admin.v1.UpdateServiceRequest
	14, // 13: mcpany.admin.v1.AdminService.DeleteService:input_type -> mcpany.admin.v1.DeleteServiceRequest
	...
	13, // 20: mcpany.admin.v1.AdminService.UpdateService:output_type -> mcpany.admin.v1.UpdateServiceResponse
	15, // 21: mcpany.admin.v1.AdminService.DeleteService:output_type -> mcpany.admin.v1.DeleteServiceResponse
