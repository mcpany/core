...
type McpAnyServerConfig struct {
	...
	xxx_hidden_SystemWebhooks             *[]*SystemWebhookConfig       `protobuf:"bytes,5,rep,name=system_webhooks"`
...
func (x *McpAnyServerConfig) GetSystemWebhooks() []*SystemWebhookConfig {
	if x != nil {
		if x.xxx_hidden_SystemWebhooks != nil {
			return *x.xxx_hidden_SystemWebhooks
		}
	}
	return nil
}
...
func (b0 McpAnyServerConfig_builder) Build() *McpAnyServerConfig {
	...
	x.xxx_hidden_SystemWebhooks = &b.SystemWebhooks
	return m0
}
