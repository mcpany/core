...
type GlobalSettings struct {
	...
	SemanticCacheDbPath *string `protobuf:"bytes,13,opt,name=semantic_cache_db_path" json:"semantic_cache_db_path,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *GlobalSettings) GetSemanticCacheDbPath() string {
	if x != nil && x.SemanticCacheDbPath != nil {
		return *x.SemanticCacheDbPath
	}
	return ""
}
...
func (x *GlobalSettings) HasSemanticCacheDbPath() bool {
	...
	return x.SemanticCacheDbPath != nil
}
...
func (b0 GlobalSettings_builder) Build() *GlobalSettings {
	...
	x.SemanticCacheDbPath = b.SemanticCacheDbPath
	return m0
}
