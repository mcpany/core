...
const file_proto_config_v1_config_proto_rawDesc = "" +
	...
	"\x05roles\x18\x04 \x03(\tR\x05roles\"\xac\x01\n" +
	"\x06Secret\x12\x0e\n" +
	...
	"\x0fLOG_FORMAT_JSON\x10\x02J\x04\b\x02\x10\x03\"\x8c\x01\n" +
	"\n" +
	"OIDCConfig\x12\x16\n" +
...
var file_proto_config_v1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_proto_config_v1_config_proto_goTypes = []any{
	...
	(*ProfileDefinition)(nil),         // 12: mcpany.config.v1.ProfileDefinition
	(*ProfileSelector)(nil),           // 13: mcpany.config.v1.ProfileSelector
	(*Middleware)(nil),                // 14: mcpany.config.v1.Middleware
	nil,                               // 15: mcpany.config.v1.AuditConfig.WebhookHeadersEntry
	nil,                               // 16: mcpany.config.v1.ProfileSelector.ToolPropertiesEntry
	(*UpstreamServiceConfig)(nil),     // 17: mcpany.config.v1.UpstreamServiceConfig
	(*UpstreamServiceCollection)(nil), // 18: mcpany.config.v1.UpstreamServiceCollection
	(*AuthenticationConfig)(nil),      // 19: mcpany.config.v1.AuthenticationConfig
	(*bus.MessageBus)(nil),            // 20: bus.MessageBus
}
var file_proto_config_v1_config_proto_depIdxs = []int32{
	...
	17, // 1: mcpany.config.v1.McpAnyServerConfig.upstream_services:type_name -> mcpany.config.v1.UpstreamServiceConfig
	18, // 2: mcpany.config.v1.McpAnyServerConfig.upstream_service_collections:type_name -> mcpany.config.v1.UpstreamServiceCollection
	4,  // 3: mcpany.config.v1.McpAnyServerConfig.users:type_name -> mcpany.config.v1.User
	19, // 4: mcpany.config.v1.User.authentication:type_name -> mcpany.config.v1.AuthenticationConfig
	...
	20, // 7: mcpany.config.v1.GlobalSettings.message_bus:type_name -> bus.MessageBus
	11, // 8: mcpany.config.v1.GlobalSettings.audit:type_name -> mcpany.config.v1.AuditConfig
	12, // 9: mcpany.config.v1.GlobalSettings.profile_definitions:type_name -> mcpany.config.v1.ProfileDefinition
	1,  // 10: mcpany.config.v1.GlobalSettings.log_format:type_name -> mcpany.config.v1.GlobalSettings.LogFormat
	14, // 11: mcpany.config.v1.GlobalSettings.middlewares:type_name -> mcpany.config.v1.Middleware
	...
	15, // 16: mcpany.config.v1.AuditConfig.webhook_headers:type_name -> mcpany.config.v1.AuditConfig.WebhookHeadersEntry
	13, // 17: mcpany.config.v1.ProfileDefinition.selector:type_name -> mcpany.config.v1.ProfileSelector
	16, // 18: mcpany.config.v1.ProfileSelector.tool_properties:type_name -> mcpany.config.v1.ProfileSelector.ToolPropertiesEntry
