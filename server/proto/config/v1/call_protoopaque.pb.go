...
type CacheConfig_Storage int32

const (
	CacheConfig_STORAGE_UNSPECIFIED CacheConfig_Storage = 0
	CacheConfig_STORAGE_MEMORY      CacheConfig_Storage = 1
	CacheConfig_STORAGE_REDIS       CacheConfig_Storage = 2
)

// Enum value maps for CacheConfig_Storage.
var (
	CacheConfig_Storage_name = map[int32]string{
		0: "STORAGE_UNSPECIFIED",
		1: "STORAGE_MEMORY",
		2: "STORAGE_REDIS",
	}
	CacheConfig_Storage_value = map[string]int32{
...
func (x CacheConfig_Storage) Enum() *CacheConfig_Storage {
	p := new(CacheConfig_Storage)
	*p = x
	return p
}

func (x CacheConfig_Storage) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CacheConfig_Storage) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_config_v1_call_proto_enumTypes[3].Descriptor()
}

func (CacheConfig_Storage) Type() protoreflect.EnumType {
	return &file_proto_config_v1_call_proto_enumTypes[3]
}

func (x CacheConfig_Storage) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
// CacheConfig defines caching behavior for tool execution.
type CacheConfig struct {
	...
	xxx_hidden_Storage     CacheConfig_Storage    `protobuf:"varint,4,opt,name=storage,enum=mcpany.config.v1.CacheConfig_Storage"`
...
func (x *CacheConfig) GetStorage() CacheConfig_Storage {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 3) {
			return x.xxx_hidden_Storage
		}
	}
	return CacheConfig_STORAGE_UNSPECIFIED
}

func (x *CacheConfig) GetRedis() *bus.RedisBus {
	if x != nil {
...
func (x *CacheConfig) SetStorage(v CacheConfig_Storage) {
	x.xxx_hidden_Storage = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 3, 5)
}

func (x *CacheConfig) SetRedis(v *bus.RedisBus) {
...
func (x *CacheConfig) HasStorage() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 3)
...
func (x *CacheConfig) HasRedis() bool {
	if x == nil {
		return false
	}
...
func (x *CacheConfig) ClearStorage() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 3)
	x.xxx_hidden_Storage = CacheConfig_STORAGE_UNSPECIFIED
}

func (x *CacheConfig) ClearRedis() {
...
const file_proto_config_v1_call_proto_rawDesc = "" +
	"\n" +
	"\x1aproto/config/v1/call.proto\x12\x10mcpany.config.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1aproto/config/v1/auth.proto\x1a\x1dproto/config/v1/webhook.proto\x1a\x13proto/bus/bus.proto\"\xce\x05\n" +
	...
	"\x06schema\x18\x01 \x01(\v2!.mcpany.config.v1.ParameterSchemaR\x06schema\x125\n" +
	"\x06secret\x18\x02 \x01(\v2\x1d.mcpany.config.v1.SecretValueR\x06secret\"\xa7\x02\n" +
	...
	"\astorage\x18\x04 \x01(\x0e2%.mcpany.config.v1.CacheConfig.StorageR\astorage\x12#\n" +
...
var file_proto_config_v1_call_proto_goTypes = []any{
	...
	(CacheConfig_Storage)(0),            // 3: mcpany.config.v1.CacheConfig.Storage
	...
	(*bus.RedisBus)(nil),                // 27: bus.RedisBus
}
var file_proto_config_v1_call_proto_depIdxs = []int32{
	...
	3,  // 57: mcpany.config.v1.CacheConfig.storage:type_name -> mcpany.config.v1.CacheConfig.Storage
	27, // 58: mcpany.config.v1.CacheConfig.redis:type_name -> bus.RedisBus
