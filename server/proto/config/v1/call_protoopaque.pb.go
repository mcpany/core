...
type CacheConfig struct {
	...
	xxx_hidden_Semantic    *SemanticCacheConfig   `protobuf:"bytes,4,opt,name=semantic"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
func (x *CacheConfig) HasSemantic() bool {
	...
	return x.xxx_hidden_Semantic != nil
}
...
func (b0 CacheConfig_builder) Build() *CacheConfig {
	...
	x.xxx_hidden_Semantic = b.Semantic
	return m0
}
...
type SemanticCacheConfig struct {
	state                          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_IsEnabled           bool                   `protobuf:"varint,1,opt,name=is_enabled"`
	xxx_hidden_SimilarityThreshold float32                `protobuf:"fixed32,2,opt,name=similarity_threshold"`
	xxx_hidden_EmbeddingProvider   *string                `protobuf:"bytes,3,opt,name=embedding_provider"`
	xxx_hidden_EmbeddingModel      *string                `protobuf:"bytes,4,opt,name=embedding_model"`
	XXX_raceDetectHookData         protoimpl.RaceDetectHookData
	XXX_presence                   [1]uint32
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
...
func (x *SemanticCacheConfig) GetEmbeddingModel() string {
	if x != nil {
		if x.xxx_hidden_EmbeddingModel != nil {
			return *x.xxx_hidden_EmbeddingModel
		}
		return ""
	}
	return ""
...
func (x *SemanticCacheConfig) ClearEmbeddingModel() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 3)
	x.xxx_hidden_EmbeddingModel = nil
}
...
func (b0 SemanticCacheConfig_builder) Build() *SemanticCacheConfig {
	...
	if b.EmbeddingModel != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 3, 4)
		x.xxx_hidden_EmbeddingModel = b.EmbeddingModel
	}
	return m0
}
