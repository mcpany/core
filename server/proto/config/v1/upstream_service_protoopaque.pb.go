...
// FilesystemUpstreamService defines an upstream service that exposes a local file system.
...
func (x *FilesystemUpstreamService) GetRootPath() string {
	if x != nil {
		if x.xxx_hidden_RootPath != nil {
			return *x.xxx_hidden_RootPath
		}
...
func (x *FilesystemUpstreamService) SetRootPath(v string) {
	x.xxx_hidden_RootPath = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 2)
}
...
func (x *FilesystemUpstreamService) HasRootPath() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *FilesystemUpstreamService) ClearRootPath() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_RootPath = nil
}
...
type FilesystemUpstreamService_builder struct {
	...
	// The root path of the file system to expose.
	RootPath *string
...
const file_proto_config_v1_upstream_service_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2#.mcpany.config.v1.SqlCallDefinitionR\x05value:\x028\x01\"W\n" +
	"\x19FilesystemUpstreamService\x12\x1c\n" +
	"\troot_path\x18\x01 \x01(\tR\troot_path\x12\x1c\n" +
	"\tread_only\x18\x02 \x01(\bR\tread_only\"\xbf\x05\n" +
...
var file_proto_config_v1_upstream_service_proto_depIdxs = []int32{
	...
	53,  // 17: mcpany.config.v1.UpstreamServiceConfig.authentication:type_name -> mcpany.config.v1.AuthenticationConfig
	...
	54,  // 21: mcpany.config.v1.UpstreamServiceConfig.profiles:type_name -> mcpany.config.v1.Profile
	55,  // 22: mcpany.config.v1.UpstreamServiceConfig.prompts:type_name -> mcpany.config.v1.PromptDefinition
