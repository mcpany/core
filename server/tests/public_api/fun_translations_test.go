...
// TestUpstreamService_FunTranslations ...
// Summary: TestUpstreamService_FunTranslations
// Parameters:
//   - None.
// Returns:
//   - None.
...
//   - None.
	...
	// --- 3. Register Fun Translations Server with MCPANY (pointing to Mock) ---
	const funTranslationsServiceID = "e2e_funtranslations"
	// Use the mock server URL instead of the real API
	...
	// Call the tool directly (mock server is fast, no retries needed for network issues)
	...
	t.Logf("DEBUG: Received text content: %s", textContent.Text)
