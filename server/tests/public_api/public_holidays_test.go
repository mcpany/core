...
func TestUpstreamService_PublicHolidaysWithTransformation(t *testing.T) {
	...
	// --- 1. Start Mock Server ---
	mockResponse := `[{"date": "2024-01-01", "name": "New Year's Day"}]`
	mockServer := integration.CreateMockServerWithResponses(t, map[string]string{
		"/api/v3/PublicHolidays/2024/US": mockResponse,
	})
	...
	// 3. Register Public Holidays Service with MCPANY
...
func TestUpstreamService_PublicHolidaysWithTransformation_CA_2025(t *testing.T) {
	...
	// --- 1. Start Mock Server ---
	mockResponse := `[{"date": "2025-01-01", "name": "New Year's Day"}]`
	mockServer := integration.CreateMockServerWithResponses(t, map[string]string{
		"/api/v3/PublicHolidays/2025/CA": mockResponse,
	})
	defer mockServer.Close()
