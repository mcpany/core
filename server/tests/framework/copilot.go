...
//
// Summary: Action for MCPServerConfig.
//
// Parameters:
//   - None.
//
...
// Returns the result.
//
// Summary: Action for NewCopilotCLI.
//
// Parameters:
//   - None.
//
