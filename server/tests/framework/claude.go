...
// ClaudeCLI claudeCLI represents a claude cli.
//
// Summary: ClaudeCLI represents a claude cli.
type ClaudeCLI struct {
	t *testing.T
}

// NewClaudeCLI creates a new claude cli.
//
// Summary: Creates a new claude cli.
//
// Parameters:
//   - t (*testing.T): The t.
//
// Returns:
//   - *ClaudeCLI: The result.
//
// Errors:
//   - None.
//
