...
//
// Summary: ValidateRegisteredTool provides functionality.
//
// Parameters:
//   - None.
//
...
//
// Summary: RunE2ETest provides functionality.
//
// Parameters:
//   - None.
//
...
func RunE2ETest(t *testing.T, testCase *E2ETestCase) {
	for _, method := range testCase.RegistrationMethods {
		...
		t.Run(fmt.Sprintf("%s_%s", testCase.Name, method), func(t *testing.T) {
			...
			// Returns the result.
			//
			// Summary: BuildGRPCWeatherServer provides functionality.
			//
			// Parameters:
			//   - None.
			//
			...
			//
			// Summary: RegisterGRPCWeatherService provides functionality.
			//
			// Parameters:
			//   - None.
			//
			...
			// Returns the result.
			//
			// Summary: BuildGRPCAuthedWeatherServer provides functionality.
			//
			// Parameters:
			//   - None.
			//
			...
			// WaitForPort waits for a process to output its assigned port.
			//
			// Summary: WaitForPort provides functionality.
			//
			// Parameters:
			//   - None.
			//
...
func WaitForPort(t *testing.T, proc *integration.ManagedProcess) int {
	...
	for time.Now().Before(deadline) {
		...
		// upstreamEndpoint is the upstreamEndpoint.
		//
		// Summary: RegisterGRPCAuthedWeatherService provides functionality.
		//
		// Parameters:
		//   - None.
		//
		...
		// Returns the result.
		//
		// Summary: BuildWebsocketWeatherServer provides functionality.
		//
		// Parameters:
		//   - None.
		//
		...
		// upstreamEndpoint is the upstreamEndpoint.
		//
		// Summary: RegisterWebsocketWeatherService provides functionality.
		//
		// Parameters:
		//   - None.
		//
		...
		// Returns the result.
		//
		// Summary: BuildWebrtcWeatherServer provides functionality.
		//
		// Parameters:
		//   - None.
		//
		...
		// upstreamEndpoint is the upstreamEndpoint.
		//
		// Summary: RegisterWebrtcWeatherService provides functionality.
		//
		// Parameters:
		//   - None.
		//
		...
		// Returns the result.
		//
		// Summary: BuildStdioServer provides functionality.
		//
		// Parameters:
		//   - None.
		//
		...
		// Returns the result.
		//
		// Summary: BuildStdioDockerServer provides functionality.
		//
		// Parameters:
		//   - None.
		//
		...
		// _ is an unused parameter.
		//
		// Summary: RegisterStdioDockerService provides functionality.
		//
		// Parameters:
		//   - None.
		//
...
func RegisterStdioDockerService(t *testing.T, registrationClient apiv1.RegistrationServiceClient, _ string) {
	...
	integration.RegisterStdioServiceWithSetup(
		...
		// Returns the result.
		//
		// Summary: BuildOpenAPIWeatherServer provides functionality.
		//
		// Parameters:
		//   - None.
		//
		...
		// upstreamEndpoint is the upstreamEndpoint.
		//
		// Summary: RegisterOpenAPIWeatherService provides functionality.
		//
		// Parameters:
		//   - None.
		//
		...
		// Returns the result.
		//
		// Summary: BuildOpenAPIAuthedServer provides functionality.
		//
		// Parameters:
		//   - None.
		//
		...
		// upstreamEndpoint is the upstreamEndpoint.
		//
		// Summary: RegisterOpenAPIAuthedService provides functionality.
		//
		// Parameters:
		//   - None.
		//
		...
		// Returns the result.
		//
		// Summary: BuildStreamableHTTPServer provides functionality.
		//
		// Parameters:
		//   - None.
		//
		...
		// upstreamEndpoint is the upstreamEndpoint.
		//
		// Summary: RegisterStreamableHTTPService provides functionality.
		//
		// Parameters:
		//   - None.
		//
		...
		// mcpanyEndpoint is the mcpanyEndpoint.
		//
		// Summary: VerifyMCPClient provides functionality.
		//
		// Parameters:
		//   - None.
		//
