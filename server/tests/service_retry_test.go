...
func (m *MockStorage) GetServiceTemplate(ctx context.Context, name string) (*configv1.ServiceTemplate, error) {
	return nil, nil
}
func (m *MockStorage) SaveServiceTemplate(ctx context.Context, template *configv1.ServiceTemplate) error {
	return nil
}
func (m *MockStorage) DeleteServiceTemplate(ctx context.Context, name string) error {
	return nil
}
