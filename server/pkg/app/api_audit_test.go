...
func TestHandleAuditExport_Mock(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		mockStore.On("Read", mock.Anything, mock.Anything), mock.Anything, mock.Anything).Return(entries, nil).Once()
	...
	t.Run("StoreError", func(t *testing.T) {
		mockStore.On("Read", mock.Anything, mock.Anything), mock.Anything, mock.Anything).Return([]audit.Entry{}, assert.AnError).Once()
