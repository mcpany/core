...
// Summary: SeedRequest defines the payload for seeding the database. We use json.RawMessage to manually unmarshal using protojson, ensuring correct Protobuf handling. Represents a SeedRequest.
//
// Parameters:
//   - None.
//
