...
//   - allowedIPs: []string. A list of strings.
//   - allowedOrigins: []string. A list of strings.
//
// Returns:
//   - *GlobalSettingsManager: The result.
...
//
// Parameters:
//   - settings: *config_v1.GlobalSettings. The config_v1.GlobalSettings instance.
