...
// Summary: TemplateManager manages the persistence and lifecycle of service templates. Represents a TemplateManager.
//
// Parameters:
//   - None.
//
...
// Summary: NewTemplateManager creates a new instance of TemplateManager. Initializes a new TemplateManager.
//
// Parameters:
//   - dataDir (string): The dataDir parameter.
//
// Returns:
//   - *TemplateManager: The resulting *TemplateManager.
//
// Errors:
//   - None.
//
...
// Summary: ListTemplates returns a list of all stored templates. Retrieves all managed templates.
//
// Parameters:
//   - None.
//
...
// Summary: SaveTemplate saves or updates a template. Persists a template.
//
// Parameters:
//   - template (*configv1.UpstreamServiceConfig): The template parameter.
//
// Returns:
...
// Summary: DeleteTemplate deletes a template by its ID or Name. Removes a template.
//
// Parameters:
//   - idOrName (string): The idOrName parameter.
//
// Returns:
//   - error: An error if the operation fails.
//
