...
func (a *Application) handleServiceValidate() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// Sentinel Security: Disabled probe checks (file existence, network reachability) in validation API
		// to prevent Oracle attacks and Information Leakage. Validation should only check configuration correctness.
