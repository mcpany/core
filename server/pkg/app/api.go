...
func (a *Application) injectRuntimeInfo(jsonBytes []byte, svc *configv1.UpstreamServiceConfig) []byte {
	...
	if err := json.Unmarshal(jsonBytes, &jsonMap); err == nil && a.ServiceRegistry != nil {
