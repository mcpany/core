...
func (a *Application) handleServices(store storage.Storage) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		switch r.Method {
		case http.MethodGet:
			a.listServices(w, r, store)
		case http.MethodPost:
			a.createService(w, r, store)
		default:
			http.Error(w, "method not allowed", http.StatusMethodNotAllowed)
		}
	}
...
func (a *Application) listServices(w http.ResponseWriter, r *http.Request, store storage.Storage) {
...
func (a *Application) createService(w http.ResponseWriter, r *http.Request, store storage.Storage) {
