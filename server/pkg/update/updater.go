...
// Summary: Updater handles the self-update process. It manages checking for updates on GitHub and applying them to the local executable. Represents a Updater.
//
// Parameters:
//   - None.
//
