...
// Summary: IsSafeIP is a global constant or variable.
//
// Parameters:
//   - None
//
...
// Summary: ValidateIP executes the operation.
//
// Parameters:
//   - ip net.IP: Input parameter.
//   - allowLoopback: Input parameter.
//   - allowPrivate bool: Input parameter.
//
// Returns:
//   - error {
