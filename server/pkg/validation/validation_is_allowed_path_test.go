...
func TestIsAllowedPath(t *testing.T) {
	tests := []struct {
		...
		{"Default_Relative", "example.yaml", "", false},
		{"Default_Subdir", "subdir/example.yaml", "", false},
		// ".." is blocked by IsSecurePath
		{"Default_Traversal", "../example.yaml", "", true},
		...
		{"Default_CleanRelative", "subdir/../example.yaml", "", true},
