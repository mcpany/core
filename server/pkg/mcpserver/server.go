...
//
// Parameters:
//   - ctx: context.Context. The application context.
...
//   - req: *mcp.ListPromptsRequest. The prompt list request.
//
// Returns:
...
// CreateMessage requests a message creation from the client.
//
// Summary: Initializes CreateMessage operation.
//
// Parameters:
//   - ctx: context.Context. The request context.
//   - params: *mcp.CreateMessageParams. The message creation parameters.
//
// Returns:
//   - *mcp.CreateMessageResult: The created message result.
...
// Parameters:
//   - ctx: context.Context. The request context.
//   - req: *mcp.GetPromptRequest. The prompt retrieval request.
//
// Returns:
//   - *mcp.GetPromptResult: The prompt result.
//   - error: An error if the prompt retrieval fails.
...
// Parameters:
//   - ctx: context.Context. The request context.
//   - req: *mcp.ListResourcesRequest. The resource list request.
//
// Returns:
//   - *mcp.ListResourcesResult: The list of available resources.
//   - error: An error if retrieval fails.
...
// Parameters:
//   - ctx: context.Context. The request context.
//   - req: *mcp.ReadResourceRequest. The resource reading request.
//
// Returns:
//   - *mcp.ReadResourceResult: The resource content result.
...
//
// Returns:
//   - tool.ManagerInterface: The tool manager instance.
//
// Parameters:
//   - None.
//
...
//
// Returns:
//   - prompt.ManagerInterface: The prompt manager instance.
//
// Parameters:
//   - None.
//
...
//
// Returns:
//   - resource.ManagerInterface: The resource manager instance.
//
// Parameters:
//   - None.
//
...
//
// Returns:
//   - []tool.Tool: A slice of all managed tools.
//
// Parameters:
//   - None.
//
...
//   - error: An error if execution fails or access is denied.
//
// Errors:
//   - Returns an error if the operation fails.
//
...
//
// Parameters:
//   - mcpServer: tool.MCPServerProvider. The provider to set.
//
// Returns:
//   - None.
//
...
//
// Parameters:
//   - t: tool.Tool. The tool instance to add.
//
// Returns:
...
//
// Parameters:
//   - f: func(context.Context) error. The reload callback function.
//
// Returns:
//   - See return values.
//
...
//
// Returns:
//   - slog.Value: The redacted JSON as a string value.
//
// Parameters:
//   - None.
//
...
// LogValue implements slog.LogValuer to summarize or redact log values.
//
// Summary: Executes LogValue operation.
//
// Returns:
