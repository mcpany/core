...
//
// Summary: A testing hook invoked when the Server method is called to verify middleware presence.
//
// Side Effects:
...
//
// Summary: Orchestrates the handling of MCP requests by managing tools, prompts, resources, and services.
//
...
//
// Summary: Returns the underlying MCP server instance for advanced configuration or direct interaction.
//
// Returns:
...
//
// Summary: Initializes a new MCP Any Server with necessary managers, router configuration, and middleware.
//
// Parameters:
...
//
// Summary: Retrieves available prompts from the PromptManager and returns them in MCP format.
//
// Parameters:
...
//
// Summary: Retrieves and executes a specific prompt by name with provided arguments.
//
// Parameters:
//   - ctx: context.Context. The context for the request.
//   - req: *mcp.GetPromptRequest. The "prompts/get" request from the client.
//
// Returns:
...
//   - Returns an error if marshalling arguments fails or access is denied.
...
//
// Summary: Fetches available resources from the ResourceManager and returns them in MCP format.
//
// Parameters:
//   - ctx: context.Context. The context for the request.
...
// Parameters:
//   - ctx: context.Context. The context for the request.
//   - req: *mcp.ReadResourceRequest. The "resources/read" request from the client.
//
// Returns:
...
//
// Summary: Returns the authentication manager responsible for handling request authentication.
//
// Returns:
...
//
// Summary: Returns the tool manager responsible for managing tool lifecycle and access.
//
// Returns:
...
//
// Summary: Returns the prompt manager responsible for managing prompt lifecycle and access.
//
// Returns:
...
//
// Summary: Returns the resource manager responsible for managing resource lifecycle and access.
//
// Returns:
...
//
// Summary: Returns the service registry which tracks all registered upstream services.
//
// Returns:
...
//
// Summary: Adds service information to the tool manager.
//
// Parameters:
...
//
// Summary: Retrieves a tool instance by its name.
//
// Parameters:
...
//
// Summary: Returns a list of all available tools.
//
// Returns:
...
//
// Summary: Executes a tool request, handling logging, metrics, and access control.
//
// Parameters:
...
//
// Throws/Errors:
//   - Returns an error if access is denied or tool execution fails.
...
//
// Summary: Sets the MCP server provider for the tool manager.
//
// Parameters:
...
//
// Summary: Registers a new tool with the tool manager.
//
// Parameters:
...
//
// Summary: Retrieves service information by its ID.
//
// Parameters:
//   - serviceID: string. The unique identifier of the service.
//
...
//
// Summary: Removes all tools associated with a specific service.
//
// Parameters:
...
//
// Summary: Sets the callback function for configuration reload.
//
// Parameters:
...
//
// Summary: Triggers the server configuration reload.
//
// Parameters:
