...
// AddReceivingMiddlewareHook allows injecting a hook to intercept middleware registration.
// This is primarily used for testing purposes to verify middleware chains.
var AddReceivingMiddlewareHook func(name string)

// Server is the core of the MCP Any application.
// It orchestrates the handling of MCP (Model Context Protocol) requests by managing
// various components such as tools, prompts, resources, and services.
...
// This provides access to the core MCP server functionality for advanced configurations.
//
// Returns:
...
//   - req (*mcp.ListPromptsRequest): The request from the client.
//
// Returns:
...
// It retrieves a specific prompt by name from the PromptManager and executes it with the provided arguments.
//
// Parameters:
//   - ctx (context.Context): The context for the request.
//   - req (*mcp.GetPromptRequest): The request from the client.
//
// Returns:
...
// It fetches the list of available resources from the ResourceManager and returns them.
//
// Parameters:
//   - ctx (context.Context): The context for the request.
//   - req (*mcp.ListResourcesRequest): The request from the client.
//
// Returns:
...
// Parameters:
//   - ctx (context.Context): The context for the request.
//   - req (*mcp.ReadResourceRequest): The request from the client.
//
// Returns:
...
// It handles permission checks, metrics recording, and result processing.
//
// Parameters:
...
//
// Returns:
//   - (any): The result of the tool execution (usually *mcp.CallToolResult or JSON-serializable).
