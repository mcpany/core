...
//
// Summary: Resource adapter for skill documentation and assets.
...
//   - assetPath: string. The relative path to the asset file.
//
// Returns:
...
//
// Returns:
//   - *mcp.ReadResourceResult: The result containing the resource content.
