...
// Summary: SkillResource adapts a Skill (or its asset) to the Resource interface. It provides a way to expose skill documentation and associated assets (like images or text files) as MCP resources, making them accessible to clients. Represents a SkillResource.
//
// Parameters:
//   - None.
//
