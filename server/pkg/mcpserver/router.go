...
//
// Summary: Function signature for MCP method handlers.
//
// Parameters:
...
//
// Summary: Maps MCP method names to handler functions.
//
// Side Effects:
...
//
// Summary: Initializes a new Router.
//
// Returns:
...
//
// Summary: Retrieves the handler for an MCP method.
//
// Parameters:
