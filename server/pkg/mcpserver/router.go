...
// Summary: MethodHandler defines the signature for a function that handles an MCP method call.
//
// Parameters:
...
// Summary: Router is responsible for mapping MCP method names to their corresponding handler functions.
//
// Side Effects:
...
// Summary: NewRouter creates and returns a new, empty Router.
//
// Returns:
...
// Summary: Register associates a handler function with a specific MCP method name.
//
// Parameters:
...
// Summary: GetHandler retrieves the handler function for a given MCP method name.
//
// Parameters:
