...
//
// Throws/Errors:
//   - Returns an error if the bus is nil.// Side Effects:
//   - None.
...
//
// Side Effects:
//   - Temporarily creates an upstream connection and then closes it.// Errors:
//   - None.
//
...
//   - Waits for a response on a dedicated result channel.// Errors:
//   - None.
//
...
//   - error: Always returns an Unimplemented error.// Errors:
//   - None.
//
// Side Effects:
//   - None.
...
//   - codes.Internal: If an internal error occurs.// Side Effects:
//   - None.
...
//   - codes.DeadlineExceeded: If the request times out.// Side Effects:
//   - None.
