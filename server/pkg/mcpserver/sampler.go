...
//
// Returns:
//   - *MCPSession: A new instance of MCPSession.// Errors:
//   - None.
//
// Side Effects:
//   - None.
...
//
// Side Effects:
//   - This function is deprecated and should be replaced by NewMCPSession.// Errors:
//   - None.
//
...
//
// Throws/Errors:
//   - Returns an error if the session is nil.// Side Effects:
//   - None.
