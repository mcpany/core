...
//
// Summary: Provides a no-op implementation of the tool manager interface.
...
//
// Summary: No-op implementation of IsServiceAllowed.
//
// Parameters:
//   - _: string. Unused.
//   - _: string. Unused.
...
//
// Summary: Provides a no-op implementation of the prompt manager interface.
...
//
// Summary: Provides a no-op implementation of the resource manager interface.
