...
//
// Summary: A no-op implementation of tool.ManagerInterface.
...
//
// Summary: A no-op implementation of prompt.ManagerInterface.
...
//
// Summary: A no-op implementation of resource.ManagerInterface.
