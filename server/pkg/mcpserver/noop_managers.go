...
// NoOpToolManager is a no-op implementation of tool.ManagerInterface. Summary: A tool manager that does nothing.
//
// Summary: NoOpToolManager is a no-op implementation of tool.ManagerInterface. Summary: A tool manager that does nothing.
//
// Fields:
//   - Contains the configuration and state properties required for NoOpToolManager functionality.
...
// NoOpPromptManager is a no-op implementation of prompt.ManagerInterface. Summary: A prompt manager that does nothing.
//
// Summary: NoOpPromptManager is a no-op implementation of prompt.ManagerInterface. Summary: A prompt manager that does nothing.
//
// Fields:
//   - Contains the configuration and state properties required for NoOpPromptManager functionality.
...
// NoOpResourceManager is a no-op implementation of resource.ManagerInterface. Summary: A resource manager that does nothing.
//
// Summary: NoOpResourceManager is a no-op implementation of resource.ManagerInterface. Summary: A resource manager that does nothing.
//
// Fields:
//   - Contains the configuration and state properties required for NoOpResourceManager functionality.
