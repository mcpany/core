...
// ConvertMCPToolToProto serves as a public interface for interacting with ConvertMCPToolToProto.
//
// Summary: Convert the mcp tool to proto appropriately based on current system conditions.
//
// Parameters:
...
// ConvertMcpFieldsToInputSchemaProperties serves as a public interface for interacting with ConvertMcpFieldsToInputSchemaProperties.
//
// Summary: Convert the mcp fields to input schema properties appropriately based on current system conditions.
//
// Parameters:
//   - Refer to the function signature for strongly-typed input arguments.
//
...
// ConvertToolDefinitionToProto serves as a public interface for interacting with ConvertToolDefinitionToProto.
//
// Summary: Convert the tool definition to proto appropriately based on current system conditions.
//
// Parameters:
//   - Refer to the function signature for strongly-typed input arguments.
//
...
// GetJSONSchemaForScalarType serves as a public interface for interacting with GetJSONSchemaForScalarType.
//
// Summary: Fetches and returns the underlying json schema for scalar type from the system state.
//
// Parameters:
//   - Refer to the function signature for strongly-typed input arguments.
//
...
// ConvertProtoToMCPTool serves as a public interface for interacting with ConvertProtoToMCPTool.
//
// Summary: Convert the proto to mcp tool appropriately based on current system conditions.
//
// Parameters:
//   - Refer to the function signature for strongly-typed input arguments.
//
