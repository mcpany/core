...
//
// Parameters:
//   - tool: *mcp.Tool. The tool instance.
//
// Returns:
//   - *pb.Tool: The resulting instance.
...
//
// Returns:
//   - *structpb.Struct: The resulting instance.
//   - error: An error if the operation fails.
...
//
// Parameters:
//   - toolDef: *configv1.ToolDefinition. The toolDef instance.
//   - inputSchema: *structpb.Struct. The inputSchema instance.
//   - outputSchema: *structpb.Struct. The outputSchema instance.
//
// Returns:
//   - *pb.Tool: The resulting instance.
//   - error: An error if the operation fails.
...
//
// Returns:
//   - *jsonschema.Schema: The resulting instance.
//   - error: An error if the operation fails.
...
//
// Parameters:
//   - pbTool: *pb.Tool. The pbTool instance.
//
// Returns:
//   - *mcp.Tool: The resulting instance.
//   - error: An error if the operation fails.
