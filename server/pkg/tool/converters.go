...
//
// Parameters:
//   - tool: *mcp.Tool. The mcp.Tool instance.
//
// Returns:
//   - *pb.Tool: The result.
...
//
// Parameters:
//   - fields: []*protobufparser.McpField. A list of *protobufparser.McpFields.
//
// Returns:
...
//
// Parameters:
//   - toolDef: *configv1.ToolDefinition. The configv1.ToolDefinition instance.
//   - outputSchema: *structpb.Struct. The structpb.Struct instance.
//
// Returns:
//   - *pb.Tool: The result.
//   - error: An error if the operation fails.
...
//
// Parameters:
//   - pbTool: *pb.Tool. The pb.Tool instance.
//
// Returns:
//   - *mcp.Tool: The result.
//   - error: An error if the operation fails.
