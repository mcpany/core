...
func findMethodDescriptor(t *testing.T, serviceName, methodName string) protoreflect.MethodDescriptor {
	...
	// Use the generated FileDescriptor directly instead of reading all.protoset
	// This avoids issues with finding the protoset file in different environments (CI/Docker)
