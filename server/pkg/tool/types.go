...
func checkSQLInjection(val, base string, quoteLevel int) error {
	...
	if err := checkSqliteInjection(base, valLower); err != nil {
		return err
	}

	if err := checkMysqlInjection(base, val); err != nil {
		return err
	}

	if err := checkPsqlInjection(base, val, valTrimmed); err != nil {
		return err
	}

	return checkGenericSQLKeywords(val)
}

func checkSqliteInjection(base, valLower string) error {
	if base != "sqlite3" {
		return nil
	}
...
func checkMysqlInjection(base, val string) error {
	if base != "mysql" {
		return nil
	}
...
func checkPsqlInjection(base, val, valTrimmed string) error {
	if base != "psql" {
		return nil
	}
...
func checkGenericSQLKeywords(val string) error {
