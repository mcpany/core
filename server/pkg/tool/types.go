...
// Returns:
//   - Tool: The tool instance if found.
//   - bool: True if the tool exists in the context, false otherwise.
...
//   - bool: True if the CacheControl exists in the context, false otherwise.
