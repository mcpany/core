...
// Summary: HealthStatusUnhealthy indicates that a service is in an unhealthy state. Defines HealthStatusUnhealthy.
//
// Parameters:
//   - None.
//
...
// Summary: Tool is the fundamental interface for any executable tool in the system. Interface for defining and executing tools. Each implementation represents a different type of underlying service (e.g., gRPC, HTTP, command-line).
//
// Parameters:
//   - None.
//
...
// Summary: ServiceInfo holds metadata about a registered upstream service, including its configuration and any associated protobuf file descriptors. Metadata for a registered service.
//
// Parameters:
//   - None.
//
...
// Summary: ExecutionRequest represents a request to execute a specific tool, including its name and input arguments as a raw JSON message. Request payload for tool execution.
//
// Parameters:
//   - None.
//
...
// Summary: ServiceRegistry defines an interface for a component that can look up tools and service information. It is used for dependency injection to decouple components from the main service registry. Interface for tool and service lookup.
//
// Parameters:
//   - None.
//
...
// Summary: ExecutionFunc represents the next middleware in the chain. Function signature for tool execution middleware.
//
// Parameters:
//   - None.
//
...
// Summary: NewContextWithTool creates a new context with the given tool embedded. Embeds a tool into the context.
//
// Parameters:
//   - ctx (context.Context): The ctx parameter.
//   - t (Tool): The t parameter.
//
// Returns:
...
// Summary: GetFromContext retrieves a tool from the context if present. Retrieves a tool from the context.
//
// Parameters:
//   - ctx (context.Context): The ctx parameter.
//
// Returns:
//   - Tool: The resulting Tool.
...
// Summary: Callable is an interface that represents a callable tool. Interface for executing a tool.
//
// Parameters:
//   - None.
//
...
// Summary: Action defines the decision made by a pre-call hook. Enumeration of possible hook actions.
//
// Parameters:
//   - None.
//
...
const (
// Summary: ActionAllow indicates that the action is allowed to proceed. Allow action.
//
// Parameters:
//   - None.
//
...
// Summary: ActionDeny indicates that the action is denied and should be blocked. Deny action.
//
// Parameters:
//   - None.
//
...
//   - None.
	ActionDeny Action = 1
// Summary: ActionSaveCache indicates that the result should be saved to the cache. Save to cache action.
//
// Parameters:
//   - None.
//
...
// Summary: ActionDeleteCache indicates that the associated cache entry should be invalidated. Delete from cache action.
//
// Parameters:
//   - None.
//
...
// Summary: CacheControl is a mutable struct to pass cache control instructions via context. Context-based cache control instructions.
//
// Parameters:
//   - None.
//
...
// Summary: NewContextWithCacheControl creates a new context with the given CacheControl. Embeds CacheControl into the context.
//
// Parameters:
//   - ctx (context.Context): The ctx parameter.
//   - cc (*CacheControl): The cc parameter.
//
// Returns:
//   - context.Context: The resulting context.Context.
//
...
// Summary: GetCacheControl retrieves the CacheControl from the context. Retrieves CacheControl from the context.
//
// Parameters:
//   - ctx (context.Context): The ctx parameter.
//
// Returns:
//   - *CacheControl: The resulting *CacheControl.
//   - bool: The resulting bool.
//
// Errors:
//   - None.
...
// Summary: PreCallHook defines the interface for hooks executed before a tool call. Interface for pre-execution hooks.
//
// Parameters:
//   - None.
//
...
// Summary: PostCallHook defines the interface for hooks executed after a tool call. Interface for post-execution hooks.
//
// Parameters:
//   - None.
//
...
// Summary: GRPCTool implements the Tool interface for a tool that is exposed via a gRPC endpoint. Tool implementation for gRPC services. It handles the marshalling of JSON inputs to protobuf messages and invoking the gRPC method.
//
// Parameters:
//   - None.
//
...
// Summary: NewGRPCTool creates a new GRPCTool instance. Initializes a new GRPCTool.
//
// Parameters:
...
//   - method (protoreflect.MethodDescriptor): The method parameter.
//   - callDefinition (*configv1.GrpcCallDefinition): The callDefinition parameter.
//   - resilienceConfig (*configv1.ResilienceConfig): The resilienceConfig parameter.
//
// Returns:
//   - *GRPCTool: The resulting *GRPCTool.
//
// Errors:
//   - None.
//
...
// Summary: Execute handles the execution of the gRPC tool. Executes the gRPC tool call. It retrieves a client from the pool, unmarshals the JSON input into a protobuf request message, invokes the gRPC method, and marshals the protobuf response back to JSON.
//
// Parameters:
//   - ctx (context.Context): The ctx parameter.
...
// Summary: HTTPTool implements the Tool interface for a tool exposed via an HTTP endpoint. Tool implementation for HTTP services. It constructs and sends an HTTP request based on the tool definition and input, handling parameter mapping, authentication, and transformations.
//
// Parameters:
//   - None.
//
...
// Summary: NewHTTPTool creates a new HTTPTool instance. Initializes a new HTTPTool.
//
// Parameters:
//   - tool (*v1.Tool): The tool parameter.
//   - poolManager (*pool.Manager): The poolManager parameter.
...
//   - callDefinition (*configv1.HttpCallDefinition): The callDefinition parameter.
//   - cfg (*configv1.ResilienceConfig): The cfg parameter.
//   - policies ([]*configv1.CallPolicy): The policies parameter.
//   - callID (string): The callID parameter.
//
// Returns:
//   - *HTTPTool: The resulting *HTTPTool.
//
// Errors:
//   - None.
//
...
// Summary: Execute handles the execution of the HTTP tool. Executes the HTTP tool call. It builds an HTTP request by mapping input parameters to the path, query, and body, applies any configured transformations, sends the request, and processes the response.
//
// Parameters:
//   - ctx (context.Context): The ctx parameter.
//   - req (*ExecutionRequest): The req parameter.
...
// Summary: MCPTool implements the Tool interface for a tool that is exposed via another MCP-compliant service. Tool implementation for proxying to MCP services. It acts as a proxy, forwarding the tool call to the downstream MCP service.
//
// Parameters:
//   - None.
//
...
// Summary: NewMCPTool creates a new MCPTool instance. Initializes a new MCPTool.
//
// Parameters:
//   - tool (*v1.Tool): The tool parameter.
//   - client (client.MCPClient): The client parameter.
//   - callDefinition (*configv1.MCPCallDefinition): The callDefinition parameter.
//
// Returns:
//   - *MCPTool: The resulting *MCPTool.
//
// Errors:
//   - None.
//
...
// Summary: Execute handles the execution of the MCP tool. Executes the MCP tool call. It forwards the tool call, including its name and arguments, to the downstream MCP service using the configured client and applies any necessary transformations to the request and response.
//
// Parameters:
//   - ctx (context.Context): The ctx parameter.
//   - req (*ExecutionRequest): The req parameter.
...
// Summary: OpenAPITool implements the Tool interface for a tool defined in an OpenAPI specification. Tool implementation for OpenAPI services. It constructs and sends an HTTP request based on the OpenAPI operation definition.
//
// Parameters:
//   - None.
//
...
// Summary: NewOpenAPITool creates a new OpenAPITool instance. Initializes a new OpenAPITool.
//
// Parameters:
//   - tool (*v1.Tool): The tool parameter.
//   - client (client.HTTPClient): The client parameter.
//   - parameterDefs (map[string]string): The parameterDefs parameter.
//   - method (string): The method parameter.
//   - url (string): The url parameter.
//   - authenticator (auth.UpstreamAuthenticator): The authenticator parameter.
//   - callDefinition (*configv1.OpenAPICallDefinition): The callDefinition parameter.
//
// Returns:
//   - *OpenAPITool: The resulting *OpenAPITool.
//
// Errors:
//   - None.
//
...
// Summary: Execute handles the execution of the OpenAPI tool. Executes the OpenAPI tool call. It constructs an HTTP request based on the operation's method, URL, and parameter definitions, sends the request, and processes the response, applying transformations as needed.
//
// Parameters:
//   - ctx (context.Context): The ctx parameter.
//   - req (*ExecutionRequest): The req parameter.
...
// Summary: CommandTool implements the Tool interface for a tool that is executed as a local command-line process. Tool implementation for command-line services (via executor). It maps tool inputs to command-line arguments and environment variables.
//
// Parameters:
//   - None.
//
...
// Summary: NewCommandTool creates a new CommandTool instance. Initializes a new CommandTool.
//
// Parameters:
//   - tool (*v1.Tool): The tool parameter.
//   - service (*configv1.CommandLineUpstreamService): The service parameter.
//   - callDefinition (*configv1.CommandLineCallDefinition): The callDefinition parameter.
//   - policies ([]*configv1.CallPolicy): The policies parameter.
//   - callID (string): The callID parameter.
//
// Returns:
...
// Summary: LocalCommandTool implements the Tool interface for a tool that is executed as a local command-line process. Tool implementation for local command-line services. It maps tool inputs to command-line arguments and environment variables.
//
// Parameters:
//   - None.
//
...
// Summary: NewLocalCommandTool creates a new LocalCommandTool instance. Initializes a new LocalCommandTool.
//
// Parameters:
//   - tool (*v1.Tool): The tool parameter.
//   - service (*configv1.CommandLineUpstreamService): The service parameter.
...
// Summary: Execute handles the execution of the command-line tool. Executes the local command-line tool. It constructs a command with arguments and environment variables derived from the tool inputs, runs the command, and returns its output.
//
// Parameters:
//   - ctx (context.Context): The ctx parameter.
//   - req (*ExecutionRequest): The req parameter.
...
// Summary: Execute handles the execution of the command-line tool. Executes the command-line tool via executor. It constructs a command with arguments and environment variables derived from the tool inputs, runs the command, and returns its output.
//
// Parameters:
//   - ctx (context.Context): The ctx parameter.
//   - req (*ExecutionRequest): The req parameter.
