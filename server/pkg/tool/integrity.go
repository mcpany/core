...
//
// Summary: Verifies the integrity of a tool definition against its hash.
//
// Parameters:
//   - t: *v1.Tool. The tool definition to verify.
//
// Returns:
//   - error: An error if the integrity check fails or the algorithm is unsupported.
...
//
// Summary: Verifies the integrity of a configuration tool definition against its hash.
//
// Parameters:
//   - t: *configv1.ToolDefinition. The tool definition from configuration.
//
// Returns:
//   - error: An error if the integrity check fails.
...
//
// Summary: Calculates the SHA256 hash of a tool definition.
//
// Parameters:
...
//
// Summary: Calculates the SHA256 hash of a configuration tool definition.
//
// Parameters:
//   - t: *configv1.ToolDefinition. The tool definition.
//
// Returns:
//   - string: The calculated hash.
//   - error: An error if marshaling fails.
