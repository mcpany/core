...
//
// Parameters:
//   - t (*configv1.ToolDefinition): The config tool definition to verify.
//
// Returns:
//   - error: An error if the integrity check fails or the algorithm is unsupported.
...
//
// Parameters:
//   - t (*v1.Tool): The runtime tool definition.
//
// Returns:
...
//
// Parameters:
//   - t (*configv1.ToolDefinition): The configuration tool definition.
//
// Returns:
//   - string: The hex-encoded SHA256 hash.
//   - error: An error if marshaling fails.
