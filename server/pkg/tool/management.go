...
type ManagerInterface interface {
	...
	//
	// Returns:
	//   - []*ServiceInfo: A list of registered services.
...
//   - info: The service metadata info.
...
//
// Returns:
//   - []Tool: A list of registered tools.
...
//
// Returns:
//   - []*mcp.Tool: A list of registered MCP tools.
