...
//
// Parameters:
//   - enabled ([]string): Parameter.
//   - defs ([]*configv1.ProfileDefinition): Parameter.
//
// Returns:
//   - None.
//
...
//
// Parameters:
//   - middleware (ExecutionMiddleware): Parameter.
//
// Returns:
//   - None.
//
