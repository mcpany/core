...
//
// Summary: Interface for providing access to the MCP server instance.
type MCPServerProvider interface {
	// Server returns the MCP server instance.
	//
	// Summary: Retrieves the underlying MCP server.
	//
	// Returns:
...
type ManagerInterface interface {
	...
	//
	// Summary: Adds a new tool to the registry.
	//
	// Parameters:
	//   - tool: Tool. The tool definition to add.
	//
	// Returns:
	...
	//
	// Summary: Lists all registered tools formatted as MCP Tool objects.
	//
	// Returns:
	//   - []*mcp.Tool: A slice of MCP Tool objects.
	ListMCPTools() []*mcp.Tool

	// ClearToolsForService removes all tools for a given service.
	//
	// Summary: Removes all tools belonging to a specific service ID.
	//
	// Parameters:
	...
	//
	// Summary: Executes a specific tool.
	//
	// Parameters:
	...
	//
	// Summary: Configures the MCP server provider for the manager.
	//
	// Parameters:
	...
	//
	// Summary: Adds a new middleware to the execution pipeline.
	//
	// Parameters:
	...
	//
	// Summary: Retrieves metadata for a specific service.
	//
	// Parameters:
	//   - serviceID: string. The unique identifier of the service.
	//
	...
	//
	// Summary: Configures active profiles for filtering.
	//
	// Parameters:
	//   - enabled: []string. List of enabled profile IDs.
	//   - defs: []*configv1.ProfileDefinition. List of profile definitions.
	...
	//
	// Summary: Verifies if a service is permitted under a profile.
	//
	// Parameters:
	...
	//
	// Summary: Verifies if a tool is compatible with a profile.
	//
	// Parameters:
	...
	//
	// Summary: Retrieves the set of allowed services for a profile.
	//
	// Parameters:
	//   - profileID: string. The profile ID.
	//
...
//
// Summary: Interface for middleware that intercepts tool execution.
type ExecutionMiddleware interface {
	// Execute executes the middleware logic.
	//
	// Summary: Runs the middleware logic and calls the next handler.
	//
	// Parameters:
	//   - ctx: context.Context. The context for the request.
	//   - req: *ExecutionRequest. The execution request.
	//   - next: ExecutionFunc. The next function in the chain.
	//
	// Returns:
	//   - any: The result of the execution.
	//   - error: An error if execution fails.
...
//
// Summary: Manages the lifecycle, registration, and execution of tools.
//
// Side Effects:
//   - Manages global state for tools and services.
//   - Interfaces with the MCP server and Event Bus.
type Manager struct {
...
//
// Summary: Initializes a new Manager instance.
//
// Parameters:
...
//
// Summary: Configures the manager with enabled profiles.
//
// Parameters:
//   - enabled: []string. List of enabled profile IDs.
//   - defs: []*configv1.ProfileDefinition. List of profile definitions.
//
// Side Effects:
//   - Clears and rebuilds the allowed services cache.
...
// IsServiceAllowed checks if a service is allowed for a given profile.
//
// Summary: Checks if a service is explicitly enabled in a profile.
//
// Parameters:
//   - serviceID: string. The service ID.
//   - profileID: string. The profile ID.
...
// ToolMatchesProfile checks if a tool matches a given profile.
//
// Summary: Public wrapper to check if a tool matches a profile.
//
// Parameters:
//   - tool: Tool. The tool definition.
//   - profileID: string. The profile ID.
...
// GetAllowedServiceIDs returns a map of allowed service IDs for a given profile.
//
// Summary: Retrieves the pre-computed allowed services map for a profile.
//
// Parameters:
//   - profileID: string. The profile ID.
//
...
//
// Summary: Appends a middleware to the global execution chain.
//
// Parameters:
//   - middleware: ExecutionMiddleware. The middleware to add.
...
//
// Summary: Sets the MCP server reference.
//
// Parameters:
...
//
// Summary: Executes a tool by name, handling logging, hooks, and middleware.
//
// Parameters:
...
//   - error: An error if the tool is not found, execution denied, or fails.
//
// Side Effects:
//   - Logs execution details.
//   - Invokes pre/post hooks and middlewares.
...
//
// Summary: Registers service metadata and compiles policies/hooks.
//
// Parameters:
//   - serviceID: string. The unique identifier for the service.
//   - info: *ServiceInfo. The ServiceInfo struct containing the service's metadata.
//
// Side Effects:
//   - Stores service info in memory.
//   - Compiles call policies and hooks.
...
//
// Summary: Retrieves service metadata with secrets stripped from config.
//
// Parameters:
//   - serviceID: string. The unique identifier for the service.
//
...
// the manager.
//
// Summary: Lists all registered services with secrets stripped.
//
// Returns:
//   - []*ServiceInfo: A slice of all service metadata.
...
// the server.
//
// Summary: Registers a new tool, updating indices and the MCP server.
//
// Parameters:
//   - tool: Tool. The tool to be added.
//
// Returns:
//   - error: An error if the tool cannot be added (e.g., integrity failure).
//
// Side Effects:
//   - Updates tool indices.
//   - Registers the tool with the MCP server (if configured).
...
//
// Summary: Retrieves a tool by name, checking name map and direct ID.
//
// Parameters:
//   - toolName: string. The name of the tool.
//
...
// the manager.
//
// Summary: Lists all tools, using a read-through cache.
//
// Returns:
//   - []Tool: A slice of all registered tools.
...
//
// Summary: Lists all tools in MCP format, using a cache.
//
// Returns:
...
// unregistered.
//
// Summary: Removes all tools for a service.
//
// Parameters:
//   - serviceID: string. The unique identifier for the service.
//
// Side Effects:
//   - Removes tools from internal storage and indices.
//   - Invalidates tool caches.
