...
type ManagerInterface interface {
	...
	//
	// Returns:
	//   - error: An error if the operation fails (e.g. tool already exists).
	...
	//
	// Returns:
	//   - []*mcp.Tool: A slice of all registered tools as MCP definitions.
	...
	//
	// Parameters:
	//   - mcpServer: The MCP server provider to use.
	...
	//
	// Parameters:
	//   - enabled: A list of enabled profile names.
...
//
// Side Effects:
//   - Updates the internal state of the manager with the new profiles.
...
//
// Returns:
//   - bool: True if the service is allowed for the profile, false otherwise.
...
//
// Side Effects:
//   - Appends the middleware to the internal list.
...
//
// Side Effects:
//   - Updates the manager with the MCP server provider.
...
//   - req: The execution request containing the tool name and inputs.
//
// Returns:
//   - any: The result of the execution.
//   - error: An error if the tool is not found or execution fails.
//
// Side Effects:
//   - Executes the tool.
//   - Logs execution details.
//   - Invokes pre and post execution hooks.
...
//
// Side Effects:
//   - Stores the service info in the internal map.
//   - Compiles call policies and registers hooks.
...
//
// Returns:
//   - error: An error if the tool ID cannot be generated or validation fails.
//
// Side Effects:
//   - Adds the tool to the internal map.
...
//
// Side Effects:
//   - Removes tools from internal maps.
