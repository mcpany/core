...
//
// Summary: Interface for providing access to the underlying MCP server.
//
...
//
// Summary: Interface defining the contract for managing tools.
//
...
type ManagerInterface interface {
	...
	//
	// Summary: Lists tools in MCP protocol format.
	//
	...
	//
	// Summary: Clears tools associated with a service.
	//
	...
	//
	// Summary: Sets the provider for the MCP server instance.
	//
	...
	//
	// Summary: Counts tools registered for a service.
	//
	// Parameters:
	//   - serviceID: string. The unique identifier of the service.
	//
...
//
// Summary: Central tool manager implementation.
//
...
//
// Summary: Creates a new Manager instance.
//
// Parameters:
...
//
// Summary: Updates active profiles and definitions.
//
...
//
// Summary: Checks if a service is allowed by a profile.
//
// Parameters:
//   - serviceID: string. The unique identifier of the service.
...
//
// Summary: Executes a tool request.
//
