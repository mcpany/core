...
//
// Summary: Interface for accessing the MCP server instance.
type MCPServerProvider interface {
	// Server returns the MCP server instance.
	//
	// Returns:
	//   - *mcp.Server: The active MCP server instance.
	Server() *mcp.Server
}
...
type ManagerInterface interface {
	...
	//
	// Returns:
	//   - error: An error if registration fails (e.g., validation error).
	AddTool(tool Tool) error

	// GetTool retrieves a tool by name.
	//
	// Summary: Retrieves a tool by its unique name or ID.
	//
	// Parameters:
	...
	//
	// Summary: Lists tools formatted for the Model Context Protocol.
	//
	// Returns:
	//   - []*mcp.Tool: A slice of MCP-formatted tools.
	...
	//
	// Summary: Injects the MCP server provider.
	//
	// Parameters:
	...
	//
	// Summary: Adds an execution middleware.
	//
	// Parameters:
	...
	//
	// Summary: Stores metadata for a service.
	//
	// Parameters:
	...
	//
	// Returns:
	//   - *ServiceInfo: The metadata if found.
	//   - bool: True if found.
	...
	//
	// Summary: Configures active profiles and definitions for filtering.
	//
	// Parameters:
	//   - enabled: []string. List of enabled profile names.
	...
	//
	// Summary: Checks service permission for a profile.
	//
	// Parameters:
	//   - serviceID: string. The service ID.
	//   - profileID: string. The profile name/ID.
	//
	// Returns:
	...
	//
	// Summary: Checks if a tool is included in a profile.
	//
	// Parameters:
	...
	//
	// Returns:
	//   - bool: True if the tool matches the profile criteria.
	...
	//
	// Summary: Retrieves the set of allowed service IDs for a profile.
	//
	// Parameters:
	//   - profileID: string. The profile name/ID.
	//
...
//
// Summary: Interface for intercepting and wrapping tool execution.
type ExecutionMiddleware interface {
	// Execute executes the middleware logic.
	//
	// Summary: Wraps the execution of a tool.
	//
	// Parameters:
	//   - ctx: context.Context. The execution context.
	//   - req: *ExecutionRequest. The request details.
...
//
// Summary: Central manager for tool registration, lookup, and execution.
type Manager struct {
...
//
// Summary: Updates the active profiles and pre-computes allowed services.
//
// Parameters:
//   - enabled: []string. List of enabled profile names.
//   - defs: []*configv1.ProfileDefinition. List of profile definitions.
...
// IsServiceAllowed checks if a service is allowed for a given profile.
//
// Summary: Checks if a service is permitted under a profile.
//
// Parameters:
//   - serviceID: string. The service ID.
//   - profileID: string. The profile name/ID.
...
// ToolMatchesProfile checks if a tool matches a given profile.
//
// Summary: Checks if a tool definition matches a profile's criteria.
//
// Parameters:
...
// GetAllowedServiceIDs returns a map of allowed service IDs for a given profile.
//
// Summary: Retrieves allowed service IDs for a profile from cache.
//
// Parameters:
//   - profileID: string. The profile name/ID.
//
// Returns:
//   - map[string]bool: Set of allowed service IDs.
//   - bool: True if the profile exists.
...
//
// Summary: Appends a middleware to the execution chain.
//
// Parameters:
//   - middleware: ExecutionMiddleware. The middleware to add.
...
//
// Parameters:
//   - mcpServer: MCPServerProvider. The server provider.
...
//
// Summary: Executes a tool by name.
//
// Parameters:
//   - ctx: context.Context. The execution context.
...
//
// Summary: Stores service metadata including hooks and policies.
//
// Parameters:
...
// the server.
//
// Summary: Registers a tool and sets up its handler.
//
// Parameters:
//   - tool: Tool. The tool to be added.
//
// Returns:
//   - error: An error if the tool ID cannot be generated or registration fails.
...
// the manager.
//
// Summary: Lists all tools (cached).
//
// Returns:
...
//
// Summary: Lists all tools in MCP format (cached).
//
// Returns:
...
// unregistered.
//
// Summary: Removes all tools for a specific service.
//
// Parameters:
//   - serviceID: string. The unique identifier for the service.
//
