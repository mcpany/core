...
//
// Summary: Determines whether a named item (tool, prompt, or resource) should be exported.
//
// Parameters:
//   - name (string): Parameter.
//   - policy (*configv1.ExportPolicy): Parameter.
//
// Returns:
//   - bool: Return value.
//
...
//
// Summary: Checks if a call should be allowed based on the policies.
//
// Parameters:
...
//
// Summary: Holds a compiled version of a call policy.
//
// Parameters:
//   - None.
//
...
//
// Returns:
//   - []*CompiledCallPolicy: Return value.
//   - error: Return value.
//
// Errors:
//   - error: If an error occurs.
...
//
// Parameters:
//   - policies ([]*CompiledCallPolicy): Parameter.
//   - toolName (string): Parameter.
//   - callID (string): Parameter.
//   - arguments ([]byte): Parameter.
//
