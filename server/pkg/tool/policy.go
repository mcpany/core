...
// Summary: ShouldExport determines whether a named item (tool, prompt, or resource) should be exported. Checks if an item should be exported based on policy.
//
// Parameters:
//   - name (string): The name parameter.
//   - policy (*configv1.ExportPolicy): The policy parameter.
//
// Returns:
...
// Summary: EvaluateCallPolicy checks if a call should be allowed based on the policies. Evaluates call policies against a tool execution. If arguments is nil, it performs a static check (ignoring rules with argument_regex). It returns true if the call is allowed, false otherwise.
//
// Parameters:
...
//   - arguments ([]byte): The arguments parameter.
//
// Returns:
//   - bool: The resulting bool.
...
// Summary: CompiledCallPolicy holds a compiled version of a call policy. Represents a pre-compiled call policy for efficient evaluation.
//
// Parameters:
//   - None.
//
...
// Summary: CompileCallPolicies compiles a list of call policies into an efficient runtime format. Compiles call policies for runtime usage.
//
// Parameters:
//   - policies ([]*configv1.CallPolicy): The policies parameter.
//
// Returns:
//   - []*CompiledCallPolicy: The resulting []*CompiledCallPolicy.
//   - error: An error if the operation fails.
//
// Errors:
//   - Returns an error if the operation fails or is invalid.
...
// Summary: NewCompiledCallPolicy compiles a single call policy. Compiles a single call policy.
//
// Parameters:
...
// Summary: EvaluateCompiledCallPolicy checks if a call should be allowed based on the compiled policies. Evaluates compiled call policies.
//
// Parameters:
//   - policies ([]*CompiledCallPolicy): The policies parameter.
//   - toolName (string): The toolName parameter.
//   - callID (string): The callID parameter.
//   - arguments ([]byte): The arguments parameter.
//
