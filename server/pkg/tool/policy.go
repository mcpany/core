...
// CompiledCallPolicy holds a compiled version of a call policy. Summary: Represents a pre-compiled call policy for efficient evaluation.
//
// Summary: CompiledCallPolicy holds a compiled version of a call policy. Summary: Represents a pre-compiled call policy for efficient evaluation.
//
// Fields:
//   - Contains the configuration and state properties required for CompiledCallPolicy functionality.
