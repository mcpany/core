...
// TestLocalCommandTool_SecretInArgs_Override verifies that a user-supplied input
// cannot override a parameter that is defined as a secret when substituting into command args.
