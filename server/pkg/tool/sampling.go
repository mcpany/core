...
//
// Summary: Session defines the interface for tools to interact with the client session. It includes capabilities like Sampling (CreateMessage) and Roots inspection.
//
// Methods:
//   - Defines the required contract and behavior for implementations of Session.
