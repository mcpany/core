...
// AddHealthStatusWithTime adds a status point to the history with a specific timestamp.
// This is primarily for testing.
func AddHealthStatusWithTime(serviceName string, status string, timestamp time.Time) {
	historyMu.Lock()
	defer historyMu.Unlock()
