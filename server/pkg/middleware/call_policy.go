...
// CallPolicyMiddleware is a middleware that enforces call policies (allow/deny) based on tool name and arguments. Summary: Middleware that evaluates and enforces security policies for tool executions.
//
// Summary: CallPolicyMiddleware is a middleware that enforces call policies (allow/deny) based on tool name and arguments. Summary: Middleware that evaluates and enforces security policies for tool executions.
//
// Fields:
//   - Contains the configuration and state properties required for CallPolicyMiddleware functionality.
