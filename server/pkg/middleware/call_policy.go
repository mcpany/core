...
//
// Summary: Initializes a middleware that enforces fine-grained access control policies for tool execution.
//
// Parameters:
//   - toolManager: tool.ManagerInterface. The manager used to look up service policies.
//
// Returns:
...
//
// Summary: Evaluates configured call policies against the current request and blocks execution if denied.
//
// Parameters:
//   - ctx: context.Context. The request context.
//   - req: *tool.ExecutionRequest. The tool execution request (including arguments).
//   - next: tool.ExecutionFunc. The next handler in the chain.
//
// Returns:
//   - any: The result of the execution.
//   - error: An error if the policy denies execution or if evaluation fails.
