...
// Limiter represents the public Limiter entity.
//
...
// RateLimitStrategy represents the public RateLimitStrategy entity.
//
// Summary: Defines the structured data model representing a limit strategy.
//
// Parameters:
//   - None.
//
