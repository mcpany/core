...
//
// Methods:
//   - Defines the required contract and behavior for implementations of Limiter.
...
//
// Methods:
//   - Defines the required contract and behavior for implementations of RateLimitStrategy.
