...
//
// Summary: Creates a middleware that redacts PII from request arguments and result content.
//
// Parameters:
//   - config (*configv1.DLPConfig): Parameter.
//   - log (*slog.Logger): Parameter.
//
// Returns:
//   - mcp.Middleware: Return value.
//
// Errors:
//   - None.
//
