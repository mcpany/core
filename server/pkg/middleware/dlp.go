...
//
// Summary: Creates an MCP middleware for Data Loss Prevention (redaction).
//
// Parameters:
//   - config: *configv1.DLPConfig. The DLP configuration.
//   - log: *slog.Logger. The logger to use for DLP events.
//
// Returns:
//   - mcp.Middleware: The configured DLP middleware.
