...
//
// Summary: Middleware for Data Loss Prevention (DLP) redaction.
//
// Parameters:
//   - config: *configv1.DLPConfig. The DLP configuration.
//   - log: *slog.Logger. Logger for recording DLP events (optional).
//
// Returns:
//   - mcp.Middleware: The MCP middleware function.
