...
// SSOMiddleware creates a new SSO middleware. config holds the configuration settings. Returns the result.
//
// Summary: creates a new SSO middleware. config holds the configuration settings. Returns the result.
//
// Parameters:
//   - config: SSOConfig
//
