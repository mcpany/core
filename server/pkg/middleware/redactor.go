...
//
// Summary: DLP Redaction Engine.
//
// Fields:
//   - customPatterns: []*regexp.Regexp. List of compiled regex patterns for custom redaction rules.
...
//
// Summary: Initializes a new Redactor.
//
// Parameters:
...
//
// Returns:
//   - *Redactor: The initialized Redactor, or nil if disabled/config is nil.
...
//
// Summary: Redacts sensitive data in JSON.
//
// Parameters:
...
//
// Summary: Redacts sensitive data in a string.
//
// Parameters:
...
//
// Summary: Recursively redacts sensitive data in a map.
//
// Parameters:
//   - v: map[string]interface{}. The map to modify in-place.
...
//
// Summary: Redacts a generic value (string, map, slice, structpb.Value).
//
// Parameters:
