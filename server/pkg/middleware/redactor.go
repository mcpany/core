...
//
// Summary: Initializes a new data redactor.
//
// Parameters:
...
//
// Returns:
//   - *Redactor: The initialized redactor.
...
//   - error: An error if JSON processing fails.
...
//
// Summary: Redacts sensitive information from a map (in-place).
//
// Parameters:
...
//
// Summary: Redacts sensitive information from a generic value.
//
// Parameters:
