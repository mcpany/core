...
//
// Summary: Initializes a middleware to track detailed metrics for tool executions (latency, I/O size, tokens).
//
// Parameters:
...
//
// Summary: Intercepts tool execution to record Prometheus metrics.
//
// Parameters:
