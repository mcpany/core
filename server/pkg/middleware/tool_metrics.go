...
//
// Summary: Initializes a new ToolMetricsMiddleware instance with the provided tokenizer.
//
// Parameters:
...
//
// Summary: Collects metrics for tool executions, including duration, input/output size, and token usage.
//
// Parameters:
