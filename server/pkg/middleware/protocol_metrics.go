...
//
// Summary: Middleware for Prometheus metrics.
//
// Parameters:
//   - t: tokenizer.Tokenizer. The tokenizer for counting tokens.
//
// Returns:
//   - mcp.Middleware: The metrics middleware.
...
//
// Summary: Calculates token count for a tool result.
//
// Parameters:
