...
//   - Modifies the Content-Encoding header.// Errors:
//   - None.
//
...
//   - Flushes buffer and writes to gzip writer if threshold is exceeded.// Errors:
//   - None.
//
...
//   - May trigger an immediate flush if the content type is not compressible.// Returns:
//   - None.
//
// Errors:
//   - None.
