...
//
// Summary: Registry for managing and looking up available middlewares.
...
//
// Summary: Function type for creating HTTP middleware from configuration.
...
//
// Summary: Function type for creating MCP middleware from configuration.
...
// Parameters:
//   - name: string. The name of the middleware.
//   - factory: MCPFactory. The factory function to create the MCP middleware.
//
// Returns:
//   - None.
//
...
//
// Parameters:
//   - configs: []*configv1.Middleware. The middleware configurations to process.
//
// Returns:
//   - []func(http.Handler) http.Handler: A slice of HTTP middleware functions.
//
// Errors:
//   - None.
//
...
//
// Returns:
//   - []func(mcp.MethodHandler) mcp.MethodHandler: A slice of MCP middleware functions.
//
// Errors:
//   - None.
//
...
//
// Summary: Container for the standard set of system middlewares.
