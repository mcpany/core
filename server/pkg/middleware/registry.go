...
//
// Summary: Registers a factory function for creating HTTP middlewares by name.
//
// Parameters:
...
//
// Summary: Registers a factory function for creating MCP middlewares by name.
//
// Parameters:
//   - name: string. The unique name of the middleware.
...
//
// Summary: Constructs and returns a list of active HTTP middlewares, sorted by priority.
//
// Parameters:
//   - configs: []*configv1.Middleware. The list of middleware configurations.
//
// Returns:
//   - []func(http.Handler) http.Handler: The ordered list of middleware functions.
...
//
// Summary: Constructs and returns a list of active MCP middlewares, sorted by priority.
//
// Parameters:
//   - configs: []*configv1.Middleware. The list of middleware configurations.
//
// Returns:
//   - []func(mcp.MethodHandler) mcp.MethodHandler: The ordered list of middleware functions.
