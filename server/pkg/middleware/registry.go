...
// Register adds a new HTTP middleware factory to the registry.
//
...
// RegisterMCP adds a new MCP middleware factory to the registry.
//
...
// GetHTTPMiddlewares returns a list of configured HTTP middlewares.
//
// Summary: Retrieves and instantiates HTTP middlewares based on configuration.
//
// Parameters:
//   - configs: []*configv1.Middleware. The list of middleware configurations.
//
// Returns:
...
// GetMCPMiddlewares returns a list of configured MCP middlewares.
//
// Summary: Retrieves and instantiates MCP middlewares based on configuration.
//
// Parameters:
//   - configs: []*configv1.Middleware. The list of middleware configurations.
//
...
// InitStandardMiddlewares initializes and registers the standard set of middlewares.
//
// Summary: Sets up standard middlewares.
//
// Parameters:
