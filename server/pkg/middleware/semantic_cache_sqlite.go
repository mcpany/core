...
//
// Returns:
//   - *SQLiteVectorStore: The created store.
//   - error: An error if database initialization fails.
...
//
// Summary: Adds an entry to memory cache and SQLite database.
//
// Parameters:
//   - ctx: context.Context.
//   - key: string.
...
//
// Summary: Searches the in-memory cache for a matching vector.
//
// Parameters:
//   - ctx: context.Context.
//   - key: string.
