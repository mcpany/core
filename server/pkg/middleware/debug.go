...
// DebugMiddleware creates an MCP middleware for debugging.
//
// It logs the full request and response of each MCP method call if debug logging is enabled.
//
// Returns:
//  - mcp.Middleware: The debugging middleware function.
