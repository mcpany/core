...
//
// Summary: returns a middleware function that logs the full request and response of each MCP method call. This is useful for debugging and understanding the flow of data through the server.
//
// Returns:
//   - mcp.Middleware
