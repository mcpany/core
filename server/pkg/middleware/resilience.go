...
//
// Returns:
//   - *ResilienceMiddleware: The initialized resilience middleware.
...
//
// Summary: Executes the tool with resilience patterns (retry, circuit breaker).
//
// Parameters:
...
//   - error: An error if the tool execution fails after retries.
