...
//
// Summary: Sets a custom Redis client creator function for tests.
//
// Parameters:
...
//
// Returns:
//   - *RedisLimiter: The initialized RedisLimiter.
...
//
// Summary: Initializes a new partitioned Redis-backed rate limiter.
//
// Parameters:
...
//
// Summary: Initializes a Redis-backed rate limiter using an existing client.
//
// Parameters:
...
//
// Summary: Checks if a single request is allowed (cost 1).
//
// Parameters:
...
//
// Summary: Retrieves the configuration hash.
//
// Returns:
