...
// Summary: Allow checks if the request is allowed (cost 1).
//
...
// Summary: AllowN checks if the request is allowed with a specific cost.
//
// _ is an unused parameter.
// n is the n.
//
...
// Summary: Create creates a new LocalLimiter.
//
// _ is an unused parameter.
// _ is an unused parameter.
// _ is an unused parameter.
