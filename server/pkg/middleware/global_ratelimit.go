...
// GlobalRateLimitMiddleware globalRateLimitMiddleware represents a global rate limit middleware.
//
// Summary: GlobalRateLimitMiddleware represents a global rate limit middleware.
