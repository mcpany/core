...
//
// Summary: Vector store backed by PostgreSQL.
//
// Fields:
...
//
// Summary: Initializes a Postgres vector store.
//
// Parameters:
...
//
// Summary: Initializes a store with existing DB.
//
// Parameters:
//   - db: *sql.DB. The database connection.
//
...
//
// Summary: Stores a vector and result.
//
// Parameters:
