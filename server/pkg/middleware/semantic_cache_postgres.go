...
// Summary: PostgresVectorStore implements VectorStore using PostgreSQL and pgvector. Provides vector storage capabilities using a PostgreSQL database with the pgvector extension.
//
// Parameters:
//   - None.
//
...
// Summary: Prune removes expired entries. Deletes expired cache entries from the database.
//
// Parameters:
...
// Summary: Close closes the database connection. Closes the underlying PostgreSQL database connection.
//
// Parameters:
//   - None.
//
