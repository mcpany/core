...
//
// Summary: Creates a new PostgresVectorStore connected to the database.
//
...
//   - Creates the vector extension and schema if they don't exist.
...
//
// Summary: Creates a new PostgresVectorStore using an existing DB connection.
//
...
// Returns:
//   - *PostgresVectorStore: The initialized vector store.
//   - error: An error if schema verification or creation fails.
//
// Side Effects:
//   - Creates the vector extension and schema if they don't exist.
...
//
// Summary: Finds the nearest neighbor vector for the given query.
//
// Parameters:
//   - ctx (context.Context): The context for the request.
...
//
// Summary: Deletes expired entries from the database.
//
// Parameters:
//   - ctx (context.Context): The context for the request.
//   - key (string): Optional key to filter the prune operation.
//
// Returns:
//   - None.
//
