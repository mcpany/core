...
//
// Returns:
//   - *RateLimitMiddleware: A new instance of the rate limiting middleware.
...
//
// It checks if the current request exceeds the rate limits configured for the service or tool.
//
// Parameters:
