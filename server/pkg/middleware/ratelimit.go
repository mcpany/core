...
//
// Summary: Configuration option for rate limiting.
type Option func(*RateLimitMiddleware)

// WithTokenizer sets a custom tokenizer for the middleware.
//
// Summary: Configures a specific tokenizer for token-based rate limiting.
//
// Parameters:
//   - t: tokenizer.Tokenizer. The tokenizer to use.
//
// Returns:
//   - Option: The functional option.
...
//
// Summary: Initializes the rate limiting middleware.
//
// Parameters:
//   - toolManager: tool.ManagerInterface. The manager for accessing tool and service configurations.
//   - opts: ...Option. Variadic functional options for configuration.
//
// Returns:
...
// Execute applies rate limiting logic before executing the tool.
//
