...
//
// Summary: Middleware for enforcing rate limits.
...
//
// Summary: Functional option type.
...
//
// Parameters:
//   - toolManager: tool.ManagerInterface. The tool manager to look up service configs.
//   - opts: ...Option. Optional configurations.
//
// Returns:
