...
//
// Summary: Functional option to configure the tokenizer used for token-based rate limiting.
//
// Parameters:
//   - t: tokenizer.Tokenizer. The tokenizer implementation.
//
// Returns:
//   - Option: The configured option function.
...
//
// Summary: Initializes a new RateLimitMiddleware for enforcing tool and service-level rate limits.
//
// Parameters:
//   - toolManager: tool.ManagerInterface. The manager used to look up tool and service configurations.
...
//
// Summary: Enforces rate limits before allowing tool execution to proceed.
//
// Parameters:
