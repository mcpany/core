...
// NewGuardrailsMiddleware creates a new Guardrails middleware. config holds the configuration settings. Returns the result.
//
// Summary: creates a new Guardrails middleware. config holds the configuration settings. Returns the result.
//
// Parameters:
