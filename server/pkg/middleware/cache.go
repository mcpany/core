...
//
// Summary: Creates a new CachingMiddleware instance.
//
// Parameters:
//   - toolManager: tool.ManagerInterface. The tool manager used to look up service configuration.
//
// Returns:
//   - *CachingMiddleware: The new CachingMiddleware instance.
...
//
// Summary: Sets a custom provider factory, primarily for testing.
//
// Parameters:
...
//
// Summary: Intercepts tool execution to handle caching.
//
// Parameters:
