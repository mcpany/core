...
//
// Summary: Overrides the embedding provider factory.
//
// Parameters:
...
//
// Summary: Checks the cache before executing a tool.
//
// Parameters:
...
//
// Returns:
//   - any: The result (cached or computed).
...
//
// Summary: Invalidates all cached entries.
//
// Parameters:
