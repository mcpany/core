...
//
// Summary: Middleware for caching tool execution results to improve performance.
...
//
// Summary: Initializes a new CachingMiddleware with in-memory storage.
//
// Parameters:
...
//
// Summary: Intercepts tool execution to check and update the cache.
//
// Parameters:
...
//
// Returns:
//   - any: The result of the tool execution (from cache or upstream).
//   - error: An error if the operation fails.
//
// Side Effects:
//   - May read from or write to the cache.
