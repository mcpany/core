...
//
// Summary: Factory function for embedding providers.
...
//
// Fields:
//   - cache: *cache.Cache. The underlying cache storage.
//   - toolManager: tool.ManagerInterface. Manager for accessing tool info.
//   - semanticCaches: sync.Map. Map of initialized semantic caches.
//   - providerFactory: ProviderFactory. Factory for creating embedding providers.
...
//
// Parameters:
//   - factory: ProviderFactory. The factory to use.
...
//
// Summary: Handles caching for tool execution.
//
// Parameters:
