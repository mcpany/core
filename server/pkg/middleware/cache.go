...
//
// Summary: Creates a new caching middleware with in-memory storage.
//
// Parameters:
...
//
// Side Effects:
//   - Initializes the cache and hasher pool.
...
//
// Summary: Sets a custom provider factory (used for testing).
//
// Parameters:
//   - factory (ProviderFactory): The custom factory function.
//
// Returns:
//   - None.
//
// Side Effects:
//   - Updates the middleware's provider factory.
...
//
// Summary: Handles caching logic for tool execution (get/set cache).
//
// Parameters:
...
//   - Records cache hits/misses/errors metrics.
