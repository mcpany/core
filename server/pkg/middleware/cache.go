...
//
// Summary: Initializes a new caching middleware.
//
// Parameters:
//   - toolManager: tool.ManagerInterface. The tool manager used to look up tool configurations.
//
// Returns:
...
//
// Summary: Sets a custom provider factory (for testing).
//
// Parameters:
...
//
// Summary: Executes the tool request with caching logic.
//
// Parameters:
...
//   - error: An error if execution or caching fails.
