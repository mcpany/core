...
func TestInitStandardMiddlewares(t *testing.T) {
	...
	standardMiddlewares, err := InitStandardMiddlewares(authManager, mockToolManager, auditConfig, cachingMiddleware, nil, nil, nil, nil)
...
func (m *MockToolManagerForRegistry) CountToolsForService(_ string) int {
	return 0
}
