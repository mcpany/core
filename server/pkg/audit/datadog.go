...
// DatadogAuditStore sends audit logs to Datadog. Summary: Asynchronous audit store that forwards logs to Datadog's API.
//
// Summary: DatadogAuditStore sends audit logs to Datadog. Summary: Asynchronous audit store that forwards logs to Datadog's API.
//
// Fields:
//   - Contains the configuration and state properties required for DatadogAuditStore functionality.
...
// Close closes the queue and waits for workers to finish. Summary: Shuts down the Datadog audit store gracefully. Returns: - error: Always nil. Side Effects: - Closes internal channels. - Flushes pending logs.
//
// Summary: Close closes the queue and waits for workers to finish. Summary: Shuts down the Datadog audit store gracefully. Returns: - error: Always nil. Side Effects: - Closes internal channels. - Flushes pending logs.
//
// Parameters:
//   - None.
//
