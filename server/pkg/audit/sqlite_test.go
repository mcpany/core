...
func TestEnsureColumn_Validation(t *testing.T) {
	...
	f, err := os.CreateTemp("", "audit_validation_*.testdb")
...
func TestSQLiteAuditStore(t *testing.T) {
	// Create a temporary database file
	f, err := os.CreateTemp("", "audit_test_*.testdb")
	require.NoError(t, err)
	dbPath := f.Name()
	f.Close()
	defer os.Remove(dbPath)
...
func TestSQLiteAuditStore_TamperEvident(t *testing.T) {
	// Create a temporary database file
	f, err := os.CreateTemp("", "audit_tamper_*.testdb")
	require.NoError(t, err)
	dbPath := f.Name()
	f.Close()
	defer os.Remove(dbPath)
...
func TestSQLiteAuditStore_Migration(t *testing.T) {
	// Create a temporary database file
	f, err := os.CreateTemp("", "audit_migration_*.testdb")
	require.NoError(t, err)
	dbPath := f.Name()
	f.Close()
	defer os.Remove(dbPath)
...
func TestSQLiteAuditStore_BackwardCompatibility(t *testing.T) {
	// Create a temporary database file
	f, err := os.CreateTemp("", "audit_compat_*.testdb")
	require.NoError(t, err)
	dbPath := f.Name()
	f.Close()
	defer os.Remove(dbPath)
...
func TestNewSQLiteAuditStore_EdgeCases(t *testing.T) {
	...
	t.Run("verify empty db", func(t *testing.T) {
		f, err := os.CreateTemp("", "audit_empty_*.testdb")
		require.NoError(t, err)
		dbPath := f.Name()
		f.Close()
		defer os.Remove(dbPath)
...
func TestEnsureColumns_Failure(t *testing.T) {
	...
	f, err := os.CreateTemp("", "audit_col_fail_*.testdb")
	require.NoError(t, err)
	dbPath := f.Name()
	f.Close()
	defer os.Remove(dbPath)
...
func TestSQLiteAuditStore_Write_Errors(t *testing.T) {
	f, err := os.CreateTemp("", "audit_write_fail_*.testdb")
	require.NoError(t, err)
	dbPath := f.Name()
	f.Close()
	defer os.Remove(dbPath)
...
func TestSQLiteAuditStore_Verify_Errors(t *testing.T) {
	f, err := os.CreateTemp("", "audit_verify_fail_*.testdb")
	require.NoError(t, err)
	dbPath := f.Name()
	f.Close()
	defer os.Remove(dbPath)
...
func TestSQLiteAuditStore_ComplexWrite(t *testing.T) {
	...
	f, err := os.CreateTemp("", "audit_complex_*.testdb")
	require.NoError(t, err)
	dbPath := f.Name()
	f.Close()
	defer os.Remove(dbPath)
...
func TestSQLiteAuditStore_IntegrityViolation_PrevHash(t *testing.T) {
	f, err := os.CreateTemp("", "audit_integrity_*.testdb")
	require.NoError(t, err)
	dbPath := f.Name()
	f.Close()
	defer os.Remove(dbPath)
...
func TestEnsureColumns_AlreadyExists(t *testing.T) {
	...
	f, err := os.CreateTemp("", "audit_exists_*.testdb")
	require.NoError(t, err)
	dbPath := f.Name()
	f.Close()
	defer os.Remove(dbPath)
...
func TestSQLiteAuditStore_ConcurrentWrites(t *testing.T) {
	f, err := os.CreateTemp("", "audit_concurrent_*.testdb")
	require.NoError(t, err)
	dbPath := f.Name()
	f.Close()
	defer os.Remove(dbPath)
...
func TestSQLiteAuditStore_Read(t *testing.T) {
	// Create a temporary database file
	f, err := os.CreateTemp("", "audit_read_*.testdb")
	require.NoError(t, err)
	dbPath := f.Name()
	f.Close()
	defer os.Remove(dbPath)
