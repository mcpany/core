...
//
// Summary: Creates a new PostgresAuditStore instance.
//
// Parameters:
//   - dsn (string): The PostgreSQL data source name (DSN).
//
// Returns:
//   - *PostgresAuditStore: The created store instance.
//   - error: An error if the DSN is empty or the database connection fails.
//
// Errors:
//   - Returns error if dsn is empty.
//   - Returns error if sql.Open or db.PingContext fails.
...
//
// Summary: Writes a single audit entry to the PostgreSQL database.
//
// Parameters:
...
//
// Errors:
//   - Returns error if transaction begin, lock, query, or commit fails.
//
// Side Effects:
//   - Inserts a new row into the audit_logs table.
//   - Locks the table briefly to ensure hash chain integrity.
...
//
// Summary: Reads audit entries from the database (Not Implemented).
//
// Parameters:
//   - ctx (context.Context): The context for the operation.
//   - filter (Filter): The filter criteria for reading logs.
//
// Returns:
//   - []Entry: A slice of audit entries.
//   - error: Always returns an error indicating not implemented.
//
// Errors:
//   - Returns "read not implemented for postgres audit store".
//
// Side Effects:
//   - None.
...
//   - error: An error if verification fails or integrity is compromised.
//
// Errors:
//   - Returns error if database query fails.
//   - Returns error if hash mismatch or prev_hash mismatch is detected.
//
// Side Effects:
...
//
// Side Effects:
//   - Closes the underlying sql.DB connection.
