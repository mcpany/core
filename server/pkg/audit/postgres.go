...
//
// Summary: PostgresAuditStore writes audit logs to a PostgreSQL database.
...
// Summary: NewPostgresAuditStore creates a new PostgresAuditStore.
//
// dsn is the dsn.
//
// Returns the result.
...
// Summary: Write writes an audit entry to the database.
//
