...
// ListServiceTemplates retrieves all service templates from the database.
//
// Parameters:
//  ctx (context.Context): The context for the request.
//
// Returns:
//  []*configv1.ServiceTemplate: A slice of service template objects.
//  error: An error if the database query or data unmarshalling fails.
...
// GetServiceTemplate retrieves a specific service template by its ID.
//
// Parameters:
//  ctx (context.Context): The context for the request.
...
//
// Returns:
//  *configv1.ServiceTemplate: The service template object if found.
//  error: An error if the template is not found or other database error occurs.
...
// Parameters:
//  ctx (context.Context): The context for the request.
//  template (*configv1.ServiceTemplate): The service template object to save.
//
// Returns:
...
// DeleteServiceTemplate deletes a service template by its ID.
//
// Parameters:
//  ctx (context.Context): The context for the request.
...
func (s *Store) DeleteServiceTemplate(ctx context.Context, id string) error {
	_, err := s.db.ExecContext(ctx, "DELETE FROM service_templates WHERE id = $1", id)
	if err != nil {
