...
//
// Summary: Initializes a new in-memory configuration store.
//
// Returns:
...
//
// Summary: Loads the entire server configuration from memory.
//
// Parameters:
//   - _ (context.Context): Unused context.
//
...
//
// Memory store always has data available (or can accept data).
//
// Returns:
//   - (bool): Always true.
