...
//
// Summary: Initializes an in-memory store.
//
// Returns:
...
//
// Returns:
//   - *configv1.UpstreamServiceConfig: The service, or nil if not found.
//   - error: Always nil.
...
//
// Returns:
//   - []*configv1.UpstreamServiceConfig: A list of services.
//   - error: Always nil.
...
//
// Returns:
//   - error: An error if the user already exists.
