...
//
// Returns:
//   - *Store: The initialized memory store.
func NewStore() *Store {
	return &Store{
...
//
// Returns:
//   - *configv1.UserToken: The token if found, otherwise nil.
//   - error: Always nil.
...
//
// Summary: Deletes a user token from memory.
//
// Parameters:
//   - ctx: context.Context. Unused.
//   - userID: string. The user ID.
...
//
// Summary: Builds and returns the full server configuration from memory.
//
// Parameters:
//   - ctx: context.Context. Unused.
//
...
// Parameters:
//   - ctx: context.Context. Unused.
//   - service: *configv1.UpstreamServiceConfig. The service to save.
//
// Returns:
//   - error: Always nil.
...
//
// Returns:
//   - *configv1.UpstreamServiceConfig: The service config if found, otherwise nil.
//   - error: Always nil.
...
//
// Summary: Retrieves all upstream service configurations.
//
// Parameters:
//   - ctx: context.Context. Unused.
//
// Returns:
//   - []*configv1.UpstreamServiceConfig: A list of all service configs.
//   - error: Always nil.
...
//
// Summary: Retrieves the global settings.
//
// Parameters:
//   - ctx: context.Context. Unused.
//
...
//
// Summary: Updates the global settings.
//
// Parameters:
//   - ctx: context.Context. Unused.
//   - settings: *configv1.GlobalSettings. The new global settings.
//
// Returns:
//   - error: Always nil.
...
//
// Returns:
//   - *configv1.Secret: The secret if found, otherwise nil.
//   - error: Always nil.
...
//
// Summary: Deletes a secret by its ID.
//
// Parameters:
//   - ctx: context.Context. Unused.
...
//
// Returns:
//   - *configv1.User: The user if found, otherwise nil.
//   - error: Always nil.
...
//
// Returns:
//   - []*configv1.User: A list of all users.
//   - error: Always nil.
...
//
// Returns:
//   - error: An error if the user does not exist.
...
//
// Returns:
//   - []*configv1.ProfileDefinition: A list of all profiles.
//   - error: Always nil.
...
//
// Returns:
//   - *configv1.ProfileDefinition: The profile if found, otherwise nil.
//   - error: Always nil.
...
//
// Returns:
//   - []*configv1.Collection: A list of all collections.
//   - error: Always nil.
...
//
// Returns:
//   - *configv1.Collection: The collection if found, otherwise nil.
//   - error: Always nil.
...
//
// Returns:
//   - *configv1.Credential: The credential if found, otherwise nil.
//   - error: Always nil.
...
//
// Summary: Deletes a credential by its ID.
//
// Parameters:
//   - ctx: context.Context. Unused.
