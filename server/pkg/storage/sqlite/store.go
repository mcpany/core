...
//
// Summary: SQLite implementation of the Storage interface.
type Store struct {
	db *DB
}
...
//
// Summary: Initializes a new SQLite storage instance.
//
// Parameters:
//   - db: *DB. The SQLite database wrapper.
//
// Returns:
...
//
// Summary: Loads the complete server configuration from SQLite.
//
// Parameters:
...
//
// Summary: Persists an upstream service configuration to SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Retrieves an upstream service configuration from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Retrieves all upstream service configurations from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
//
...
//
// Summary: Removes an upstream service configuration from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Retrieves the global settings from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
//
...
//
// Summary: Persists the global settings to SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Creates a new user in SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Retrieves a user from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Retrieves all users from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
//
...
//
// Summary: Updates an existing user in SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Removes a user from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Retrieves all secrets from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
//
...
//
// Summary: Retrieves a specific secret from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Persists a secret to SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Removes a secret from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Retrieves all profile definitions from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
//
...
//
// Summary: Retrieves a profile definition from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Persists a profile definition to SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Removes a profile definition from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Retrieves all service collections from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
//
...
//
// Summary: Retrieves a service collection from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Persists a service collection to SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Removes a service collection from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Persists a user authentication token to SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Retrieves a user authentication token from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Removes a user authentication token from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
//   - userID: string. The unique identifier of the user.
...
//
// Summary: Retrieves all credentials from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
//
...
//
// Summary: Retrieves a credential from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
...
//
// Summary: Persists a credential to SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
//   - cred: *configv1.Credential. The credential to save. Must have a valid ID.
//
// Returns:
//   - error: Returns nil on success, or an error if the operation fails.
//
// Throws/Errors:
//   - Returns error if "credential ID is required".
...
//
// Summary: Removes a credential from SQLite.
//
// Parameters:
//   - ctx: context.Context. Context for the operation.
