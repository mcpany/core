...
// Summary: Store implements config.Store using SQLite. SQLite storage implementation.
//
// Parameters:
//   - None.
//
...
// Summary: NewStore creates a new SQLite store. Creates a new SQLite store.
//
// Parameters:
