...
//
// Summary: Initializes a new SQLite-based configuration store.
//
// Parameters:
//   - db (*DB): The initialized SQLite database connection.
//
// Returns:
...
//
// Summary: Checks if the store has underlying configuration sources.
//
// For DB stores, this always returns true as the database itself is the source.
//
// Returns:
//   - (bool): Always true.
...
//
// It fetches services, users, settings, collections, and profiles in parallel
// to construct the full `McpAnyServerConfig`.
//
// Parameters:
...
//   - (error): An error if the database query or unmarshaling fails.
...
//
// Summary: Removes a service configuration from the database.
//
// Parameters:
//   - ctx (context.Context): The request context.
...
//
// Returns:
//   - (error): An error if the user ID is missing or database insert fails.
...
//
// Summary: Persists a secret to the database.
//
// Parameters:
//   - ctx (context.Context): The request context.
...
//
// Returns:
//   - (error): An error if user ID/Service ID are missing or write fails.
...
//
// Summary: Persists a credential to the database.
//
// Parameters:
//   - ctx (context.Context): The request context.
