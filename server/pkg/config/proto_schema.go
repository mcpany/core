...
//
// Parameters:
//   - msg (protoreflect.Message): Parameter.
//
// Returns:
//   - *jsonschema.Schema: Return value.
//   - error: Return value.
//
// Errors:
...
//
// Summary: Generates a raw JSON schema map from a protobuf message using reflection.
//
// Parameters:
//   - msg (protoreflect.Message): Parameter.
//
...
//
// Parameters:
//   - schemaMap (map[string]interface{}): Parameter.
//
// Returns:
//   - *jsonschema.Schema: Return value.
//   - error: Return value.
