...
// Summary: GenerateSchemaFromProto generates a jsonschema from a protobuf message using reflection. Generates a JSON schema object from a protobuf message descriptor.
//
// Parameters:
//   - msg (protoreflect.Message): The msg parameter.
//
// Returns:
...
// Summary: GenerateSchemaMapFromProto generates a raw JSON schema map from a protobuf message using reflection. This is useful if you want to export the schema as JSON. Generates a raw JSON schema map from a protobuf message.
//
// Parameters:
//   - msg (protoreflect.Message): The msg parameter.
//
...
// Summary: CompileSchema compiles a raw JSON schema map into a jsonschema.Schema object. Compiles a JSON schema map into a valid schema object.
//
// Parameters:
//   - schemaMap (map[string]interface{}): The schemaMap parameter.
//
// Returns:
//   - *jsonschema.Schema: The resulting *jsonschema.Schema.
//   - error: An error if the operation fails.
