...
// ValidationError - Auto-generated documentation.
//
// Summary: ValidationError encapsulates a validation error for a specific service.
//
// Fields:
//   - Various fields for ValidationError.
