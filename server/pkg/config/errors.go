...
//
// Summary: An error type that provides actionable feedback to the user.
...
//
// Summary: Returns a formatted error message.
//
// Returns:
...
//
// Summary: Retrieves the underlying error.
//
// Returns:
...
//
// Summary: Wraps an error while preserving actionable suggestions.
//
