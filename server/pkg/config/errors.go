...
//
// Summary: Returns the error message including the suggestion.
//
// Returns:
...
//
// Summary: Returns the original error wrapped by ActionableError.
//
// Returns:
...
//
// Summary: Wraps an error, preserving ActionableError type if applicable.
//
...
//
// Parameters:
//   - context: string. A description of the context in which the error occurred.
//   - err: error. The original error to wrap.
//
// Returns:
//   - error: The wrapped error, potentially an ActionableError.
