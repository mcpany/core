...
//
// Summary: Binds global command-line flags to configuration.
//
...
//   - Modifies global Viper configuration state.
...
//
// Summary: Binds server-specific flags to configuration.
//
...
//
// Summary: Binds all flags to configuration.
//
