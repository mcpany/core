...
//
// Summary: Binds global and persistent command-line flags to Viper.
//
...
//
// Summary: Binds server-specific command-line flags to Viper.
//
...
//
// Summary: Binds all command-line flags to Viper.
//
