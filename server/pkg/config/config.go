...
//   - log-format: Set the logging format (text, json).
//   - logfile: Path to a file for log output.
//   - set: Overrides for configuration values.
//
// Parameters:
