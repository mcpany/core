...
// Summary: Engine defines the interface for configuration unmarshaling from different file formats. Abstraction for parsing configuration files into protobuf messages.
//
// Parameters:
//   - None.
//
...
// Summary: StructuredEngine defines an interface for engines that can unmarshal directly from a map structure. Abstraction for parsing configurations from map structures, avoiding double parsing.
//
// Parameters:
//   - None.
//
...
// Summary: ConfigurableEngine defines an interface for engines that support configuration options. Interface for engines that can be configured (e.g. skip validation).
//
// Parameters:
//   - None.
//
...
// Summary: NewEngine returns a configuration engine capable of unmarshaling the format indicated by the file extension. Factory function to create the appropriate Engine for a given file path.
//
// Parameters:
//   - path (string): The path parameter.
//
// Returns:
//   - Engine: The resulting Engine.
...
// Summary: Store defines the interface for loading MCP-X server configurations. Abstraction for configuration sources.
//
// Parameters:
//   - None.
//
...
// Summary: ServiceStore extends Store to provide CRUD operations for UpstreamServices. Interface for stores that support managing individual services.
//
// Parameters:
//   - None.
//
...
// Summary: FileStore implements the `Store` interface for loading configurations from files. Loads configurations from the filesystem.
//
// Parameters:
//   - None.
//
...
// Summary: NewFileStore creates a new FileStore with the given filesystem and paths. Initializes a new FileStore.
//
// Parameters:
...
//
// Returns:
//   - *FileStore: The resulting *FileStore.
//
// Errors:
//   - None.
//
...
// Summary: NewFileStoreWithSkipErrors creates a new FileStore that skips malformed config files. Initializes a new FileStore that tolerates errors in config files.
//
// Parameters:
//   - fs (afero.Fs): The fs parameter.
//   - paths ([]string): The paths parameter.
...
// Summary: Load scans the configured paths and merges them into a single configuration. Loads and merges configurations from all configured paths.
//
// Parameters:
...
// Summary: MultiStore implements the Store interface for loading configurations from multiple stores. Combines multiple stores into a single logical store.
//
// Parameters:
//   - None.
//
...
// Summary: NewMultiStore creates a new MultiStore with the given stores. Initializes a new MultiStore.
//
// Parameters:
//   - stores (...Store): The stores parameter.
//
// Returns:
//   - *MultiStore: The resulting *MultiStore.
//
// Errors:
//   - None.
//
...
// Summary: Load loads configurations from all stores and merges them into a single config. Loads and merges configurations from all underlying stores.
//
// Parameters:
//   - ctx (context.Context): The ctx parameter.
//
