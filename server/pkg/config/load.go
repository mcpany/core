...
//
// It acts as a resilient loader that filters out invalid services to allow the
// server to start even with partial configuration failures.
//
// Parameters:
...
//   - error: An error if loading or validation fails (e.g., global settings invalid).
