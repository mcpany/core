...
//   - binaryType: The type of binary (server, worker) running the loader.
//
// Returns:
//   - *configv1.McpAnyServerConfig: The loaded and validated configuration.
...
//
// Returns:
//   - *configv1.McpAnyServerConfig: The loaded configuration with defaults applied.
