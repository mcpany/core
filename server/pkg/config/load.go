...
//
// Summary: Loads, validates, and processes the server configuration from a given store.
//
// Parameters:
//   - ctx: context.Context. The context for the operation.
//   - store: Store. The configuration store to load from.
//   - binaryType: string. The type of binary running the code (e.g., "server", "worker").
//
// Returns:
//   - *configv1.McpAnyServerConfig: The validated configuration object.
