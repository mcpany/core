...
//
// Summary: Loads and validates the server configuration from a store.
//
// Parameters:
//   - ctx: context.Context. The context for the operation.
//   - store: Store. The configuration store.
//   - binaryType: string. The type of binary (e.g., "server", "worker").
//
// Returns:
//   - *configv1.McpAnyServerConfig: The validated configuration.
//   - error: An error if loading or validation fails.
//
// Errors/Throws:
//   - Returns error if LoadResolvedConfig fails.
//   - Returns error if binaryType is unknown.
//   - Returns error if validation fails (and logs details).
//
// Side Effects:
...
//
// Summary: Loads resolved configuration without strict validation.
//
// Parameters:
//   - ctx: context.Context. The context for the operation.
//   - store: Store. The configuration store.
...
//
// Errors/Throws:
//   - Returns error if store.Load fails.
//   - Returns error if service loading/merging fails.
//
// Side Effects:
//   - Creates a default user if none configured.
//   - Hydrates secrets.
