...
//
// It holds configuration values that affect the entire application lifecycle,
// such as listening ports, logging settings, and database paths.
...
//
// It ensures that only one instance of Settings is created and returned.
//
// Returns:
...
//
// Returns:
//   - *configv1.GlobalSettings: The protobuf representation of the settings.
...
//
// It parses flags, environment variables, and configuration files to populate
// the Settings struct.
//
// Parameters:
...
//
// Returns:
//   - configv1.GlobalSettings_LogFormat: The log format (e.g., TEXT, JSON).
...
//
// Returns:
//   - string: The gRPC port (e.g., ":50051").
...
//
// Returns:
//   - string: The address the MCP server is listening on.
...
//
// Returns:
//   - []string: A slice of paths to configuration files or directories.
...
//
// Returns:
//   - string: The path to the log file, or empty string if not set.
...
//
// Returns:
//   - []string: A slice of active profile names.
...
//
// Returns:
//   - configv1.GlobalSettings_LogLevel: The log level.
...
//
// Returns:
//   - []*configv1.Middleware: The configured middlewares.
...
//
// Parameters:
//   - dlp: *configv1.DLPConfig. The DLP configuration.
