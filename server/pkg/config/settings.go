...
//
// Returns:
//   - configv1.GlobalSettings_LogFormat: The configured log format.
...
//
// Returns:
//   - string: The configured MCP listen address.
...
//
// Returns:
//   - string: The configured metrics listen address.
...
//
// Returns:
//   - []string: A list of configuration file paths.
...
//
// Parameters:
//   - middlewares: A list of middleware configurations.
...
//
// Returns:
//   - []string: A list of active profiles.
...
//
// Returns:
//   - configv1.GlobalSettings_LogLevel: The configured log level.
...
//
// Returns:
//   - []string: A list of configuration values to set.
...
//
// Returns:
//   - []*configv1.Middleware: A list of configured middlewares.
...
//
// Parameters:
//   - dlp: The DLP configuration to set.
