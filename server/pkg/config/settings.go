...
//
// Summary: Holds the global runtime configuration settings.
...
//
// Summary: Accessor for the singleton Settings instance.
//
// Returns:
...
//
// Returns:
//   - *configv1.GlobalSettings: The protobuf representation of global settings.
...
//
// Summary: Loads configuration from flags and config files.
//
// Parameters:
...
//   - Modifies the global settings singleton.
//   - Reads environment variables (via Viper).
...
//
// Returns:
//   - configv1.GlobalSettings_LogFormat: The log format enum (e.g., TEXT, JSON).
...
//
// Summary: Retrieves the address where the MCP server listens.
//
// Returns:
//   - string: The MCP listen address.
...
//
// Summary: Retrieves the address where metrics are exposed.
//
// Returns:
...
//
// Returns:
//   - bool: True if stdio mode is enabled, false otherwise.
...
//
// Summary: Retrieves the list of configuration file paths.
//
// Returns:
...
//
// Summary: Retrieves the path to the log file.
//
// Returns:
...
//
// Summary: Retrieves the configured shutdown timeout duration.
//
// Returns:
...
//
// Summary: Retrieves the configured API key.
//
// Returns:
//   - string: The API key.
...
//
// Side Effects:
//   - Updates the underlying protobuf message.
...
//
// Summary: Configures the middlewares for the server.
//
// Parameters:
...
//
// Summary: Retrieves the list of active profiles.
//
// Returns:
//   - []string: A list of active profile names.
...
//
// Summary: Retrieves the configured log level.
//
// Returns:
...
//
// Summary: Retrieves the path to the SQLite database.
//
// Returns:
...
//
// Summary: Retrieves key-value pairs for configuration overrides.
//
// Returns:
...
//
// Summary: Retrieves the Database Data Source Name (DSN).
//
// Returns:
//   - string: The database DSN.
...
//
// Summary: Retrieves the database driver name.
//
// Returns:
...
//
// Summary: Retrieves the list of configured middlewares.
//
// Returns:
//   - []*configv1.Middleware: The list of middlewares.
...
//
// Returns:
//   - *configv1.DLPConfig: The DLP configuration.
...
//
// Parameters:
//   - dlp: *configv1.DLPConfig. The DLP configuration to set.
//
// Side Effects:
//   - Updates the underlying protobuf message.
...
//
// Returns:
//   - *configv1.OIDCConfig: The OIDC configuration.
...
//
// Summary: Retrieves the defined profiles.
//
// Returns:
//   - []*configv1.ProfileDefinition: The list of profile definitions.
...
//
// Summary: Retrieves the configured GitHub API URL.
//
// Returns:
