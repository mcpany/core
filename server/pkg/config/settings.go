...
//
// Summary: Retrieves the singleton Settings instance.
//
// Returns:
...
//
// Summary: Converts the settings to their protobuf representation.
//
// Returns:
...
//
// Summary: Loads configuration from flags, environment variables, and files.
//
// Parameters:
...
//
// Summary: Retrieves the configured MCP listen address.
//
// Returns:
...
//
// Summary: Retrieves the configured metrics listen address.
//
// Returns:
...
//
// Returns:
//   - []string: The configuration file paths.
...
//
// Summary: Retrieves the configured log file path.
//
// Returns:
...
//
// Summary: Retrieves the configured shutdown timeout.
//
// Returns:
...
//
// Summary: Updates the middleware configuration.
//
// Parameters:
//   - middlewares: []*configv1.Middleware. The new middleware list.
...
//
// Summary: Retrieves the configured database path.
//
// Returns:
...
//
// Summary: Retrieves the list of configuration override values.
//
// Returns:
...
//
// Summary: Retrieves the configured database DSN.
//
// Returns:
...
//
// Summary: Retrieves the configured database driver.
//
// Returns:
