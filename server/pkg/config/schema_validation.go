...
// Summary: ValidateConfigAgainstSchema validates the raw configuration map against the generated JSON schema.
//
// Parameters:
...
// Summary: GenerateJSONSchemaBytes returns the JSON schema for McpAnyServerConfig as a byte slice.
//
// Returns the result.
