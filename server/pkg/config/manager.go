...
//
// Summary: Initializes the manager with the specified enabled profiles and default settings.
//
// Parameters:
...
//
// Summary: Processes both locally defined services and remote service collections, merging them based on their priority and name.
//
// Parameters:
