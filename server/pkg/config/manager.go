...
// UpstreamServiceManager upstreamServiceManager represents a upstream service manager.
//
// Summary: UpstreamServiceManager represents a upstream service manager.
