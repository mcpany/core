...
type Prompt interface {
	...
	//   - args: The input arguments as a JSON message.
	//
	// Returns:
...
//
// Parameters:
//   - definition: The prompt definition from the configuration.
//   - serviceID: The ID of the service providing the prompt.
//
// Returns:
//   - *TemplatedPrompt: The new TemplatedPrompt instance.
...
//
// Parameters:
//   - _ : The context (unused in this implementation but required by interface).
//   - args: The input arguments as a JSON message.
//
// Returns:
//   - *mcp.GetPromptResult: The prompt result containing messages.
//   - error: An error if unmarshalling or template rendering fails.
...
//
// Parameters:
//   - definition: The prompt definition.
//   - serviceID: The service identifier.
//
// Returns:
//   - Prompt: The created prompt.
//   - error: An error if creation fails (always nil currently).
