...
//
// It handles the lifecycle of prompts, including registration, retrieval, and
// association with the MCP server.
type ManagerInterface interface {
	...
	//
	// Parameters:
	//   - serviceID: string. The ID of the service whose prompts should be removed.
	ClearPromptsForService(serviceID string)

	// SetMCPServer sets the MCP server provider.
	//
	// Parameters:
	//   - mcpServer: MCPServerProvider. The MCP server provider to set.
...
//
// Side Effects:
//   - Modifies the internal prompt map.
...
// Side Effects:
//   - Modifies the internal prompt map.
//   - Invalidates the prompt cache if any prompts were removed.
