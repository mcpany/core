...
//
// Parameters:
//   - mcpServer: MCPServerProvider. Represents the mcpServer for the operation.
//
// Returns:
//   - None.
//
...
//
// Parameters:
//   - prompt: Prompt. Represents the prompt for the operation.
//
// Returns:
//   - None.
//
...
//
// Returns:
//   - []Prompt: The resulting output from the operation.
//
// Errors:
//   - None.
//
