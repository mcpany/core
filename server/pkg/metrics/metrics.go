...
//
// Summary: Creates a Prometheus metrics sink.
//
// Returns:
...
//
// Summary: Returns the HTTP handler for Prometheus metrics.
//
// Returns:
...
//
// Summary: Starts the metrics HTTP server.
//
// Parameters:
...
//
// Summary: Records the time elapsed since the start time.
//
// Parameters:
...
//
// Summary: Records the time elapsed since the start time with labels.
//
// Parameters:
//   - name: []string. The name of the metric (as a path).
//   - start: time.Time. The start time.
...
//
// Summary: Adds a sample to a histogram or summary.
//
// Parameters:
//   - name: []string. The name of the metric (as a path).
...
//
// Summary: Adds a sample to a histogram or summary with labels.
//
// Parameters:
//   - name: []string. The name of the metric (as a path).
//   - val: float32. The value to sample.
