...
// Summary: Config defines the configuration for the GC Worker. Represents a Config.
//
// Parameters:
//   - None.
//
...
// Summary: Worker implements a background worker for garbage collection. Represents a Worker.
//
// Parameters:
//   - None.
//
