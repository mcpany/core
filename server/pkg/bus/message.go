...
//
// Summary: Defines the interface that all messages exchanged on the event bus must implement.
...
//
// Summary: Provides a default implementation of the Message interface.
...
//
// Summary: A message sent to the bus to request the registration of a new upstream service.
...
//
// Summary: A message published in response to a ServiceRegistrationRequest.
...
//
// Summary: A message sent to the bus to request the execution of a specific tool on an upstream service.
...
//
// Summary: A message published in response to a ToolExecutionRequest.
...
// registered services.
//
// Summary: A message sent to the bus to request a list of all registered services.
...
//
// Summary: A message published in response to a ServiceListRequest.
...
//
// Summary: A message sent to the bus to request a specific service.
...
//
// Summary: A message published in response to a ServiceGetRequest.
