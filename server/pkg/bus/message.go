...
//
// Summary: defines the interface that all messages exchanged on the event bus must implement. It provides a standard way to manage correlation IDs for tracking requests and their corresponding responses.
...
//
// Summary: provides a default implementation of the Message interface. It includes a correlation ID field (`CID`) and can be embedded in other message structs to provide a common mechanism for message tracking.
...
//
// Summary: is a message sent to the bus to request the registration of a new upstream service. It contains the service's configuration and the context for the request.
...
//
// Summary: is a message published in response to a ServiceRegistrationRequest. It contains the outcome of the registration process, including the generated service key, a list of any tools that were discovered, or an error if the registration failed.
...
//
// Summary: is a message sent to the bus to request the execution of a specific tool on an upstream service. It includes the name of the tool and its inputs in raw JSON format.
...
//
// Summary: is a message published in response to a ToolExecutionRequest. It contains the result of the tool execution, in raw JSON format, or an error if the execution failed.
...
//
// Summary: is a message sent to the bus to request a list of all registered services.
...
//
// Summary: is a message published in response to a ServiceListRequest. It contains a list of all registered services.
