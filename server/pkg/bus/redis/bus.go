...
//
// It leverages Redis Pub/Sub for message delivery.
...
//
// Parameters:
//   - redisConfig: *bus.RedisBus. The configuration settings.
//
// Returns:
//   - *Bus[T]: The new RedisBus instance.
...
//
// Parameters:
//   - client: *redis.Client. The Redis client to use.
//
// Returns:
//   - *Bus[T]: The new RedisBus instance.
