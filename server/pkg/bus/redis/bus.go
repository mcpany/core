...
//
// Summary: Initializes New operation for Redis bus.
//
// Parameters:
...
//
// Summary: Initializes NewWithClient operation with a provided client.
//
// Parameters:
...
//
// Summary: Executes Publish operation to send a message to Redis.
//
// Parameters:
...
//
// Summary: Executes Subscribe operation to listen to a Redis channel.
//
// Parameters:
...
//
// Summary: Executes SubscribeOnce operation for a one-time message.
//
// Parameters:
//   - ctx (context.Context): The context for the subscription.
//   - topic (string): The topic (channel) to subscribe to.
