...
func (b *Broadcaster) Broadcast(msg any) {
	...
	// If caller passes a pointer and modifies it later, history will reflect that.
	// But LogEntry is passed by value (struct).
...
func (b *Broadcaster) Hydrate(messages []any) {
	...
	for _, msg := range messages {
		...
		// Assuming msg is immutable or value type.
