...
// Summary: LogEntry is the structure for logs sent over WebSocket. It matches the frontend expectation. Represents a LogEntry.
//
// Parameters:
//   - None.
//
...
// Summary: BroadcastHandler implements slog.Handler and sends logs to the Broadcaster. Represents a BroadcastHandler.
//
// Parameters:
//   - None.
//
...
// Summary: TeeHandler is a slog.Handler that writes to multiple handlers. Represents a TeeHandler.
//
// Parameters:
//   - None.
//
...
// Summary: NewTeeHandler creates a new TeeHandler. handlers is the handlers. Returns the result.
//
// Parameters:
