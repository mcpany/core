...
// Conn conn represents a conn.
//
// Summary: Conn represents a conn.
type Conn interface {
...
// GrpcClientWrapper grpcClientWrapper represents a grpc client wrapper.
//
// Summary: GrpcClientWrapper represents a grpc client wrapper.
