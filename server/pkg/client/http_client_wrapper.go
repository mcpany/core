...
//
// Summary: Wrapper for http.Client to support pooling.
//
// This allows HTTP clients to be managed by a
...
//
// Returns:
//   - *HTTPClientWrapper: The new wrapper instance.
...
//
// Summary: Checks upstream health.
//
// Parameters:
