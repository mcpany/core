...
//
// Summary: WebsocketClientWrapper wraps a *websocket.
//
...
//
// Summary: IsHealthy checks if the underlying WebSocket connection is still active.
//
...
// Summary: Close terminates the underlying WebSocket connection.
//
