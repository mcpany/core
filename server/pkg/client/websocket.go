...
// WebsocketClientWrapper websocketClientWrapper represents a websocket client wrapper.
//
// Summary: WebsocketClientWrapper represents a websocket client wrapper.
