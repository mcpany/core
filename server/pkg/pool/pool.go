...
//
// Errors:
//   - Returns "maxSize must be positive" if triggered.
//   - Returns "invalid maxIdleSize/maxSize configuration" if triggered.
//   - Returns "initialSize must be between 0 and maxIdleSize" if triggered.
