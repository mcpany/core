...
type ManagerInterface interface {
	...
	//
	// Returns:
	//   - []Resource: A slice of all managed resources.
	...
	//
	// Parameters:
	//   - callback: The function to execute when the list changes.
	OnListChanged(callback func())
...
//
// Returns:
//   - error: An error if the resource is not found or subscription fails.
//
// Errors:
//   - ErrResourceNotFound: If the resource with the given URI does not exist.
...
//
// Side Effects:
//   - Removes matching resources from the internal map.
//   - Triggers the OnListChanged callback if any resources were removed.
