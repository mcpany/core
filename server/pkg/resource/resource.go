...
//   - Triggers the on-change callback if registered.// Errors:
//   - None.
//
...
//
// Returns:
//   - []Resource: A slice of currently registered resources.// Parameters:
//   - None.
//
// Errors:
//   - None.
...
//
// Returns:
//   - error: An error if resource not found or subscription fails.// Errors:
//   - None.
//
// Side Effects:
//   - None.
...
//   - Invalidates the list cache.
//   - Triggers the on-change callback.// Errors:
//   - None.
//
