...
// Summary: GetResource retrieves a resource from the manager by its URI.
//
// Parameters:
//   - uri: string. The URI of the resource.
//
...
// AddResource adds a new resource to the manager.
// Summary: AddResource adds a new resource to the manager.
//
// Parameters:
//   - resource: Resource. The resource to add.
//
...
// RemoveResource removes a resource from the manager by its URI.
// Summary: RemoveResource removes a resource from the manager by its URI.
//
// Parameters:
//   - uri: string. The URI of the resource.
//
...
//
// Summary: OnListChanged sets a callback function that will be invoked whenever the list
//
...
// Summary: Subscribe finds a resource by its URI and calls its Subscribe method.
//
// Parameters:
//   - ctx: context.Context. The context for the subscription.
//   - uri: string. The URI of the resource.
...
// ClearResourcesForService removes all resources associated with a given service ID.
// Summary: ClearResourcesForService removes all resources associated with a given service ID.
//
// Parameters:
//   - serviceID: string. The service ID.
//
