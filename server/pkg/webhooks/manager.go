...
// WebhookConfig webhookConfig represents a webhook config.
//
// Summary: WebhookConfig represents a webhook config.
...
//
// Summary: AddWebhook add webhook.
//
// Parameters:
//   - w (*WebhookConfig): The w.
//
// Returns:
//   - None.
//
