...
// Frontmatter frontmatter represents a frontmatter.
//
// Summary: Frontmatter represents a frontmatter.
...
// Skill skill represents a skill.
//
// Summary: Skill represents a skill.
type Skill struct {
