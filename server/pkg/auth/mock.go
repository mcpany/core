...
// MockUpstreamAuthenticator mockUpstreamAuthenticator represents a mock upstream authenticator.
//
// Summary: MockUpstreamAuthenticator represents a mock upstream authenticator.
