...
// OAuth2Config - Auto-generated documentation.
//
// Summary: OAuth2Config holds the configuration for OAuth2 authentication. It is used to
//
// Fields:
//   - Various fields for OAuth2Config.
