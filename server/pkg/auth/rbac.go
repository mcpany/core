...
//
// Summary: Checks if a user has any of the roles.
//
// Parameters:
//   - user: *configv1.User. The user to check.
//   - roles: []string. The list of roles to verify against.
//
// Returns:
...
//
// Summary: Checks role presence in context.
//
// Parameters:
...
//
// Returns:
//   - bool: True if the context contains the role, false otherwise.
