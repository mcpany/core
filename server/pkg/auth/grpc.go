...
// Summary: PerRPCCredentials adapts an UpstreamAuthenticator to the gRPC credentials.PerRPCCredentials interface. It allows applying upstream authentication headers to outgoing gRPC requests. Represents a PerRPCCredentials.
//
// Parameters:
//   - None.
//
