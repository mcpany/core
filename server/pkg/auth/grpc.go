...
//
// Parameters:
//   - authenticator: UpstreamAuthenticator. Represents the authenticator for the operation.
//
// Returns:
//   - credentials.PerRPCCredentials: The resulting output from the operation.
//
// Errors:
//   - None.
//
