...
// NewUpstreamAuthenticator creates an UpstreamAuthenticator based on the configuration.
//
...
//
// Returns:
//   - UpstreamAuthenticator: The initialized authenticator, or nil.
...
// Authenticate adds the configured API key to the request.
//
