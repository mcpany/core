...
type UpstreamAuthenticator interface {
	...
	//
	// Summary: Adds authentication credentials to the request.
	//
	// Parameters:
	//   - req: *http.Request. The HTTP request to be modified.
	//
	// Returns:
	//   - error: An error if authentication fails (e.g. secret resolution failure).
...
//
// Summary: Factory function to create an UpstreamAuthenticator.
//
...
//
// Summary: Authenticator for API Key.
...
//
// Summary: Injects the API key into the request.
//
// Parameters:
//   - req: *http.Request. The HTTP request to be modified.
//
...
//
// Summary: Authenticator for Bearer Token.
...
//
// Summary: Injects the Bearer Token into the request.
//
// Parameters:
//   - req: *http.Request. The HTTP request to be modified.
//
...
//
// Summary: Authenticator for Basic Auth.
...
//
// Summary: Injects Basic Auth credentials into the request.
//
// Parameters:
//   - req: *http.Request. The HTTP request to be modified.
//
...
//
// Summary: Authenticator for OAuth2 Client Credentials flow.
...
//
// Summary: Fetches an OAuth2 token and injects it into the request.
//
// Parameters:
//   - req: *http.Request. The HTTP request to be modified.
//
