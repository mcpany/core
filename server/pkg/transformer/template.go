...
// Summary: TextTemplate provides a simple wrapper around Go's standard text/template for rendering strings with dynamic data. High-performance template engine using fasttemplate.
//
// Parameters:
//   - None.
//
...
// Summary: NewTemplate parses a template string and creates a new TextTemplate. Initializes a new TextTemplate.
//
// Parameters:
//   - templateString (string): The templateString parameter.
//   - startTag (string): The startTag parameter.
//   - endTag (string): The endTag parameter.
//
// Returns:
//   - *TextTemplate: The resulting *TextTemplate.
