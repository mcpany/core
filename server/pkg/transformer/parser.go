...
//
// Side Effects:
//   - Initializes the singleton on first call.// Parameters:
//   - None.
//
// Errors:
//   - None.
...
//   - error: An error if transformation fails.// Errors:
//   - None.
//
// Side Effects:
//   - None.
...
//   - Returns "unsupported input type" for unknown types.// Side Effects:
//   - None.
