...
// Summary: Middleware returns a middleware function to track session activity. Creates an MCP middleware for tracking and recording session activity metrics.
//
// Parameters:
