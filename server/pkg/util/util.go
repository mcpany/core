...
//
// Returns:
//   - (string): The service key part of the tool name.
//   - (string): The bare tool name part without the service key.
//   - (error): An error if parsing fails (currently always nil).
