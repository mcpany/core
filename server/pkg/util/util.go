...
//
// Parameters:
//   - ids ([]string): Parameter.
//   - alwaysAppendHash (bool): Parameter.
//   - maxSanitizedPrefixLength (int): Parameter.
//   - reqHashLength (int): Parameter.
//
// Returns:
//   - string: Return value.
//   - error: Return value.
...
//
// Summary: Sanitizes the given service name.
//
// Parameters:
...
//
// Summary: Sanitizes the given tool name.
//
// Parameters:
//   - name (string): Parameter.
//
...
//
// Summary: Is a string constant representing the boolean value true.
//
// Parameters:
//   - None.
//
...
//
// Summary: Creates a new random (version 4) UUID.
//
// Parameters:
//   - None.
//
...
//
// Summary: Deconstructs a fully qualified tool name into its service key
//
// Parameters:
...
//
// Summary: Cleans an input string to make it suitable for use as an
//
// Parameters:
...
//
// Summary: Converts a byte slice to a string without allocation.
//
// Parameters:
//   - b ([]byte): Parameter.
//
...
//
// Summary: Returns the command and base arguments for running Docker.
//
// Parameters:
//   - None.
//
...
//
// Summary: Replaces placeholders in a URL path with values from a params map.
//
// Parameters:
//   - urlPath (string): Parameter.
//   - params (map[string]interface{}): Parameter.
//   - noEscapeParams (map[string]bool): Parameter.
//
// Returns:
//   - string: Return value.
//
...
//
// Summary: Replaces placeholders in a URL query string with values from a params map.
//
// Parameters:
//   - urlQuery (string): Parameter.
//   - params (map[string]interface{}): Parameter.
//   - noEscapeParams (map[string]bool): Parameter.
//
// Returns:
...
//
// Summary: Checks if an interface value is nil or holds a nil pointer.
//
// Parameters:
//   - i (any): Parameter.
//
...
//
// Summary: Converts a value to a string representation efficiently.
//
// Parameters:
//   - v (any): Parameter.
//
...
//
// Summary: Cleans a filename to ensure it is safe to use.
//
// Parameters:
