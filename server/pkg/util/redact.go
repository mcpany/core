...
// Note: We use (.*?) for the password to allow spaces and other characters (like @) if url.Parse failed.
// The non-greedy match ensures we stop at the *first* valid @host sequence.
