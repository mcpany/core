...
//
// Parameters:
//   - m (map[string]interface{}): Parameter.
//
// Returns:
...
//
// Summary: Handles redaction of secrets from text.
//
// Parameters:
//   - None.
//
...
//
// Summary: Creates a new SecretRedactor with the given secrets.
//
// Parameters:
//   - secrets ([]string): Parameter.
//
// Returns:
//   - *SecretRedactor: Return value.
//
// Errors:
//   - None.
//
...
//
// Summary: Replaces all occurrences of the configured secrets in the text with [REDACTED].
//
// Parameters:
