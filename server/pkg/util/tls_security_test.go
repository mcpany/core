...
func TestNewHTTPClientWithTLS_SSRF_Protection(t *testing.T) {
	...
	t.Run("allowed via env var", func(t *testing.T) {
		os.Setenv("MCPANY_ALLOW_LOOPBACK", "true")
		defer os.Unsetenv("MCPANY_ALLOW_LOOPBACK")
