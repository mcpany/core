...
type IPResolver interface {
	...
	//   - error: An error if lookup fails.
...
type NetDialer interface {
	...
	//
	// Summary: Establishes a network connection.
	//
	// Parameters:
	//   - ctx: context.Context. The context for the request.
