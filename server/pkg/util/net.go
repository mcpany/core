...
//   - Returns error if all resolved IPs are blocked by security policy (SSRF).
//   - Returns error if connection fails.
//
// Side Effects:
//   - Performs DNS resolution.
...
//
// Errors:
//   - Returns error if connection is blocked or fails.
//
// Side Effects:
//   - Performs DNS resolution.
//   - Establishes a network connection.
...
//
// Side Effects:
//   - Reads environment variables to configure safety policies.
...
//   - Returns error if connection fails or is blocked.
//
// Side Effects:
