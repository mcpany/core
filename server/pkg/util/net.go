...
//
// Summary: Interface for IP resolution.
//
...
//
// Summary: SSRF-safe network dialer.
//
// Fields:
//   - AllowLoopback: bool. Allows connections to loopback addresses (127.0.0.1, ::1).
//   - AllowPrivate: bool. Allows connections to private network addresses (RFC 1918, RFC 4193).
//   - AllowLinkLocal: bool. Allows connections to link-local addresses (169.254.x.x, fe80::/10).
//   - Resolver: IPResolver. Used for DNS lookups.
//   - Dialer: NetDialer. Used for establishing connections.
...
//
// Summary: Checks connectivity to an address.
//
