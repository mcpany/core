...
//   - MCPANY_DANGEROUS_ALLOW_LOCAL_IPS: Set to "true" to allow both loopback and private network connections (overrides others).
//
// Returns:
...
func NewSafeHTTPClient() *http.Client {
	...
	// Allow overriding safety checks via global unsafe flag (useful for testing/dev)
