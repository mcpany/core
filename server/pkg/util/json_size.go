...
// EstimateJSONSize serves as a public interface for interacting with EstimateJSONSize.
//
// Summary: Estimate the json size appropriately based on current system conditions.
//
// Parameters:
