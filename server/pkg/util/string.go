...
func LevenshteinDistance(s1, s2 string) int {
	...
	// ⚡ Bolt Optimization: Handle mixed cases without unnecessary allocation.
	// If one string is ASCII, we don't need to convert it to []rune.
	var r1, r2 []rune
	if !s1ASCII {
		r1 = []rune(s1)
	}
