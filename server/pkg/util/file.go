...
//
// It is optimized to read from the end of the file using a seek-and-read approach,
...
//   - error: An error if the file cannot be opened, read, or if an I/O error occurs.
