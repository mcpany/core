...
//   - None.
//
// Summary: NewMockClientConn creates a new mock client connection.
//
// Parameters:
...
//   - None.
//
// Summary: Invoke is a mock implementation of the Invoke method.
//
// Parameters:
...
func (m *MockClientConn) Invoke(_ context.Context, _ string, _ interface{}, _ interface{}, _ ...grpc.CallOption) error {
	...
	// Summary: NewStream is a mock implementation of the NewStream method.
	//
	// Parameters:
