...
// StripSecretsFromService removes sensitive information from the service configuration. Summary: Removes sensitive information from service configuration. Parameters: - svc (*configv1.UpstreamServiceConfig): The upstream service configuration to strip secrets from.
//
// Summary: StripSecretsFromService removes sensitive information from the service configuration. Summary: Removes sensitive information from service configuration. Parameters: - svc (*configv1.UpstreamServiceConfig): The upstream service configuration to strip secrets from.
//
// Parameters:
//   - svc (*configv1.UpstreamServiceConfig): The svc parameter used in the operation.
//
// Returns:
//   - None.
//
...
// StripSecretsFromProfile removes sensitive information from the profile definition. Summary: Removes sensitive information from profile definition. Parameters: - profile (*configv1.ProfileDefinition): The profile definition to strip secrets from.
//
// Summary: StripSecretsFromProfile removes sensitive information from the profile definition. Summary: Removes sensitive information from profile definition. Parameters: - profile (*configv1.ProfileDefinition): The profile definition to strip secrets from.
//
// Parameters:
//   - profile (*configv1.ProfileDefinition): The profile parameter used in the operation.
//
// Returns:
//   - None.
//
...
// StripSecretsFromCollection removes sensitive information from the service collection. Summary: Removes sensitive information from service collection. Parameters: - collection (*configv1.Collection): The service collection to strip secrets from.
//
// Summary: StripSecretsFromCollection removes sensitive information from the service collection. Summary: Removes sensitive information from service collection. Parameters: - collection (*configv1.Collection): The service collection to strip secrets from.
//
// Parameters:
//   - collection (*configv1.Collection): The collection parameter used in the operation.
//
// Returns:
//   - None.
//
...
// StripSecretsFromAuth removes sensitive values from the authentication config. Summary: Removes sensitive values from authentication config. Parameters: - auth (*configv1.Authentication): The authentication configuration to strip secrets from.
//
// Summary: StripSecretsFromAuth removes sensitive values from the authentication config. Summary: Removes sensitive values from authentication config. Parameters: - auth (*configv1.Authentication): The authentication configuration to strip secrets from.
//
// Parameters:
//   - auth (*configv1.Authentication): The auth parameter used in the operation.
//
// Returns:
//   - None.
//
...
// HydrateSecretsInService populates the service configuration with resolved secret values. Summary: Populates service configuration with resolved secret values. Parameters: - svc (*configv1.UpstreamServiceConfig): The upstream service configuration to hydrate secrets into. - secrets (map[string]*configv1.SecretValue): A map of resolved secret values.
//
// Summary: HydrateSecretsInService populates the service configuration with resolved secret values. Summary: Populates service configuration with resolved secret values. Parameters: - svc (*configv1.UpstreamServiceConfig): The upstream service configuration to hydrate secrets into. - secrets (map[string]*configv1.SecretValue): A map of resolved secret values.
//
// Parameters:
//   - svc (*configv1.UpstreamServiceConfig): The svc parameter used in the operation.
//   - secrets (map[string]*configv1.SecretValue): The secrets parameter used in the operation.
//
// Returns:
//   - None.
//
