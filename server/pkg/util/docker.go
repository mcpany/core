...
var (
	...
	//
	// Summary: Exposes a hook to check Docker socket accessibility, primarily used for test mocking.
	//
	// Parameters:
	//   - none
	//
	// Returns:
	//   - func() bool: A function that returns true if Docker is accessible.
	//
	// Errors:
	//   - none
	//
