...
//
// Summary: Creates an HTTP client with TLS and SSRF protection.
//
// It supports setting a custom CA certificate, a client certificate and key,
// the server name for SNI, and skipping verification.
//
...
//
// Parameters:
//   - tlsConfig: *configv1.TLSConfig. The TLS settings to apply to the HTTP client's transport.
//
// Returns:
...
//
// Side Effects:
//   - Reads certificate files from the filesystem.
