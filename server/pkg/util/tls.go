...
// NewHTTPClientWithTLS serves as a public interface for interacting with NewHTTPClientWithTLS.
//
// Summary: Constructs and returns an initialized http client with tls ready for consumption.
//
// Parameters:
