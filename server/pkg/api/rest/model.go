...
//
// Summary: Represents the request body for config validation.
...
//
// Summary: Represents the response body for config validation.
...
//
// Summary: Represents the result of the validation logic.
