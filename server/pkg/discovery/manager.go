...
//
// Summary: Stores the current status of a discovery provider.
...
//
// Summary: Orchestrates service discovery from multiple providers.
type Manager struct {
	providers []Provider
	mu        sync.RWMutex
...
//
// Summary: Adds a provider to the discovery manager.
//
// Parameters:
//   - p: Provider. The discovery provider implementation.
//
// Side Effects:
//   - Appends to the internal providers list.
//   - Initializes status tracking for the provider.
...
//
// Summary: Executes discovery across all providers.
//
// Parameters:
//   - ctx: context.Context. The execution context.
//
// Returns:
//   - []*configv1.UpstreamServiceConfig: A list of discovered services.
//
// Side Effects:
//   - Logs discovery events.
//   - Updates provider statuses.
...
//
// Summary: Retrieves status for a specific provider by name.
//
// Parameters:
