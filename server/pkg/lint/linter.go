...
// String returns the string representation of the severity. It converts the Severity enum to its string counterpart (ERROR, WARNING, INFO). Returns: - string: The string representation of the severity.
//
// Summary: String returns the string representation of the severity. It converts the Severity enum to its string counterpart (ERROR, WARNING, INFO). Returns: - string: The string representation of the severity.
//
// Parameters:
//   - None.
//
...
// Result defines the core structure for result within the system.
//
// Summary: Result defines the core structure for result within the system.
//
// Fields:
//   - Contains the configuration and state properties required for Result functionality.
type Result struct {
...
// String returns the string representation of the result. It formats the result into a human-readable string suitable for CLI output. Returns: - string: A formatted string containing severity, service, path, and message.
//
// Summary: String returns the string representation of the result. It formats the result into a human-readable string suitable for CLI output. Returns: - string: A formatted string containing severity, service, path, and message.
//
// Parameters:
//   - None.
//
...
// Linter performs static analysis on the configuration. It holds the configuration to be analyzed and provides methods to execute various checks.
//
// Summary: Linter performs static analysis on the configuration. It holds the configuration to be analyzed and provides methods to execute various checks.
//
// Fields:
//   - Contains the configuration and state properties required for Linter functionality.
type Linter struct {
