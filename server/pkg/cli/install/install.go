...
// Package install provides the install command for the MCP Any CLI.
package install
...
// Config represents the structure of the Claude Desktop configuration file.
type Config struct {
...
func installClaude(cmd *cobra.Command, opts *Options, absConfigPath string) error {
	...
	config.MCPServers[opts.Name] = serverConfig
