...
//
// Summary: Helper for JSON-based IO execution.
...
//
// Summary: Encodes request and decodes response as JSON.
//
// Parameters:
//   - data: any. The request data to encode.
//   - result: any. A pointer to the struct where the response will be decoded.
//
// Returns:
