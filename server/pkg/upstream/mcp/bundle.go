...
// Summary: Manifest represents the structure of the manifest.json file in an MCP bundle. Represents a Manifest.
//
// Parameters:
//   - None.
//
...
// Summary: ManifestServer represents the server configuration in the manifest. Represents a ManifestServer.
//
// Parameters:
//   - None.
//
...
// Summary: ManifestMcpConfig represents the MCP configuration in the manifest. Represents a ManifestMcpConfig.
//
// Parameters:
//   - None.
//
