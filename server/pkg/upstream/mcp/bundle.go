...
//
// Summary: Data structure for the MCP bundle manifest.
...
//
// Summary: Configuration for the server within an MCP bundle manifest.
...
//
// Summary: MCP-specific runtime configuration within a bundle manifest.
