...
// Summary: DockerTransport implements the mcp.Transport interface to connect to a service running inside a Docker container. It manages the container lifecycle. Represents a DockerTransport.
//
// Parameters:
//   - None.
//
...
// Summary: Write takes a byte slice, scans it for lines, and logs each line individually using the configured slog.Logger and level.
//
// Parameters:
