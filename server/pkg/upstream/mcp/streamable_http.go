...
func buildCommandFromStdioConfig(ctx context.Context, stdio *configv1.McpStdioConnection, useSudo bool) (*exec.Cmd, error) {
	...
	logging.GetLogger().Error("🚨 SECURITY WARNING: Using setup_commands in StdioTransport. This allows Arbitrary Command Execution! Ensure you trust this configuration.", "setup_commands_count", len(setupCommands))
