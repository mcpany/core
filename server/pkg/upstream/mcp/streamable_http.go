...
//
// Parameters:
//   - f func(client *mcp.Client, stdioConfig *configv1.McpStdioConnection, httpAddress string, httpClient *http.Client): client.MCPClient. The f func(client *mcp.Client, stdioConfig *configv1.McpStdioConnection, httpAddress string, httpClient *http.Client).
...
//
// Parameters:
//   - f func(impl *mcp.Implementation): *mcp.Client. The f func(impl *mcp.Implementation) instance.
...
//
// Parameters:
//   - f func(client *mcp.Client, ctx context.Context, transport mcp.Transport, roots []mcp.Root) (ClientSession,: context.Context. The context for the operation.
...
//
// Parameters:
//   - globalSettings: *configv1.GlobalSettings. The globalSettings instance.
//
// Returns:
...
//
// Returns:
//   - *mcp.Prompt: The resulting instance.
...
//
// Returns:
//   - *mcp.GetPromptResult: The resulting instance.
//   - error: An error if the operation fails.
...
//
// Returns:
//   - *mcp.Resource: The resulting instance.
...
//
// Returns:
//   - *mcp.ReadResourceResult: The resulting instance.
//   - error: An error if the operation fails.
...
// Parameters:
//   - ctx: context.Context. The context for the operation.
//   - params: *mcp.CallToolParams. The params instance.
//
// Returns:
//   - *mcp.CallToolResult: The resulting instance.
//   - error: An error if the operation fails.
