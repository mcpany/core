...
//
// Summary: MCP transport using standard input/output for communication.
...
//
// Summary: Executes Connect operation to start the stdio command.
//
// Parameters:
...
//
// Summary: Retrieves Read operation for stdio connection.
//
// Parameters:
//   - _ (context.Context): Unused context.
//
...
//
// Summary: Updates Write operation for stdio connection.
//
// Parameters:
//   - _ (context.Context): Unused context.
...
//
// Summary: Executes Close operation for stdio connection.
//
// Returns:
