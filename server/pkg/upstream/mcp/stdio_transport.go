...
// Summary: StdioTransport implements mcp.Transport for a local command, capturing stderr to provide better error messages on failure. Represents a StdioTransport.
//
// Parameters:
//   - None.
//
