...
// HealthChecker defines an optional interface for upstream services that support
...
type HealthChecker interface {
	...
	// or unreachable.
	CheckHealth(ctx context.Context, config *configv1.UpstreamServiceConfig) error
}
