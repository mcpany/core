...
//
// Summary: Data structure containing extracted OpenAPI specification information.
...
//
// Summary: Wrapper for an individual OpenAPI path item.
...
//
// Summary: Simplified representation of an OpenAPI operation for MCP conversion.
