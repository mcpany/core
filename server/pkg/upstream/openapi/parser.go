...
// Summary: ParsedOpenAPIData holds the high-level information extracted from an OpenAPI specification, such as metadata, server details, and the defined paths. Represents a ParsedOpenAPIData.
//
// Parameters:
//   - None.
//
...
// Summary: PathItem represents a single path within an OpenAPI specification and holds a reference to its corresponding openapi3.PathItem. Represents a PathItem.
//
// Parameters:
//   - None.
//
...
// Summary: McpOperation provides a simplified, MCP-centric representation of an OpenAPI operation. It contains the essential details needed to convert an API endpoint into an executable tool. Represents a McpOperation.
//
// Parameters:
//   - None.
//
