...
//
// Summary: holds the high-level information extracted from an OpenAPI specification, such as metadata, server details, and the defined paths.
...
//
// Summary: represents a single path within an OpenAPI specification and holds a reference to its corresponding openapi3.PathItem.
...
//
// Summary: provides a simplified, MCP-centric representation of an OpenAPI operation. It contains the essential details needed to convert an API endpoint into an executable tool.
