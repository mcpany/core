...
//
// Parameters:
//   - ctx: context.Context. The context for shutdown.
//
// Returns:
...
//
// Summary: Creates a new HTTP Upstream.
//
// Parameters:
...
//
// Summary: Registers the HTTP service and its tools.
//
// Parameters:
