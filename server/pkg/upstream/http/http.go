...
//
// Summary: Upstream implementation for standard HTTP services.
...
//
// Returns:
//   - upstream.Upstream: The new HTTP upstream instance.
//
// Errors:
//   - None.
//
...
// Register processes the configuration for an HTTP service.
//
