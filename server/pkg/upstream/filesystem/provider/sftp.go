...
//
// Parameters:
// - config (*configv1.SftpFs): Configuration settings.
//
// Returns:
...
// Parameters:
// - oldname: The .
// - newname (string): The string value.
//
// Returns:
// - error: An error if the operation fails.
//
...
// Parameters:
// - name (string): The name of the resource.
// - mode (os.FileMode): The operation mode.
//
// Returns:
// - error: An error if the operation fails.
//
...
//
// Parameters:
// - offset (int64): The pagination offset.
// - whence (int): The integer value.
//
// Returns:
// - int64: The result.
// - error: An error if the operation fails.
