...
// OpenFile opens a file using the SFTP filesystem, resolving the path first.
//
...
// Returns the file.
// Returns an error if the operation fails.
func (p *SftpProvider) OpenFile(path string, flag int, perm os.FileMode) (afero.File, error) {
