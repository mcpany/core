...
import (
	...
	"github.com/aws/aws-sdk-go/aws"             //nolint:staticcheck // Known deprecation
	"github.com/aws/aws-sdk-go/aws/credentials" //nolint:staticcheck // Known deprecation
	"github.com/aws/aws-sdk-go/aws/session"     //nolint:staticcheck // Known deprecation
	s3 "github.com/fclairamb/afero-s3"
	configv1 "github.com/mcpany/core/proto/config/v1"
	"github.com/spf13/afero"
)

// S3Provider is a filesystem provider that uses Amazon S3.
...
// ResolvePath resolves a virtual path to a real path (key) in S3.
...
// Close closes the provider (no-op for S3).
