...
import (
	...
	"github.com/aws/aws-sdk-go/aws"             //nolint:staticcheck // AWS SDK v1 is deprecated but used by afero-s3
	"github.com/aws/aws-sdk-go/aws/credentials" //nolint:staticcheck // AWS SDK v1 is deprecated but used by afero-s3
	"github.com/aws/aws-sdk-go/aws/session"     //nolint:staticcheck // AWS SDK v1 is deprecated but used by afero-s3
	s3 "github.com/fclairamb/afero-s3"
	configv1 "github.com/mcpany/core/proto/config/v1"
	"github.com/spf13/afero"
)

// S3Provider provides an S3 filesystem.
