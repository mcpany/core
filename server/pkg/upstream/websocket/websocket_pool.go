...
//
// Summary: is a type alias for a pool of WebSocket client connections. It simplifies the type signature for WebSocket connection pools.
...
//
// Summary: creates a new connection pool for WebSocket clients. It configures the pool with a factory function that establishes new WebSocket connections to the specified address.
//
// Parameters:
//   - maxSize: int
