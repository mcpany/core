...
//
// Summary: Upstream implements the upstream.Upstream interface for services that are exposed via a WebSocket connection. It manages a connection pool and registers tools based on the service configuration.
//
// Fields:
