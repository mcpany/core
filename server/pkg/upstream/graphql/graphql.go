...
// NewGraphQLUpstream serves as a public interface for interacting with NewGraphQLUpstream.
//
// Summary: Constructs and returns an initialized graph ql upstream ready for consumption.
//
// Parameters:
