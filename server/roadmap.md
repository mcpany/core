...
*   **[P0] UMDP-Native Discovery Gateway**: Authoritative discovery proxy implementing the Universal Mesh Discovery Protocol for cross-node tool registration. (Added: 2026-07-25)
*   **[P0] Post-Quantum Mesh Handshake (PQMH)**: Implementation of NIST-standard quantum-resistant algorithms for all inter-mesh handshakes. (Added: 2026-07-25)
*   **[P0] Inter-Mesh Lock-Free Tasking (IM-LFT)**: Distributed hub utilizing cross-node CRDTs for sub-millisecond task synchronization. (Added: 2026-07-25)
*   **[P1] Reasoning-Path PQ-Enveloping**: Security extension for SRM Provider cryptographically wrapping reasoning fragments in PQ-resistant envelopes. (Added: 2026-07-25)
