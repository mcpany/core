...
*   **[P0] Hardware-Attested Resource Rebalancer (HARR)**: Authoritative budget arbiter utilizing hardware-attested urgency signals for dynamic re-allocation. (Added: 2026-07-25)
*   **[P0] Monotonic Tunnel Nonce (MTN) Enforcer**: Security middleware mandating hardware-bound monotonic counters for all P2P tunnel calls. (Added: 2026-07-25)
*   **[P1] Intent-Aware Shard Migration (IASM)**: Performance optimization proactively migrating context shards between distributed nodes based on real-time reasoning intent. (Added: 2026-07-25)
*   **[P0] Recursive Mission Exhaustion (RME) Monitor**: Stability monitor for detecting infinite tool-calling loops and triggering HARR re-allocation. (Added: 2026-07-25)
