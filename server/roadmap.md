...
*   **[P0] ToxicSkill Static Analysis (TSSA)**: Automated scanner for dynamic skill grafts to detect credential exfiltration and backdoors. (Added: 2026-07-25)
*   **[P0] Flag-Locked Agent Execution (FLAX)**: Kernel-level proxy to intercept and block unauthorized security-override flags in agent processes. (Added: 2026-07-25)
*   **[P0] Fast-Path Identity Resumption (FPIR)**: Hardware-attested trust ticket broker for low-latency P2P tunnel resumption in multi-node meshes. (Added: 2026-07-25)
