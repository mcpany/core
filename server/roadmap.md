...
*   **[P0] Loopback Rate-Limiting & Origin Validation**: Mandatory browser-origin validation and non-exempt rate limiting for all localhost traffic (mitigates CVE-2026-27485). (Added: 2026-03-09)
*   **[P0] Agent Chain Provenance Attestation**: Cryptographic tracing of subagent delegation to prevent lateral movement and "Excessive Agency." (Added: 2026-03-09)
*   **[P1] Decision Trace Logger**: Capture LLM reasoning preceding tool calls for OWASP ASI compliance. (Added: 2026-03-09)
