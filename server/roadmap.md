...
*   **[P0] Full-Stack Tunnel Sovereignty (FTS)**: Mandatory deep-packet semantic inspection for P2P handshakes and hardware-bound heartbeats. (Added: 2026-07-25)
*   **[P0] ACP-Immune Memory Tiers**: Pinning system for mission-root fragments to prevent eviction during model-side Active Context Pruning. (Added: 2026-07-25)
*   **[P0] Atomic Lease-Bound Purge (ALBP)**: Kernel-level secure wipe for project-local scratchpads upon HLML lease invalidation. (Added: 2026-07-25)
*   **[P0] Dynamic Quorum Damping (DQD)**: Stability middleware for scaling consensus weighting based on network jitter and reasoning entropy. (Added: 2026-07-25)
