...
*   **[P0] Active Attention Heartbeats (AAH)**: Authoritative attention auditing service injecting periodic guardrail probes into the LLM context. (Added: 2026-07-25)
*   **[P0] Hidden-Channel Interceptor (HCI)**: Advanced security middleware monitoring OS-level side-channels (inode timing, flock patterns) for agent collusion. (Added: 2026-07-25)
*   **[P0] IWS Controller**: High-speed environment recovery service facilitating sub-200ms OS-level rollbacks. (Added: 2026-07-25)
*   **[P1] Sub-Quantum Mesh Attestation (SQMA)**: Security service implementing lattice-based cryptographic handshakes for inter-node mesh integrity. (Added: 2026-07-25)
