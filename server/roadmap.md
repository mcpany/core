...
*   **[P0] JIT Permission Broker**: Protocol and middleware for dynamic capability escalation. (Added: 2026-02-27)
*   **[P1] Self-Healing Tool Bridge**: Sandboxed hot-reloading for agent-proposed tool fixes. (Added: 2026-02-27)
*   **[P1] Attention-Aware Discovery**: Relevance-based tool schema ranking. (Added: 2026-02-27)
