...
*   **[P0] Task-Bound Ephemeral Identity (TBEI) Provider**: Authoritative identity service issuing hardware-attested tokens bound to Blackboard Task UUIDs. (Added: 2026-07-25)
*   **[P0] Active Attention Enforcer (AAE)**: Advanced attention governance service enforcing hardware-locked context-window budgets to prevent "Attention Hijacking." (Added: 2026-07-25)
*   **[P0] Atomic Shard Handshake (ASH) Broker**: Performance-optimizing identity service facilitating sub-10ms mesh-wide verification using pre-cached session tickets. (Added: 2026-07-25)
*   **[P1] Bid-Inflation Interceptor**: Security extension for the ANB Hub that performs real-time analysis of UACO bids to detect and block recursive re-bidding loops. (Added: 2026-07-25)
