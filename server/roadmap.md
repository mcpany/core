...
*   **[P0] Fast-Path Mesh Resumption (FPMR)**: Performance optimization for AMT Broker utilizing session-bound "Mesh Tickets" to reduce tunneling overhead. (Added: 2026-07-25)
*   **[P0] LFMC v2 (Conflict-Free Task Resolution)**: CRDT-based extension for the Lock-Free Mesh Arbiter (LFMA) enabling asynchronous task resolution. (Added: 2026-07-25)
