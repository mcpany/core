...
*   **[P0] Speculative Intent Shield (SIS)**: Isolated ephemeral buffers for predictive tool results to prevent un-attested state corruption. (Added: 2026-07-25)
*   **[P0] Neural Context Sanitizer (NCS)**: Real-time semantic analysis of compressed context kernels during decompression to block instruction injection. (Added: 2026-07-25)
*   **[P0] Trust Ticket Rotation (TTR)**: Mandatory monotonic rotation of trust tickets for distributed meshes to neutralize CVE-2026-95001. (Added: 2026-07-25)
