...
*   **[P0] Output Sanitization Middleware**: Real-time interception and sanitization of tool outputs to block indirect prompt injections. (Added: 2026-03-01)
*   **[P1] Ephemeral Tool Sandbox Manager**: Lifecycle management for transient, container-isolated MCP servers. (Added: 2026-03-01)
*   **[P1] DHT-based Swarm Adapter**: Integration with decentralized DHT protocols (OpenClaw v2) for tool discovery in peer-to-peer swarms. (Added: 2026-03-01)
