...
*   **[P0] Non-TCP Transport (UDS/Named Pipes)**: Implement Unix Domain Sockets for local IPC to mitigate "ClawJacked" browser-based attacks. (Added: 2026-03-06)
*   **[P0] Loopback Rate-Limit Enforcer**: Ensure `127.0.0.1` is never exempted from auth or throttling. (Added: 2026-03-06)
*   **[P1] Peer-Process Attestation**: OS-level verification of connecting process identity (PID/User). (Added: 2026-03-06)
