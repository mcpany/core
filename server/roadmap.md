...
*   **[P0] Tunnel-Splitting Interceptor (TSI)**: Recursive origin validation for all tool calls within established P2P mesh tunnels. (Added: 2026-07-25)
*   **[P1] Biometric-Bound Identity (BBI)**: Hardware-attested identity tokens requiring physical biometric re-attestation (BBSA-compliant). (Added: 2026-07-25)
*   **[P1] Leased Biometric Attestation (LBA)**: Performance-optimizing service for managing time-bound biometric leases. (Added: 2026-07-25)
