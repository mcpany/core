...
*   **[P0] Hardware-Locked Configuration Anchor (HLCA)**: cryptographic binding of project settings to hardware-attested user sessions. (Added: 2026-07-25)
*   **[P0] Multi-Signature Skill Attestation (MSSA)**: mandatory 3-of-5 auditor consensus for dynamic tool grafts from public registries. (Added: 2026-07-25)
*   **[P0] Deterministic Boot Manifest Provider**: generation of signed environment integrity manifests including non-existence proofs. (Added: 2026-07-25)
