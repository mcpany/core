...
*   **[P0] Intent-Gated Delegation (IGD) Validator**: Security middleware mandating cryptographic proof that subagent tasks directly serve an authorized parent intent. (Added: 2026-04-03)
*   **[P1] Provider-Agnostic Context Normalizer (PACN)**: Lifecycle extension for ContextEngine to normalize summarization signals across disparate LLMs. (Added: 2026-04-03)
*   **[P0] Burst-Mode Trust Lease Broker**: Performance optimization for FPIR issuing short-lived leases for high-frequency reasoning bursts. (Added: 2026-04-03)
