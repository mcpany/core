...
- **Dynamic Context Reshuffling (DCR) Middleware**: (P1) Attention window optimizer re-prior-itizing context fragments based on real-time reasoning path shifts (Added: 2026-06-18).
