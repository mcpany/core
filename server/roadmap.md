...
*   **[P0] JIT Permission Broker**: Protocol-level middleware for Just-In-Time capability requests. (Added: 2026-02-27)
*   **[P1] Self-Healing Tool Staging**: Secure gateway for staging and testing agent-proposed tool code. (Added: 2026-02-27)
*   **[P1] A2A Semantic Negotiator**: Version-aware handoff protocol for multi-agent swarms. (Added: 2026-02-27)
