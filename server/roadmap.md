...
*   **[P0] Capability Shadowing Detector (CSD)**: Authoritative discovery arbiter for lineage-aware tool registration. (Added: 2026-07-25)
*   **[P0] Intent-Bound Token Manager (IBTM)**: Resource management service tying quotas to intent signatures. (Added: 2026-07-25)
*   **[P1] Federated Memory Shard (FMS) Adapter**: Coordination bridge for gossiped teammate state. (Added: 2026-07-25)
