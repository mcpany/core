...
*   **[P0] Speculative Handoff Token (SHT) Broker**: Authoritative security service for hardware-bound pre-attestation execution. (Added: 2026-07-25)
*   **[P0] Conflict-Free Task Sharding (CFTS)**: Middleware for partitioning teammate mailbox by task-dependency to eliminate locks. (Added: 2026-07-25)
*   **[P0] GC-Immune Attention Pining**: Implementation of hardware-priority flags for ALRA anchors. (Added: 2026-07-25)
*   **[P1] Ticket-Based Handshake Resumption**: Performance optimization for sub-millisecond tunnel resumption. (Added: 2026-07-25)
