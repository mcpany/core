...
*   **[P0] WebSocket Origin Guard**: Strict Origin header validation and session secrets to prevent localhost hijacking. (Added: 2026-02-27)
*   **[P0] Parallel A2A Dispatcher**: Support for "Agent Team" parallel execution and result merging in the A2A Bridge. (Added: 2026-02-27)
*   **[P1] Declarative Policy Profiles**: Standardized "Seatbelt" security profiles for simplified tool access control. (Added: 2026-02-27)
