...
*   **[P0] Recursive Lease Inheritance (RLI)**: Mandatory propagation of hardware-bound mission leases to sub-processes to neutralize "Lineage Escape." (Added: 2026-07-25)
*   **[P0] Atomic Resource Handshake (ARH)**: High-performance coordination broker for hardware-bound trust tickets and pre-attested identities across remote nodes. (Added: 2026-07-25)
*   **[P0] Attention-Locked Shard Persistence (ALSP)**: Advanced cognitive security middleware utilizing hardware-bound headers to protect critical shards from garbage collection. (Added: 2026-07-25)
*   **[P1] Cross-Framework Manifest Translator**: Interoperability service harmonizing hardware lease formats between disparate agent frameworks. (Added: 2026-07-25)
