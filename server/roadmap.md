...
*   **[P0] Zero-Knowledge Topology Broker (ZKTB)**: authoritative mesh management service utilizing hardware-attested "Virtual Hops" to hide physical node layout. (Added: 2026-07-25)
*   **[P0] Cognitive Load-Aware Routing (CLAR)**: dynamic task-placement middleware routing subagent spawns to nodes with highest available reasoning/token budgets. (Added: 2026-07-25)
*   **[P0] Hardware-Locked Node Identity (HLNI)**: mandatory advanced identity service for TPM-signed, hardware-bound mesh certificates. (Added: 2026-07-25)
