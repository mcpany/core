...
*   **[P0] Hardware-Locked Mission Lease (HLML) Provider**: Mandatory task-bound capability leases anchored to hardware TPM signatures. (Added: 2026-07-25)
*   **[P0] Identity Shard Relay (ISR)**: Multi-node identity re-composition broker for MNIS-compliant mesh transport. (Added: 2026-07-25)
*   **[P1] Partition-Resilient Task Persistence**: Stability middleware for isolated agent reasoning during network partitions. (Added: 2026-07-25)
