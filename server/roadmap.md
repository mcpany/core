...
*   **[P0] Configuration Sandboxing Middleware**: Intercept and sanitize repository-level hooks/env vars before tool execution. (Added: 2026-03-01)
*   **[P1] Identity-First A2A Gateway**: Transition to OIDC-compliant managed identities for agentic comms. (Added: 2026-03-01)
*   **[P1] Intent-Scoped Context Pruning**: Dynamic context filtering based on verified agent intent. (Added: 2026-03-01)
