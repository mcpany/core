...
*   **[P0] Task-Claim Arbiter (TCA)**: Authoritative coordination service for the Shared Task Board mandating hardware-attested identity verification. (Added: 2026-07-25)
*   **[P0] Reasoning-Aware Rate Limiter (RARL)**: Economic security middleware monitoring real-time reasoning effort and throttling quota-drain attempts. (Added: 2026-07-25)
*   **[P0] Semantic Handoff Validator**: Stability middleware ensuring mission-root anchors are preserved during specialist handoffs. (Added: 2026-07-25)
*   **[P0] Kernel-Level Pipe Isolation (KLPI)**: Hardware-enclave bound isolation for Docker-bound inter-agent communication. (Added: 2026-07-25)
