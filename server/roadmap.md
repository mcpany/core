...
*   **[P0] Atomic Session-Revocation Enforcer (ASRE)**: authoritative service for sub-millisecond transport termination upon token revocation. (Added: 2026-07-25)
*   **[P0] Scope-Lineage Attestation (SLA) Provider**: identity middleware for verifying cryptographically signed scope lineage in horizontal Agent Teams. (Added: 2026-07-25)
*   **[P0] Ghost-Hook Interdiction Proxy (GHIP)**: mandatory pre-discovery security scanner for natural-language configuration hooks. (Added: 2026-07-25)
