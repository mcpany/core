...
| 70   | **Config Encryption**                         | **Security**: Support for encrypting sensitive parts of the configuration file at rest.                                                                                                                            | High       |
| 71   | **Dynamic Default Values**                    | **Flexibility**: Allow default values in config expansion to come from other sources (e.g. files) not just literals.                                                                                               | Medium     |
