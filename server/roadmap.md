...
*   **[P0] AID (Agent Identity) Resolver**: Implement DID-based identity resolution (OpenClaw AID spec). (Added: 2026-03-09)
*   **[P0] Signed Discovery Protocol**: Enforce cryptographic signatures for MCP server discovery to prevent "Ghost Tooling" exfiltration. (Added: 2026-03-09)
*   **[P1] Ephemeral Tool Lifecycle Manager**: Support for session-bound, recursively discovered tools (Claude Code style). (Added: 2026-03-09)
