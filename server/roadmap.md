...
*   **[P0] Swarm-Mesh Attestation (SMA) Bridge**: Authoritative identity service providing hardware-attested, mesh-resident tokens that persist across environmental boundaries. (Added: 2026-07-25)
*   **[P0] Reasoning-Chain Probability (RCP) Firewall**: Real-time semantic probability analysis (ARE v1.9 compliant) to block "Context-Splicing v2" and hallucination-driven exfiltration. (Added: 2026-07-25)
*   **[P0] Anti-Mailbox-Squatting Provider**: Lifecycle security service mandating hardware-locked mailbox cleanup upon session termination to prevent permission inheritance. (Added: 2026-07-25)
*   **[P1] Mission-Root Token Isolation Vault**: Hardware-bound storage for kernel-resident, encrypted mission-root tokens to neutralize "Mission Hijacking." (Added: 2026-07-25)
