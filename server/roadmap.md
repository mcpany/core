...
*   **[P0] Mesh-Resident Consensus Hub (MRCH) Adapter**: implementation of decentralized gossip-based teammate verification. (Added: 2026-07-25)
*   **[P0] SMM v2 (Stylometric Identity Hardening)**: behavioral entropy validation to neutralize mimicry attacks. (Added: 2026-07-25)
*   **[P0] Active Shard-Boundary Enforcement (ASBE)**: hardware-attested context walls for horizontal teammates. (Added: 2026-07-25)
