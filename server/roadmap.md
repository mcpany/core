...
*   **[P0] JIT Capability Negotiation Middleware**: Support runtime permission escalation requests. (Added: 2026-03-05)
*   **[P0] Ephemeral Tool Registry**: In-memory store for task-scoped agent tools. (Added: 2026-03-05)
*   **[P1] Fair-Share MCP Scheduler**: Multi-tenant multiplexing for shared stdio/http servers. (Added: 2026-03-05)
