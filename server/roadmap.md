...
*   **[P0] Defense-in-Depth Validation Middleware**: Inspects tool inputs/outputs for SSRF, Path Traversal, and data exfiltration patterns. (Added: 2026-03-02)
*   **[P0] Hardened Cloud-to-Local Bridge**: Secure, high-performance tunneling specifically optimized for CLI agents like Claude Code. (Added: 2026-03-02)
*   **[P1] Strict Parameter Type Binding**: Enforces strict typing and resource-binding for tool parameters to prevent injection. (Added: 2026-03-02)
