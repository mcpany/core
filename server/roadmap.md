...
*   **[P0] Recursive Shard Nesting (RSN) Hub**: Authoritative broker for hierarchical context allowing for infinite nesting of mission-root intents. (Added: 2026-07-25)
*   **[P0] Anti-Shadowing Attention Guard**: Cognitive security middleware implementing "Frequency-Aware Intent Pinning" to prevent mission-root eviction. (Added: 2026-07-25)
*   **[P0] Verifiable Ephemeral Filesystem (VEF) Broker**: Tool execution service providing cryptographically attested memory-mapped views and diff-quorums. (Added: 2026-07-25)
*   **[P1] Adaptive Negotiation Arbitrator (ANA)**: Efficiency service dynamically shifting bidding processes to hardware-attested capability matching. (Added: 2026-07-25)
