...
*   **[P0] Kernel-Bound Tunnel Reaper (KBTR)**: authoritative security service utilizing eBPF hooks to forcefully close kernel-level sockets associated with terminated subagent missions. (Added: 2026-07-25)
*   **[P0] Intent-Bound Garbage Collection (IBGC)**: cognitive security service performing real-time semantic analysis to protect "Mission Anchors" during context pruning. (Added: 2026-07-25)
*   **[P0] Hardware-Attested Trust Batching (HATB)**: performance middleware brokering multi-task trust tickets to reduce TPM attestation overhead. (Added: 2026-07-25)
*   **[P0] Speculative Shard Prefetcher (SSP)**: optimization service pre-loading relevant context shards based on real-time intent analysis. (Added: 2026-07-25)
