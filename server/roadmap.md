...
*   **[P0] Tool Taint Tracking Engine**: Implement trust-based tagging for tool outputs and input validation for sink tools. (Added: 2026-03-07)
*   **[P1] Repository-Level Config Sandbox**: Sanitize and isolate local project settings (`.claude/settings.json`) to prevent RCE. (Added: 2026-03-07)
*   **[P1] Real-Time Tool-Call Interceptor**: Active inspection of tool payloads for prompt injection and data leaks. (Added: 2026-03-07)
