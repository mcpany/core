...
*   **[P0] Policy-as-Code Bridge**: Compatibility layer for Gemini-style "Seatbelt" policies. (Added: 2026-02-27)
*   **[P0] Root-of-Trust Attestation Engine**: Multi-layered cryptographic provenance verification for MCP servers. (Added: 2026-02-27)
*   **[P1] Inter-Agent State Observability (Swarm-Watch)**: Middleware for detecting and halting cascading agent failures. (Added: 2026-02-27)
