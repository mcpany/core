...
*   **[P0] Agent Cost-Control Middleware**: Real-time token budgeting and enforcement for autonomous agent sessions. (Added: 2026-03-09)
*   **[P0] A2A Mesh Discovery Protocol**: P2P capability discovery across distributed MCP Any nodes. (Added: 2026-03-09)
*   **[P1] OpenCode SDK Adapter**: Native support for the OpenCode agentic control SDK. (Added: 2026-03-09)
