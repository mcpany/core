...
*   **[P0] Mission-Root Defragmenter (MRD)**: Authoritative semantic scrubbing service to prevent intent drift in long-running missions. (Added: 2026-07-25)
*   **[P0] Hardware-Attested Resumption Guard (HARG)**: TPM-bound monotonic counter service to neutralize "TunnelCrack" and replay attacks. (Added: 2026-07-25)
*   **[P1] Epistemic Integrity Quorum Hub**: Distributed attestation for reflective reasoning traces to block recursive hallucination loops. (Added: 2026-07-25)
