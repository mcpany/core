...
*   **[P0] Attested Mesh Tunneling (AMT) Broker**: Hardware-attested, encrypted P2P tunnels for multi-node agent mesh support. (Added: 2026-07-25)
*   **[P0] Hardware-Locked Mission Leases (HLML)**: Advanced security service for issuing TPM-signed, task-specific capability leases. (Added: 2026-07-25)
*   **[P0] Autonomous State Migration (ASM) Controller**: Automatic re-sharding and migration of mission state between physical nodes for mesh resilience. (Added: 2026-07-25)
*   **[P1] Zero-Knowledge Audit (ZKA) Hub**: Proof broker for hardware-attested reasoning path auditing without context exposure. (Added: 2026-07-25)
