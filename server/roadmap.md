...
*   **[P0] Remote Control Security Proxy (RCSP)**: Authoritative gateway for secure headless session steering via hardware-attested signals. (Added: 2026-07-25)
*   **[P1] GNAP Coordination Adapter**: Decentralized coordination bridge for Git-Native Agent Protocol interoperability. (Added: 2026-07-25)
*   **[P0] Headless Handoff Continuity (HHC)**: BSH context snapshot brokering for long-haul remote-controlled missions. (Added: 2026-07-25)
