...
*   **[P0] Compliance-Bound Governance (CBG)**: Implementation of hardware-attested traceability for EU AI Act compliance. (Added: 2026-07-25)
*   **[P0] Context Engine Plugin Broker (CEPB)**: Authoritative host for framework-neutral context sidecars and smart fragment management. (Added: 2026-07-25)
