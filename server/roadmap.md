...
*   **[P0] CSRF-Protected Local Gateway**: Implement cryptographic origin verification for local endpoints to prevent browser-based RCE. (Added: 2026-02-27)
*   **[P1] Snapshot-based Context Forking**: Middleware for managing DAG-based session state and speculative branching. (Added: 2026-02-27)
*   **[P1] Behavioral Anomaly Detector**: Real-time monitoring of tool call sequences for offensive pattern detection. (Added: 2026-02-27)
