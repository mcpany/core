...
*   **[P0] Deterministic Agent Replay Engine (DARE)**: Snapshot-based replay system for tool execution sequences. (Added: 2026-03-03)
*   **[P0] USH Adapter (Unified State Handshake)**: Native implementation of the USH protocol for intent-state transfer. (Added: 2026-03-03)
*   **[P1] Context-Aware Semantic Discovery**: Vector-based semantic search for Lazy-MCP discovery. (Added: 2026-03-03)
