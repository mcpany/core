...
*   **[P0] WASM Skill Runtime**: Secure, sandboxed execution environment for "Skills as Code" from untrusted sources. (Added: 2026-03-02)
*   **[P1] Ephemeral Agent Controller**: Lifecycle management for deterministic sub-agent spawning and resource cleanup. (Added: 2026-03-02)
*   **[P1] IPC A2A Transport**: Secure inter-agent communication via Unix Domain Sockets to mitigate local port exposure. (Added: 2026-03-02)
