...
*   **[P0] Ephemeral Tool Scoping**: Implement JWS-based short-lived, task-bound tool capabilities. (Added: 2026-03-08)
*   **[P0] Distributed State Locking**: Mutex/Locking mechanism for Shared KV Store to prevent swarm desync. (Added: 2026-03-08)
*   **[P1] Streaming Tool Proxy**: Secure, sanitized streaming for tool stdout/stderr. (Added: 2026-03-08)
