...
*   **[P0] Hierarchical Mission Anchor (HMA) Manager**: authoritative lineage service utilizing hardware-locked monotonic counters to anchor deep agent chains. (Added: 2026-07-25)
*   **[P0] Cross-Node State Synchronization (CNSS) Hub**: distributed coordination service for optimistic context shard synchronization across multi-node agent meshes. (Added: 2026-07-25)
*   **[P0] Temporal Lease Delegation (TLD) Provider**: advanced security service for delegating hardware-signed leases without mission-root roundtrips. (Added: 2026-07-25)
