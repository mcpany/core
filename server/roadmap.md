...
*   **[P0] Universal Commerce Adapter (UCA)**: Authoritative bridge for UCP-compliant tools with hardware-attested transaction gating. (Added: 2026-07-25)
*   **[P0] Episodic Mesh Sharding (EMS)**: Governance middleware for Gemini-style "Chapters" using hardware-attested episodic shards. (Added: 2026-07-25)
*   **[P0] Teammate Lateral-Movement Guard (TLMG)**: Semantic inspection of inter-teammate coordination messages to prevent privilege escalation. (Added: 2026-07-25)
*   **[P0] Regulatory Attribution Engine (RAE)**: Hardware-attested audit trail service for EU AI Act compliance. (Added: 2026-07-25)
