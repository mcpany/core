...
*   **[P0] Dispatch-Aware Task Arbiter (DATA)**: CRDT-based non-blocking coordination for parallel Claude Code Channels. (Added: 2026-07-25)
*   **[P0] ACP-Native Coordination Bridge**: Representation of legacy MCP tasks as first-class OpenClaw ACP messages. (Added: 2026-07-25)
*   **[P0] Pre-Flight Environment Attestation (PEA)**: Hardware-attested browser/CLI validation before tool exposure. (Added: 2026-07-25)
*   **[P0] Fast-Path ACP Tunneling**: Tunnel Ticket broker for sub-millisecond P2P coordination in sharded meshes. (Added: 2026-07-25)
