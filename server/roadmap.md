...
*   **[P0] Sandboxed Hook Environment**: WASM-based isolation for all local configuration hooks to prevent RCE (CVE-2025-59356). (Added: 2026-03-02)
*   **[P0] Identity-Based A2A Router**: Cryptographically verified A2A message routing. (Added: 2026-03-02)
*   **[P0] Config Attestation Service**: Signed approvals for sensitive configuration changes. (Added: 2026-03-02)
