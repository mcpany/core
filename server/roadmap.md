...
*   **[P0] Real-time Threat Intel Middleware**: Connects to a verified feed of malicious MCP servers and agent skills. (Added: 2026-03-05)
*   **[P1] Ephemeral Tool Sandboxing**: Lightweight isolation (nsjail/Wasm) for high-risk tool execution. (Added: 2026-03-05)
*   **[P0] Cross-Origin Security Enforcement**: Mandatory strict CORS and security headers to prevent localhost RCE. (Added: 2026-03-05)
