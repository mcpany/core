...
*   **[P0] Zero-Trust MCP Proxy (ZTMP)**: Authoritative security gateway enforcing authentication and semantic sanitization for all external MCP servers. (Added: 2026-07-25)
*   **[P0] Active Discovery Shield (ADS)**: Cryptographic masking of tool capabilities until a mission-bound handshake is verified. (Added: 2026-07-25)
*   **[P1] Mission-Root Reinforcement Injector**: Dynamic anchor token injection to prevent "Attention Drift" in parallel teams. (Added: 2026-07-25)
