...
*   **[P0] Skill Workspace Sandbox Hardening**: Implement "Workspace Chrooting" and symlink escape protection for local agent tools. (Added: 2026-03-03)
*   **[P0] Explicit Auth-First Routing Middleware**: Mandatory authentication for all agent-to-agent and tool-to-tool handoffs. (Added: 2026-03-03)
*   **[P1] Multimodal Tool Transport (MMTT)**: Core support for binary/stream tool inputs (Audio, PDF). (Added: 2026-03-03)
*   **[P1] SecretRef Infrastructure**: Integration of the `SecretRef` mechanism for secure credential handling across the tool lifecycle. (Added: 2026-03-03)
