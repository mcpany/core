...
*   **[P0] Cross-Mesh Intent Scoper (CMIS)**: Authoritative federation gatekeeper enforcing mission-root constraints across attested AMT tunnels. (Added: 2026-07-25)
*   **[P0] ZK-Reasoning Proof (ZKRP) Broker**: Privacy-preserving attestation service for generating and verifying Zero-Knowledge reasoning proofs. (Added: 2026-07-25)
*   **[P0] Hardware-Attested Cache Invalidation (HACI)**: Security middleware cryptographically linking MLCC caches to hardware revocation lists. (Added: 2026-07-25)
*   **[P0] Multi-Domain Conflict Resolver (MDCR)**: Kernel-level arbiter for federated Blackboard states resolving collisions across disparate mesh domains. (Added: 2026-07-25)
