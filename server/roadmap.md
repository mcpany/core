...
*   **[P0] JIT Permission Broker**: Dynamic intent-based capability escalation middleware. (Added: 2026-02-27)
*   **[P1] Self-Healing Tool Bridge**: Error interception and recovery metadata provider. (Added: 2026-02-27)
*   **[P1] Attention-Aware Discovery**: Filtered tool discovery based on task context. (Added: 2026-02-27)
