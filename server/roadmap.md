...
*   **[P0] Multi-Node Consensus Hub (MNCH)**: implementation of a majority consensus broker for multi-device environments. (Added: 2026-07-25)
*   **[P0] Asynchronous Identity Persistence (AIP) Broker**: service for managing Teammate-Resume-Tokens across hardware nodes. (Added: 2026-07-25)
*   **[P1] Speculative Token Filter (STF)**: hardware-locked middleware to neutralize Speculative Decoding Leakage (SDL). (Added: 2026-07-25)
