...
*   **[P0] GNAP Protocol Adapter**: Implementation of Git-Native Agent Protocol for decentralized, repo-resident coordination. (Added: 2026-07-25)
*   **[P0] CI/CD Workflow Integrity Guard**: Stateful security middleware for validating agent action-chains in build pipelines. (Added: 2026-07-25)
*   **[P0] Infer Hub Protocol Bridge**: autoritative gateway for OpenClaw's multi-provider inference hub. (Added: 2026-07-25)
*   **[P1] Memory-Wiki Compaction Engine**: Versioned context management with pluggable compaction for long-running repo missions. (Added: 2026-07-25)
