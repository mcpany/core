...
*   **[P0] Discovery-Phase Sandbox Isolation (DPSI)**: Ephemeral, zero-trust execution environment for pre-flight discovery commands to neutralize "Settings-as-Shell" exploits. (Added: 2026-07-25)
*   **[P0] Lock-Free Mesh Coordination (LFMC)**: High-speed coordination service utilizing CRDT-based mailbox shards to eliminate synchronization bottlenecks. (Added: 2026-07-25)
*   **[P0] Hardware-Attested Skill Provenance Provider**: Advanced discovery service mandating hardware signatures and Inode lineage for all tool metadata. (Added: 2026-07-25)
*   **[P0] Zero-Trust T2T Tunneling Middleware**: Authenticated transport layer for inter-teammate coordination, cryptographically bound to the mission root. (Added: 2026-07-25)
