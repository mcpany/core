...
*   **[P0] Origin-Aware Middleware**: Mandatory origin validation using local session tokens to prevent agent hijacking. (Added: 2026-03-06)
*   **[P0] Agentic "Confused Deputy" Guard**: Middleware to verify tool request chains against user intent. (Added: 2026-03-06)
*   **[P1] Intent-Bound Handoff Protocol**: Cryptographically signed intent tokens for secure swarm coordination. (Added: 2026-03-06)
