...
*   **[P0] Origin-Bound Request Validation**: Middleware enforcing cryptographic origin checks to prevent browser-based localhost hijacking. (Added: 2026-03-05)
*   **[P1] Marketplace Reputation Middleware**: Reputation-aware filtering of tools based on community audits. (Added: 2026-03-05)
