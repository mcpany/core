...
*   **[P0] Agent Identity Management (Agent IAM)**: Verifiable cryptographic identities for individual agents to enable granular ACLs. (Added: 2026-03-06)
*   **[P1] Autonomous Security Attestation**: Real-time generation of security proofs for agent tool calls. (Added: 2026-03-06)
*   **[P1] A2A Visibility Middleware**: Specialized monitoring for Agent-to-Agent interactions to eliminate observability gaps. (Added: 2026-03-06)
