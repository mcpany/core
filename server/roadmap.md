...
*   **[P0] Hardened Sandbox Proxy Middleware**: Gateway-level scrubbing of tool inputs/outputs to prevent SSRF and path traversal. (Added: 2026-03-01)
*   **[P1] Annotation-Based Policy Matching**: Support for matching security policies based on tool metadata/annotations. (Added: 2026-03-01)
*   **[P1] Config Integrity & Impact Analyzer**: Pre-flight validation of `mcpany.yaml` changes to prevent malicious config injection. (Added: 2026-03-01)
