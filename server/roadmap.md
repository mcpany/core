...
*   **[P0] Zero-Privilege Discovery Hub (ZPDH)**: Transition discovery-phase execution to network-locked, resource-constrained bubblewrap containers. (Added: 2026-07-25)
*   **[P0] Hardware-Attested De-biometricization (HAD)**: Local PII/biometric scrubbing with hardware-signed "Sovereignty Receipts." (Added: 2026-07-25)
*   **[P0] Natural-Language Injection Shield (NLIS)**: Semantic scanning of MD/JSON context files to block imperative instruction injection. (Added: 2026-07-25)
*   **[P0] CRDT-Native State Synchronizer**: implementation of lock-free coordination for high-density horizontal Agent Teams. (Added: 2026-07-25)
