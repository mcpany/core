...
*   **[P0] Origin/Host Validation Middleware**: Prevent browser-based hijacking by enforcing strict header checks on all local listeners. (Added: 2026-03-04)
*   **[P0] Intelligent Context Compactor**: Autonomous middleware for summarizing and compacting agent tool history. (Added: 2026-03-04)
*   **[P1] Attested Skill Marketplace**: Automatic filtering and reputation-based warnings for unverified MCP tools. (Added: 2026-03-04)
