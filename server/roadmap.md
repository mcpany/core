...
*   **[P0] Predictive Shard Placement (PSP) Engine**: authoritative scheduling service for speculatively migrating context shards based on attention heatmaps. (Added: 2026-07-25)
*   **[P0] Recursive Lease Chaining (RLC) Provider**: identity service facilitating deep autonomous delegation via hardware-chained sub-leases. (Added: 2026-07-25)
*   **[P0] Semantic Attention Pinning (SAP) Middleware**: cognitive security extension for ALRA utilizing driver-level weighting to prevent anchor eviction. (Added: 2026-07-25)
*   **[P0] Migration-Time Attestation (MTA) Hub**: mandatory hardware-re-attestation of physical memory boundaries during shard migration. (Added: 2026-07-25)
