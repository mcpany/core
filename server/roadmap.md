...
*   **[P0] Zero-Trust Config Sandbox**: Implement cryptographic verification and sandboxing for repository-local `.mcpany` files. (Added: 2026-03-04)
*   **[P0] X-MCP-Agent-ID Identity Propagator**: Middleware for identity-bound tool calls and nested swarm authorization. (Added: 2026-03-04)
*   **[P1] Swarm Residency Manager**: Enhanced persistent state management for hierarchical agent swarms. (Added: 2026-03-04)
