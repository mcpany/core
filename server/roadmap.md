...
*   **[P0] Universal State Handover (USH) Bridge**: Implementation of the USH-compliant header protocol for stateful agent handoffs. (Added: 2026-03-04)
*   **[P1] Intelligent Tool-Output Sanitizer**: Local middleware for smart summarization/truncation of tool returns. (Added: 2026-03-04)
*   **[P1] Lazy-State Registry**: Integration with Shared KV Store to offload large agent state objects. (Added: 2026-03-04)
