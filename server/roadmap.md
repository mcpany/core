...
*   **[P0] Recursive Reputation Quorum (RRQ)**: authoritative reputation service deriving trust scores from hardware-attested lineage. (Added: 2026-07-25)
*   **[P0] Atomic Teammate Branching (ATB) Bridge**: high-speed coordination middleware for private speculative mailbox branches. (Added: 2026-07-25)
*   **[P0] Attention-Weighted Context Pinning (AWCP)**: cognitive security layer for dynamic attention-weight injection. (Added: 2026-07-25)
*   **[P0] Handshake Integrity Guard (HIG)**: transport-level security for AMT Broker session buffer protection. (Added: 2026-07-25)
