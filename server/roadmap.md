...
*   **[P0] Dynamic Shard Orchestrator (DSO)**: Support for hardware-attested migration of context shards between distributed SNT nodes (ABSM compliance). (Added: 2026-07-25)
*   **[P0] Recipient-Bound Mailbox Integrity (RBMI)**: Advanced security extension mandating recipient-locked coordination fragments to neutralize teammate shadowing. (Added: 2026-07-25)
*   **[P0] Mission-Bound Lease Reaper (MBLR)**: Hardware-locked reclamation of orphaned MBHLs to neutralize "Lease Squatting." (Added: 2026-07-25)
*   **[P1] Intent-Aware Jitter Controller**: Risk-aware side-channel defense scaling PPRP timing variations based on mission sensitivity. (Added: 2026-07-25)
