...
*   **[P0] Glic-Jack Defense (GJD)**: Mandatory out-of-band hardware attestation for high-privilege tool calls initiated from browser-resident agents. (Added: 2026-07-25)
*   **[P1] Autonomous Company Governance (ACG) Hub**: Organization-bound policy service for autonomous agent swarms, ensuring bylaw compliance. (Added: 2026-07-25)
