...
*   **[P0] Intent-Scoped Snapshot Controller**: Targeted environment rollbacks restricted to affected intent branches to minimize swarm disruption. (Added: 2026-05-03)
*   **[P0] Deterministic Absence Proof (DAP) Generator**: Signed "Negative Attestation" manifests as a blocking prerequisite for agent boot (CVE-2026-25725). (Added: 2026-05-03)
*   **[P1] ContextEngine Sidecar Adapter**: Pluggable middleware for hosting OpenClaw-native context strategies and modular context sovereignty. (Added: 2026-05-03)
