...
*   **[P0] Role-Based Context Distillation (RBCD) Provider**: Authoritative distillation service performing role-aware context pruning while mandating instruction shielding. (Added: 2026-07-25)
*   **[P0] Hardware-Attested Intent Forking (HAIF) Gateway**: High-performance forking service utilizing "Fork Leases" to reduce TPM attestation latency. (Added: 2026-07-25)
*   **[P0] Conflict-Free Replicated Memory (CFRM) Sync**: Shared state middleware utilizing CRDTs to enable lock-free state replication across swarms. (Added: 2026-07-25)
*   **[P0] Anti-Eviction Instruction Shield**: Security middleware ensuring core behavioral guardrails remain cryptographically pinned during distillation. (Added: 2026-07-25)
