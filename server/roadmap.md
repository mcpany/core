...
*   **[P0] MCP Metadata Sanitizer**: Security middleware to prevent tool-jacking via metadata injection. (Added: 2026-02-27)
*   **[P1] Asynchronous A2A Handoff**: Support for long-running agent tasks with callback mechanisms. (Added: 2026-02-27)
*   **[P0] Federated MCP Peering (Promoted)**: Re-prioritized to P0 for cross-org swarm security. (Added: 2026-02-27)
