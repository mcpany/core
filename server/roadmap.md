...
*   **[P0] Attention-Aware Shard Orchestrator (AASO)**: Implementation of real-time reasoning focus analysis and automated P2P shard migration. (Added: 2026-07-25)
*   **[P0] Recursive Lease Validator (RLV)**: Security middleware for cryptographically validating sub-delegation chains back to the Mission Root. (Added: 2026-07-25)
*   **[P0] Active Discovery Interdiction (ADI) Hub**: Authoritative discovery guard for blocking speculative reasoning hallucinations in the tool-bus. (Added: 2026-07-25)
*   **[P1] Multi-Node Continuity Provider (MNCP)**: Persistent state recovery service for mesh-resident missions crossing physical device boundaries. (Added: 2026-07-25)
