...
*   **[P0] Ephemeral Enclave Isolation (EEI) Manager**: Core orchestration service for physical mission-root isolation and destruction. (Added: 2026-07-25)
*   **[P0] Context-Inception Firewall (CIF)**: Middleware implementing recursive lineage-binding to neutralize phantom mission-root injections. (Added: 2026-07-25)
*   **[P1] Speculative Resumption Ticket Provider**: Background service for pre-emptive trust ticket rotation in AMT tunnels. (Added: 2026-07-25)
*   **[P0] Autonomous Lease Reaper**: Authority for hardware-locked reclamation and scrubbing of expired mission-bound capabilities. (Added: 2026-07-25)
