...
*   **[P0] Intent-Aware Routing Middleware**: Suggests tools based on high-level agent intent and historical success rates. (Added: 2026-03-03)
*   **[P0] Attested Configuration Deeplinks**: Cryptographic verification for one-click config imports to mitigate configuration hijacking (CVE-2026-23523). (Added: 2026-03-03)
*   **[P1] Economical Telemetry Layer**: Inject real-time cost and performance metrics into tool metadata for model-level reasoning. (Added: 2026-03-03)
