...
*   **[P0] Ephemeral Lifecycle Manager**: High-performance registry and proxy for short-lived, task-specific MCP servers. (Added: 2026-03-02)
*   **[P0] Metadata Sanitization Middleware**: Intercepts and cleans tool descriptions to prevent "Context Smuggling" instruction injection. (Added: 2026-03-02)
*   **[P1] Side-Effect Attestation Guard**: Enforce Zero-IO policies by requiring cryptographic attestation for side-effect-heavy tools. (Added: 2026-03-02)
