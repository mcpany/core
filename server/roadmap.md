...
*   **[P0] Origin-Locked Localhost Gateway**: Mandatory `Origin` header verification for loopback connections to prevent cross-origin agent hijacking. (Added: 2026-03-08)
*   **[P0] Sandboxed Shell Middleware**: Ephemeral OCI container execution for all shell-based tools to prevent RCE. (Added: 2026-03-08)
*   **[P1] Durable Task Lifecycle Manager**: Full implementation of MCP "Tasks" for long-running workflow state tracking. (Added: 2026-03-08)
