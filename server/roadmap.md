...
*   **[P0] Mission-Bound Hardware Lease (MBHL) Provider**: TPM-signed, task-specific capability leases for secure privilege escalation. (Added: 2026-07-25)
*   **[P0] Sovereign P2P Tunnel Broker**: Hardware-attested, agent-aware encrypted tunnels for distributed multi-node meshes. (Added: 2026-07-25)
*   **[P1] Fast-Path Mesh Handshake Provider**: Session-bound trust tickets for sub-millisecond tunnel resumption across nodes. (Added: 2026-07-25)
