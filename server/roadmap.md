...
*   **[P0] Recursive Swarm Heartbeat (RSH) Hub**: Authoritative coherence service for hardware-attested subagent health monitoring. (Added: 2026-07-25)
*   **[P0] Contextual Lease Handoff (CLH) Provider**: High-speed trust service for peer-to-peer lease migration within mission scope. (Added: 2026-07-25)
*   **[P0] Attention-Locked Context Pinning**: Implementation of the `x-gemini-attention-lock` standard for hardware-bound anchor protection. (Added: 2026-07-25)
*   **[P0] State-Fragment Collision Resolver**: Consensus middleware for resolving conflicting teammate mutations before mailbox sync. (Added: 2026-07-25)
