...
*   **[P0] Kernel-Level Intent Enforcement (KLIE)**: eBPF-based syscall interdiction to bind agent actions to hardware-attested manifests. (Added: 2026-07-25)
*   **[P0] Epistemic Shard Pinning (ESP) Hub**: Hardware-attested metadata service for protecting high-certainty reasoning fragments. (Added: 2026-07-25)
*   **[P0] Cross-Framework Reward Attestation (CFRA)**: Framework-neutral RL coordination broker for cross-swarm reward tokens. (Added: 2026-07-25)
