...
*   **[P0] Universal Tool Argument Sanitizer**: Middleware to recursively sanitize tool arguments for command injection and directory traversal. (Added: 2026-03-04)
*   **[P1] Tool Behavioral Monitoring**: Detect and block anomalous tool execution patterns (network/file access). (Added: 2026-03-04)
*   **[P0] Subagent Sandbox Isolation**: Disposable per-call sandboxing for subagent tool execution. (Added: 2026-03-04)
