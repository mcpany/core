...
*   **[P0] Secure Command Execution Gateway (SEG)**: Intercept and sanitize shell-like tool calls to mitigate RCE vulnerabilities. (Added: 2026-02-26)
*   **[P1] Swarm Accountability Ledger**: Structured audit log linking tool calls to specific agent provenance and intents. (Added: 2026-02-26)
