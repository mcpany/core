...
*   **[P0] HITL Verification Protocol**: Standardize JSON-RPC extensions for human-in-the-loop approval requests. (Added: 2026-02-27)
*   **[P1] Isolated Worktree Provisioner**: Automate ephemeral Git worktrees for agentic task isolation. (Added: 2026-02-27)
*   **[P1] Admin MCP Allowlisting**: Centralized governance for approved MCP server configurations. (Added: 2026-02-27)
