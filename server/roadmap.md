...
OpenClaw's pluggable context management. (Added: 2026-03-13 - Promoted to P0 on
2026-03-14)
...
transport layer for agent state transfer. (Added: 2026-03-23 - Promoted to P0 on
2026-03-24)
...
environment variables when a configured variable is missing, helping users catch
...
"Boundary Expansion" requests, preventing Intent Smuggling. (Added: 2026-04-16)
...
compatible ContextEngine plugins, supporting sovereignty-aware state management.
(Added: 2026-04-24)
...
textual reasoning traces (SVG, CSS, Audio) to prevent context smuggling. (Added:
2026-05-20)
...
full OpenClaw v2026.3.7 plugin hooks for third-party context strategies. (Added:
2026-05-17)
...
existent files to neutralize "Shadow-Sandbox" escapes (CVE-2026-25725). (Added:
2026-05-10)
...
middleware for non-bypassable enforcement of project-local "Deny" rules. (Added:
2026-05-08)
...
dynamically throttle subagent capabilities based on reasoning intensity. (Added:
2026-05-21)
...
task-bound mailbox shards and eliminate coordination locks. (Added: 2026-05-25)
...
the Speculative Execution Guard to neutralize "Speculative Fragment Poisoning."
...
service for the LFTA Trust Lease Manager to support persistent hardware-attested
