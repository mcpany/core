...
*   **[P0] Attested Repository Config Guard**: Secure sandbox and MFA-attestation for project-local configurations (Claude Code RCE Mitigation). (Added: 2026-03-05)
*   **[P1] Economic Intelligence Middleware**: Real-time cost metadata injection and routing advisor for LLMs. (Added: 2026-03-05)
*   **[P1] MFA-Attested Tool Execution**: Mandatory physical attestation policy for high-risk tool calls. (Added: 2026-03-05)
