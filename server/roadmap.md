...
*   **[P0] Teammate-to-Teammate (T2T) Auth Bridge**: Authoritative middleware for encrypted, session-bound messaging between horizontal teammates. (Added: 2026-07-12)
*   **[P0] Marketplace Skill Profiler Sandbox**: Air-gapped behavioral profiling environment (gVisor) for third-party agent skills. (Added: 2026-07-12)
*   **[P0] Pre-Flight Instruction Sanitizer**: Structural metadata scanner for tool definitions to neutralize prompt-to-command injections. (Added: 2026-07-12)
