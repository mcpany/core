...
*   **[P0] Anti-Hijack WebSocket Middleware**: Mandatory `Origin` validation and zero loopback exemptions for rate limiting. (Added: 2026-03-10)
*   **[P0] Cryptographic Device Handshake**: Physical-presence/Local-Secret pairing for all new agents/nodes. (Added: 2026-03-10)
*   **[P1] WebSocket Security Attestation API**: Status check for transport security during high-risk tool execution. (Added: 2026-03-10)
