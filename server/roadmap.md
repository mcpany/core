...
*   **[P0] Epistemic Uncertainty Broker (EUB)**: Authority for model uncertainty signals (EUM) and automated supervisor escalation. (Added: 2026-07-25)
*   **[P0] Attested Reflection Middleware (ARM)**: Kernel-level arbiter for teammate self-correction requiring hardware-attested reasoning proofs. (Added: 2026-07-25)
*   **[P1] Mesh-Aware GC Manager**: Distributed coordination service for synchronizing context pruning across multi-node meshes. (Added: 2026-07-25)
