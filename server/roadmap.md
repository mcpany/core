...
*   **[P0] Hardware-Attested Lease Aggregator (HALA)**: Bundler service for aggregating high-frequency subagent leases to neutralize "Attestation Storms." (Added: 2026-07-25)
*   **[P0] Mesh-Local Offload (MLO) Integrity**: Security middleware for hardware-attested sub-reasoning offloads between edge nodes. (Added: 2026-07-25)
*   **[P1] Zero-Knowledge Shard Verification (ZKSV)**: Hub for parallel, privacy-preserving attestation of individual context fragments. (Added: 2026-07-25)
*   **[P1] Mission-Root Jitter Normalizer**: Hardware-attested timing normalization for P2P coordination signals to ensure consistent wait-graph analysis. (Added: 2026-07-25)
