...
*   **[P0] Universal "Tool Search" Middleware**: Implements `defer_loading` pattern for infinite tool scaling. (Added: 2026-03-09)
*   **[P0] Threadbound Session Isolation**: Cryptographic binding of context and tools to specific user threads. (Added: 2026-03-09)
*   **[P1] MCP Any Agent CA (ACA)**: Built-in Certificate Authority for agent identity management. (Added: 2026-03-09)
