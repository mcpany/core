...
*   **[P0] Action-Chain Sovereignty Monitor (ACSM)**: Real-time monitoring and validation of complete agent workflow sequences. (Added: 2026-07-25)
*   **[P0] Metadata Sanitization Gateway (MSG)**: Semantic scrubbing of imperative instructions from external tool descriptions. (Added: 2026-07-25)
*   **[P1] Post-Quantum Mesh Handshake (PQMH)**: NIST-standard quantum-resistant algorithms for mesh transport. (Added: 2026-07-25)
