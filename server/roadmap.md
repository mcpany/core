...
*   **[P0] Sandboxed MCP Runtime**: Implement Docker-based isolation for MCP servers and hooks. (Added: 2026-02-27)
*   **[P0] Config Trust Service**: Admin allowlisting and signing for "system-level" tool configurations. (Added: 2026-02-27)
*   **[P1] MCP Session Extension**: Native implementation of `sessions_*` tools for cross-agent coordination. (Added: 2026-02-27)
