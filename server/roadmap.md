...
*   **[P0] Hardened Local Agent Sandbox**: Ephemeral containerized execution for untrusted tools. (Added: 2026-03-03)
*   **[P0] Command-Level Cryptographic Attestation**: Mandatory digital signatures for high-risk operations. (Added: 2026-03-03)
*   **[P1] WebSocket Origin Enforcement**: Mitigation for browser-to-local hijacking vulnerabilities. (Added: 2026-03-03)
*   **[P1] A2A End-to-End Encryption**: Encrypted inter-agent messaging via the MCP Any bus. (Added: 2026-03-03)
