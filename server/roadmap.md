...
*   **[P0] JIT Permission Broker**: Ephemeral capability elevation middleware with Rego auto-approval. (Added: 2026-02-27)
*   **[P0] Discovery Schema Sanitizer**: Intent-scrubbing middleware for MCP tool metadata to prevent prompt injection. (Added: 2026-02-27)
*   **[P1] Self-Healing Tool Sandbox**: Virtualized execution environment for real-time tool patching and testing. (Added: 2026-02-27)
