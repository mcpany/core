...
*   **[P0] Semantic Egress Filtering (SEF) Engine**: Real-time semantic scanner for agent outputs to prevent PII/IP leakage during summarization. (Added: 2026-07-25)
*   **[P0] Supply-Chain Attestation Broker (SCAB)**: Hardware-attested validation for all agent framework components and MCP extensions. (Added: 2026-07-25)
*   **[P0] Knowledge Manifest Manager**: Governance service for enforcing TPM-signed retrieval boundaries and mission-bound scoping. (Added: 2026-07-25)
