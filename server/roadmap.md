...
*   **[P0] Privacy-Preserving Audit (PPA) Hub**: Zero-Knowledge proof broker for hardware-attested reasoning path auditing. (Added: 2026-07-24 - Promoted to P0 on 2026-07-25)
...
*   **[P0] Autonomous Audit Sovereignty (AAS) Hub**: Authoritative security service for real-time verification of auditor reasoning traces. (Added: 2026-07-25)
*   **[P0] OpenShell-Native Sandbox Adapter**: Kernel-level security middleware for OS-enforced agent isolation via NVIDIA OpenShell. (Added: 2026-07-25)
*   **[P1] Audit-Aware Monotonic Anchoring**: Identity extension binding audit signals to hardware enclave IDs and monotonic counters. (Added: 2026-07-25)
*   **[P0] Zero-Trust Audit Discovery Proxy**: Discovery extension mandating cryptographic masking of audit capabilities until handshake. (Added: 2026-07-25)
