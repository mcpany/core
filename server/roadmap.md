...
| **P0** | **Policy Firewall** | **Security:** Cri... | High | |

| **P0** | **HITL Middleware** | **Safety:** Preve... | High | |

| **P1** | **Recursive Context** | **Usability:** So... | Medium | |

| **P1** | **Shared KV Store** | **Reliability:** ... | Medium | |

| 1 | **Team Configuration Sync** | **Collaboration**... | Medium | |

| 2 | **Smart Error Recovery** | **Resilience**: U... | High | |

| 3 | **Service Health History** | **Observability**... | Medium | |

| 4 | **Tool Execution Timeline** | **Debugging**: A ... | High | |

| 3 | **Canary Tool Deployment** | **Ops**: graduall... | High | |

| 4 | **Compliance Reporting** | **Enterprise**: A... | Medium | |

| 5 | **Advanced Tiered Caching** | **Performance**: ... | Medium | |

| 14 | **Partial Reloads** | **Resilience**: W... | High | |

| 15 | **Filesystem Health Check** | **Observability**... | Low | |

| 16 | **Safe Symlink Traversal** | **Security**: Add... | Medium | |

| 17 | **Multi-Model Advisor** | **Intelligence**:... | High | |

| 18 | **MCP Server Aggregator/Proxy** | **Architecture**:... | High | |

| 20 | **Configuration Migration Tool** | **DevX**: A CLI c... | Low | |

| 22 | **Dynamic Tool Pruning** | **Performance/Cos... | High | |

| 23 | **Config Schema Migration** | **Maintenance**: ... | Medium | |

| 26 | **Linter Git Hook** | **DevX**: Provide... | Low | |

| 27 | **Secret Rotation Helper** | **Ops**: A CLI to... | Medium | |

| 28 | **Structured Logging for Config Errors** | **DevX**: Output ... | Low | |

| 33 | **Interactive Config Validator** | **DevX**: A CLI m... | Medium | |

| 34 | **Secret Validation Pre-flight** | **Security**: Val... | Low | |

| 29 | **Automatic Config Fixer** | **DevX**: An inte... | Medium | |

| 30 | **Windows Filesystem Locking Fix** | **Compatibility**... | Medium | |

| 32 | **Interactive Config Generator** | **DevX**: `mcpany... | Low | |

| 34 | **Configuration Diffing API** | **Observability**... | Medium | |

| 35 | **Automatic WebSocket Reconnection Strategy** | **Resilience**: A... | Medium | |

| 36 | **WebSocket Message Inspector** | **Debugging**: A ... | Medium | |

| 37 | **Config Diffing UI** | **UX**: A visual ... | Medium | |

| 39 | **Config Snapshot/Restore** | **Ops**: Ability ... | Medium | |

| 40 | **Config Inheritance** | **DevX**: Allow `... | High | |

| 43 | **Doctor Auto-Fix** | **DevX**: Allow `... | High | |

| 44 | **Doctor Web Report** | **DevX**: Generat... | Low | |

| 45 | **Upstream Latency Metrics** | **Observability**... | Low | |

| 47 | **Interactive Doctor** | **UX**: A TUI (Te... | Medium | |

| 48 | **Doctor Integration with Telemetry** | **Observability**... | Low | |

| 41 | **Hard Failure Mode** | **Resilience**: A... | Low | |

| 41 | **Tool Name Fuzzy Matching** | **UX**: Improve e... | Low | |

| 42 | **Config Strict Mode** | **Ops**: Add a CL... | Low | |

| 43 | **Context-Aware Suggestions** | **UX**: Refine th... | Medium | |

| 43 | **Config Schema Visualization** | **UX**: A UI view... | Low | |

| 44 | **Validator Plugin System** | **Extensibility**... | High | |

| 44 | **Config Version History** | **Ops**: Keep a h... | High | |

| 43 | **Stdio Error Channel** | **DevX**: A dedic... | Medium | |

| 44 | **Log Redaction Rules** | **Security**: Con... | Medium | |

| 45 | **Remote Schema Validation** | **Feature**: Allo... | Medium | |

| 46 | **Schema Validation Caching** | **Performance**: ... | Low | |

| 46 | **Health Webhooks** | **Ops**: Configur... | Medium | |

| 47 | **Config Validation Dry Run** | **DevX**: Allow u... | Medium | |

| 47 | **Metrics Persistence** | **Observability**... | High | |

| 50 | **Duplicate Tool Detection** | **Safety**: Detec... | Low | |

| 51 | **Tool Execution Simulation** | **DevX**: A UI fe... | Medium | |

| 62 | **Config Validation Diff** | **Experience**: W... | High | |

| 64 | **Service Retry Policy** | **Resilience**: A... | Medium | |

| 65 | **Config Reload Status API** | **DevX**: Expose ... | Low | |

| 66 | **Dynamic Profile Switching** | **UX**: Allow use... | Medium | |

| 67 | **Config Schema Versioning** | **Maintenance**: ... | High | |

| 68 | **Connection Draining** | **Availability**:... | Medium | |

| 69 | **Secure Defaults Enforcer** | **Security**: Aut... | Medium | |

| 70 | **Interactive Doctor Fixer** | **DevX**: Extend ... | High | |

| 71 | **Config Validation Webhook** | **Ops**: A pre-co... | Medium | |

| 70 | **Tool Activity Feed** | **UX**: A dedicat... | Medium | |

| 70 | **User Preference Storage** | **UX/Backend**: A... | Low | |

| 71 | **Top Tools API Extensions** | **Observability**... | Medium | |

| 72 | **Config Hot-Reload Validation** | **Resilience**: V... | High | |

| 76 | **Config Auto-Format API** | **DevX**: API end... | Low | |

| 77 | **Service Dependency Alerts** | **Ops**: Alert if... | Medium | |

| 78 | **Tool Execution Timeout Configuration** | **Resilience**: A... | Medium | |

| 79 | **Secret Versioning Support** | **Security**: All... | Medium | |

| 73 | **Docker Secret Native Support** | **Ops**: Native s... | Medium | |

| 75 | **Health Check Flap Damping** | **Resilience**: C... | Medium | |

| 74 | **Environment Variable Wizard** | **DevX**: A UI he... | Low | |

| 75 | **Global Redaction Policy** | **Security**: Cen... | Medium | |

| 74 | **Tool Search & Filter API** | **UX/DevX**: A de... | Low | |

| 75 | **Tool Execution Trace ID** | **Observability**... | Medium | |

| 76 | **Auto-Discovery Status API** | **Observability**... | Low | |

| 77 | **Configurable Discovery Providers** | **Configuration**... | Medium | |

| 76 | **Config Schema Validation with Line Numbers** | **DevX**: Extend ... | Medium | |
| 77 | **YAML AST Caching** | **Performance**: ... | Low | |

| 78 | **Strict Config Validation on Reload** | **Resilience**: E... | High | |

| 79 | **Conflict-Free Port Allocation** | **DevX**: Add a `... | Low | |

| 80 | **Secret Format Validation for Known Services** | **Security**: Heu... | Low | |

| 81 | **Interactive Env Var Fixer** | **DevX**: A CLI t... | Medium | |

| 78 | **Upstream Connectivity Debugger** | **DevX**: CLI too... | Medium | |

| 79 | **Configuration Template Generator** | **DevX**: CLI com... | Low | |
...
#### Upcoming (2026-05-30 Architecture Evolution)


* **[P0] Intent Hierarchy Enforcer (IHE)**: Priority-based Blackboard

  validation.
  (Added: 2026-05-30)

* **[P0] Kernel-Namespace (KNS) Command Runner**: Micro-VM isolation (IEC) for

  tool execution. (Added: 2026-05-30)

* **[P0] Mission Anchor Host (MAH)**: Orchestration for pinned context anchors.

  (Added: 2026-05-30)

* **[P1] Zero-Knowledge Capability Masker**: Metadata-less capability proving.
