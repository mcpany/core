...
*   **[P0] Action Cascade Guardrail**: High-fidelity simulation of state-changing tool calls to detect harmful shortcuts before host commitment. (Added: 2026-03-01)
*   **[P0] Intent-Bound Sub-agent Scoping**: Delegation protocol for parent agents to spawn sub-agents with limited, intent-bound tokens. (Added: 2026-03-01)
*   **[P1] Adaptive Context Compaction**: Automatic semantic summarization of tool history for large (1M+) context windows. (Added: 2026-03-01)
