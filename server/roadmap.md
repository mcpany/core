...
*   **[P0] Reasoning-Responsive Memory Broker (RRMB)**: Authoritative context arbiter for multi-node swarms utilizing semantic importance scoring. (Added: 2026-07-25)
*   **[P0] Multi-Node Workspace Orchestrator**: Virtualized cross-node file system coordination for MNWO support. (Added: 2026-07-25)
*   **[P0] Attention-Locked Memory Segmentation (ALMS)**: Cognitive security middleware masking non-relevant context fragments. (Added: 2026-07-25)
*   **[P0] Shadow-Handshake Interceptor (SHI)**: Transport-level monitoring for AMT tunnels to neutralize mesh-shadowing. (Added: 2026-07-25)
