...
*   **[P0] Atomic Swarm Transaction (AST) Manager**: Authoritative coordination service implementing 2-phase commit protocols for memory enclave transitions. (Added: 2026-07-25)
*   **[P0] Instruction-Origin Watermarking (IOW) Provider**: Advanced security service cryptographically watermarking Blackboard writes with full subagent lineage and environment IDs. (Added: 2026-07-25)
*   **[P0] Recursive Logic-Bomb Scanner (RLBS)**: Forensic service performing isolated behavioral burn-in for imported specialist libraries. (Added: 2026-07-25)
*   **[P0] Temporal Remote Sovereignty (TRS) Provider**: Identity middleware brokering hardware-bound "Presence Heartbeats" for remote sessions. (Added: 2026-07-25)
