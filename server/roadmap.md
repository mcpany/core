...
*   **[P0] Annotation-Based Policy Routing**: Policy engine that enforces controls based on tool-level metadata. (Added: 2026-03-02)
*   **[P1] Headless CI/CD Attestation**: Support for non-interactive attestation (OIDC, TPM) for CI/CD environments. (Added: 2026-03-02)
*   **[P1] Intent-Bound "Auto-Accept" Middleware**: authorize high-level intents to auto-approve sub-tasks. (Added: 2026-03-02)
