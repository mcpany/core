...
*   **[P0] Off-Model Policy Gate (OMPG)**: Go-native enforcement of negative security constraints to neutralize model-based bypasses. (Added: 2026-04-11)
*   **[P1] ClawHub Attestation Support**: Authoritative provenance verification for skills sourced from the OpenClaw marketplace. (Added: 2026-04-11)
