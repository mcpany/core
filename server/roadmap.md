...
*   **[P0] Sovereign Shard Migration (SSM) Hub**: Authoritative coordination service for hardware-attested migration of entangled shards. (Added: 2026-07-25)
*   **[P0] Teammate Reflection Quorum (TRQ) Broker**: Distributed verification service for hardware-attested inter-teammate monologue cross-verification. (Added: 2026-07-25)
*   **[P0] Salience-Salted Attention Masking (SSAM)**: Cognitive security middleware adding mission-bound salt to shard-level attention masks. (Added: 2026-07-25)
*   **[P1] Economic Value-of-Thought (EVoT) Attestation**: Resource management service reconciling reasoning effort with real-time token costs. (Added: 2026-07-25)
