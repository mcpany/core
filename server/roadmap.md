...
*   **[P0] Recursive Trust Provider (RTP)**: Authoritative trust relay utilizing Recursive Trust Tickets for multi-hop hardware attestation. (Added: 2026-07-25)
*   **[P0] Task-Bound Inode Locking (TBIL)**: Kernel-level cryptographic binding between filesystem Inodes and mission-root tasks to prevent symlink racing. (Added: 2026-07-25)
*   **[P0] Kernel-Resident Lease Reaper**: Real-time monitor for subagent liveness to automatically revoke orphaned hardware leases. (Added: 2026-07-25)
*   **[P1] Attestation Load Balancer (ALB)**: Mesh-wide arbiter for dynamically prioritizing hardware attestation signals to mitigate "Attestation Storms." (Added: 2026-07-25)
