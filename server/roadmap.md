...
*   **[P0] Origin-Locked RPC Gateway**: Mandate `Origin` and `Referer` header validation for all HTTP listeners. (Added: 2026-03-07)
*   **[P0] Event-Driven Blackboard (BaaS)**: Transition the KV store to a pub-sub model for real-time agent coordination. (Added: 2026-03-07)
*   **[P1] ACP Delegation Proxy**: Direct support for the Agent Control Protocol to standardize subagent tasking. (Added: 2026-03-07)
