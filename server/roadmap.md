...
*   **[P0] Hardware-Locked Mesh Handshake (HLMH)**: mandatory TPM-attested device metadata signatures for all inter-node handshakes (CVE-2026-44001 defense). (Added: 2026-07-25)
*   **[P0] Speculative Collision Arbiter (SCA)**: high-speed coordination service for interdicting redundant task claims in optimistic meshes. (Added: 2026-07-25)
*   **[P1] ZK-Proof Alignment Bridge**: implementation of Gemini-compliant `x-gemini-pprp` header validation for multi-framework audit quorums. (Added: 2026-07-25)
