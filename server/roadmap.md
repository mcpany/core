...
*   **[P0] Vulnerability Intelligence Middleware**: Dynamic virtual patching based on AI-discovered zero-days. (Added: 2026-02-27)
*   **[P1] Opaque Shared State (invocation_state)**: Support for hidden metadata passing in Recursive Context Protocol. (Added: 2026-02-27)
*   **[P1] Managed Task Lifecycle Engine**: State tracking for long-running autonomous workflows. (Added: 2026-02-27)
