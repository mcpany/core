...
1.  **to have overlapping responsibilities (e.g., multiple "detail" views). A UI
1.  **component audit is recommended.
2.  **Test Coverage gaps**: While core logic is tested, cloud providers (S3/GCS)
2.  **and some new UI features lack comprehensive integration tests.
