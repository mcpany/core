...
*   **[P0] Deterministic Configuration Anchor**: Core service to verify integrity and absence of unauthorized config files (CVE-2026-25725 defense). (Added: 2026-03-25)
