...
*   **[P0] Isolated Named-Pipe Transport**: Secure inter-agent comms via Docker-bound pipes/Unix sockets (Replaces local HTTP). (Added: 2026-03-08)
*   **[P0] Swarm Accountability Audit Log**: Cryptographically signed hierarchical audit trail for swarm actions. (Added: 2026-03-08)
*   **[P1] Deterministic Spawning Guard**: Permission-aware sub-agent spawning middleware. (Added: 2026-03-08)
