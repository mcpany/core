...
*   **[P0] Multi-Registry Discovery Broker (MRDB)**: Authoritative coordination service for heterogeneous tool registries. (Added: 2026-07-25)
*   **[P0] Subagent Tool Filtering Middleware (STFM)**: Real-time, semantic filtering of agent capability cards based on mission role. (Added: 2026-07-25)
*   **[P0] Isolated Discovery Sandbox**: Ephemeral execution environment for pre-flight capability mapping to neutralize shadow mapping. (Added: 2026-07-25)
