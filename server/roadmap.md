...
*   **[P0] Chapter-Bound Mission Broker**: Implementation of cryptographic binding between tool capabilities and mission interaction groups (Chapters). (Added: 2026-07-25)
*   **[P0] Autonomous NHI Identity Rotation (ANIR)**: Hardware-locked, task-triggered rotation for non-human identity credentials to neutralize identity squatting. (Added: 2026-07-25)
*   **[P1] Cross-Session Chapter Resumption**: Persistence layer ensuring chapter-specific mission state and intent-anchors survive system reboots. (Added: 2026-07-25)
