...
*   **[P0] Mesh-Resident Handshake Attestation (MRHA)**: Mandatory hardware-attested handshakes for inter-node tool calls to neutralize CVE-2026-32211. (Added: 2026-07-25)
*   **[P0] Mission-Bound Hardware Lease (MBHL) Provider**: JIT privilege model issuing TPM-signed capability leases linked to task IDs. (Added: 2026-07-25)
*   **[P1] Zero-Knowledge Auditability (ZKA) Hub**: Recursive SNARK-based reasoning proofs for third-party integrity auditing. (Added: 2026-07-25)
*   **[P1] QUIC-SNT Transport Adapter**: Latency-optimized P2P tunnels for distributed Agent meshes. (Added: 2026-07-25)
