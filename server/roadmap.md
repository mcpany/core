...
*   **[P0] Self-Correction Loop Arbiter**: Authoritative lifecycle service performing real-time analysis of refinement traces to block intent-washing. (Added: 2026-07-25)
*   **[P0] Atomic Scratchpad Arbiter**: Kernel-level lock manager for project-local workspaces providing mission-bound atomic write-access. (Added: 2026-07-25)
*   **[P1] Optimistic Attestation Middleware**: Speculative security service allowing parallel context preparation and background discovery attestation. (Added: 2026-07-25)
