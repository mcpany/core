...
*   **[P0] Cryptographic Skill Attestation**: Enforce signature verification for all third-party MCP skills. (Added: 2026-03-01)
*   **[P0] Runtime Behavioral Analysis (Immune System)**: Behavioral monitoring of tool call chains to detect anomalous patterns. (Added: 2026-03-01)
*   **[P1] Automated Security Policy Generation**: LLM-assisted generation of Rego/CEL policies based on safe behavior. (Added: 2026-03-01)
