...
*   **[P0] Origin Verification Middleware**: Enforce same-origin and handshake tokens for WebSockets/HTTP to prevent cross-site hijacking. (Added: 2026-03-05)
*   **[P0] Context Threshold Auto-Pruning**: Dynamic "Lazy-Discovery" trigger based on 10% context window saturation. (Added: 2026-03-05)
*   **[P1] Agentic Identity Governance**:persona-based auditing and policy enforcement for tool-calling subagents. (Added: 2026-03-05)
