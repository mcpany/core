...
*   **[P0] Cross-Framework Attestation Broker (CFAB)**: authoritative translation service for hardware-attested intents. (Added: 2026-07-25)
*   **[P0] Hardware-Attestation Load Balancer (HALB)**: dynamic batching and prioritization of signing requests across multiple enclaves. (Added: 2026-07-25)
*   **[P0] ZKCV Provider**: implementation of Gemini-compliant ZK-proofs for skill verification. (Added: 2026-07-25)
*   **[P1] Long-Haul Intent Reinforcement (LHIR)**: periodic re-injection of attested intent anchors into long-running swarms. (Added: 2026-07-25)
