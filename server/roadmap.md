...
*   **[P0] Ephemeral Context Vault**: Session-bound secure storage for sensitive context. (Added: 2026-02-27)
*   **[P0] Sandboxed Tool Runtime**: Docker-bound isolation for high-risk tool calls (shell/fs). (Added: 2026-02-27)
*   **[P1] Agent Behavior Analytics**: Sequence-aware malicious activity detection. (Added: 2026-02-27)
