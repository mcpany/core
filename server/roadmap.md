...
*   **[P0] Optimistic Attestation Middleware (OAM)**: Implementation of speculative tool execution with background hardware attestation. (Added: 2026-07-25)
*   **[P0] CRDT-Native Coordination Sharding**: Transition mailbox infra to lock-free shards for NBTA compliance. (Added: 2026-07-25)
*   **[P0] Hierarchical Provenance Chain (HPC) Validator**: Cryptographic hash-chaining for multi-hop agent delegations. (Added: 2026-07-25)
*   **[P0] Lease-Budget Auto-Reclaimer**: Autonomous reclamation of hardware-attested leases from dormant missions. (Added: 2026-07-25)
