...
*   **[P0] Universal Skill Orchestrator (`SKILL.md` Adapter)**: Parses and exposes project-local skill playbooks as MCP tools. (Added: 2026-03-10)
*   **[P0] Threadbound Session Middleware**: Implements strict session/thread isolation for multi-user agent environments. (Added: 2026-03-10)
*   **[P1] WebSocket-First Transport Wrapper**: Reliable, high-performance transport with integrated health monitoring. (Added: 2026-03-10)
