...
*   **[P0] Schema Harmonization Middleware**: Automatically transform and sanitize MCP tool definitions for specific LLM requirements (e.g., Gemini-specific constraints). (Added: 2026-03-01)
*   **[P0] A2A Message Residency (Persistent Queue)**: Persistent mailbox for A2A messages, enabling reliable asynchronous communication. (Added: 2026-03-01)
*   **[P1] Swarm Snapshotting (Deep-Freeze)**: Ability to capture and restore the full state of an agent swarm for long-term tasks. (Added: 2026-03-01)
