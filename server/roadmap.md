...
*   **[P0] Intent-Bounded Governance Middleware**: Semantic validation of tool calls against signed user intent. (Added: 2026-02-27)
*   **[P1] Interactive "Ask-the-User" Passthrough**: Protocol extension for interactive subagent prompting. (Added: 2026-02-27)
*   **[P2] State Branching Service**: Implementation of lightweight state branching for parallel execution (/fork). (Added: 2026-02-27)
