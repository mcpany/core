...
*   **[P0] Hardware-Locked Mission Lease (HLML) Provider**: Authoritative TPM-signed lease service for deterministic lifecycle-bound agency. (Added: 2026-07-25)
*   **[P0] Fast-Path Mesh Resumption**: Performance optimization for AMT using hardware-attested Mesh Tickets to bypass repeated handshakes. (Added: 2026-07-25)
*   **[P0] Deterministic Mission Lifecycle Controller**: Authoritative service for synchronizing resource reclamation with HLML lease expiration. (Added: 2026-07-25)
