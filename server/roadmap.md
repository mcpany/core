...
*   **[P0] Invocation Sovereignty Shield (ISS)**: Kernel-resident interceptor to block unauthorized high-risk flags in agent invocations (CVE-2026-38102 defense). (Added: 2026-07-25)
*   **[P0] Stylometric Entropy Monitor (SEM)**: Reasoning-smoothness analysis to detect template-based mimicry in AIR quorums. (Added: 2026-07-25)
*   **[P0] Process-Bound Lineage Attestation**: Mandatory parent-process validation for local agent spawns to neutralize supply chain attacks. (Added: 2026-07-25)
*   **[P0] Atomic Mailbox Integrity (AMI) Validator**: Fragment-level hardware attestation for inter-teammate coordination messages. (Added: 2026-07-25)
