...
*   **[P0] Memory Integrity Scanner**: Immune-system middleware for Shared KV Store to detect and quarantine poisoned agent state. (Added: 2026-03-10)
*   **[P0] Confused Deputy Guard**: Intent-aware tool validation to ensure tool calls align with human-attested goals. (Added: 2026-03-10)
*   **[P1] Encrypted Local Persistence**: Standardized, zero-knowledge SQLite storage for all agent session and conversation data. (Added: 2026-03-10)
