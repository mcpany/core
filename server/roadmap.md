...
*   **[P0] Headless Handoff Attestation (HHA)**: (P0) authoritative security protocol for transferring agent sessions between controllers using hardware-attested tokens. (Added: 2026-07-25)
*   **[P0] Registry-Bound Skill Attestation (RBSA)**: (P0) security middleware mandating cryptographically signed "Registry Proofs" for all discovered tools. (Added: 2026-07-25)
*   **[P1] Background Dispatch Sandbox (BDS)**: (P1) isolated execution environment for background agents with integrated reasoning-drift monitoring. (Added: 2026-07-25)
