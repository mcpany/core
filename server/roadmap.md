...
*   **[P0] Audit Sovereignty Hub (ASH)**: Authoritative local log issuer providing hardware-attested, high-fidelity audit logs. (Added: 2026-07-25)
*   **[P0] NHI Lifecycle Monitor (NLM)**: Real-time monitoring and automated revocation for orphaned or overprivileged agent tokens. (Added: 2026-07-25)
*   **[P0] Hardware-Attested Provenance Logging**: Mandatory TPM-bound signatures for all agent-driven audit events. (Added: 2026-07-25)
*   **[P1] NHI Privilege Pruner**: Dynamic capability restriction middleware based on real-time task lifecycle. (Added: 2026-07-25)
