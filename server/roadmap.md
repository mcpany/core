...
*   **[P0] Semantic Hash-Chained Mailbox**: Mandatory cryptographic chaining for all shared teammate mailbox messages to neutralize "Mailbox Splicing." (Added: 2026-07-25)
*   **[P0] System-Level Attention Anchor (SLAA)**: Hardware-locked attention-pinning for gateway security policies using `x-gemini-attention-lock` headers. (Added: 2026-07-25)
*   **[P1] RaaS Quota Manager**: Authoritative economic gatekeeper for governing tool-initiated sub-reasoning loops (Reasoning-as-a-Service). (Added: 2026-07-25)
