...
*   **[P0] Semantic State Pruning Middleware**: Intent-aware conversation history filtering for subagent handoffs. (Added: 2026-03-03)
*   **[P0] Discovery-Time Metadata Security Scanner**: Proactive prompt injection scanning for tool schemas. (Added: 2026-03-03)
*   **[P1] Ephemeral Session Entitlements**: Short-lived, one-time-use tool access tokens. (Added: 2026-03-03)
*   **[P1] Looping Drain Protection**: Rate-limiting and recursion depth monitoring for tool calls. (Added: 2026-03-03)
