...
*   **[P0] Fresh Context Window Isolation (FCWI) Manager**: Implement mission-bound context pruning for swarm specialists. (Added: 2026-07-25)
*   **[P1] Inter-Agent Messaging Observability (IAMO) Hub**: Authoritative audit trail service for inter-agent @mentions. (Added: 2026-07-25)
*   **[P0] Discovery-Phase Handshake Provider**: Hardware-attested handshake requirement for tool schema visibility. (Added: 2026-07-25)
*   **[P0] Fast-Path Identity Resumption (FPIR)**: Broker mission-bound Mesh Tickets to reduce inter-node coordination latency. (Added: 2026-07-25)
