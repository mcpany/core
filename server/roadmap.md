...
*   **[P0] Swarm Governance Middleware**: Auditor (Critic Agent) to intercept and validate inter-agent (A2A) message intent against signed manifests. (Added: 2026-03-08)
*   **[P0] Deterministic A2A Routing**: Cryptographic "Lineage Tokens" for message lineage tracking and auditability in large swarms. (Added: 2026-03-08)
*   **[P1] Model-Steering Context Propagation**: Propagate high-level "Steering Hints" (e.g. Gemini CLI) across the multi-agent execution chain. (Added: 2026-03-08)
