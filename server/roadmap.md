...
*   **[Discovery] Autonomous Tool Synthesis:** Interface for AgentSkills-driven tool registration.
*   **[Security] Zero-Trust Sandbox:** Docker-bound execution for local command tools.
