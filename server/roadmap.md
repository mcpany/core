...
*   **[P0] OpenClaw Security Sandbox**: Middleware for filesystem chroot and shell command filtering to secure autonomous agents. (Added: 2026-03-06)
*   **[P0] Verified Marketplace Gateway**: Enforcement layer for cryptographically signed tool packages. (Added: 2026-03-06)
*   **[P1] RAG-Augmented Tool Middleware**: Similarity-based injection of safety docs and grounding context into tool calls. (Added: 2026-03-06)
