...
*   **[P0] Anti-Hijack Gateway Guard**: Strict Host/Origin validation for local listeners. (Added: 2026-03-04)
*   **[P0] Stateful A2A Inbox**: Mailbox-style async communication for agent swarms. (Added: 2026-03-04)
*   **[P1] WASM Hook Runtime**: Sandboxed execution for lifecycle hooks. (Added: 2026-03-04)
