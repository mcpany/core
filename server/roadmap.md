...
*   **[P0] Tool-Specific Egress Firewall**: Network interception layer for all MCP tool calls to prevent SSRF and exfiltration. (Added: 2026-03-10)
*   **[P0] MCP Attestation Registry (Local)**: Local database of cryptographic hashes for all allowed MCP servers and tool definitions. (Added: 2026-03-10)
*   **[P1] Binary Sidecar Manager**: Secure management of ephemeral binary assets generated by tools, mapped to agent sessions. (Added: 2026-03-10)
