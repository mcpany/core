...
*   **[P0] Instruction-Bound Tunnel Sovereignty (IBTS)**: Implementation of per-instruction hardware attestation for AMT tunnels to neutralizing "Ghost Proxying." (Added: 2026-07-25)
*   **[P0] Speculative Consensus Hub (SCH)**: Transition from LFMA to SCH, supporting DRQ-compliant speculative task resolution. (Added: 2026-07-25)
*   **[P0] Root Attention Segment (RAS) Provider**: Implementation of AACP-compliant hardware-locked instruction pinning for mission-root guardrails. (Added: 2026-07-25)
*   **[P0] Identity-Jitter Mitigator (IJM)**: Performance-optimizing identity service utilizing asynchronous hardware-attested leases. (Added: 2026-07-25)
