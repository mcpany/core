...
*   **[P0] Persistent Headless Handoff**: Infrastructure for agents to run as background workers with remote steering capability. (Added: 2026-04-13)
*   **[P0] JIT Context Discovery Adapter**: Demand-based fetching of tool schemas and environment context. (Added: 2026-04-13)
*   **[P0] Bubblewrap Sandbox Integration**: Mandatory kernel-level isolation for process-bound discovery and tool execution. (Added: 2026-04-13)
