...
*   **[P0] Intent-Scoped Snapshot Controller**: Extension for PLSS to perform targeted, non-disruptive environment rollbacks. (Added: 2026-05-03)
*   **[P1] ContextEngine Sidecar Adapter**: Pluggable bridge for OpenClaw-native modular context management. (Added: 2026-05-03)
*   **[P0] Absence Proof (DAP) Generator**: (Re-affirmed P0) Security service for signing proofs of non-existence for restricted config files (CVE-2026-25725).
