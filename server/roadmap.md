...
*   **[P0] Chain of Custody (CoC) Middleware**: Cryptographic signing of agent intent chains to prevent "Shadow Agent" exploits. (Added: 2026-03-01)
*   **[P0] Dynamic Capability Bridge**: Secure, attested local capability provider for cloud-sandboxed agents (e.g. Claude STS). (Added: 2026-03-01)
*   **[P1] Lazy-MCP Discovery Guardrails**: Real-time availability verification to prevent semantic discovery hallucinations. (Added: 2026-03-01)
