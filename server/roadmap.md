...
*   **[P0] Wait-Graph Lease Arbiter (WLA)**: Proactive deadlock resolution for teammate meshes utilizing dependency-graph analysis. (Added: 2026-07-25)
*   **[P0] Speculative Tunnel Prefetcher (STP)**: Performance-optimizing service pre-emptively establishing hardware-attested mesh handshakes. (Added: 2026-07-25)
*   **[P0] GC-Immune Attention Hub**: Infrastructure for flagging mission-critical context fragments as exempt from attention-window GC. (Added: 2026-07-25)
