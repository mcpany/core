...
for all coordination fragments. (Added: 2026-06-14) * **[P0] Side-Channel
Immunity Filter**: Frequency-analysis middleware for SCI to detect hidden
coordination noise. (Added: 2026-06-14) * **[P0] MRA-Backed Lineage Provider**:
Hardware-bound collision-resistant semantic hashes for deep reasoning chains.
(Added: 2026-06-14)
