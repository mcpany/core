...
*   **[P0] Secure Hook Execution Engine**: Sandboxed command execution with mandatory HITL approval. (Added: 2026-02-27)
*   **[P1] Skill Marketplace Verifier**: Automated provenance and signature verification for 3rd-party skills. (Added: 2026-02-27)
*   **[P1] Managed-Local Hybrid Bridge**: Centralized security telemetry for local agent nodes. (Added: 2026-02-27)
