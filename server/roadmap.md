...
*   **[P0] Neural Monologue Shield (NMS)**: Implementation of hardware-bound encryption for subagent reasoning monologues. (Added: 2026-07-25)
*   **[P0] Hardware-Locked Resumption (HLR)**: Authority service mandating fresh TPM signatures for persistent session recovery. (Added: 2026-07-25)
*   **[P1] DSG-Native Grafting Hub**: Authoritative broker for UAB v1.6 Dynamic Skill Grafting protocol. (Added: 2026-07-25)
