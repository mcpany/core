...
*   **[P0] Epistemic Uncertainty Gate (EUG)**: Real-time monitoring of agent confidence scores for automated supervisor escalation. (Added: 2026-07-25)
*   **[P0] Hardware-Locked Lease Refresh (HLLR)**: Process-bound anchoring and sub-minute re-attestation for high-privilege leases. (Added: 2026-07-25)
*   **[P0] Mesh-Local Offloading (MLO) Broker**: Authoritative tunnel manager for peer-to-peer compute sharing between local nodes. (Added: 2026-07-25)
*   **[P1] Kernel-Resident Shard Persistence**: zero-copy state handoffs for MLO utilizing `memfd_create`. (Added: 2026-07-25)
