...
*   **[P0] Domain Socket / Named Pipe Gateway**: Security-hardened IPC transport to replace local TCP/WebSockets. (Added: 2026-03-01)
*   **[P0] Config Integrity Guard (Double-Lock)**: Prevent untrusted project-local configs from overriding security settings. (Added: 2026-03-01)
*   **[P1] Ephemeral Port Tokenization**: Single-use auth tokens for legacy TCP tool discovery. (Added: 2026-03-01)
