...
*   **[P0] Agent Identity Provider (AIDP)**: Core service for managing cryptographic agent identities (AIM) and signing tool requests. (Added: 2026-03-06)
*   **[P0] Inline Policy Engine (MCP-DPI)**: Payload-level inspection and enforcement middleware for tool call arguments. (Added: 2026-03-06)
*   **[P1] Identity-Linked Audit Logging**: Integration of AIDP signatures into the global audit trail. (Added: 2026-03-06)
