...
*   **[P0] Reasoning-Aware Garbage Collection (R-GC)**: Context eviction tied to reasoning confidence to neutralize "State Squatting." (Added: 2026-07-25)
*   **[P0] Ephemeral Registry Token (ERT) Provider**: session-locked discovery schemas to neutralize Registry Persistence exploits. (Added: 2026-07-25)
*   **[P0] Hierarchical Provenance Validator (v2)**: Support for recursive fragment signing (Gemini v2 compliance). (Added: 2026-07-25)
*   **[P0] Mesh Shadowing Interceptor**: Detection and blocking of unauthorized inter-node local tunnels in AMT. (Added: 2026-07-25)
