...
*   **[P0] Context Budgeting Middleware**: Implement LRU-based tool eviction for context window management. (Added: 2026-02-27)
*   **[P1] Dynamic Tool Refresh**: Add support for `notifications/list_changed` to update tool registry without session resets. (Added: 2026-02-27)
*   **[P1] Local Sandbox Execution Bridge**: Build isolated environment for high-risk local tools with strict env-var stripping. (Added: 2026-02-27)
