...
*   **[P0] Federated Skill Attestation (FSA) Hub**: Authoritative trust oracle for agent skills utilizing Merkle-tree attestations. (Added: 2026-07-25)
*   **[P0] Epistemic Truth Broker (ETB)**: authoritative state-verification service issuing hardware-signed Truth Receipts. (Added: 2026-07-25)
*   **[P1] Stylometric Phishing Detector**: Real-time security extension for SBF v2 detecting mimicry-based intent hijacking. (Added: 2026-07-25)
*   **[P0] ZKCD Mandate Enforcement**: Implementation of mandatory cryptographic capability masking for enterprise swarms. (Added: 2026-07-25)
