...
*   **[P0] Shard-Level Ephemeral Secret (SLES) Broker**: authoritative secret management providing hardware-attested, task-bound credentials tied to context shards. (Added: 2026-07-25)
*   **[P0] Recursive Mission Reflection (RMR) Auditor**: advanced alignment service mandating hardware-attested subagent self-reflection audits. (Added: 2026-07-25)
*   **[P0] Attested Context-Shift Validator**: security middleware implementing CWSA to ensure anchor permanence during window shifts. (Added: 2026-07-25)
*   **[P0] Fast-Path Reflection Attestation**: time-bound reflection leases to neutralize RMR latency via session-bound trust. (Added: 2026-07-25)
