...
*   **[P0] Supply Chain Provenance Attestor (SCPA)**: Authoritative provenance root for hardware-attested tool signatures. (Added: 2026-06-05)

*   **[P0] RAG-Retrieval Integrity Guard (RRIG)**: Real-time semantic sanitization of retrieved context fragments to prevent PII/IP leakage. (Added: 2026-06-05)

*   **[P0] Upstream Signature Validation (USV)**: Mandatory cryptographic provenance for all A2A tool discovery. (Added: 2026-06-05)

*   **[P0] Provenance-Aware Task Auctioning**: Logic to weight agent bids based on tool library provenance strength. (Added: 2026-06-05)
