...
*   **[P0] Atomic Process-Tree Reaping (APTR)**: Recursive kernel-level process monitoring to neutralize "Lease-Shadowing" exploits (CVE-2026-99102). (Added: 2026-07-25)
*   **[P0] Adaptive Mesh Compression (AMC)**: Dynamic compression scaling for the AMT Broker based on real-time link latency and entropy. (Added: 2026-07-25)
*   **[P0] Multi-Modal Anchor Pinning (MMAP)**: Hardware-locked pinning for non-textual context fragments to prevent visual anchor eviction. (Added: 2026-07-25)
