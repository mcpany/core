...
*   **[P0] WebSocket Origin Validation Middleware**: Strict origin/CSRF validation for all management WebSockets. (Added: 2026-03-11)
*   **[P0] Cross-Platform Skill Signature Matching**: Middleware for identifying known malicious "ToxicSkills" patterns. (Added: 2026-03-11)
*   **[P1] Global Attestation Mesh Protocol**: Federated trust score sharing for MCP tools. (Added: 2026-03-11)
