...
*   **[P0] Mesh-Resident Lease Arbiter (MRLA)**: Authoritative host for hardware-attested lease expansion to resolve capability deadlocks. (Added: 2026-07-25)
*   **[P1] P2P Congestion Controller (PCC)**: High-speed monitoring and fragment prioritization for Sovereign Node Tunnels. (Added: 2026-07-25)
*   **[P0] Reasoning-Aware Proof Aggregation (RAPA)**: Distributed attestation service for bundling subagent ZK-proofs into mission-root fragments. (Added: 2026-07-25)
