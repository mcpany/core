...
*   **[P0] Docker-Bound Named Pipe Transport**: Implement OS-level isolation for inter-agent A2A transport. (Added: 2026-03-07)
*   **[P0] Inter-Agent Exploit Guard**: Real-time detection and blocking of unauthorized host-port access. (Added: 2026-03-07)
*   **[P1] Port-Less Discovery Protocol**: Use Unix domain sockets for local service discovery. (Added: 2026-03-07)
