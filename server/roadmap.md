...
*   **[P0] Project-Level Security Sandbox**: Quarantine and manual attestation for project-local MCP servers and hooks. (Added: 2026-03-04)
*   **[P1] Dynamic Tool Scoping Middleware**: Automated filtering of tools based on project context and intent. (Added: 2026-03-04)
*   **[P0] A2A Session Hardening**: Cryptographically bound session handoffs for multi-agent swarms. (Added: 2026-03-04)
