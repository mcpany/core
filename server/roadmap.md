...
*   **[P0] Local Ingress Guardian**: Implement UDS/Named Pipe transport to prevent Cross-Site WebSocket hijacking (OpenClaw exploit mitigation). (Added: 2026-02-27)
*   **[P1] Dynamic Policy Synthesizer**: AI-assisted policy generation for agent reputations. (Added: 2026-02-27)
