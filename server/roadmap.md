...
*   **[P0] Consensus-Bound Tunnel Revocation (CBTR)**: Authoritative mesh monitoring allowing quorums to revoke inter-node tunnels. (Added: 2026-07-25)
*   **[P0] Nested Lease Attestation (NLA)**: Recursive scope validation ensuring sub-leases remain bound to primary mission root. (Added: 2026-07-25)
*   **[P0] Stylometric Reasoning Defense (SRD)**: High-dimensional behavioral anchoring using token-log-probability analysis. (Added: 2026-07-25)
*   **[P1] Speculative Shard Prefetcher**: Coordination middleware to reduce attention-warmup latency in sharded meshes. (Added: 2026-07-25)
