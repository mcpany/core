...
*   **[P0] Atomic Lease Invalidation (ALI) Hub**: Kernel-mediated (ebpf) instant revocation for Sovereign Node Tunnels. (Added: 2026-07-25)
*   **[P0] RAE Shard Broker**: Hardware-enclave session key management for reasoning-aware encryption of teammate shards. (Added: 2026-07-25)
*   **[P0] CMIR Validator**: Pre-reasoning semantic deconstruction for SVG/binary traces to reconstruct intent maps. (Added: 2026-07-25)
*   **[P0] Mesh-Resident Handshake Interceptor (MRHI)**: Security middleware for detecting out-of-band tunnel initiation. (Added: 2026-07-25)
