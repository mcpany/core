...
*   **[P0] Shard-Level Redaction (SLR) Hub**: Authoritative redaction broker for automated context shard sanitization. (Added: 2026-07-25)
*   **[P0] Ephemeral Workspace Snapshot (EWS) Bridge**: Integration for hardware-locked environment recovery during autonomous file edits. (Added: 2026-07-25)
*   **[P1] Attention-Aware Quota (AAQ) Controller**: Dynamic resource management scaling budgets based on mission-root attention priority. (Added: 2026-07-25)
*   **[P0] Multi-modal Header Sanitizer (MHS)**: Recursive semantic deconstruction of image/audio metadata to block instruction smuggling. (Added: 2026-07-25)
