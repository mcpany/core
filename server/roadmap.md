...
- [x] **Tool Name Fuzzy Matching**: **UX**: Improve error messages for tool execution by suggesting similar tool names when a user makes a typo. (Friction Fighter)
...
| 49   | **Tool Argument Fuzzy Matching**              | **UX**: Improve error messages for tool execution by suggesting correct argument names when a user makes a typo in the input JSON.                                                                                 | Medium     |
| 50   | **Tool Registration Debugger**                | **DevX**: A CLI command or UI view to list all registered tools and their source (config file, dynamic discovery, etc.) to help debug why a tool is missing.                                                       | Low        |
