...
*   **[P0] Monotonic Coordination Anchoring (MCA)**: mandatory hardware-bound timestamps for coordination fragments to neutralize contextual replay attacks. (Added: 2026-07-25)
*   **[P0] Epistemic Confidence Broker (ECB)**: automated epistemic escalation and reflection-quorum triggering for low-confidence reasoning. (Added: 2026-07-25)
*   **[P0] Teammate Mirror-Intent Arbiter (TMIA)**: authoritative mission-root synchronization service for horizontal meshes. (Added: 2026-07-25)
