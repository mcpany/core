...
*   **[P0] Temporal Mesh Resumption (TMR) Gateway**: authoritative temporal broker utilizing MRT session tokens for sub-millisecond mission resumption across distributed nodes. (Added: 2026-07-25)
*   **[P0] ZK-Lease Provider**: security service brokering hardware-attested, zero-knowledge capability proofs to reduce compute overhead of ZKLV. (Added: 2026-07-25)
*   **[P0] Monotonic Reasoning Attestation (MRA)**: identity service cryptographically binding reasoning fragments to monotonic counters to neutralize replay attacks. (Added: 2026-07-25)
