...
*   **[P0] Config Integrity Attestation**: Cryptographic signing and verification of project-level configuration files to prevent malicious overrides. (Added: 2026-03-06)
*   **[P0] Universal Credential Isolation Proxy**: Secure middleware to proxy API requests and isolate credentials from agent environments. (Added: 2026-03-06)
*   **[P1] Swarm Economic Guardrails**: Policy-based limits on tool-call recursion and token spend for large-scale agent swarms. (Added: 2026-03-06)
