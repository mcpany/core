...
*   **[P0] Enclave-Aware Session Migration (EASM)**: Authoritative broker for TPM-signed reasoning session handovers between physical devices. (Added: 2026-07-25)
*   **[P1] Compact Capability Tokens (CCT)**: Identity service issuing cryptographically minimized tokens to neutralize "Attestation Exhaustion." (Added: 2026-07-25)
*   **[P1] Asynchronous Reflection Hub**: Distributed coordination service for non-blocking teammate reflection quorums. (Added: 2026-07-25)
*   **[P0] Recursive Nesting Guard (RNG)**: Security extension for sharded context fragments to prevent "Context Inversion" in nested swarms. (Added: 2026-07-25)
