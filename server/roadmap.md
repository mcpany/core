...
*   **[P0] Mesh-Resident Identity Hub (MRIH)**: authoritative identity service for horizontal meshes issuing hardware-attested, session-bound tokens. (Added: 2026-07-25)
*   **[P0] Teammate Mailbox Integrity (TMI)**: real-time semantic validation of inter-agent coordination messages to neutralize "Mailbox Splicing." (Added: 2026-07-25)
*   **[P0] Mission-Root Continuity Broker (MRCB)**: hardware-locked resumption of agent states across headless rotations and session decay. (Added: 2026-07-25)
*   **[P0] Sovereign Discovery Proxy (SDP)**: advanced discovery gate mandating cryptographic capability masking until mission-bound handshake. (Added: 2026-07-25)
