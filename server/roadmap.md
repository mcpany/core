...
*   **[P0] Lazy-Discovery Search Standard (ToolSearchTool)**: Universal middleware for the `ToolSearchTool` standard to eliminate "Context Wall" issues. (Added: 2026-03-01)
*   **[P0] Mandatory Tool Provenance Signing**: Cryptographic enforcement of MCP server integrity to prevent marketplace-based RCE. (Added: 2026-03-01)
*   **[P1] Context Metadata Sanitizer**: Security layer to prevent indirect prompt injection (CVE-2026-27001) in agent environments. (Added: 2026-03-01)
