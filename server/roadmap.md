...
*   **[P0] Immutable Execution Logs**: Cryptographic append-only ledger for tool calls and system state. (Added: 2026-03-05)
*   **[P0] Config Sandbox Validator**: Secure, isolated parsing and validation of project-level MCP configurations. (Added: 2026-03-05)
*   **[P1] Policy Refinement Loop**: HITL-driven evolution of security policies based on observed ecosystem threats. (Added: 2026-03-05)
