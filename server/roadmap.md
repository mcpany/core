...
*   **[P0] Discovery-Phase Sandbox Middleware**: Ephemeral execution for discovery commands to neutralize startup-time RCE. (Added: 2026-07-25)
*   **[P0] Lock-Free Teammate Coordination (LFTC)**: CRDT-based mailbox sharding for non-blocking horizontal swarms. (Added: 2026-07-25)
*   **[P0] Argument-Level Semantic Validator (ALSV)**: Deep-inspection for command arguments to prevent shell-fallback exploits. (Added: 2026-07-25)
