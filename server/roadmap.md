...
*   **[P0] A2A-to-MCP Adapter**: Gateway for wrapping A2A agents as standard MCP tools. (Added: 2026-02-27)
*   **[P1] Predictive Federated Registry Sync**: Background sync of tool registries to minimize discovery latency. (Added: 2026-02-27)
*   **[P1] Privacy-Preserving Handoff Middleware**: Automatic context pruning for A2A handoffs. (Added: 2026-02-27)
