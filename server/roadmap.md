...
*   **[P0] Dynamic Attestation Scaler (DAS)**: risk-adaptive security service within the CQ Hub to resolve "Consensus Fatigue" in high-density swarms. (Added: 2026-07-25)
*   **[P0] Hardened Discovery Sandbox (HDS)**: kernel-isolated runtime for tool discovery with mandatory ALSV to neutralize CVE-2026-25593. (Added: 2026-07-25)
*   **[P0] Verifiable Semantic Lineage (VSL) Provider**: identity service issuing hardware-attested semantic fingerprints for multi-hop reasoning. (Added: 2026-07-25)
*   **[P1] Trust Domain Orchestrator**: management service for Tiered Mission Sovereignty and low-latency mesh coordination. (Added: 2026-07-25)
