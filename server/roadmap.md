...
*   **[P0] Collaborative Anomaly Detection (CAD)**: Authoritative security service performing cross-agent behavioral analysis to detect coordinated offensive patterns. (Added: 2026-07-25)
*   **[P0] Origin-Bound Session Pinning**: Mandatory cryptographic binding between session tokens and initiating origins to neutralize WebSocket hijacking. (Added: 2026-07-25)
