...
*   **[P0] Active Context Refresh (ACR) Middleware**: implementation of real-time attention-head re-injection of mission-root anchors. (Added: 2026-07-25)
*   **[P0] Task-Completion Attestation (TCA)**: mandatory hardware-attested proofs of task completion for mission-root sovereignty. (Added: 2026-07-25)
*   **[P1] Handshake Proxy Service (HPS)**: pre-authenticated mesh-ticket brokering for low-latency P2P tunnel resumption. (Added: 2026-07-25)
*   **[P1] Semantic Token Compression (STC)**: real-time lossy history compression for performance-aware context refresh. (Added: 2026-07-25)
