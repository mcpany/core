...
*   **[P0] Federated Discovery Quorum (FDQ)**: Decentralized discovery service for mesh-native tool registries without a central gateway. (Added: 2026-07-25)
*   **[P0] Risk-Aware Adaptive Attestation (RAAA)**: Dynamic security middleware scaling attestation strength based on real-time risk scores. (Added: 2026-07-25)
*   **[P0] Multimodal Reason-Proof (MMRP) Validator**: Zero-Knowledge proof validator for non-textual reasoning fragments (SVG, Audio). (Added: 2026-07-25)
*   **[P0] Mission-Bound Inode Pinning (MBIP) Enforcer**: Kernel-level protection for shared workspace file descriptors bound to mission-root IDs. (Added: 2026-07-25)
