...
*   **[P0] Anomalous Tool Call Detector**: LLM-reasoning layer to detect and block hijacked tool calls based on intent drift. (Added: 2026-03-02)
*   **[P1] Context Integrity Attestation**: Cryptographic Linkage Tokens for binding parent instructions to subagent tool calls. (Added: 2026-03-02)
*   **[P1] Tool Annotation Policy Matcher**: Fine-grained governance using semantic tool annotations and wildcards. (Added: 2026-03-02)
