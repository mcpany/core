...
replace github.com/mcpany/core/pkg/client => ../pkg/client
...
require (
	...
	github.com/mcpany/core/pkg/client v0.0.0-00010101000000-000000000000
...
replace github.com/eko/gocache/lib/v4 => github.com/eko/gocache/lib/v4 v4.2.0

replace github.com/eko/gocache/store/go_cache/v4 => github.com/eko/gocache/store/go_cache/v4 v4.2.0

replace github.com/gin-gonic/gin => github.com/gin-gonic/gin v1.9.1

replace k8s.io/client-go => k8s.io/client-go v0.34.1

replace google.golang.org/api => google.golang.org/api v0.256.0
...
replace github.com/fclairamb/afero-s3 => github.com/fclairamb/afero-s3 v0.3.1

replace github.com/googleapis/enterprise-certificate-proxy => github.com/googleapis/enterprise-certificate-proxy v0.3.7
