...
// Summary: DoctorRunner runs the doctor command checks. Component to run system health diagnostics.
//
// Parameters:
//   - None.
//
...
// Summary: Run executes the doctor checks. Runs a series of health checks (config, connectivity, deep health).
//
// Parameters:
