...
//
// It starts an HTTP server that acts as a sidecar for webhook processing.
// It handles signature verification and standard webhook tasks like
// markdown conversion, text truncation, and pagination.
//
// Side Effects:
