...
//
// It starts an HTTP server that listens for incoming webhook requests, verifies signatures
// (if configured), and routes them to the appropriate handler (e.g., /markdown, /truncate).
//
// Side Effects:
