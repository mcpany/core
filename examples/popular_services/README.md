...
This directory contains a collection of popular services that have been converted to upstream services for MCP Any.

## Usage

To use these services, you can load the `config.yaml` files in this directory into your MCP Any instance. You can do this by adding the following to your MCP Any configuration:
...
2. In the subdirectory, create a `config.yaml` file that registers the service in MCP Any format.
