...
SRM (Signed Reasoning Monologue) provider to ensure every system-level command
carries its full reasoning lineage.
3. **Mailbox Sovereignty:** Harden the T2T bridge to support sharded, lock-free
mailboxes that enforce mesh-resident identity rotation.
