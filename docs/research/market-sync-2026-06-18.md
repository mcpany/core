...
**Finding:** OpenClaw has transitioned from reactive R-GC to "Predictive State Purging" (PSP). This proactively prunes speculative context shards based on a real-time "Mission Utility" score *before* they can flood the parent's attention window.
