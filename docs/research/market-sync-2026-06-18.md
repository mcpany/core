...
- **OpenClaw**: Released the **Cognitive Entropy Guard (CEG)**, a new middleware
...
allowing for TPM-signed state snapshots that persist across framework handoffs.
...
their security posture, leading to unauthorized tool calls in horizontal swarms.
