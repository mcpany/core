...
* **System Flow:**
    [Agent] --(Reasoning Trace)--> [CEC Middleware]
    [CEC Middleware] --(Calculate)--> [Hardware Accelerator]
    [Hardware Accelerator] --(Entropy Score)--> [CEC Middleware]
    [CEC Middleware] --(Verify)--> [Mission Policy]
* **APIs / Interfaces:**
