...
ACR Hub implements the OpenClaw ACR protocol to provide a centralized revocation
...
* **The Happy Path (Tasks):**
  ...
  4. The subagent's next attempt to use a search tool is blocked at the gateway.
