...
*   **2026-03-01:** Expanded to support **Nested Hierarchical Delegation** and **Parallel Agent Teams**. Introduced `X-MCP-Depth` header to prevent infinite recursion in nested swarms.
