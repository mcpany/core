...
* System Flow:
  * Agent A initiates request.
  * HLCH Gateway challenges for TPM signature.
  * Hardware-bound session token is verified against the Mission-Root Registry.
  * Coordination is permitted or blocked.
* APIs / Interfaces:
