...
* **Goals:**
    ...
    * Scan JSON-RPC tool schemas, descriptions, and examples for imperative
      command patterns.
    * Detect and block hidden "Prompt Injection" fragments in structural
      metadata.
    * Provide hardware-attested (TPM) signatures for sanitized metadata
      lineages.
* **Non-Goals:**
...
* **Security (Zero Trust):** The SMS must be a mandatory gate for all discovery-
  time data.
...
* **2026-06-15:** Added **WASM-Hook Behavioral Profiling** to counter PR "Logic
  Bombs." SMS now performs mandatory, sandboxed behavioral profiling of AI-
  generated configuration hooks before they are deemed "Loadable."
