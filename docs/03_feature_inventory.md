...
### Proposed Additions
- **Reason-Graph Integrity (RGI) Provider**: (P0) Authoritative security middleware performing hardware-attested structural analysis.
- **Mesh-Resident Policy Manager (MRPM)**: (P0) Federated policy service for MRPS compliance.
- **AAG Middleware**: (P1) Optimization extension for DAG middleware implementing "Entropy-Aware Attention Gating."
- **Spectral Attention Guard**: (P0) Advanced security service for DAG middleware that injects timing jitter.
