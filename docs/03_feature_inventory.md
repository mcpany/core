...
### Proposed Additions
- **Chapter-Bound Mission Broker**: (P0) Authoritative chapter management service that cryptographically binds tool capabilities and context shards to specific mission phases.
- **Autonomous NHI Identity Rotation (ANIR)**: (P0) Hardware-locked identity management service that rotates subagent credentials automatically upon task or chapter completion.
- **Cross-Session Chapter Resumption Provider**: (P1) Persistence middleware ensuring that mission-root anchors and chapter-specific state fragments survive environment reboots.

### Priority Shifts
- **Just-In-Time (JIT) Capability Masking**: (Re-affirmed P0) Elevated to **v2** with mandatory support for chapter-local toolset invisibility.
- **Mission-Root Continuity Provider (MRCP)**: (Re-affirmed P0) Designated as the primary backend for the new **Cross-Session Chapter Resumption** requirements.
