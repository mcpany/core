...
* **Intent Hierarchy Enforcer (IHE):** P0. Middleware to ensure mission-root
  priority for all state fragments in the Shared Blackboard.
* **Kernel-Namespace (KNS) Command Runner:** P0. High-performance micro-VM
  wrapper for tool execution, neutralizing cross-agent file access.
* **Mission Anchor Host (MAH):** P0. Orchestration service for pinned, team-
  wide context anchors to reduce swarm coordination latency.
* **Zero-Knowledge (ZK) Capability Masker:** P1. Discovery component
