...
- **Intent Hierarchy Enforcer (IHE)**: (P0) Authoritative security
  middleware that enforces a strict "Intent Priority".
- **Kernel-Namespace Command Runner**: (P0) High-security tool execution
  engine that utilizes Firecracker micro-VMs.

### Strategic Priority Shifts [2026-05-30]

- **CSAD Hub**: (Re-affirmed P0) Now elevated with the requirement for
  **Intent-Hierarchy Verification**.
