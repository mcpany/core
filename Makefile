...
gen: gen-gateway-proto gen-protoset
...
docker-test:
	docker build -t mcpany/core-test -f server/docker/Dockerfile.dev .
	docker run $(DOCKER_RUN_OPTS) sh -c 'mkdir -p /workspace/build/home && git config --global --add safe.directory /workspace && make test'

docker-lint:
	docker build -t mcpany/core-test -f server/docker/Dockerfile.dev .
	docker run $(DOCKER_RUN_OPTS) sh -c 'mkdir -p /workspace/build/home && git config --global --add safe.directory /workspace && make lint'
