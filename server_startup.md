...
time=2025-12-31T03:05:33.389Z level=INFO source=/usr/local/google/home/kxw/core/server/pkg/config/load.go:58 msg="No users configured, creating default user" component=configLoader
time=2025-12-31T03:05:33.389Z level=INFO source=/usr/local/google/home/kxw/core/server/cmd/server/main.go:76 msg=Configuration service=mcpany mcp-listen-address=50050 registration-port="" stdio=false config-path=[/usr/local/google/home/kxw/core/server/config.minimal.yaml]
time=2025-12-31T03:05:33.389Z level=INFO source=/usr/local/google/home/kxw/core/server/cmd/server/main.go:78 msg="Attempting to load services from config path" service=mcpany paths=[/usr/local/google/home/kxw/core/server/config.minimal.yaml]
time=2025-12-31T03:05:33.389Z level=INFO source=/usr/local/google/home/kxw/core/server/pkg/app/server.go:228 msg="Starting MCP Any Service..."
time=2025-12-31T03:05:33.391Z level=INFO source=/usr/local/google/home/kxw/core/server/pkg/config/load.go:58 msg="No users configured, creating default user" component=configLoader
time=2025-12-31T03:05:33.391Z level=INFO source=/usr/local/google/home/kxw/core/server/pkg/worker/upstream_worker.go:47 msg="Upstream worker started" component=UpstreamWorker
time=2025-12-31T03:05:33.391Z level=INFO source=/usr/local/google/home/kxw/core/server/pkg/worker/registration_worker.go:50 msg="Service registration worker started" component=ServiceRegistrationWorker
time=2025-12-31T03:05:33.391Z level=INFO source=/usr/local/google/home/kxw/core/server/pkg/tool/management.go:435 msg="Registering tool with MCP server" toolID=builtin.mcplist_roots_b10148e7 toolName=builtin.mcp:list_roots tool="&{Meta:map[] Annotations:<nil> Description:Lists the roots available on the client side. InputSchema:map[type:object] Name:builtin.mcp:list_roots OutputSchema:<nil> Title:List Roots}"
time=2025-12-31T03:05:33.391Z level=INFO source=/usr/local/google/home/kxw/core/server/pkg/app/server.go:832 msg="DEBUG: Registering /mcp/u/ handler"
time=2025-12-31T03:05:33.392Z level=ERROR source=/usr/local/google/home/kxw/core/server/pkg/app/server.go:1205 msg="Server startup failed, initiating shutdown..." error="failed to start a server: [MCP Any HTTP] server failed to listen: listen tcp :50050: bind: address already in use"
time=2025-12-31T03:05:33.392Z level=INFO source=/usr/local/google/home/kxw/core/server/pkg/app/server.go:1215 msg="Waiting for HTTP and gRPC servers to shut down..."
time=2025-12-31T03:05:33.392Z level=INFO source=/usr/local/google/home/kxw/core/server/pkg/app/server.go:1217 msg="All servers have shut down."
time=2025-12-31T03:05:33.392Z level=INFO source=/usr/local/google/home/kxw/core/server/pkg/worker/upstream_worker.go:90 msg="Upstream worker stopping" component=UpstreamWorker
time=2025-12-31T03:05:33.392Z level=INFO source=/usr/local/google/home/kxw/core/server/pkg/worker/registration_worker.go:211 msg="Service registration worker stopping" component=ServiceRegistrationWorker
time=2025-12-31T03:05:33.392Z level=ERROR source=/usr/local/google/home/kxw/core/server/cmd/server/main.go:124 msg="Application failed" service=mcpany error="failed to start a server: [MCP Any HTTP] server failed to listen: listen tcp :50050: bind: address already in use"
Error: failed to start a server: [MCP Any HTTP] server failed to listen: listen tcp :50050: bind: address already in use
Usage:
  mcpany run [flags]
